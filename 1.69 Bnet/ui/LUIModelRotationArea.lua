...
local function var_0_16(arg_5_0, arg_5_1)
	...
	if var_5_5 and arg_5_0.currentState ~= var_5_5 and not arg_5_0.lockTurnAnimUpdate then
		...
		if var_5_5 == var_0_11.Left then
			var_5_6 = OPERATOR.GetTurnLeftAnimation(arg_5_0.operatorRef, arg_5_0.operatorSkinRef, arg_5_0.turnCounter)
			arg_5_0.turnCounter = arg_5_0.turnCounter + 1
		elseif var_5_5 == var_0_11.Right then
			var_5_6 = OPERATOR.GetTurnRightAnimation(arg_5_0.operatorRef, arg_5_0.operatorSkinRef, arg_5_0.turnCounter)
			arg_5_0.turnCounter = arg_5_0.turnCounter - 1
		end
		...
		local var_5_14 = OPERATOR.GetTurnIdleAnimation(arg_5_0.operatorRef, arg_5_0.operatorSkinRef, arg_5_0.turnCounter)
...
function LUI.UIModelRotationArea.ResetRotation(arg_12_0, arg_12_1)
	...
	if arg_12_0._modelIndex and arg_12_0._type == LUI.UIModelRotationArea.Types.Weapon then
		ClientWeapon.BJDAEAFFA(arg_12_0._modelIndex, arg_12_1[1], arg_12_1[2], arg_12_1[3])
	end

	arg_12_0._currentYaw = arg_12_1[2]
	arg_12_0._currentYawDirection = arg_12_1[2]
	arg_12_0._currentRoll = arg_12_1[3]
end
...
function LUI.UIModelRotationArea.SetCharacterInfo(arg_23_0, arg_23_1, arg_23_2, arg_23_3)
	assert(type(arg_23_1) == "number")

	arg_23_0._modelIndex = arg_23_1
	arg_23_0.operatorRef = arg_23_2
	arg_23_0.operatorSkinRef = arg_23_3
	arg_23_0.turnCounter = 0
	arg_23_0.currentState = var_0_11.Idle
end

function LUI.UIModelRotationArea.SetCharacterSkinRef(arg_24_0, arg_24_1)
	arg_24_0.operatorSkinRef = arg_24_1
end

function LUI.UIModelRotationArea.GetClientCharacterTurnIdleAnim(arg_25_0)
	return (OPERATOR.GetTurnIdleAnimation(arg_25_0.operatorRef, arg_25_0.operatorSkinRef, arg_25_0.turnCounter))
end

function LUI.UIModelRotationArea.init(arg_26_0, arg_26_1)
	LUI.UIModelRotationArea.super.init(arg_26_0, arg_26_1)
	assert(arg_26_1)
	assert(arg_26_1.type)

	arg_26_0._type = arg_26_1.type
	arg_26_0._controllerIndex = arg_26_1.controllerIndex

	if arg_26_0._type == LUI.UIModelRotationArea.Types.Character then
		arg_26_0:OverrideMouseCursorType(MouseCursorType.CURSOR_TYPE_ARROW_PANFOURWAYS)
	else
		arg_26_0:OverrideMouseCursorType(MouseCursorType.CURSOR_TYPE_ROTATION_NORMAL)
	end

	arg_26_0.Reset = var_0_25
	arg_26_0._rotationInput = 0
	arg_26_0._currentYaw = 0
	arg_26_0._currentRoll = 0
	arg_26_0._currentYawDirection = 0

	arg_26_0:registerEventHandler("gamepad_sticks", var_0_20)
	arg_26_0:registerEventHandler("leftmousedown", var_0_21)
	arg_26_0:registerEventHandler("leftmouseup", var_0_24)
	arg_26_0:addEventHandler("popup_active", var_0_24)
	arg_26_0:addEventHandler("mouse_capture_lost", var_0_24)
	arg_26_0:addEventHandler("mousemove", var_0_19)
	arg_26_0:registerEventHandler("tick", var_0_23)

	function arg_26_0.AcceptsFocusType(arg_27_0, arg_27_1)
		return arg_27_1 == FocusType.MouseOver
	end

	arg_26_0:SetHandleMouse(true)

	if arg_26_0._type == LUI.UIModelRotationArea.Types.Weapon then
		arg_26_0.weaponYawRotationTimer = LUI.UITimer.new({
			interval = 50,
			event = "update_weapon_yaw_rotation"
		})
		arg_26_0.weaponYawRotationTimer.id = "lobbyTimer"

		arg_26_0:addElement(arg_26_0.weaponYawRotationTimer)
		arg_26_0:addEventHandler("update_weapon_yaw_rotation", function(arg_28_0, arg_28_1)
			var_0_13(arg_28_0)
		end)
	end

	local function var_26_0(arg_29_0, arg_29_1)
		if LUI.IsLastInputKeyboardMouse(arg_29_1) then
			if arg_29_0.timer then
				arg_29_0.timer:closeTree()

				arg_29_0.timer = nil
			end
		elseif arg_29_0._type == LUI.UIModelRotationArea.Types.Character and not arg_29_0.timer then
			local var_29_0 = LUI.UITimer.new({
				interval = 15,
				event = "tick"
			})

			var_29_0.id = "UIModelRotationAreaTimer"

			arg_29_0:addElement(var_29_0)

			arg_29_0.timer = var_29_0
		end
	end

	arg_26_0:registerEventHandler("update_input_type", function(arg_30_0, arg_30_1)
		var_26_0(arg_30_0, arg_30_1.controllerIndex)
	end)
end
