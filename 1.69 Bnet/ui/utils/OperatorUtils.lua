...
local function var_0_2(arg_5_0)
	...
	for iter_5_0 = 0, var_5_0 - 1 do
		...
		if var_5_1 then
			...
			if var_5_1.ref == "soap_western" then
				var_5_2 = false
			elseif var_5_1.dvarFilter ~= "" then
				local var_5_3 = Dvar.CFHDGABACF(var_5_1.dvarFilter)

				var_5_2 = var_5_3 == nil or var_5_3 == OPERATOR.UnlockState.HIDDEN

				if var_5_2 and OPERATOR.IsUnlocked(arg_5_0, var_5_1.ref) then
					var_5_2 = false
				end
			end

			OPERATOR.DvarFilterRefs[var_5_1.ref] = var_5_2
		end
	end
end
