...
CLIENT_MODEL.coreMPModels = {
	...
	PERK_PATCH_SOURCE = {
		name = "loadout_perk_source_patch_1"
	},
	PERK_ACTIVE_PATCH_SOURCE = {
		name = "loadout_perk_source_patch_2"
	},
	PERK_PASSIVE_PATCH_SOURCE = {
		name = "loadout_perk_source_patch_3"
	}
}
...
function CLIENT_MODEL.SetAllModelsModifiable(arg_5_0)
	local var_5_0 = {
		...
		CLIENT_MODEL.coreMPModels.PERK_PATCH_SOURCE,
		CLIENT_MODEL.coreMPModels.PERK_ACTIVE_PATCH_SOURCE,
		CLIENT_MODEL.coreMPModels.PERK_PASSIVE_PATCH_SOURCE
	}
...
function CLIENT_MODEL.UpdatePatchClientModels(arg_11_0, arg_11_1)
	...
	CLIENT_MODEL.SetModel(CLIENT_MODEL.coreMPModels.PERK_PATCH_SOURCE, PERK.GetSourceModel(arg_11_1.loadoutPerks[0]:get()))
	CLIENT_MODEL.SetModel(CLIENT_MODEL.coreMPModels.PERK_ACTIVE_PATCH_SOURCE, PERK.GetSourceModel(arg_11_1.loadoutPerks[1]:get()))
	CLIENT_MODEL.SetModel(CLIENT_MODEL.coreMPModels.PERK_PASSIVE_PATCH_SOURCE, PERK.GetSourceModel(arg_11_1.loadoutPerks[2]:get()))
end
