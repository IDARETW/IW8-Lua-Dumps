...
function GetErrorMessageButtons(arg_7_0)
	...
	if not CONDITIONS.CanAccessOfflineMenu() then
		return {
			var_7_0
		}
	end
...
function PopupNoOnlineServiceSubscriptionError(arg_10_0, arg_10_1)
	...
	local var_10_0
	local var_10_1 = Engine.CIEGIACHAE() and "PLATFORM/PSPLUS_REQUIRED" or Engine.EAABDHIDFJ() and "MSSTORE_PLATFORM/MPNOTALLOWED" or "XBOXLIVE/MPNOTALLOWED"
