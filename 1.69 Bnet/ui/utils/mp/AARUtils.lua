...
function AAR.GetGunsmithUnlockData(arg_24_0)
	...
	if not var_24_6 or var_24_6 == "" then
		return
	end
...
function AAR.GetUnlockIDTableAtRank(arg_27_0, arg_27_1, arg_27_2)
	if not arg_27_2 then
		...
		if CONDITIONS.ShouldUseCrossTitleIds() then
			local var_27_2 = CSV.progressionItems.cols.firstItem
			local var_27_3 = tonumber(StringTable.DIFCHIGDFB(CSV.progressionItems.GetFile(), CSV.progressionItems.cols.rank, arg_27_1, var_27_2))

			while var_27_3 and var_27_3 ~= "" do
				table.insert(var_27_1, var_27_3)

				var_27_2 = var_27_2 + 1
				var_27_3 = tonumber(StringTable.DIFCHIGDFB(CSV.progressionItems.GetFile(), CSV.progressionItems.cols.rank, arg_27_1, var_27_2))
			end
		else
			for iter_27_0 = CSV.progressionItems.cols.firstItem, CSV.progressionItems.cols.lastItem do
				local var_27_4 = tonumber(StringTable.DIFCHIGDFB(CSV.progressionItems.GetFile(), CSV.progressionItems.cols.rank, arg_27_1, iter_27_0))
...
function AAR.GetNextRankUnlockID(arg_28_0)
	local var_28_0 = PROGRESSION.GetPlayerProgressionData({
		_controllerIndex = arg_28_0
	})

	if not var_28_0._isUsingSeasonalRank then
		local var_28_1 = var_28_0._rank + 1

		if var_28_1 <= var_28_0._rankMax then
			return tonumber(StringTable.DIFCHIGDFB(CSV.progressionItems.GetFile(), CSV.progressionItems.cols.rank, var_28_1, CSV.progressionItems.cols.firstItem))
		end
	end
...
function AAR.GetNewUnlocksTable(arg_29_0, arg_29_1, arg_29_2)
	...
	if #arg_29_2 > 0 then
		...
		for iter_29_0 = 1, var_29_1 do
			local var_29_2 = tonumber(arg_29_2[iter_29_0].ID)

			if var_29_2 and not PROGRESSION.IsProgressionTracker(var_29_2) and not BATTLEPASS.IsTierUnlock(var_29_2) and PROGRESSION.IsProgressionUnlockItem(var_29_2) then
				local var_29_3 = LOOT.GetTypeForID(var_29_2)
				local var_29_4 = var_29_2 and LOOT.IsCamo(var_29_2)

				if var_29_3 and var_29_3 ~= LOOT.itemTypes.INVALID and var_29_3 ~= LOOT.itemTypes.ATTACHMENT and not var_29_4 then
					local var_29_5 = LOOT.GetItemRef(var_29_3, var_29_2)
					local var_29_6 = LOOT.GetItemQuality(var_29_3, var_29_5) or 0
					local var_29_7 = 0

					table.insert(var_29_0, {
						ID = var_29_2,
						rarity = var_29_6,
						isMaxRankUnlockItem = var_29_7
					})
				elseif var_29_3 then
					DebugPrint("Invalid unlocks ID" .. var_29_2 .. ". We should not have unlocks of type " .. var_29_3)
				else
					DebugPrint("Invalid unlocks ID" .. var_29_2 .. ".The loot type is not supported")
				end
			end
		end
	end
...
function AAR.GetRankupUnlockPackage(arg_31_0, arg_31_1, arg_31_2)
	local var_31_0 = {}
	local var_31_1 = AAR.GetUnlockIDTableAtRank(arg_31_0, arg_31_1, arg_31_2)

	for iter_31_0 = 1, #var_31_1 do
		local var_31_2 = tonumber(var_31_1[iter_31_0])

		if var_31_2 and not PROGRESSION.IsProgressionTracker(var_31_2) then
			local var_31_3 = LOOT.GetTypeForID(var_31_2)

			if var_31_3 and var_31_3 ~= LOOT.itemTypes.INVALID then
...
function AAR.PrestreamImagePackage(arg_32_0, arg_32_1, arg_32_2, arg_32_3, arg_32_4)
	...
	local var_32_8 = PROGRESSION.GetPlayerIsInSeasonalProgression(arg_32_1)
...
function AAR.IsAnyValidChallengeAvailable(arg_42_0, arg_42_1)
	...
	for iter_42_1 = 1, #arg_42_1 do
		...
		if var_42_4 and LOOT.IsCamo(var_42_4) then
			return true
		end
	end
		...
		if var_45_1[var_45_2] then
			...
			if var_45_4 and #var_45_4 > 0 then
				...
				elseif Challenge.IsGunsmithCamoChallenge(var_45_2, var_45_3) then
					...
					var_45_10 = LOOT.GetItemQuality(var_45_8, var_45_9, var_45_18) or 0
...
function AAR.GetCamoUnlocksPackage(arg_48_0)
	...
	for iter_48_0 = 1, #arg_48_0 do
		...
		if var_48_1 and LOOT.IsCamo(var_48_1) then
...
local function var_0_0(arg_49_0)
	arg_49_0 = tonumber(arg_49_0)
	arg_49_0 = arg_49_0 or PROGRESSION.FIRST_VALID_RANK

	return arg_49_0 + 1
end

local function var_0_1(arg_50_0, arg_50_1)
	assert(arg_50_0 and type(arg_50_0) == "number", "AAR.GetNumPrestigeLevelUpTriggersForSeasonalRankRange() -> startRange is nil and/or not a number, but expected to always be valid")
	assert(arg_50_1 and type(arg_50_1) == "number", "AAR.GetNumPrestigeLevelUpTriggersForSeasonalRankRange() -> endRange is nil and/or not a number, but expected to always be valid")

	arg_50_0 = var_0_0(arg_50_0)
	arg_50_1 = var_0_0(arg_50_1)

	local var_50_0 = arg_50_1 - arg_50_0
	local var_50_1 = arg_50_0 / PROGRESSION.NUM_RANKS_PER_PRESTIGE_LEVEL % 1
	local var_50_2 = PROGRESSION.NUM_RANKS_PER_PRESTIGE_LEVEL - var_50_1 * PROGRESSION.NUM_RANKS_PER_PRESTIGE_LEVEL
	local var_50_3 = 0

	if var_50_2 <= var_50_0 then
		var_50_3 = 1
		var_50_0 = var_50_0 - var_50_2
	end

	assert(var_50_0, "AAR.GetNumPrestigeLevelUpTriggersForSeasonalRankRange() -> numSeasonalRanks is nil and expected never to be")

	return var_50_3 + math.floor(var_50_0 / PROGRESSION.NUM_RANKS_PER_PRESTIGE_LEVEL)
end

function AAR.GetMatchInfoPackage(arg_51_0)
	local var_51_0 = OnlineAAR.BIJEDCBCBH(arg_51_0)
	local var_51_1 = AAR.ParsePlayerProgressionXPData(arg_51_0, var_51_0.StartXP, var_51_0.CurrentXP, var_51_0.StartSeasonXP, var_51_0.CurrentSeasonXP)

	var_51_0.ContractXP = 0

	if CONDITIONS.IsMagmaGameMode() then
		local var_51_2 = AAR.BrGetContractStatsForController(arg_51_0)

		if var_51_2 and var_51_2.totalContractXp then
			var_51_0.ContractXP = tonumber(var_51_2.totalContractXp) or 0
		end
	end

	local var_51_3 = {
		startXP = var_51_0.StartXP,
		currentXP = var_51_0.CurrentXP,
		startSeasonXP = var_51_0.StartSeasonXP,
		currentSeasonXP = var_51_0.CurrentSeasonXP,
		startTierXP = var_51_0.StartBattlepassXP,
		currentTierXP = var_51_0.CurrentBattlepassXP,
		battlepassTimeXP = var_51_0.BattlepassTimeXP,
		battlepassChallengeXP = var_51_0.BattlepassChallengeXP,
		startLevelXP = var_51_0.StartLevelXP,
		currentLevelXP = var_51_0.CurrentLevelXP,
		startLevel = var_51_0.StartLevel,
		currentLevel = var_51_0.CurrentLevel,
		startKeys = var_51_0.StartKeys,
		currentKeys = var_51_0.CurrentKeys,
		startCommonCrate = var_51_0.StartCommonCrate,
		currentCommonCrate = var_51_0.CurrentCommonCrate,
		startCPpoints = var_51_0.StartCPpoints,
		currentCPpoints = var_51_0.CurrentCPpoints,
		challengeBonus = var_51_0.ChallengeXP,
		missionXP = var_51_0.MissionXP,
		plunderBonus = var_51_0.PlunderXP or 0,
		matchXP = var_51_0.CurrentXP - var_51_0.StartXP + (var_51_0.CurrentSeasonXP - var_51_0.StartSeasonXP) - var_51_0.ChallengeXP - var_51_0.MissionXP - var_51_0.PlunderXP - var_51_0.ContractXP,
		earnedXP = var_51_0.CurrentXP - var_51_0.StartXP,
		earnedSeasonXP = var_51_0.CurrentSeasonXP - var_51_0.StartSeasonXP,
		contractBonus = var_51_0.ContractXP or 0,
		challenges = var_51_0.Challenges,
		unlocks = var_51_0.Unlocks,
		rank = PROGRESSION.GetPlayerRank(arg_51_0),
		prestige = PROGRESSION.GetPlayerPrestigeLevel(arg_51_0),
		preRank = var_51_1.preRank,
		curRank = var_51_1.curRank,
		preSeasonRank = var_51_1.preSeasonRank,
		curSeasonRank = var_51_1.curSeasonRank,
		isElder = var_51_1.isElder,
		isElderFirstTime = var_51_1.isElderFirstTime,
		isGainingElderXP = var_51_1.isGainingElderXP
	}

	if AAR.IsDebugBattlePassEnabled() then
		local var_51_4 = Dvar.CFHDGABACF("NPQKMMLMRS")

		var_51_3.startTierXP = BATTLEPASS.GetXP(arg_51_0)
		var_51_3.currentTierXP = BATTLEPASS.GetXP(arg_51_0) + var_51_4
	end

	var_51_3.matchXP = math.max(var_51_3.matchXP, 0)

	local var_51_5 = var_0_1(var_51_3.preSeasonRank, var_51_3.curSeasonRank)

	var_51_3.startPrestige = var_51_3.prestige - var_51_5

	return var_51_3
end

function AAR.ResetMatchData(arg_52_0)
	OnlineAAR.DBIGAJIAFG(arg_52_0)
end

function AAR.GetGunsmithUnlockPackage(arg_53_0, arg_53_1)
	local var_53_0 = {}

	if arg_53_1 == nil or #arg_53_1 == 0 then
		return var_53_0
	end
	...
	for iter_53_0 = 1, var_53_1 do
		local var_53_2 = arg_53_1[iter_53_0].ID

		if not PROGRESSION.IsProgressionTracker(var_53_2) then
			local var_53_3 = LOOT.GetTypeForID(var_53_2)

			if var_53_3 and var_53_3 ~= LOOT.itemTypes.INVALID and var_53_3 == LOOT.itemTypes.ATTACHMENT then
				local var_53_4 = AAR.GetUnlockData(arg_53_0, var_53_2)

				if var_53_4 then
					local var_53_5 = true

					for iter_53_1 = 1, #var_53_0 do
						if var_53_0[iter_53_1].weaponRef == var_53_4.weaponRef and var_53_4.weaponRef and var_53_4.weaponRef ~= "" then
							var_53_5 = false

							table.insert(var_53_0[iter_53_1].attachmentsData, var_53_4)
...
function AAR.GetGunsmithCamoUnlockPackage(arg_54_0, arg_54_1)
	local var_54_0 = {}

	if arg_54_1 == nil or #arg_54_1 == 0 then
		return var_54_0
	end
	...
	for iter_54_0 = 1, var_54_1 do
		local var_54_2 = arg_54_1[iter_54_0].ID

		if not PROGRESSION.IsProgressionTracker(var_54_2) and var_54_2 and LOOT.IsCamo(var_54_2) then
			local var_54_3 = LOOT.GetLootItemRelatedWeapon(var_54_2, LOOT.itemTypes.CAMO)
			local var_54_4 = StringTable.DIFCHIGDFB(CSV.weaponIDs.file, CSV.weaponIDs.cols.index, var_54_3, CSV.weaponIDs.cols.baseRef)
			local var_54_5 = LOOT.GetItemRef(LOOT.itemTypes.CAMO, var_54_2, {
				weaponRef = var_54_4
			})
			local var_54_6 = StringTable.BJJBBCJGEJ(CSV.camoTable.file, CSV.camoTable.cols.ref, var_54_5)
			local var_54_7 = CSV.ReadRow(CSV.camoTable, var_54_6)
			local var_54_8 = {
				weaponRef = var_54_4,
				icon = var_54_7.image,
				name = Engine.CBBHFCGDIC(var_54_7.name)
			}
			local var_54_9 = true

			for iter_54_1 = 1, #var_54_0 do
				if var_54_0[iter_54_1].weaponRef == var_54_8.weaponRef then
					var_54_9 = false

					table.insert(var_54_0[iter_54_1].camoData, var_54_8)
...
function AAR.ParsePlayerProgressionXPData(arg_55_0, arg_55_1, arg_55_2, arg_55_3, arg_55_4)
	local var_55_0 = arg_55_4 > 0
	local var_55_1 = arg_55_3 <= 0 and arg_55_4 > 0
	local var_55_2 = var_55_0 and var_55_1
	local var_55_3 = var_55_0 and arg_55_1 == arg_55_2 and arg_55_3 ~= arg_55_4
	local var_55_4 = PROGRESSION.GetMilitaryRankByXP(arg_55_1)
	local var_55_5 = PROGRESSION.GetMilitaryRankByXP(arg_55_2)
	local var_55_6 = PROGRESSION.GetSeasonRankByXP(arg_55_3)
	local var_55_7 = PROGRESSION.GetSeasonRankByXP(arg_55_4)

	return {
		isElder = var_55_0,
		isElderFirstTime = var_55_2,
		isGainingElderXP = var_55_3,
		preRank = var_55_4,
		curRank = var_55_5,
		preSeasonRank = var_55_6,
		curSeasonRank = var_55_7
	}
end

function AAR.IsBRFrontendScoreboardAvailable()
	if CONDITIONS.InFrontend() then
		local var_56_0 = AAR.IsBRTDMClientMatchDataAvailable()
		local var_56_1 = (CONDITIONS.IsMagmaGameMode() or CONDITIONS.IsBloodMoney() or CONDITIONS.IsWZRatRace()) and not var_56_0

		if IsPrivateMatch() then
			var_56_1 = CONDITIONS.IsMagmaGameMode() and not var_56_0
		end
...
function AAR.IsPublicMatchClientDataAvailable()
	local var_60_0 = Engine.EAIADADAIH("isPublicMatch")

	if Engine.EAIICIFIFA() then
		return Engine.JCFIBGGJB(AAR.ClientMatchData.CP) and var_60_0
	else
		return Engine.JCFIBGGJB(AAR.ClientMatchData.MP) and var_60_0
	end
end

function AAR.IsPrivateMatchClientDataAvailable()
	local var_61_0 = not Engine.EAIADADAIH("isPublicMatch")

	if Engine.EAIICIFIFA() then
		return Engine.JCFIBGGJB(AAR.ClientMatchData.CP) and var_61_0
	else
		return Engine.JCFIBGGJB(AAR.ClientMatchData.MP) and var_61_0
	end
end

function AAR.IsBloodMoneyAARDataReady(arg_62_0)
	local var_62_0 = Dvar.CFHDGABACF("NMPNSQNNRQ")
	local var_62_1 = AAR.IsPublicMatchClientDataAvailable() or AAR.IsPrivateMatchClientDataAvailable()
	local var_62_2 = var_62_0 == AAR.MagmaSummaryState.BM_SUMMARY_READY
	local var_62_3 = var_62_1 and var_62_2

	return Engine.DDJFBBJAIG() and CONDITIONS.IsMagmaGameMode() and var_62_3
end

function AAR.IsBRKingSlayerAARDataReady(arg_63_0)
	local var_63_0 = Dvar.CFHDGABACF("NMPNSQNNRQ")
	local var_63_1 = AAR.IsPublicMatchClientDataAvailable() or AAR.IsPrivateMatchClientDataAvailable()
	local var_63_2 = var_63_0 == AAR.MagmaSummaryState.BR_KING_SLAYER_SUMMARY_READY
	local var_63_3 = var_63_1 and var_63_2

	return Engine.DDJFBBJAIG() and CONDITIONS.IsMagmaGameMode() and var_63_3
end

function AAR.IsBRRebirthAARDataReady(arg_64_0)
	local var_64_0 = Dvar.CFHDGABACF("NMPNSQNNRQ")
	local var_64_1 = AAR.IsPublicMatchClientDataAvailable() or AAR.IsPrivateMatchClientDataAvailable()
	local var_64_2 = var_64_0 == AAR.MagmaSummaryState.BR_REBIRTH_SUMMARY_READY
	local var_64_3 = var_64_1 and var_64_2

	return Engine.DDJFBBJAIG() and CONDITIONS.IsMagmaGameMode() and var_64_3
end

function AAR.IsBRPayloadAARDataReady(arg_65_0)
	local var_65_0 = Dvar.CFHDGABACF("NMPNSQNNRQ")
	local var_65_1 = AAR.IsPublicMatchClientDataAvailable() or AAR.IsPrivateMatchClientDataAvailable()
	local var_65_2 = var_65_0 == AAR.MagmaSummaryState.BR_PAYLOAD_SUMMARY_READY
	local var_65_3 = var_65_1 and var_65_2

	return Engine.DDJFBBJAIG() and CONDITIONS.IsMagmaGameMode() and var_65_3
end

function AAR.IsMatchClientDataAvailable()
	local var_66_0 = Dvar.CFHDGABACF("NMPNSQNNRQ")
	local var_66_1 = AAR.IsPublicMatchClientDataAvailable()
	local var_66_2 = AAR.IsPrivateMatchClientDataAvailable()
	local var_66_3 = var_66_1 or var_66_2
	local var_66_4 = var_66_0 == AAR.MagmaSummaryState.BR_SUMMARY_READY
	local var_66_5 = var_66_0 == AAR.MagmaSummaryState.BM_SUMMARY_READY
	local var_66_6 = var_66_0 == AAR.MagmaSummaryState.BR_TDM_SUMMARY_READY
	local var_66_7 = var_66_0 == AAR.MagmaSummaryState.BR_KING_SLAYER_SUMMARY_READY
	local var_66_8 = var_66_0 == AAR.MagmaSummaryState.BR_REBIRTH_SUMMARY_READY
	local var_66_9 = var_66_0 == AAR.MagmaSummaryState.BR_PAYLOAD_SUMMARY_READY

	DebugPrint("AAR match data: IsMatchClientDataAvailable ------------ \n" .. "\n isClientMatchDataAvailable " .. tostring(var_66_3) .. "\n isPublicMatchClientData " .. tostring(var_66_1) .. "\n isPrivateMatchClientData " .. tostring(var_66_2) .. "\n isBRClientMatchData " .. tostring(var_66_4) .. "\n isBMClientMatchData " .. tostring(var_66_5) .. "\n isBRTDMClientMatchData " .. tostring(var_66_6) .. "\n isBRKingSlayerClientMatchData " .. tostring(var_66_7) .. "\n isBRRebirthClientMatchData " .. tostring(var_66_8) .. "\n isBRPayloadClientMatchData " .. tostring(var_66_9))
	...
	if CONDITIONS.IsMagmaGameMode() then
		...
		elseif CONDITIONS.IsWZPayload() then
			...
			return var_66_9 and var_66_3
		else
			local var_66_10 = var_66_3 and var_66_4
			local var_66_11 = var_66_3 and var_66_5
			local var_66_12 = var_66_3 and var_66_6
			local var_66_13 = var_66_3 and var_66_7
			local var_66_14 = var_66_3 and var_66_8

			DebugPrint("AAR Match Data: Game Type: BRTDM")

			local var_66_15 = Engine.DBFFAEEFGJ().flowManager:GetStackTop(false)
			local var_66_16 = var_66_15 and (var_66_15.name == "BRMainMenu" or var_66_15.name == "leave_public_mp_lobby" or var_66_15.name == "leave_private_mp_lobby")

			DebugPrint("AAR Match Data: isInBRMainMenu: " .. tostring(var_66_16))

			if not var_66_16 then
				return var_66_3 and var_66_4
			end

			return var_66_10 or var_66_11 or var_66_12 or var_66_13 or var_66_14
		end
	elseif CONDITIONS.IsThirdGameMode() then
		DebugPrint("AAR Match Data: Game Mode: CP")

		if var_66_5 or var_66_4 or var_66_6 or var_66_7 then
			return false
		end
	...
	DebugPrint("AAR Match Data: Game Mode: Unknown/Unsupported")

	return false
end

function AAR.IsAnyNonXPParadeAvailable(arg_67_0)
	local var_67_0 = AAR.GetMatchInfoPackage(arg_67_0)
	local var_67_1 = AAR.GetGunsmithCamoUnlockPackage(arg_67_0, var_67_0.unlocks)
	local var_67_2 = AAR.GetAccoladesPackage(arg_67_0)
	local var_67_3 = #AAR.GetGunsmithUnlockPackage(arg_67_0, var_67_0.unlocks) > 0
	local var_67_4 = #var_67_1 > 0
	local var_67_5 = CONDITIONS.AreKeysEnabled() and var_67_0.currentKeys - var_67_0.startKeys >= AAR.KEY_UNIT_CURRENCY
	local var_67_6 = AAR.IsCommendtionEnabled() and var_67_2 and #var_67_2 > 0

	return var_67_3 or var_67_4 or var_67_5 or var_67_6
end

function AAR.GetBattlePassTierBreakdown(arg_68_0, arg_68_1)
	local var_68_0 = arg_68_1.startTierXP
	local var_68_1 = arg_68_1.currentTierXP - var_68_0
	local var_68_2 = SCOREBOARD.GetColumnNames(arg_68_0)
	local var_68_3 = SCOREBOARD.GetMaxColumn(arg_68_0)
	local var_68_4 = AAR.BattlePassBonusTypes.SKILL_BONUS1
	local var_68_5 = {}
	local var_68_6 = 0
	local var_68_7 = arg_68_1.battlepassTimeXP
	local var_68_8 = arg_68_1.battlepassChallengeXP
	local var_68_9

	if not AAR.IsDebugBattlePassEnabled() then
		local var_68_10 = CONDITIONS.IsCoreMultiplayer() and DataSources.frontEnd.AAR.scoreboard.numPlayersTeamA or CONDITIONS.IsThirdGameMode() and DataSources.frontEnd.AAR.scoreboard.numCPPlayers or nil

		if var_68_10 then
			local var_68_11 = var_68_10:GetValue(arg_68_0)
			local var_68_12 = PostMatch.DGCJIFGJBD(arg_68_0, var_68_11)

			for iter_68_0 = 0, #var_68_12 do
				if var_68_12[iter_68_0] and var_68_12[iter_68_0].isMe then
					var_68_9 = var_68_12[iter_68_0]
				end
			end
		end
	end
	...
	for iter_68_1 = 1, var_68_3 do
		local var_68_13 = var_68_2[iter_68_1]

		if StringTable.DIFCHIGDFB(CSV.gameStats.file, CSV.gameStats.cols.ref, var_68_13, CSV.gameStats.cols.enabledInAAR) == "1" then
			local var_68_14 = SCOREBOARD.GetGameModeFieldName(arg_68_0, iter_68_1)

			if var_68_14 and (var_68_9 and tonumber(var_68_9[var_68_14]) > 0 or true) then
				local var_68_15 = StringTable.DIFCHIGDFB(CSV.gameStats.file, CSV.gameStats.cols.ref, var_68_13, CSV.gameStats.cols.AARName)
				local var_68_16 = StringTable.DIFCHIGDFB(CSV.gameStats.file, CSV.gameStats.cols.ref, var_68_13, CSV.gameStats.cols.AARIcon)

				if var_68_4 <= AAR.BattlePassBonusTypes.SKILL_BONUS5 then
					var_68_5[var_68_4] = {
						value = 0,
						name = Engine.CBBHFCGDIC(var_68_15),
						icon = var_68_16
					}
					var_68_4 = var_68_4 + 1
					var_68_6 = var_68_6 + 1
	...
	local var_68_17 = (var_68_1 - var_68_7 - var_68_8) / 2
	local var_68_18 = var_68_6 > 0 and var_68_17 / var_68_6 or 0
	local var_68_19 = LOOT.IsDoubleBattlePassXPActive()
	local var_68_20 = {
		[AAR.BattlePassBonusTypes.TIME_BONUS] = {
			sound = SOUND_SETS.aarBattlePass.timeBonus,
			icon = BATTLEPASS.IsOwned(arg_68_0) and "battlepass_emblem_gold" or "battlepass_emblem_silver",
		...
		[AAR.BattlePassBonusTypes.MATCH_BONUS] = {
			...
			value = var_68_19 and var_68_17 / 2 or var_68_17
		},
		[AAR.BattlePassBonusTypes.MATCH_BONUS_DOUBLE] = {
			...
			value = var_68_19 and var_68_17 / 2 or 0
		},
	...
	for iter_68_2 = AAR.BattlePassBonusTypes.SKILL_BONUS1, AAR.BattlePassBonusTypes.SKILL_BONUS1 + var_68_6 - 1 do
		var_68_20[iter_68_2].icon = var_68_5[iter_68_2].icon
		var_68_20[iter_68_2].name = var_68_5[iter_68_2].name
		var_68_20[iter_68_2].value = var_68_18
	end

	return var_68_20
end

function AAR.GetAccoladesPackage(arg_69_0, arg_69_1)
	local var_69_0 = CSV.accolades
	local var_69_1 = {}
	local var_69_2

	if arg_69_1 then
		var_69_2 = PlayerData.BFFBGAJGD(arg_69_0, CoD.StatsGroup.Ranked).playerStats.accoladeStats
	else
		var_69_2 = PlayerData.BFFBGAJGD(arg_69_0, CoD.StatsGroup.Ranked).playerStats.matchAccolades
	end

	local var_69_3 = StringTable.BFHCAIIDA(var_69_0.file)

	for iter_69_0 = 1, var_69_3 - 1 do
		local var_69_4 = StringTable.CBGJCDIHCE(var_69_0.file, iter_69_0, var_69_0.cols.ref)

		if var_69_2[var_69_4] then
			local var_69_5 = var_69_2[var_69_4]:get()

			if var_69_5 and (arg_69_1 and CONDITIONS.IsShowingUnachievedAccolades() and true or var_69_5 > 0) then
				local var_69_6 = {
					ref = var_69_4,
					num = var_69_5,
					priority = StringTable.CBGJCDIHCE(var_69_0.file, iter_69_0, var_69_0.cols.priority),
					name = StringTable.CBGJCDIHCE(var_69_0.file, iter_69_0, var_69_0.cols.name),
					desc = StringTable.CBGJCDIHCE(var_69_0.file, iter_69_0, var_69_0.cols.desc),
					image = StringTable.CBGJCDIHCE(var_69_0.file, iter_69_0, var_69_0.cols.image)
				}

				table.insert(var_69_1, var_69_6)
			end
		else
			DebugPrint("Warning: Missing accolade ref: " .. var_69_4)
		end
	end

	if arg_69_1 then
		table.sort(var_69_1, function(arg_70_0, arg_70_1)
			return arg_70_0.num > arg_70_1.num
		end)
	else
		table.sort(var_69_1, function(arg_71_0, arg_71_1)
			return arg_71_0.priority > arg_71_1.priority
		end)
	end
...
function AAR.GetDebugMatchInfoPackage(arg_73_0)
	local var_73_0
	local var_73_1
	local var_73_2

	function PROGRESSION.GetPlayerIsInSeasonalProgression(arg_74_0)
		return true
	end

	if AAR.IsDebugAARMatchInfoPrestigeLevelTransitionPackageEnabled() then
		local var_73_3 = {
			StartSeasonXP = 1250000,
			CurrentSeasonXP = 1500000,
			StartXP = PROGRESSION.GetMaxMilitaryRankXP(),
			CurrentXP = PROGRESSION.GetMaxMilitaryRankXP()
		}
		local var_73_4 = AAR.ParsePlayerProgressionXPData(arg_73_0, var_73_3.StartXP, var_73_3.CurrentXP, var_73_3.StartSeasonXP, var_73_3.CurrentSeasonXP)
		...
		var_73_2 = {
			...
			currentTierXP = 1620000,
			startCPpoints = 528,
			currentKeys = 9190,
			rank = 54,
			startXP = var_73_3.StartXP,
			currentXP = var_73_3.CurrentXP,
			startSeasonXP = var_73_3.StartSeasonXP,
			currentSeasonXP = var_73_3.CurrentSeasonXP,
			challenges = {
				{
					ID = 1501,
					type = 15
			...
			preRank = var_73_4.preRank,
			curRank = var_73_4.curRank,
			preSeasonRank = var_73_4.preSeasonRank,
			curSeasonRank = var_73_4.curSeasonRank,
			isElder = var_73_4.isElder,
			isElderFirstTime = var_73_4.isElderFirstTime,
			isGainingElderXP = var_73_4.isGainingElderXP
		}
	else
		local var_73_5 = {
			StartXP = 1200515,
		...
		local var_73_6 = AAR.ParsePlayerProgressionXPData(arg_73_0, var_73_5.StartXP, var_73_5.CurrentXP, var_73_5.StartSeasonXP, var_73_5.CurrentSeasonXP)
		...
		var_73_2 = {
			...
			currentKeys = 9190,
			rank = 54,
			startXP = var_73_5.StartXP,
			currentXP = var_73_5.CurrentXP,
			startSeasonXP = var_73_5.StartSeasonXP,
			currentSeasonXP = var_73_5.CurrentSeasonXP,
			challenges = {
				{
					ID = 1501,
					type = 15
			...
			preRank = var_73_6.preRank,
			curRank = var_73_6.curRank,
			preSeasonRank = var_73_6.preSeasonRank,
			curSeasonRank = var_73_6.curSeasonRank,
			isElder = var_73_6.isElder,
			isElderFirstTime = var_73_6.isElderFirstTime,
			isGainingElderXP = var_73_6.isGainingElderXP
		}
	end

	local var_73_7 = var_0_1(var_73_2.preSeasonRank, var_73_2.curSeasonRank)

	var_73_2.startPrestige = var_73_2.prestige - var_73_7
	var_73_2.matchXP = var_73_2.currentXP - var_73_2.startXP + (var_73_2.currentSeasonXP - var_73_2.startSeasonXP) - var_73_2.challengeBonus - var_73_2.missionXP - var_73_2.plunderBonus - var_73_2.contractBonus

	return var_73_2
end

function AAR.GetDebugMatchInfoPackageString(arg_75_0)
	local var_75_0 = AAR.GetMatchInfoPackage(arg_75_0)

	return " startXP " .. tostring(var_75_0.startXP) .. " \n currentXP " .. tostring(var_75_0.currentXP) .. " \n startSeasonXP " .. tostring(var_75_0.startSeasonXP) .. " \n currentSeasonXP " .. tostring(var_75_0.currentSeasonXP) .. " \n startTierXP " .. tostring(var_75_0.startTierXP) .. " \n currentTierXP " .. tostring(var_75_0.currentTierXP) .. " \n battlepassTimeXP " .. tostring(var_75_0.battlepassTimeXP) .. " \n battlepassChallengeXP " .. tostring(var_75_0.battlepassChallengeXP) .. " \n startLevelXP " .. tostring(var_75_0.startLevelXP) .. " \n currentLevelXP " .. tostring(var_75_0.currentLevelXP) .. " \n startLevel " .. tostring(var_75_0.startLevel) .. " \n currentLevel " .. tostring(var_75_0.currentLevel) .. " \n startKeys " .. tostring(var_75_0.startKeys) .. " \n currentKeys " .. tostring(var_75_0.currentKeys) .. " \n startCommonCrate " .. tostring(var_75_0.startCommonCrate) .. " \n currentCommonCrate " .. tostring(var_75_0.currentCommonCrate) .. " \n startCPpoints " .. tostring(var_75_0.startCPpoints) .. " \n currentCPpoints " .. tostring(var_75_0.currentCPpoints) .. " \n challengeBonus " .. tostring(var_75_0.challengeBonus) .. " \n missionXP " .. tostring(var_75_0.missionXP) .. " \n plunderBonus " .. tostring(var_75_0.plunderBonus) .. " \n matchXP " .. tostring(var_75_0.matchXP) .. " \n earnedXP " .. tostring(var_75_0.earnedXP) .. " \n earnedSeasonXP " .. tostring(var_75_0.earnedSeasonXP) .. " \n contractBonus " .. tostring(var_75_0.contractBonus) .. " \n rank " .. tostring(var_75_0.rank) .. " \n prestige " .. tostring(var_75_0.prestige) .. " \n startPrestige " .. tostring(var_75_0.startPrestige) .. " \n preRank " .. tostring(var_75_0.preRank) .. " \n curRank " .. tostring(var_75_0.curRank) .. " \n preSeasonRank " .. tostring(var_75_0.preSeasonRank) .. " \n curSeasonRank " .. tostring(var_75_0.curSeasonRank) .. " \n isElder " .. tostring(var_75_0.isElder) .. " \n isElderFirstTime " .. tostring(var_75_0.isElderFirstTime) .. " \n isGainingElderXP " .. tostring(var_75_0.isGainingElderXP)
end

function AAR.GetDebugCommendationPackage(arg_76_0)
	return {
		{
			value = 10,
			name = "10 Killstreak",
...
function AAR.GetDebugChallengesPackage(arg_77_0)
	local var_77_0 = {}
	local var_77_1 = StringTable.BFHCAIIDA(CSV.questChallenges.file)

	for iter_77_0 = 0, var_77_1 - 1 do
		local var_77_2 = CSV.ReadRow(CSV.questChallenges, iter_77_0)
	end

	local var_77_3 = StringTable.BFHCAIIDA(CSV.gunChallenges.file)

	for iter_77_1 = 0, var_77_3 - 1 do
		local var_77_4 = CSV.ReadRow(CSV.gunChallenges, iter_77_1)
	end
	...
	return AAR.GetChallengesPackage(arg_77_0, var_77_0)
end
...
function AAR.GetDebugGunsmithUnlockPackage()
	...
	return AAR.GetGunsmithUnlockPackage(0, var_78_0)
end
...
function AAR.IsDebugAARMatchInfoPackageEnabled()
	if CONDITIONS.IsDevelopmentBuild() then
...
function AAR.IsDebugAARMatchInfoPrestigeLevelTransitionPackageEnabled()
	if CONDITIONS.IsDevelopmentBuild() then
...
function AAR.IsScoreboardDataValid(arg_83_0)
	local var_83_0 = false
	local var_83_1 = Engine.EAIADADAIH("scoreboardPlayerCount")
	local var_83_2 = var_83_1 and var_83_1 > 0

	if AAR.IsBRTDMClientMatchDataAvailable() and CONDITIONS.IsCoreMultiplayer() then
		local var_83_3 = PostMatch.DGCJIFGJBD(arg_83_0, Teams.allies)
		local var_83_4 = PostMatch.DGCJIFGJBD(arg_83_0, Teams.axis)
		local var_83_5 = DataSources.frontEnd.AAR.friendlyScore:GetValue(arg_83_0)
		local var_83_6 = DataSources.frontEnd.AAR.enemyScore:GetValue(arg_83_0)

		var_83_0 = var_83_2 and var_83_3 and var_83_4 and var_83_5 and var_83_5 >= 0 and var_83_6 and var_83_6 >= 0
	elseif CONDITIONS.IsMagmaGameMode() then
		var_83_0 = var_83_2

		local var_83_7 = PostMatch.DGCJIFGJBD(arg_83_0, Teams.free)
		local var_83_8 = false

		if var_83_7 then
			var_83_8 = #var_83_7 > 0 or false
		...
		var_83_0 = var_83_0 and var_83_8
	elseif AAR.IsFFAMatch(arg_83_0) then
		local var_83_9 = PostMatch.DGCJIFGJBD(arg_83_0, Teams.free)

		var_83_0 = var_83_2 and var_83_9
	elseif CONDITIONS.IsCoreMultiplayer() then
		local var_83_10 = PostMatch.DGCJIFGJBD(arg_83_0, Teams.allies)
		local var_83_11 = PostMatch.DGCJIFGJBD(arg_83_0, Teams.axis)
		local var_83_12 = DataSources.frontEnd.AAR.friendlyScore:GetValue(arg_83_0)
		local var_83_13 = DataSources.frontEnd.AAR.enemyScore:GetValue(arg_83_0)

		var_83_0 = var_83_2 and var_83_10 and var_83_11 and var_83_12 and var_83_12 >= 0 and var_83_13 and var_83_13 >= 0
	elseif CONDITIONS.IsThirdGameMode() then
		var_83_0 = var_83_2
	end
...
function AAR.GetBloodMoneyXPPackage(arg_84_0)
	local var_84_0 = {}
	local var_84_1 = PlayerData.BFFBGAJGD(arg_84_0, CoD.StatsGroup.Ranked).aarValue

	if var_84_1 then
		local var_84_2 = 0

		for iter_84_0 = 1, AAR.BRXPType.MAX_NUM - 1 do
			local var_84_3 = AAR.BRXPTable[iter_84_0]
			local var_84_4 = {
				name = var_84_3.name,
				summaryNameKey = var_84_3.summaryNameKey
			}
			local var_84_5 = var_84_1[iter_84_0 - 1]:get()

			if var_84_5 > 0 then
				var_84_2 = var_84_2 + var_84_5
				var_84_4.value = var_84_5

				table.insert(var_84_0, var_84_4)

				if CONDITIONS.IsDevelopmentBuild() then
					local var_84_6 = "\n BR InGame AAR Data - name: " .. tostring(var_84_4.name) .. " Value: " .. tostring(var_84_4.value)
		...
		local var_84_7 = AAR.BRXPTable[AAR.BRXPType.MAX_NUM]
		local var_84_8 = {
			name = var_84_7.name,
			summaryNameKey = var_84_7.summaryNameKey
		}
		local var_84_9 = var_84_1[BR_FINAL_XP_INDEX]:get()
		local var_84_10 = var_84_1[BR_INIT_XP_INDEX]:get()

		var_84_8.value = var_84_9 - var_84_10 - var_84_2
		var_84_8.value = var_84_8.value > 0 and var_84_8.value or 0

		table.insert(var_84_0, 1, var_84_8)

		if CONDITIONS.IsDevelopmentBuild() then
			local var_84_11 = "\n BR InGame AAR Data ( misc ) - name: " .. tostring(var_84_8.name) .. " Value: " .. tostring(var_84_8.value) .. "\n final xp: " .. tostring(var_84_9) .. " initXP: " .. tostring(var_84_10)

			DebugPrint(var_84_11)
		end
	end
...
function AAR.GetDebugBloodMoneyXPPackage(arg_85_0)
	local var_85_0 = {}
	local var_85_1 = PlayerData.BFFBGAJGD(arg_85_0, CoD.StatsGroup.Ranked).aarValue
	local var_85_2 = AAR.GetDebugBRMatchPackage()
	local var_85_3 = (var_85_2.earnedXP + var_85_2.earnedSeasonXP) / AAR.BRXPType.MAX_NUM

	for iter_85_0 = 1, AAR.BRXPType.MAX_NUM do
		local var_85_4 = AAR.BRXPTable[iter_85_0]
		local var_85_5 = {
			name = var_85_4.name,
			summaryNameKey = var_85_4.summaryNameKey
		}
		local var_85_6 = var_85_3

		if var_85_6 > 0 then
			var_85_5.value = var_85_6

			table.insert(var_85_0, var_85_5)
		end
	end
...
function AAR.GetBRMatchXPPackage(arg_86_0)
	local var_86_0 = {}
	local var_86_1 = PlayerData.BFFBGAJGD(arg_86_0, CoD.StatsGroup.Ranked).aarValue

	if var_86_1 then
		local var_86_2 = 0

		for iter_86_0 = 1, AAR.BRXPType.MAX_NUM - 1 do
			local var_86_3 = AAR.BRXPTable[iter_86_0]
			local var_86_4 = {
				name = var_86_3.name,
				summaryNameKey = var_86_3.summaryNameKey
			}
			local var_86_5 = var_86_1[iter_86_0 - 1]:get()

			if var_86_5 > 0 then
				var_86_2 = var_86_2 + var_86_5
				var_86_4.value = var_86_5

				table.insert(var_86_0, var_86_4)

				if CONDITIONS.IsDevelopmentBuild() then
					local var_86_6 = "\n BR InGame AAR Data - name: " .. tostring(var_86_4.name) .. " Value: " .. tostring(var_86_4.value)
		...
		local var_86_7 = AAR.BRXPTable[AAR.BRXPType.MAX_NUM]
		local var_86_8 = {
			name = var_86_7.name,
			summaryNameKey = var_86_7.summaryNameKey
		}
		local var_86_9 = var_86_1[BR_FINAL_XP_INDEX]:get()
		local var_86_10 = var_86_1[BR_INIT_XP_INDEX]:get()

		var_86_8.value = var_86_9 - var_86_10 - var_86_2
		var_86_8.value = var_86_8.value > 0 and var_86_8.value or 0

		if CONDITIONS.IsDevelopmentBuild() then
			local var_86_11 = "\n BR InGame AAR Data ( misc ) - name: " .. tostring(var_86_8.name) .. " Value: " .. tostring(var_86_8.value) .. "\n final xp: " .. tostring(var_86_9) .. " initXP: " .. tostring(var_86_10)

			DebugPrint(var_86_11)
		end

		table.insert(var_86_0, 1, var_86_8)
	end

	return var_86_0
end

function AAR.GetDebugBRMatchPackage(arg_87_0)
	return {
		curRank = 54,
		currentTierXP = 67498,
		matchXP = 66753,
...
function AAR.ShouldShowBattlePassPurchasePopup(arg_88_0)
	if BATTLEPASS.IsOwned(arg_88_0) then
		return false
	end

	local var_88_0 = AAR.GetMatchInfoPackage(arg_88_0)
	local var_88_1 = BATTLEPASS.GetTierByXP(arg_88_0, var_88_0.startTierXP)
	local var_88_2 = BATTLEPASS.GetTierByXP(arg_88_0, var_88_0.currentTierXP)
	local var_88_3 = {}
	local var_88_4 = BATTLEPASS.GetTierByTotalCPRewards(arg_88_0, BATTLEPASS.START_TO_SHOW_COD_POINTS)

	table.insert(var_88_3, var_88_4)

	local var_88_5 = tonumber(BATTLEPASS.GetItemCost(BATTLEPASS.GetPurchaseRef()))
	local var_88_6 = BATTLEPASS.GetTierByTotalCPRewards(arg_88_0, var_88_5)

	table.insert(var_88_3, var_88_6)

	local var_88_7 = BATTLEPASS.GetMaxTier()

	table.insert(var_88_3, var_88_7)

	for iter_88_0, iter_88_1 in ipairs(var_88_3) do
		if var_88_1 < iter_88_1 and iter_88_1 <= var_88_2 then
			return true
		end
	end
...
function AAR.CheckAndShowBattlePassPurchasePopup(arg_89_0)
	if AAR.ShouldShowBattlePassPurchasePopup(arg_89_0) then
		local var_89_0 = LUI.FlowManager.GetScopedData("MainMenu")

		var_89_0.tabIndexToFocus = TAB.GetIndex(TAB.MP.BATTLE_PASS)
		var_89_0.showBattlePassPurchasePopup = true
	end
end
