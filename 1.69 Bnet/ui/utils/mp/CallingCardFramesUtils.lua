CallingCardFramesUtils = {}
CallingCardFramesUtils.Categories = {
	VICTORY = 2,
	CORE = 1
}
CallingCardFramesUtils.DefaultCardID = 0

function CallingCardFramesUtils.GetCardIDByRow(arg_1_0)
	return StringTable.CBGJCDIHCE(CSV.callingCardFrames.file, arg_1_0, CSV.callingCardFrames.cols.index)
end

function CallingCardFramesUtils.GetAllFrames(arg_2_0, arg_2_1)
	local var_2_0 = {}
	...
	local var_2_3 = StringTable.BFHCAIIDA(CSV.callingCardFrames.file)

	for iter_2_0 = 0, var_2_3 - 1 do
		local var_2_4 = CSV.ReadRow(CSV.callingCardFrames, iter_2_0)

		if var_2_4 and var_2_4.hideInUI ~= "1" then
			var_2_4.isUnlocked = LOOT.IsUnlocked(arg_2_0, LOOT.itemTypes.FRAME, var_2_4.ref)
			var_2_4.rarity = LOOT.GetItemQuality(LOOT.itemTypes.FRAME, var_2_4.ref)
			var_2_4.season, var_2_4.event, var_2_4.isPremium = LOOT.GetItemSeason(LOOT.itemTypes.FRAME, var_2_4.ref)
			var_2_4.lootID = LOOT.GetItemID(LOOT.itemTypes.FRAME, var_2_4.ref)
			var_2_4.lootType = LOOT.itemTypes.FRAME
...
function CallingCardFramesUtils.AreAllVictoryChallengesUnlocked(arg_3_0)
	local var_3_0 = CallingCardFramesUtils.GetAllFrames(arg_3_0, {
		{
			unlockType = CallingCardFramesUtils.Categories.VICTORY
		}
	})
...
function CallingCardFramesUtils.GetFrameRef(arg_4_0)
	return StringTable.DIFCHIGDFB(CSV.callingCardFrames.file, CSV.callingCardFrames.cols.index, arg_4_0, CSV.callingCardFrames.cols.ref)
end

function CallingCardFramesUtils.GetFrameName(arg_5_0)
	return StringTable.DIFCHIGDFB(CSV.callingCardFrames.file, CSV.callingCardFrames.cols.ref, arg_5_0, CSV.callingCardFrames.cols.name)
end

function CallingCardFramesUtils.GetFrameNameFromID(arg_6_0)
	return StringTable.DIFCHIGDFB(CSV.callingCardFrames.file, CSV.callingCardFrames.cols.index, arg_6_0, CSV.callingCardFrames.cols.name)
end

function CallingCardFramesUtils.GetFrameImage(arg_7_0)
	local var_7_0 = StringTable.DIFCHIGDFB(CSV.callingCardFrames.file, CSV.callingCardFrames.cols.ref, arg_7_0, CSV.callingCardFrames.cols.image)

	if var_7_0 == nil or #var_7_0 == 0 then
		var_7_0 = CallingCardFramesUtils.GetCardTexture(CallingCardFramesUtils.DefaultCardIndex)
	end

	return var_7_0
end

function CallingCardFramesUtils.GetFrameTexture(arg_8_0)
	assert(arg_8_0 and arg_8_0 ~= "")

	local var_8_0 = CallingCardFramesUtils.GetFrameIsShippable(arg_8_0)
	local var_8_1

	if var_8_0 then
		var_8_1 = StringTable.DIFCHIGDFB(CSV.callingCardFrames.file, CSV.callingCardFrames.cols.index, arg_8_0, CSV.callingCardFrames.cols.image)
	else
		DebugPrint("DEBUG CALLING CARD: frame " .. arg_8_0 .. "is not shippable")

		var_8_1 = StringTable.DIFCHIGDFB(CSV.callingCardFrames.file, CSV.callingCardFrames.cols.index, tostring(tonumber(arg_8_0) % 10), CSV.callingCardFrames.cols.image)
	end

	if var_8_1 == nil or #var_8_1 == 0 then
		return StringTable.DIFCHIGDFB(CSV.callingCardFrames.file, CSV.callingCardFrames.cols.index, CallingCardFramesUtils.DefaultCardIndex, CSV.callingCardFrames.cols.image)
	end

	return var_8_1
end

function CallingCardFramesUtils.GetFrameSeason(arg_9_0)
	return StringTable.DIFCHIGDFB(CSV.callingCardFrames.file, CSV.callingCardFrames.cols.ref, arg_9_0, CSV.callingCardFrames.cols.season)
end

function CallingCardFramesUtils.GetFrameSeasonFromID(arg_10_0)
	return StringTable.DIFCHIGDFB(CSV.callingCardFrames.file, CSV.callingCardFrames.cols.index, arg_10_0, CSV.callingCardFrames.cols.season)
end

function CallingCardFramesUtils.GetFrameCategoryFromID(arg_11_0)
	return StringTable.DIFCHIGDFB(CSV.callingCardFrames.file, CSV.callingCardFrames.cols.index, arg_11_0, CSV.callingCardFrames.cols.category)
end

function CallingCardFramesUtils.GetFrameCategory(arg_12_0)
	return StringTable.DIFCHIGDFB(CSV.callingCardFrames.file, CSV.callingCardFrames.cols.ref, arg_12_0, CSV.callingCardFrames.cols.category)
end

function CallingCardFramesUtils.GetFrameChallenge(arg_13_0)
	return StringTable.DIFCHIGDFB(CSV.callingCardFrames.file, CSV.callingCardFrames.cols.index, arg_13_0, CSV.callingCardFrames.cols.challenge)
end

function CallingCardFramesUtils.GetFrameChallengeName(arg_14_0)
...
function CallingCardFramesUtils.GetFrameChallengeDesc(arg_15_0, arg_15_1, arg_15_2)
	return Challenge.GetLocalizedChallengeDesc(arg_15_0, arg_15_1, arg_15_2)
end

function CallingCardFramesUtils.GetChallengeFrameTexture(arg_16_0)
...
function CallingCardFramesUtils.GetFrameChallengeTier(arg_17_0, arg_17_1)
	if arg_17_0 == nil or arg_17_0 == "" then
		return ""
	end

	return CallingCardFramesUtils.GetChallengeEntry(arg_17_0, arg_17_1).currentTierLabel
end

function CallingCardFramesUtils.GetFrameChallengeInfoAlpha(arg_18_0)
...
function CallingCardFramesUtils.GetFrameChallengeCategoryRef(arg_19_0, arg_19_1)
	local var_19_0 = arg_19_0.category:GetValue(arg_19_1)

	if var_19_0 == nil or var_19_0 == "" then
		local var_19_1 = CallingCardFramesUtils.GetFrameChallengeSubCategoryRef(arg_19_0, arg_19_1)
...
function CallingCardFramesUtils.GetFrameChallengeCategoryRefByFrameID(arg_20_0, arg_20_1)
	local var_20_0 = CallingCardFramesUtils.GetCardCategoryFromID(arg_20_0)

	if var_20_0 == nil or var_20_0 == "" then
		local var_20_1 = CallingCardFramesUtils.GetCardChallenge(arg_20_0)
		local var_20_2 = CallingCardFramesUtils.GetCardChallengeSubCategoryRefByChallenge(var_20_1, arg_20_1)
...
function CallingCardFramesUtils.GetFrameChallengeSubCategoryRefByChallenge(arg_21_0)
...
function CallingCardFramesUtils.GetFrameChallengeSubCategoryRef(arg_22_0, arg_22_1)
...
function CallingCardFramesUtils.GetFrameChallengeSubCategoryFromID(arg_23_0)
...
function CallingCardFramesUtils.GetFrameChallengeCategoryFromID(arg_24_0, arg_24_1, arg_24_2)
	if arg_24_0 == nil or arg_24_0 == "" then
		local var_24_0 = CallingCardFramesUtils.GetCardChallengeSubCategoryFromID(arg_24_1, arg_24_2)
...
function CallingCardFramesUtils.GetFrameChallengeCategoryStringFromID(arg_25_0, arg_25_1, arg_25_2, arg_25_3)
	if arg_25_2 == nil or arg_25_2 == "" then
		local var_25_0 = CallingCardFramesUtils.GetCardChallengeSubCategoryFromID(arg_25_2, arg_25_3)
		...
		return CallingCardFramesUtils.GetCardCategoryName(arg_25_0)
	end
end

function CallingCardFramesUtils.BuildChallengeEntriesDataSources(arg_26_0, arg_26_1, arg_26_2, arg_26_3)
	local var_26_0, var_26_1 = CallingCardFramesUtils.LoadChallengeEntries(arg_26_0, arg_26_2, arg_26_3)
	local var_26_2 = {}
	...
	local function var_26_3(arg_27_0)
		...
		if var_27_2 == nil or var_27_2 == "" then
			local var_27_3 = StringTable.DIFCHIGDFB(CSV.callingCardFrames.file, CSV.callingCardFrames.cols.challenge, var_27_0, CSV.callingCardFrames.cols.index)

			var_27_2 = CallingCardFramesUtils.GetCardTexture(var_27_3)
		end
...
function CallingCardFramesUtils.LoadChallengeEntries(arg_29_0, arg_29_1, arg_29_2)
	local var_29_0 = {}
	local var_29_1 = {
	...
	for iter_29_0, iter_29_1 in ipairs(var_29_1) do
		for iter_29_2 = 0, StringTable.BFHCAIIDA(iter_29_1) - 1 do
			...
			if var_29_4 ~= "" and StringTable.CBGJCDIHCE(iter_29_1, iter_29_2, CSV.allChallengesTable.cols.subCategory) == arg_29_0 then
				local var_29_5 = CallingCardFramesUtils.GetChallengeEntry(var_29_4, arg_29_2, iter_29_1)
...
function CallingCardFramesUtils.GetChallengeEntry(arg_30_0, arg_30_1, arg_30_2)
	local var_30_0
	...
	var_30_3.image = StringTable.DIFCHIGDFB(CSV.callingCardFrames.file, CSV.callingCardFrames.cols.challenge, arg_30_0, CSV.callingCardFrames.cols.image)
	...
	if var_30_3.isUnlocked then
		var_30_3.desc = CallingCardFramesUtils.GetFrameChallengeDesc(arg_30_0, var_30_3.currentTierMax, var_30_1)
	else
		var_30_3.desc = Cac.GetUnlockText(CSV.challengeUnlockTable, arg_30_0)
	end

	local var_30_13 = StringTable.DIFCHIGDFB(CSV.callingCardFrames.file, CSV.callingCardFrames.cols.challenge, arg_30_0, CSV.callingCardFrames.cols.index)

	var_30_3.isMasterChallenge = CallingCardFramesUtils.GetCardIsMasterCard(var_30_13) == "TRUE"
...
function CallingCardFramesUtils.GetChallengeSubcatName(arg_31_0)
...
function CallingCardFramesUtils.GetFrameIsShippable(arg_32_0)
	return StringTable.DIFCHIGDFB(CSV.callingCardFrames.file, CSV.callingCardFrames.cols.index, arg_32_0, CSV.callingCardFrames.cols.hideInUI) ~= "1"
end

function CallingCardFramesUtils.GetFrameHideIfLocked(arg_33_0)
	return StringTable.DIFCHIGDFB(CSV.callingCardFrames.file, CSV.callingCardFrames.cols.index, arg_33_0, CSV.callingCardFrames.cols.hideIfLocked) == "1"
end

function CallingCardFramesUtils.HasAnyNewLootFrames(arg_34_0)
	local var_34_0 = StringTable.BFHCAIIDA(CSV.callingCardFrames.file)

	for iter_34_0 = 0, var_34_0 do
		local var_34_1 = StringTable.CBGJCDIHCE(CSV.callingCardFrames.file, iter_34_0, CSV.callingCardFrames.cols.lootID)
...
function CallingCardFramesUtils.HasNewLootCardsByCategory(arg_35_0, arg_35_1)
	local var_35_0 = StringTable.BFHCAIIDA(CSV.callingCardFrames.file)

	for iter_35_0 = 0, var_35_0 do
		if StringTable.CBGJCDIHCE(CSV.callingCardFrames.file, iter_35_0, CSV.callingCardFrames.cols.category) == arg_35_1 then
			local var_35_1 = StringTable.CBGJCDIHCE(CSV.callingCardFrames.file, iter_35_0, CSV.callingCardFrames.cols.lootID)
