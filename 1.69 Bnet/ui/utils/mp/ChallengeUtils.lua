...
function Challenge.GetMasterChallengesCount()
	local var_87_0 = StringTable.BFHCAIIDA(CSV.callingCardMasterChallenges.file)
	local var_87_1 = 0

	for iter_87_0 = 0, var_87_0 - 1 do
		local var_87_2 = StringTable.CBGJCDIHCE(CSV.callingCardMasterChallenges.file, iter_87_0, CSV.callingCardMasterChallenges.cols.categoryType)

		if var_87_2 and #var_87_2 > 0 and not (var_87_2 == "BR" and CONDITIONS.IsLazeOrOutrun()) then
			var_87_1 = var_87_1 + 1
		end
	end
...
function Challenge.GetMasterChallengeCategories()
	...
	for iter_88_0 = 0, var_88_2 - 1 do
		local var_88_4 = StringTable.CBGJCDIHCE(CSV.callingCardMasterChallenges.file, iter_88_0, CSV.callingCardMasterChallenges.cols.categoryType)

		if var_88_4 and #var_88_4 > 0 and not (var_88_4 == "BR" and CONDITIONS.IsLazeOrOutrun()) then
			var_88_0[var_88_4] = true
			var_88_3 = var_88_3 + 1
		end
	end

	return var_88_0, var_88_3
end
