...
MP_COMMON.LivePrivileges = {
	LIVE_PRIVILEGE_INDEX_MULTIPLAYER = 4,
	LIVE_PRIVILEGE_INDEX_COUNT = 5,
	LIVE_PRIVILEGE_INDEX_USERGENERATEDCONTENT = 2,
	LIVE_PRIVILEGE_INDEX_COMMUNICATIONS = 3,
	LIVE_PRIVILEGE_INDEX_CROSSPLAY = 0,
	LIVE_PRIVILEGE_INDEX_SESSIONS = 1
}
