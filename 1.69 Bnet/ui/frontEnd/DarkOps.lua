...
local function var_0_0(arg_1_0, arg_1_1, arg_1_2)
	...
	arg_1_0.MenuTitle:SetTitle(Engine.CBBHFCGDIC("LUA_MENU/DARK_OPS"))
end

function DarkOps(arg_2_0, arg_2_1)
	...
	var_2_4.MenuTitle:setText(Engine.CBBHFCGDIC("LUA_MENU/DARK_OPS"), 0)
