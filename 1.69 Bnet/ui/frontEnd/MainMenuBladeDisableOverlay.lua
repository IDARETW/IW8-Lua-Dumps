...
local var_0_2 = {
	...
	[MAIN_MENU.BladeStates.New] = {
		...
		refreshAction = function(arg_6_0)
			...
			if CONDITIONS.IsLaze() and arg_6_0.GradientBanner and arg_6_0.Label then
				arg_6_0.GradientBanner:SetAlpha(0)
				arg_6_0.Label:SetAlpha(0)
			end
		end
	},
...
local function var_0_5(arg_11_0, arg_11_1, arg_11_2)
	...
	if CONDITIONS.IsLaze() and arg_11_0.GradientBanner and arg_11_0.Label then
		arg_11_0.GradientBanner:SetAlpha(0)
		arg_11_0.Label:SetAlpha(0)
	end
end
