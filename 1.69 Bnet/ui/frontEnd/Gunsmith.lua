...
local function var_0_2(arg_5_0, arg_5_1, arg_5_2)
	...
	if not var_5_4.startTime then
		...
		var_5_4.lootID = arg_5_0._weaponTable and arg_5_0._weaponTable.lootID or nil
	end
	...
	arg_5_0.bindButton:addEventHandler("button_secondary", function(arg_7_0, arg_7_1)
		...
		METRICS.LootUsageSendDLogEvent(arg_7_0, {
			gunsmithFlag = true,
			controllerIndex = arg_5_1,
			startTime = var_7_1,
			previousItemIDs = var_5_4.previousLootID,
			newItemIDs = var_5_4.lootID
		})

		var_5_4.previousLootID = var_5_4.lootID
	end)
	...
	if var_5_6 then
		if arg_5_0.SaveMod then
			local var_5_7 = GUNSMITH.CountAvailableCustomModSlots(arg_5_1, arg_5_0._weaponTable.weapon, var_5_5)
			local var_5_8 = GUNSMITH.CountModSlotsUnlocked(arg_5_1, var_5_5)

			arg_5_0.CustomModSlotCount:setText(Engine.CBBHFCGDIC("LUA_MENU/CUSTOM_MOD_COUNT", var_5_8 - var_5_7, var_5_8))

			if arg_5_0.NextSlotUnlock then
				local var_5_9 = GUNSMITH.GetNextModUnlockRank(arg_5_1, arg_5_0._weaponTable.weapon, var_5_5)

				if var_5_9 ~= nil and #var_5_9 > 0 then
					arg_5_0.NextSlotUnlock:setText(Engine.CBBHFCGDIC("LUA_MENU/CUSTOM_MOD_NEXT_UNLOCK", var_5_9))
				else
		...
		elseif arg_5_0.NextSlotUnlock then
			local var_5_10 = GUNSMITH.GetNextModUnlockRank(arg_5_1, arg_5_0._weaponTable.weapon, var_5_5)

			if var_5_10 ~= nil and #var_5_10 > 0 then
				arg_5_0.NextSlotUnlock:setText(Engine.CBBHFCGDIC("LUA_MENU/CUSTOM_MOD_UNLOCK", var_5_10))
			else
				arg_5_0.NextSlotUnlock:SetAlpha(0)
			end
		end
	else
		if arg_5_0.CustomModSlotCount then
			arg_5_0.CustomModSlotCount:SetAlpha(0)
		end

		if arg_5_0.SaveMod then
			arg_5_0.SaveMod:SetAlpha(0)
		end
	...
	if Engine.DDJFBBJAIG() then
		local var_5_11 = Onboarding.Gunsmith.WasCompleted(arg_5_0, arg_5_1)

		local function var_5_12(arg_9_0, arg_9_1)
		...
		if not var_5_11 then
			...
			if CONDITIONS.IsWZWipFlowEnabled() and CONDITIONS.AreWZLoadoutsEnabled() then
				var_5_13 = ONBOARDING_DATA.GetOnboardingWZCH2GunsmithData()
			else
				var_5_13 = ONBOARDING_DATA.GetOnboardingGunsmithData()
			end

			if CONDITIONS.GunsmithCanMakeModification(arg_5_0, arg_5_1) then
				local function var_5_14(arg_10_0, arg_10_1)
					ACTIONS.LeaveMenu(arg_10_0)
					var_5_12(arg_5_0, arg_10_1)
				end

				var_5_13.confirmButton.action = var_5_14
			end

			LUI.FlowManager.RequestPopupMenu(arg_5_0, "onboardingpopup", true, arg_5_1, false, var_5_13)
			Onboarding.Gunsmith.MarkCompleted(arg_5_0, arg_5_1)
		elseif CONDITIONS.GunsmithCanMakeModification(arg_5_0, arg_5_1) then
			var_5_12(arg_5_0, arg_5_1)
		end
	end
...
function Gunsmith(arg_11_0, arg_11_1)
	...
	local var_11_3
	local var_11_4 = MenuBuilder.BuildRegisteredType("WZAccentMenuOverlay", {
		controllerIndex = var_11_1
	})
	...
	local var_11_5
	local var_11_6 = MenuBuilder.BuildRegisteredType("TabBacker", {
		controllerIndex = var_11_1
	})

	var_11_6.id = "TabBacker"

	var_11_6:SetAnchorsAndPosition(0, 0, 0, 1, 0, 0, 0, _1080p * 160)
	var_11_0:addElement(var_11_6)

	var_11_0.TabBacker = var_11_6
	...
	local var_11_9 = LUI.TabManager.new(var_11_8)

	var_11_9.id = "Tabs"

	var_11_9:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 90, _1080p * 993, _1080p * 108, _1080p * 160)
	var_11_0:addElement(var_11_9)

	var_11_0.Tabs = var_11_9

	local var_11_10
	local var_11_11 = MenuBuilder.BuildRegisteredType("MenuTitle", {
		controllerIndex = var_11_1
	})

	var_11_11.id = "MenuTitle"

	var_11_11.MenuTitle:setText("", 0)
	var_11_11.Line:SetLeft(0, 0)
	var_11_11:SetAnchorsAndPosition(0, 1, 0, 1, 0, _1080p * 1020, 0, _1080p * 100)
	var_11_0:addElement(var_11_11)

	var_11_0.MenuTitle = var_11_11

	local var_11_12

	if CONDITIONS.InFrontend() then
		local var_11_13 = MenuBuilder.BuildRegisteredType("LobbyMembersFooter", {
			controllerIndex = var_11_1
		})

		var_11_13.id = "LobbyMembersFooter"

		var_11_13:SetAnchorsAndPosition(0, 0, 0, 1, 0, 0, 0, _1080p * 150)
		var_11_0:addElement(var_11_13)

		var_11_0.LobbyMembersFooter = var_11_13
	end

	local var_11_14

	if CONDITIONS.GunsmithCanMakeModification(var_11_0, var_11_1) then
		var_11_14 = LUI.UIText.new()
		var_11_14.id = "CustomModSlotCount"

		var_11_14:SetRGBFromTable(SWATCHES.genericButton.description, 0)
		var_11_14:SetAlpha(0.5, 0)
		var_11_14:setText(Engine.CBBHFCGDIC("LUA_MENU/CUSTOM_MOD_COUNT"), 0)
		var_11_14:SetFont(FONTS.GetFont(FONTS.MainRegular.File))
		var_11_14:SetWordWrap(false)
		var_11_14:SetAlignment(LUI.Alignment.Left)
		var_11_14:SetAnchorsAndPosition(0, 1, 1, 0, _1080p * 135, _1080p * 592, _1080p * -397, _1080p * -373)
		var_11_0:addElement(var_11_14)

		var_11_0.CustomModSlotCount = var_11_14
	end

	local var_11_15

	if CONDITIONS.GunsmithCanMakeModification(var_11_0, var_11_1) then
		var_11_15 = LUI.UIText.new()
		var_11_15.id = "SaveMod"

		var_11_15:SetRGBFromTable(SWATCHES.genericButton.description, 0)
		var_11_15:setText(Engine.CBBHFCGDIC("CAS/SAVE_BLUEPRINT"), 0)
		...
		var_11_15:SetAnchorsAndPosition(0, 1, 1, 0, _1080p * 137, _1080p * 594, _1080p * -437, _1080p * -409)
		var_11_0:addElement(var_11_15)

		var_11_0.SaveMod = var_11_15
	end

	local var_11_16

	if CONDITIONS.IsPublicMatch() then
		var_11_16 = LUI.UIText.new()
		var_11_16.id = "NextSlotUnlock"

		var_11_16:SetRGBFromTable(SWATCHES.genericButton.description, 0)
		var_11_16:SetAlpha(0.5, 0)
		var_11_16:setText(Engine.CBBHFCGDIC("LUA_MENU/CUSTOM_MOD_NEXT_UNLOCK"), 0)
		...
		var_11_16:SetAnchorsAndPosition(0, 1, 1, 0, _1080p * 135, _1080p * 592, _1080p * -373, _1080p * -349)
		var_11_0:addElement(var_11_16)

		var_11_0.NextSlotUnlock = var_11_16
	end
	...
	if CONDITIONS.GunsmithCanMakeModification(var_11_0, var_11_1) then
		...
		var_11_14:RegisterAnimationSequence("AR", var_11_19)
	end
	...
	if CONDITIONS.IsPublicMatch() then
		...
		var_11_16:RegisterAnimationSequence("AR", var_11_21)
	end
	...
	var_11_0._sequences.AR = var_11_22
