...
function LobbyMembersHeader(arg_3_0, arg_3_1)
	...
	var_3_5:SetRGBFromTable(SWATCHES.genericMenu.breadcrumbs, 0)
	...
	var_3_7:SetRGBFromTable(SWATCHES.genericMenu.breadcrumbs, 0)
	var_3_7:setText("", 0)
	...
	var_3_9:SetRGBFromTable(SWATCHES.genericMenu.breadcrumbs, 0)
	...
	if CONDITIONS.IsPlayerRoleAllowed(var_3_0) then
		...
		var_3_11:SetRGBFromTable(SWATCHES.genericMenu.breadcrumbs, 0)
