...
local function var_0_1(arg_2_0, arg_2_1, arg_2_2, arg_2_3)
	...
	if not WEAPON.SupportsOptics(var_2_1) then
		...
		local var_2_13 = LOOT.IsMWItem({
			type = LOOT.itemTypes.WEAPON,
			ref = var_2_1
		})
		local var_2_14 = ATTACHMENT.SupportsCustomReticles(arg_2_0.equippedOptic, var_2_13)
		local var_2_15 = ATTACHMENT.IsDefaultScope(arg_2_0.equippedOptic)

		if not var_2_14 or not var_2_13 and var_2_15 then
		...
		elseif var_2_5 then
			local var_2_16 = var_2_5 == WEAPON.ReticleNoneValue and WEAPON.emptyCustomizeSlotIcon or WEAPON.GetReticleImage(var_2_5)

			var_2_8(arg_2_0.OpticButton, var_2_16)

			local var_2_17 = GUNSMITH.CheckNewReticleForOptic(arg_2_1, arg_2_0.equippedOptic, var_2_13)

			arg_2_0.OpticButton:UpdateBreadcrumb(var_2_17)
		end
	end
	...
	elseif var_2_6 then
		local var_2_18 = var_2_6 == WEAPON.CharmNoneValue and WEAPON.emptyCustomizeSlotIcon or WEAPON.GetCharmImage(var_2_6)

		var_2_8(arg_2_0.CharmButton, var_2_18)

		local var_2_19 = LOOT.GetItemGameSource({
			type = LOOT.itemTypes.WEAPON,
			ref = var_2_1
		})
		local var_2_20 = LOOT.IsCategoryNew(arg_2_1, LOOT.itemTypes.CHARM, var_2_19)

		arg_2_0.CharmButton:UpdateBreadcrumb(var_2_20)
	end
	...
	elseif var_2_7 then
		local var_2_21 = {}
		local var_2_22 = WEAPON.GetMaxStickerSlotsForWeapon(var_2_1)

		for iter_2_0 = 1, var_2_22 do
			local var_2_23 = var_2_7[iter_2_0]
			local var_2_24 = var_2_23 == WEAPON.StickerNoneValue and WEAPON.emptyCustomizeSlotIcon or WEAPON.GetStickerImage(var_2_23)

			table.insert(var_2_21, var_2_24)
		end

		arg_2_0.StickerButton:SetAvailableImages(var_2_22)
		var_2_9(arg_2_0.StickerButton, var_2_21)

		local var_2_25 = LOOT.GetItemGameSource({
			type = LOOT.itemTypes.WEAPON,
			ref = var_2_1
		})
		local var_2_26 = LOOT.IsCategoryNew(arg_2_1, LOOT.itemTypes.STICKER, var_2_25)

		arg_2_0.StickerButton:UpdateBreadcrumb(var_2_26)
	end
end
