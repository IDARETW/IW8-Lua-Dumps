...
function MainMenuBladeUpsellOverlay(arg_5_0, arg_5_1)
	...
	if not CONDITIONS.HideBuyMWPromptMagmaBlades() then
		...
		var_5_3.PurchaseText:setText(Engine.CBBHFCGDIC("LUA_MENU/PURCHASE_MW"), 0)
	...
	var_5_5:setImage(RegisterMaterial("widg_gradient_center_out"), 0)
	...
	var_5_9:setImage(RegisterMaterial("widg_gradient_center_out"), 0)
	...
	var_5_11:SetAnchorsAndPosition(0, 0, 0, 1, 0, 0, _1080p * 246, _1080p * 282)
