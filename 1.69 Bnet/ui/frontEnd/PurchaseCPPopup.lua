...
local function var_0_0(arg_1_0, arg_1_1)
	...
	if var_1_1 and #var_1_1 > 0 then
		local var_1_2 = STORE.GetActiveCODPointsCategory()

		for iter_1_0 = 1, #var_1_1 do
			local var_1_3 = var_1_1[iter_1_0].categoryId

			if var_1_3 == var_1_2 then
				local var_1_4 = InGameStore.GetCategoryProducts(arg_1_1, var_1_3)

				if var_1_4 and #var_1_4 > 0 then
					local var_1_5 = {}

					for iter_1_1, iter_1_2 in ipairs(var_1_4) do
						if string.find(iter_1_2.productId, var_1_2) ~= nil then
							iter_1_2.itemIndex = #var_1_5
							iter_1_2.owned = false
							iter_1_2.isFirstParty = true
							iter_1_2.image = iter_1_2.image == "" and "placeholder_x" or iter_1_2.image .. "_small"

							table.insert(var_1_5, iter_1_2)
						end
					end

					local function var_1_6(arg_2_0, arg_2_1, arg_2_2)
						local var_2_0 = arg_1_0.Grid:GetContentIndex(arg_2_1, arg_2_2)

						arg_2_0:SetButtonData(var_1_5[var_2_0 + 1])
					end

					arg_1_0.Grid:SetRefreshChild(var_1_6)
					arg_1_0.Grid:SetNumChildren(#var_1_5)
...
local function var_0_1(arg_3_0, arg_3_1)
	InGameStore.FetchCatalog(arg_3_1, true, true)
