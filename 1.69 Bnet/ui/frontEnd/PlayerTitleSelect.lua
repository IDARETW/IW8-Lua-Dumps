...
local function var_0_3(arg_2_0, arg_2_1)
	local var_2_0 = RANDOM.IsEnabled(arg_2_0._controllerIndex, LOOT.itemTypes.TITLE)
	local var_2_1 = RANDOM.IsEnabled(arg_2_0._controllerIndex, LOOT.itemTypes.TITLE, {
		isFav = true
	})
	local var_2_2 = var_2_1 and arg_2_1.isRandomFavorite

	return not var_2_0 and not var_2_1 and arg_2_0._equippedTitleIndex == tonumber(arg_2_1.index) or var_2_0 and arg_2_1.isRandom and not arg_2_1.isRandomFavorite or var_2_2
end

local function var_0_4(arg_3_0, arg_3_1)
	arg_3_0._titleTable = {}

	if not arg_3_0._allTitleTable then
		arg_3_0._allTitleTable = PlayerTitleUtils.GetAllPlayerTitles(arg_3_1, {
			unlockType = PlayerTitleUtils.Categories.CORE
		})
	end
	...
	for iter_3_0 = 1, #arg_3_0._allTitleTable do
		local var_3_2 = arg_3_0._allTitleTable[iter_3_0]
	...
	for iter_3_1 = 1, #arg_3_0._allTitleTable do
		if arg_3_0._allTitleTable[iter_3_1].isUnlocked or arg_3_0.lockedSortingType == LOOT.lockedSortingOptions.SHOW then
			table.insert(arg_3_0._titleTable, arg_3_0._allTitleTable[iter_3_1])
		end
	end
	...
	table.insert(var_3_3, {
		...
		sortFuncParams = {
			favoritesTable = arg_3_0._favoriteTitles
		}
	})
	table.insert(var_3_3, {
	...
	MenuUtils.SortTableViaOptions(arg_3_0._titleTable, var_3_3)
	...
	if Dvar.IBEGCHEFE("TQRNTTMSL") then
		...
		var_3_4.isUnlocked = arg_3_0._favoriteTitles.count >= 2
		var_3_4.unlockText = Engine.CBBHFCGDIC("CUSTOMIZE/RANDOM_TITLE_FAVORITE_UNLOCK")

		table.insert(arg_3_0._titleTable, 1, var_3_4)
		table.insert(arg_3_0._titleTable, 1, RANDOM.GetItemData(arg_3_1, {
			itemType = LOOT.itemTypes.TITLE
		}))
	end
...
local function var_0_7(arg_7_0)
	return function(arg_8_0, arg_8_1, arg_8_2)
		...
		local var_8_1 = arg_7_0._titleTable[var_8_0 + 1]
		local var_8_2 = var_0_3(arg_7_0, var_8_1)
		local var_8_3 = arg_7_0._favoriteTitles[var_8_1.ref]
...
local function var_0_8(arg_9_0, arg_9_1)
	local var_9_0 = arg_9_0._favoriteTitles[arg_9_1.ref]
	local var_9_1 = arg_9_0._favoriteTitles.count
...
local function var_0_9(arg_10_0)
	...
	local var_10_1 = arg_10_0._titleTable[var_10_0]

	if not var_0_5(var_10_1) then
		return
	end

	if arg_10_0._favoriteTitles[var_10_1.ref] then
		LOOT.RemoveFavoriteForType(LOOT.itemTypes.TITLE, var_10_1.ref)

		if Dvar.IBEGCHEFE("TQRNTTMSL") then
			local var_10_2 = arg_10_0._favoriteTitles.count

			arg_10_0._titleTable[var_0_1].isUnlocked = var_10_2 - 1 >= 2

			var_0_7(arg_10_0)

			if RANDOM.IsEnabled(arg_10_0._controllerIndex, LOOT.itemTypes.TITLE, {
				isFav = true
			}) and not arg_10_0._titleTable[var_0_1].isUnlocked then
				local var_10_3 = arg_10_0.PlayerCardGrid:GetPositionForIndex(var_0_0)
		...
		local var_10_4 = arg_10_0._favoriteTitles.count
		...
		if var_10_4 >= LOOT.maxFavorites then
			...
			LOOT.AddFavoriteForType(LOOT.itemTypes.TITLE, var_10_1.ref)

			if Dvar.IBEGCHEFE("TQRNTTMSL") then
				arg_10_0._titleTable[var_0_1].isUnlocked = var_10_4 + 1 >= 2
	...
	if not arg_10_0._favoriteTitles[var_10_1.ref] then
	...
	arg_10_0._favoriteTitles = LOOT.GetFavoritesForType(LOOT.itemTypes.TITLE)

	arg_10_0.PlayerCardGrid:RefreshContent()

	if #arg_10_0._titleTable > 0 then
...
local function var_0_10(arg_11_0, arg_11_1)
	...
	local var_11_0 = arg_11_0._titleTable[arg_11_1]
	...
	if var_11_0.isRandom or not var_0_3(arg_11_0, var_11_0) then
		...
		if var_11_0.isRandomFavorite then
			RANDOM.Toggle(arg_11_0._controllerIndex, LOOT.itemTypes.TITLE, {
				isFav = true
			})

			if not RANDOM.IsEnabled(arg_11_0._controllerIndex, LOOT.itemTypes.TITLE, {
				isFav = true
			}) then
				var_11_2 = PlayerTitleUtils.GetTitleNameFromID(arg_11_0._equippedTitleIndex)
				var_11_1 = arg_11_0._equippedTitleIndex
			end

			RANDOM.SetEnabled(arg_11_0._controllerIndex, LOOT.itemTypes.TITLE, false)
		elseif var_11_0.isRandom then
			RANDOM.Toggle(arg_11_0._controllerIndex, LOOT.itemTypes.TITLE)

			if not RANDOM.IsEnabled(arg_11_0._controllerIndex, LOOT.itemTypes.TITLE) then
				var_11_2 = PlayerTitleUtils.GetTitleNameFromID(arg_11_0._equippedTitleIndex)
				var_11_1 = arg_11_0._equippedTitleIndex
			end
			...
			Playercard.DAIIIAHAHH(arg_11_0._controllerIndex, var_11_1)

			arg_11_0._equippedTitleIndex = var_11_1
		end

		if var_11_1 == PlayerTitleUtils.DefaultTitleID then
			arg_11_0.DetailPanel.WZSmallPlayerCard.PlayerTitle:SetAlpha(0)
			arg_11_0.DetailPanel.WZSmallPlayerCard.TitleBacker:SetAlpha(0)
		else
			arg_11_0.DetailPanel.WZSmallPlayerCard.PlayerTitle:SetAlpha(1)
			arg_11_0.DetailPanel.WZSmallPlayerCard.TitleBacker:SetAlpha(0.5)

			if not RANDOM.IsEnabled(arg_11_0._controllerIndex, LOOT.itemTypes.TITLE) and not RANDOM.IsEnabled(arg_11_0._controllerIndex, LOOT.itemTypes.TITLE, {
				isFav = true
			}) then
				arg_11_0.DetailPanel.WZSmallPlayerCard.PlayerTitle:setText(Engine.CBEAHDFCFC(Engine.CBBHFCGDIC(var_11_2)))
			end
		end
...
local function var_0_11(arg_12_0)
	...
	local var_12_1 = arg_12_0._titleTable[var_12_0]
	...
	if var_0_5(var_12_1) then
		...
		local var_12_3 = arg_12_0._favoriteTitles[var_12_1.ref]
		local var_12_4 = arg_12_0._favoriteTitles.count
...
local function var_0_12(arg_13_0)
	...
	arg_13_0.PlayerCardGrid:SetNumChildren(#arg_13_0._titleTable)
	arg_13_0.PlayerCardGrid:RefreshContent()

	if #arg_13_0._titleTable > 0 then
		arg_13_0.NoPlayerCardsLabel:SetAlpha(0)
	end
end

local function var_0_13(arg_14_0)
	local var_14_0 = PlayerTitleUtils.GetTitleRef(arg_14_0._equippedTitleIndex)

	return LOOT.GetItemID(LOOT.itemTypes.TITLE, var_14_0)
end

local function var_0_14(arg_15_0)
	local var_15_0 = (function()
		for iter_16_0, iter_16_1 in ipairs(arg_15_0._titleTable) do
...
local function var_0_15(arg_17_0)
	if arg_17_0._isComingFromFilterMenu then
		local var_17_0 = (function()
			for iter_18_0, iter_18_1 in ipairs(arg_17_0._titleTable) do
...
local function var_0_16(arg_19_0, arg_19_1)
	...
	table.insert(var_19_0, {
		disabled = false,
		name = Engine.CBBHFCGDIC("LUA_MENU/LB_FILTER_GROUP_ALL"),
		tabHeight = _1080p * 52,
		focusFunction = function(arg_20_0, arg_20_1, arg_20_2, arg_20_3)
			arg_19_0._allTitleTable = PlayerTitleUtils.GetAllPlayerTitles(arg_20_1)

			var_0_4(arg_19_0, arg_20_1)
			arg_19_0:UpdateGrid()
		end
	})
	arg_19_0.Tabs:SetTabs(var_19_0)
...
local function var_0_17(arg_21_0, arg_21_1)
	...
	arg_21_0.MenuTitle:SetTitle(Engine.CBBHFCGDIC("LUA_MENU/PLAYERTITLE"))
	...
	arg_21_0.FavoriteTitle = FavoriteTitle
	arg_21_0.Preview = var_0_11
	arg_21_0.UpdateGrid = var_0_12
	arg_21_0._controllerIndex = arg_21_1
	arg_21_0._titleTable = {}
	arg_21_0._allTitleTable = PlayerTitleUtils.GetAllPlayerTitles(arg_21_1, {
		unlockType = PlayerTitleUtils.Categories.CORE
	})
	arg_21_0._favoriteTitles = LOOT.GetFavoritesForType(LOOT.itemTypes.TITLE)
	arg_21_0._equippedTitleIndex = DataSources.frontEnd.PlayerCard.title:GetValue(arg_21_1)
	arg_21_0._isComingFromFilterMenu = false

	LOOT.SetupSortingBehavior(arg_21_0, arg_21_1, LOOT.itemTypes.TITLE)
	var_0_4(arg_21_0, arg_21_1)
	arg_21_0.PlayerCardGrid:SetRefreshChild(var_0_7(arg_21_0))
	...
	arg_21_0:addEventHandler("menu_close", function(arg_22_0, arg_22_1)
		DataSources.frontEnd.PlayerCard.title:SetValue(arg_21_1, arg_21_0._equippedTitleIndex)
	...
	arg_21_0.bindButton:addEventHandler("button_left_trigger", function(arg_25_0, arg_25_1)
		if LUI.IsLastInputGamepad(arg_25_1.controller) then
			...
			arg_21_0._currentSelectedLootID = arg_21_0._titleTable[var_25_0].lootID
		end

		local var_25_1 = MenuBuilder.BuildRegisteredType("CustomizeSortingPopup", {
			controllerIndex = arg_21_1,
			menu = arg_21_0,
			type = LOOT.itemTypes.TITLE
		})
	...
	var_0_16(arg_21_0, arg_21_1, options)
end

function PlayerTitleSelect(arg_28_0, arg_28_1)
	local var_28_0 = LUI.UIElement.new()

	var_28_0.id = "PlayerTitleSelect"
	...
	var_28_22.MenuTitle:setText(Engine.CBBHFCGDIC("LUA_MENU/PLAYERTITLE"), 0)
...
MenuBuilder.registerType("PlayerTitleSelect", PlayerTitleSelect)
LockTable(_M)
