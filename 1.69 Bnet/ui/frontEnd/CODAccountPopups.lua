...
function CODAccountEULAPopupA(arg_6_0, arg_6_1)
	...
	function arg_6_1.declineAction(arg_8_0, arg_8_1)
		LUI.FlowManager.RequestPopupMenu(nil, "CODAccountEULADeclinePopup", true, arg_8_1.controller, false, {
			overrideTitle = Engine.CBBHFCGDIC("LUA_MENU/BOOT_TERMS_OF_USE_DECLINE_TITLE"),
...
function CODAccountEULAPopupB(arg_10_0, arg_10_1)
	...
	function arg_10_1.declineAction(arg_12_0, arg_12_1)
		LUI.FlowManager.RequestPopupMenu(nil, "CODAccountEULADeclinePopup", true, arg_12_1.controller, false, {
			overrideTitle = Engine.CBBHFCGDIC("LUA_MENU/BOOT_PRIVACY_POLICY_DECLINE_TITLE"),
...
local function var_0_2(arg_17_0, arg_17_1)
	...
	arg_17_1.title = arg_17_1 and arg_17_1.overrideTitle ~= nil and arg_17_1.overrideTitle or Engine.CBBHFCGDIC("LUA_MENU/EULA_ACCEPT")
	arg_17_1.buttons = {
		{
			label = Engine.CBBHFCGDIC("MENU/OK")
		}
...
local function var_0_3(arg_18_0, arg_18_1)
...
local function var_0_4(arg_19_0, arg_19_1)
...
local function var_0_6(arg_24_0, arg_24_1)
...
MenuBuilder.registerType("CODAccountEULADeclinePopup", var_0_2)
...
MenuBuilder.registerType("CODAccountRegisteringPopup", var_0_3)
...
MenuBuilder.registerType("CODAccountLoggingInPopup", var_0_4)
...
MenuBuilder.registerType("CODAccountRestartingPopup", var_0_5)
...
MenuBuilder.registerType("CODAccountSuccessPopup", var_0_6)
...
MenuBuilder.registerType("CODAccountErrorPopup", var_0_7)
...
MenuBuilder.registerType("CODAccountOptionsPopup", var_0_1)
