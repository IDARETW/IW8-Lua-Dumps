...
MenuBuilder.registerType("CampaignMenuOffline", function(arg_10_0, arg_10_1)
	local var_10_0 = arg_10_1 or {}

	var_10_0.chatOptOut = true

	return MenuBuilder.BuildRegisteredType("CampaignMenu", var_10_0)
end)
LUI.FlowManager.RegisterStackPushBehaviour("CampaignMenuOffline", var_0_3)
LUI.FlowManager.RegisterStackPushBehaviour("CampaignMenuOffline", var_0_4)
...
local function var_0_6(arg_12_0, arg_12_1, arg_12_2)
	...
	arg_12_0.MenuTitle:SetTitle(Engine.CBBHFCGDIC("MENU/CAMPAIGN"))

	arg_12_0._controllerIndex = arg_12_1

	Engine.BHEJICHIDE()
	Engine.DFJDIFJEGA("initialGameMode", MAIN_MENU.BladeKeys.SP, arg_12_1)
	Engine.DFJDIFJEGA("isSPNew", 0, arg_12_1)
	Engine.EBIDFIDHIE("updategamerprofile")
	Engine.EBIDFIDHIE("updatesavegameavailable")

	if arg_12_0.MPPlayerDetails then
		ACTIONS.AnimateSequence(arg_12_0.MPPlayerDetails, "HideRank")
	end

	arg_12_0.SetupTabs = var_0_2

	arg_12_0:addEventHandler("menu_create", arg_12_0.SetupTabs)
	arg_12_0.Tabs:SetAlignment(LUI.Alignment.Left)

	if arg_12_2 then
		arg_12_0.chatOptOut = arg_12_2.chatOptOut
	end
	...
	if CONDITIONS.ArePartiesEnabledInMainMenu() and Lobby.GFFECBCCF() then
		Engine.DAGFFDGFII("xstopprivateparty 0 1", arg_12_1)
	end
	...
	if Dvar.IBEGCHEFE("Kleenex") then
		arg_12_0:RemoveButtonHelperText("button_secondary", "right")
		Dvar.BDEHAEGHAF("start", "")
	end

	if CONDITIONS.IsPCAchievementsMenuAvailable(arg_12_0) then
		arg_12_0:addEventHandler("menu_create", function(arg_13_0, arg_13_1)
			arg_13_0:AddButtonHelperText({
				side = "left",
				button_ref = "button_right_stick",
				priority = 10,
				helper_text = Engine.EAABDHIDFJ() and Engine.CBBHFCGDIC("MSSTORE_PLATFORM/ACHIEVEMENT") or Engine.CBBHFCGDIC("LUA_MENU/ACHIEVEMENT")
			})
		end)
		arg_12_0.bindButton:addEventHandler("button_right_stick", function(arg_14_0, arg_14_1)
			ACTIONS.OpenPCAchievementMenu(arg_14_1.controller)
		end)
	end

	assert(arg_12_0.bindButton)
	arg_12_0.bindButton:addEventHandler("button_secondary", function(arg_15_0, arg_15_1)
		local var_15_0 = arg_12_0.activeTabWidget
		local var_15_1 = true

		if var_15_0 and var_15_0.BackButtonOverride then
			var_15_1 = var_15_0.BackButtonOverride(arg_15_0, arg_15_1)
		end

		if var_15_1 and not Dvar.IBEGCHEFE("Kleenex") then
			LUI.FlowManager.RequestLeaveMenu(arg_12_0)
		end
	end)
	LAYOUT.AddAspectRatioFadeFrame(arg_12_0, arg_12_1)
	OnlineProgression.HGBFIHEHE(arg_12_1)

	if Dvar.IBEGCHEFE("MNMTKTRPPP") then
		LUI.FlowManager.RequestPopupMenu(nil, "ProgramDetectedErrorPopup", true, arg_12_1, false, {}, nil, true, true)
	end

	arg_12_0:addEventHandler("OverwolfDetectedEvent", function(arg_16_0, arg_16_1)
		LUI.FlowManager.RequestPopupMenu(nil, "ProgramDetectedErrorPopup", true, arg_12_1, false, {}, nil, true, true)
	end)
end

function CampaignMenu(arg_17_0, arg_17_1)
	local var_17_0 = LUI.UIElement.new()

	var_17_0.id = "CampaignMenu"
	...
	local var_17_3
	local var_17_4 = LUI.UIText.new()

	var_17_4.id = "Copyright"

	var_17_4:SetRGBFromInt(14277081, 0)
	var_17_4:SetAlpha(0, 0)
	var_17_4:setText(Engine.CBBHFCGDIC("LUA_MENU/LEGAL_COPYRIGHT"), 0)
	var_17_4:SetFont(FONTS.GetFont(FONTS.MainLight.File))
	var_17_4:SetAlignment(LUI.Alignment.Center)
	var_17_4:SetAnchorsAndPosition(0, 0, 0, 1, 0, 0, _1080p * 880, _1080p * 925)
	var_17_0:addElement(var_17_4)

	var_17_0.Copyright = var_17_4

	local var_17_5

	if CONDITIONS.IsUserSignedInDemonware(var_17_1) then
		local var_17_6 = MenuBuilder.BuildRegisteredType("MPPlayerDetails", {
			controllerIndex = var_17_1
		})

		var_17_6.id = "MPPlayerDetails"

		var_17_6:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 1404, _1080p * 1824, _1080p * 54, _1080p * 114)
		var_17_0:addElement(var_17_6)

		var_17_0.MPPlayerDetails = var_17_6
	end
	...
	local var_17_9 = LUI.TabManager.new(var_17_8)

	var_17_9.id = "Tabs"

	var_17_9:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 90, _1080p * 996, _1080p * 108, _1080p * 160)
	var_17_0:addElement(var_17_9)

	var_17_0.Tabs = var_17_9
	...
	var_17_11.MenuTitle:setText(ToUpperCase(Engine.CBBHFCGDIC("MENU/CAMPAIGN")), 0)
	...
	var_17_4:RegisterAnimationSequence("ShowCopyright", var_17_14)

	local function var_17_15()
		var_17_4:AnimateSequence("ShowCopyright")
	end

	var_17_0._sequences.ShowCopyright = var_17_15
	...
	var_17_0.bindButton:addEventHandler("button_start", function(arg_21_0, arg_21_1)
		local var_21_0 = arg_21_1.controller or var_17_1

		ACTIONS.OpenOptionsMenu(var_21_0, "", "", "")
	end)
