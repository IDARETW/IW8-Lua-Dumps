...
local function var_0_5(arg_3_0, arg_3_1)
	if arg_3_1.type == LOOT.itemTypes.VEHICLE_TRACK then
		local var_3_0 = VEHICLE.GetTrackPack(arg_3_1.ref)

		arg_3_1.vehicleTrackCount = #VEHICLE.GetAllTracksInPack(var_3_0)
	end

	arg_3_1.image = LOOT.GetBattlepassImage(arg_3_1.type, arg_3_1.ref, arg_3_1.ID)
...
function BattlePassTierItem(arg_5_0, arg_5_1)
	...
	var_5_4:RegisterAnimationSequence("ButtonOver", var_5_7)

	local function var_5_8()
		var_5_4:AnimateSequence("ButtonOver")
	end

	var_5_0._sequences.ButtonOver = var_5_8
	...
	var_5_4:RegisterAnimationSequence("ButtonUp", var_5_10)
