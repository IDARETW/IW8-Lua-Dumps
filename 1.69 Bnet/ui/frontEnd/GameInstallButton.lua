		...
		elseif arg_3_0._product.status == InGameStoreProductStatus.INSTALLED then
			if not Engine.BAHIIBFDDG() then
				local function var_7_0()
					if string.sub(arg_3_0._product.productId, 1, 6) == "dlc_t9" then
						InGameStore.DeleteContent(arg_3_1, arg_3_0._product.productId)
				...
				local var_7_1 = "LUA_MENU/UNINSTALL_PACK_DESC"

				if arg_3_0._product.productId == STORE.DATA_PACK_1_NAME then
					var_7_1 = "LUA_MENU/UNINSTALL_DATA_PACK_1_DESC"
				elseif arg_3_0._product.productId == STORE.DATA_PACK_2_NAME then
					var_7_1 = "LUA_MENU/UNINSTALL_DATA_PACK_2_DESC"
				end
