...
local function var_0_3(arg_1_0, arg_1_1, arg_1_2, arg_1_3)
	for iter_1_0, iter_1_1 in pairs(arg_1_1) do
		...
		if var_1_0 then
			...
			if var_1_4.type == LOOT.itemTypes.S4_MISC then
				var_1_4.miscType = LOOT.GetMiscTypeForID(iter_1_1)
			end

			var_1_4.image = LOOT.GetItemImage(var_1_1, var_1_2, iter_1_1)
			var_1_4.name = LOOT.GetItemName(var_1_1, var_1_2, iter_1_1)
			var_1_4.rarity = var_1_3
			var_1_4.rarityImage = LOOT.GetRarityImage(var_1_3)
			var_1_4.rarityColor = LOOT.GetRarityColor(var_1_3)
			var_1_4.isOperatorChallenge = LOOT.IsFeatureOperatorChallenge(var_1_2)
...
local function var_0_7(arg_6_0, arg_6_1)
	if arg_6_1.id == arg_6_0._currentlyShownBundleId then
		return
	end
	...
	arg_6_0._currentlyShownBundleId = arg_6_1.id
