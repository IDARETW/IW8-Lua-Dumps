...
local function var_0_5(arg_6_0, arg_6_1, arg_6_2)
	...
	if arg_6_0.AchievementButton then
		if Engine.EAABDHIDFJ() then
			arg_6_0.AchievementButton.Text:setText(ToUpperCase(Engine.CBBHFCGDIC("MSSTORE_PLATFORM/ACHIEVEMENT")), 0)
			arg_6_0.AchievementButton.Description:setText(Engine.CBBHFCGDIC("MSSTORE_PLATFORM/ACHIEVEMENTS_DESC"), 0)
		end
