...
function SetupVehicleInfo(arg_1_0, arg_1_1, arg_1_2)
	...
	if arg_1_1.icon and #arg_1_1.icon > 0 then
		arg_1_0.Image:setImage(RegisterMaterial(arg_1_1.icon))
	end
	...
	arg_1_0.LockedText:setText(LAYOUT.SetWarzoneStringHighlightOverride(Engine.CBBHFCGDIC("VEHICLES/LOCKED_TEXT", arg_1_1.name)))
...
local function var_0_0(arg_2_0, arg_2_1, arg_2_2)
	...
	arg_2_0:addEventHandler("button_over", function(arg_3_0)
	...
	arg_2_0:addEventHandler("button_up", function(arg_4_0)
		WZWIP.AnimateThemeElement(arg_4_0, "ButtonUp")
	end)
	arg_2_0:addEventHandler("button_disable", function(arg_5_0)
		WZWIP.AnimateThemeElement(arg_5_0, "ButtonUpDisabled")
	end)
	arg_2_0:addEventHandler("button_over_disable", function(arg_6_0)
	...
	arg_2_0:addEventHandler("button_action", function(arg_7_0)
		LUI.FlowManager.GetScopedData("VehicleSelect").currentVehicleRef = arg_7_0._vehicleInfo.ref

		LUI.FlowManager.RequestAddMenu("VehicleCustomization", true, arg_2_1, false, {
			vehicleInfo = arg_7_0._vehicleInfo
		})
	end)

	if CONDITIONS.IsMagmaGameMode() then
		ACTIONS.AnimateSequence(arg_2_0, "WZSetup")
		arg_2_0.LockedText:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 14, _1080p * 196, _1080p * 42, _1080p * 62)
	end
end
...
function VehicleButton(arg_8_0, arg_8_1)
	...
	var_8_8:RegisterAnimationSequence("WZSetup", var_8_40)
	...
	var_8_14:RegisterAnimationSequence("WZSetup", var_8_41)

	local function var_8_42()
		var_8_8:AnimateSequence("WZSetup")
		var_8_14:AnimateSequence("WZSetup")
	end

	var_8_0._sequences.WZSetup = var_8_42
	...
	var_8_6:RegisterAnimationSequence("WZWipButtonOver", var_8_44)
	...
	var_8_8:RegisterAnimationSequence("WZWipButtonOver", var_8_45)
	...
	var_8_0._sequences.WZWipButtonOver = var_8_46
	...
	var_8_6:RegisterAnimationSequence("WZWipButtonOverDisabled", var_8_48)
	...
	var_8_8:RegisterAnimationSequence("WZWipButtonOverDisabled", var_8_49)
	...
	var_8_14:RegisterAnimationSequence("WZWipButtonOverDisabled", var_8_50)
	...
	var_8_0._sequences.WZWipButtonOverDisabled = var_8_51
	...
	var_8_6:RegisterAnimationSequence("WZWipButtonUp", var_8_53)
	...
	var_8_8:RegisterAnimationSequence("WZWipButtonUp", var_8_54)
	...
	var_8_0._sequences.WZWipButtonUp = var_8_55
	...
	var_8_6:RegisterAnimationSequence("WZWipButtonUpDisabled", var_8_57)
	...
	var_8_8:RegisterAnimationSequence("WZWipButtonUpDisabled", var_8_58)
	...
	var_8_14:RegisterAnimationSequence("WZWipButtonUpDisabled", var_8_59)
	...
	var_8_0._sequences.WZWipButtonUpDisabled = var_8_60
