...
local function var_0_6(arg_10_0, arg_10_1)
	...
	local function var_10_2(arg_13_0, arg_13_1)
		...
		if arg_13_0._isGamepad then
			ACTIONS.AnimateSequence(arg_13_0, "Gamepad")
			...
			if not arg_13_0._buttonAdded then
				arg_13_0.FriendsButton.Prompt:SetAlpha(1)
				arg_13_0:addElement(arg_13_0.BindButton)

				arg_13_0._buttonAdded = true
			end
		else
			ACTIONS.AnimateSequence(arg_13_0, "KBM")
			...
			if arg_13_0._buttonAdded then
				arg_13_0.FriendsButton.Prompt:SetAlpha(0)
...
local function var_0_9(arg_18_0, arg_18_1, arg_18_2)
	...
	assert(arg_18_0.FriendsButton.Prompt)
...
function SocialPartyWidgetLayout(arg_23_0, arg_23_1)
	...
	var_23_4.id = "IconSpacer"

	var_23_4:SetAlpha(0, 0)
	var_23_4:SetAnchorsAndPosition(0, 1, 0, 1, 0, _1080p * 2, 0, _1080p * 64)
	var_23_0:addElement(var_23_4)

	var_23_0.IconSpacer = var_23_4

	local var_23_5
	local var_23_6 = LUI.UIImage.new()

	var_23_6.id = "NotificationSpacer"

	var_23_6:SetAlpha(0, 0)
	var_23_6:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 4, _1080p * 14, 0, _1080p * 64)
	var_23_0:addElement(var_23_6)

	var_23_0.NotificationSpacer = var_23_6

	local var_23_7
	local var_23_8 = MenuBuilder.BuildRegisteredType("NewItemSmallIcon", {
		controllerIndex = var_23_1
	})

	var_23_8.id = "SocialNotification"

	var_23_8:SetAlpha(0, 0)
	var_23_8:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 16, _1080p * 24, _1080p * 35, _1080p * 43)
	var_23_0:addElement(var_23_8)

	var_23_0.SocialNotification = var_23_8
	...
	var_23_10:SetAnchorsAndPosition(0, 1, 0.5, 0.5, _1080p * 26, _1080p * 90, _1080p * -32, _1080p * 32)
	var_23_0:addElement(var_23_10)

	var_23_0.Emblem = var_23_10

	local var_23_11
	local var_23_12 = LUI.UIImage.new()

	var_23_12.id = "IsDediMarker"

	var_23_12:SetAlpha(0, 0)
	var_23_12:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 92, _1080p * 94, _1080p * 29, _1080p * 49)
	var_23_0:addElement(var_23_12)

	var_23_0.IsDediMarker = var_23_12

	local var_23_13
	local var_23_14 = MenuBuilder.BuildRegisteredType("FriendsButton", {
		controllerIndex = var_23_1
	})

	var_23_14.id = "FriendsButton"

	var_23_14:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 96, _1080p * 300, _1080p * 23, _1080p * 55)
	var_23_0:addElement(var_23_14)

	var_23_0.FriendsButton = var_23_14

	local function var_23_15()
		return
	end

	var_23_0._sequences.DefaultSequence = var_23_15
	...
	var_23_8:RegisterAnimationSequence("KBM", var_23_17)

	local function var_23_18()
		var_23_8:AnimateSequence("KBM")
	end

	var_23_0._sequences.KBM = var_23_18
	...
	var_23_8:RegisterAnimationSequence("Gamepad", var_23_20)

	local function var_23_21()
		var_23_8:AnimateSequence("Gamepad")
	end

	var_23_0._sequences.Gamepad = var_23_21
