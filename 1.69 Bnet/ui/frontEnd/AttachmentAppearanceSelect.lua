...
local function var_0_3(arg_5_0, arg_5_1, arg_5_2)
	...
	ATTACHMENT.SetupSlotDisplay(arg_5_0.DetailedEquippedSlots, {
		weaponTable = arg_5_0._weaponTable,
		currentCategory = arg_5_2.category
	})
	...
	arg_5_0.DetailedEquippedSlots.EquippedText:setText(Engine.CBBHFCGDIC("CAS/EQUIPPED_COUNT", var_5_1, ATTACHMENT.GetMaxAttachmentCount(arg_5_0._weaponTable.weapon)))
