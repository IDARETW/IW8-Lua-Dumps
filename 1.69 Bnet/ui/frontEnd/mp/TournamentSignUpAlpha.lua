...
local function var_0_2(arg_1_0, arg_1_1, arg_1_2)
	...
	local var_1_20 = var_1_19.columnWidth * var_1_16 + var_1_19.spacingX * (var_1_16 - 1)
	local var_1_21 = LUI.UIGrid.new(var_1_19)

	var_1_21.id = "Maps"

	var_1_21:setUseStencil(true)
	var_1_21:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 495, _1080p * 495 + var_1_20, _1080p * 673, _1080p * 767)
	arg_1_0:addElement(var_1_21)

	arg_1_0.Maps = var_1_21
end
...
function TournamentSignUpAlpha(arg_13_0, arg_13_1)
	...
	var_13_12:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 750, _1080p * 1170, _1080p * 845, _1080p * 883)
	...
	var_13_16:SetAnchorsAndPosition(0, 0, 0, 1, _1080p * 750, _1080p * -750, _1080p * 798, _1080p * 836)
