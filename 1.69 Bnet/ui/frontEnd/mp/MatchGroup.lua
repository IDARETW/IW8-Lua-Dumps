	...
	for iter_5_0, iter_5_1 in ipairs(arg_5_1.teams) do
		...
		if not arg_5_1.complete then
			if arg_5_1.canSpectate then
				...
				if arg_5_0.TournamentPlayerStatus1 then
					arg_5_0.TournamentPlayerStatus1:SetAlpha(0)
				end

				if arg_5_0.TournamentPlayerStatus2 then
					arg_5_0.TournamentPlayerStatus2:SetAlpha(0)
				end
			else
