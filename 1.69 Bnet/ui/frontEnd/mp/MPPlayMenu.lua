...
local function var_0_1(arg_2_0, arg_2_1)
	...
	if arg_2_0.MPPlayMenuButtons.PlaylistEventButton then
		arg_2_0.MPPlayMenuButtons.PlaylistEventButton.navigation = {}
	end
	...
	if arg_2_0.SquadLobbyButton then
		...
		if arg_2_0.MPPlayMenuButtons.PlaylistEventButton then
			arg_2_0.MPPlayMenuButtons.PlaylistEventButton.navigation.up = arg_2_0.SquadLobbyButton
			arg_2_0.SquadLobbyButton.navigation.down = arg_2_0.MPPlayMenuButtons.PlaylistEventButton
		else
	...
	if arg_2_0.CODTvButton then
		...
		if arg_2_0.MPPlayMenuButtons.PlaylistEventButton then
			...
			arg_2_0.CODTvButton.navigation.up = arg_2_0.MPPlayMenuButtons.PlaylistEventButton
			arg_2_0.MPPlayMenuButtons.PlaylistEventButton.navigation.down = arg_2_0.CODTvButton
		else
			arg_2_0.MPPlayMenuButtons.QuickPlayButtonContainer.navigation.up = arg_2_0.CODTvButton
			arg_2_0.CODTvButton.navigation.down = arg_2_0.MPPlayMenuButtons.QuickPlayButtonContainer
		end
	...
	if arg_2_0.MPPlayMenuButtons.CdlEntryButton then
		arg_2_0.MPPlayMenuButtons.CdlEntryButton.navigation = {}
		arg_2_0.MPPlayMenuButtons.CdlEntryButton.navigation.down = arg_2_0.PlaylistMenuButton
		arg_2_0.PlaylistMenuButton.navigation.up = arg_2_0.MPPlayMenuButtons.CdlEntryButton
	elseif arg_2_0.MPPlayMenuButtons.GameBattlesButton then
...
local function var_0_2(arg_7_0, arg_7_1, arg_7_2)
	...
	if arg_7_2 then
		arg_7_0.Challenges:SetAlpha(arg_7_1 and 1 or 0)
	else
...
local function var_0_5(arg_10_0, arg_10_1, arg_10_2)
	...
	arg_10_0._challengesVisible = nil
	arg_10_0.FocusButtonByName = var_0_4
	arg_10_0.UpdateChallengesVisibility = var_0_2

	local var_10_0 = MenuBuilder.BuildRegisteredType("FrontendCameraMover", {
		enableSway = true,
		controllerIndex = arg_10_1
	})

	var_10_0:SetLimits(-2, 2, -2, 2)
	...
	local function var_10_1()
		...
		Lobby.UpdateClientCharactersDelayed(arg_10_0, arg_10_1, var_11_0, function(arg_12_0)
			arg_10_0._clientCharacterMap = arg_12_0

			Lobby.UpdateCharacterDetailsWidgets(arg_10_0._clientCharacterMap, arg_10_0.characterDetailsWidgets, arg_10_1)
		end)
	end

	local var_10_2 = LUI.DataSourceInGlobalModel.new("alwaysLoaded.privateParty.count")

	arg_10_0:SubscribeToModel(var_10_2:GetModel(arg_10_1), function(arg_13_0)
		local var_13_0 = var_10_2:GetValue(arg_13_0)
	...
	if MLG.IsCDLActive(arg_10_1) then
		var_10_3 = MP.GetLastQuickplayFilter(arg_10_1) == MP.PLAYLIST_FILTER_MODE.CDLRules

		arg_10_0.CDLRestrictionTag:SetAlpha(var_10_3 and 1 or 0)
	end

	if arg_10_0.EventPromoBanner and not var_10_3 then
		arg_10_0.EventPromoBanner:Setup()
	end
	...
	if Dvar.IBEGCHEFE("LNLNSSNKQ") then
		...
		local var_10_4 = WORLD_MAP.BuildCurrentMap(arg_10_1)

		if var_10_4 then
			arg_10_0:addElement(var_10_4)

			arg_10_0.worldMap = var_10_4
		end

		local function var_10_5(arg_16_0, arg_16_1)
		...
		local function var_10_6(arg_17_0, arg_17_1)
	...
	arg_10_0:registerEventHandler("matchrules_updated", function(arg_18_0, arg_18_1)
		var_10_3 = arg_18_0.CDLRestrictionTag:UpdateVisibility(arg_10_1)

		if arg_18_0.EventPromoBanner and not var_10_3 then
			arg_18_0.EventPromoBanner:Setup()
		end
	end)
	arg_10_0:addEventHandler("gift_queued_in", function(arg_19_0, arg_19_1)
		GIFT.ProcessQueuedBundleGifts(arg_10_1)
...
function MPPlayMenu(arg_20_0, arg_20_1)
	...
	if CONDITIONS.IsDemoBuildOrDevBuildOrAreDevFeaturesEnabled() then
		...
		var_20_4.id = "DevButtonsBackground"

		var_20_4:SetRGBFromTable(SWATCHES.CAC.panelBacker, 0)
		var_20_4:SetAlpha(0.4, 0)
		var_20_4:setImage(RegisterMaterial("widg_gradient_top_to_bottom"), 0)
		var_20_4:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 544, _1080p * 924, _1080p * 796, _1080p * 1026)
		var_20_0:addElement(var_20_4)

		var_20_0.DevButtonsBackground = var_20_4
	end

	local var_20_5
	local var_20_6 = MenuBuilder.BuildRegisteredType("WZAccentMenuOverlay", {
		controllerIndex = var_20_1
	})

	var_20_6.id = "Vignette"

	var_20_6:SetAnchorsAndPosition(0, 1, 0, 1, 0, _1080p * 1920, 0, _1080p * 1080)
	var_20_0:addElement(var_20_6)

	var_20_0.Vignette = var_20_6

	local var_20_7
	local var_20_8 = MenuBuilder.BuildRegisteredType("MPPlayMenuButtons", {
		controllerIndex = var_20_1
	})

	var_20_8.id = "MPPlayMenuButtons"

	var_20_8:SetAnchorsAndPosition(0, 1, 0, 0, _1080p * 96, _1080p * 526, _1080p * 216, _1080p * -108)
	var_20_0:addElement(var_20_8)

	var_20_0.MPPlayMenuButtons = var_20_8

	local var_20_9

	if CONDITIONS.IsDemoBuildOrDevBuildOrAreDevFeaturesEnabled() then
		local var_20_10 = MenuBuilder.BuildRegisteredType("MPMenuButton", {
			controllerIndex = var_20_1
		})

		var_20_10.id = "PlaylistMenuButton"

		if CONDITIONS.IsDemoBuildOrDevBuildOrAreDevFeaturesEnabled() then
			-- block empty
		end

		var_20_10.Text:setText("Playlist Menu", 0)
		var_20_10.Description:setText("OG Playlist menu", 0)
		var_20_10:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 559, _1080p * 909, _1080p * 843, _1080p * 883)
		var_20_0:addElement(var_20_10)

		var_20_0.PlaylistMenuButton = var_20_10
	end

	local var_20_11

	if CONDITIONS.IsCODTvEnabled() then
		local var_20_12 = MenuBuilder.BuildRegisteredType("GenericButton", {
			controllerIndex = var_20_1
		})

		var_20_12.id = "CODTvButton"

		if CONDITIONS.IsCODTvEnabled() then
			-- block empty
		end

		var_20_12.Text:SetLeft(_1080p * 20, 0)
		var_20_12.Text:setText(ToUpperCase("COD Tv"), 0)
		var_20_12.Text:SetAlignment(LUI.Alignment.Left)
		var_20_12:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 559, _1080p * 909, _1080p * 941, _1080p * 979)
		var_20_0:addElement(var_20_12)

		var_20_0.CODTvButton = var_20_12
	end

	local var_20_13

	if CONDITIONS.IsDevelopmentBuild() then
		local var_20_14 = MenuBuilder.BuildRegisteredType("MPMenuButton", {
			controllerIndex = var_20_1
		})

		var_20_14.id = "SquadLobbyButton"

		if CONDITIONS.IsDevelopmentBuild() then
			-- block empty
		end

		var_20_14.Text:setText("Debug Squad Lobby", 0)
		var_20_14.Description:setText("", 0)
		var_20_14:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 559, _1080p * 909, _1080p * 889, _1080p * 933)
		var_20_0:addElement(var_20_14)

		var_20_0.SquadLobbyButton = var_20_14
	end
	...
	if CONDITIONS.IsDemoBuildOrDevBuildOrAreDevFeaturesEnabled() then
		...
		var_20_16.id = "DevLabel"

		var_20_16:SetRGBFromTable(SWATCHES.text.primaryText, 0)
		var_20_16:setText("DEVELOPMENT", 0)
		var_20_16:SetFont(FONTS.GetFont(FONTS.MainBold.File))
		var_20_16:SetAlignment(LUI.Alignment.Left)
		var_20_16:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 559, _1080p * 909, _1080p * 803, _1080p * 833)
		var_20_0:addElement(var_20_16)

		var_20_0.DevLabel = var_20_16
	end

	local var_20_17

	if not CONDITIONS.IsWebMotdEnabled() then
		local var_20_18 = MenuBuilder.BuildRegisteredType("CRMMain", {
			controllerIndex = var_20_1
		})

		var_20_18.id = "CRMMain"

		var_20_18:SetAnchorsAndPosition(0, 1, 1, 0, _1080p * 1394, _1080p * 1824, _1080p * -342, _1080p * -66)
		var_20_0:addElement(var_20_18)

		var_20_0.CRMMain = var_20_18
	end

	local var_20_19

	if CONDITIONS.IsWebMotdEnabled() then
		local var_20_20 = MenuBuilder.BuildRegisteredType("CRMWeb", {
			controllerIndex = var_20_1
		})

		var_20_20.id = "CRMWeb"

		var_20_20:SetAnchorsAndPosition(0, 1, 1, 0, _1080p * 1394, _1080p * 1802, _1080p * -342, _1080p * -92)
		var_20_0:addElement(var_20_20)

		var_20_0.CRMWeb = var_20_20
	end

	local var_20_21
	local var_20_22 = MenuBuilder.BuildRegisteredType("ChallengesSummary", {
		controllerIndex = var_20_1
	})

	var_20_22.id = "Challenges"

	var_20_22:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 1394, _1080p * 1824, _1080p * 216, _1080p * 716)
	var_20_0:addElement(var_20_22)

	var_20_0.Challenges = var_20_22

	local var_20_23
	local var_20_24 = MenuBuilder.BuildRegisteredType("DoubleXPNotifications", {
		controllerIndex = var_20_1
	})

	var_20_24.id = "DoubleXPNotifications"

	var_20_24:SetAnchorsAndPosition(0, 1, 1, 0, _1080p * 1000, _1080p * 1384, _1080p * -223, _1080p * -93)
	var_20_0:addElement(var_20_24)

	var_20_0.DoubleXPNotifications = var_20_24

	local var_20_25
	local var_20_26 = MenuBuilder.BuildRegisteredType("CDLRestrictionTag", {
		controllerIndex = var_20_1
	})

	var_20_26.id = "CDLRestrictionTag"

	var_20_26:SetAlpha(0, 0)
	var_20_26:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 96, _1080p * 446, _1080p * 173, _1080p * 203)
	var_20_0:addElement(var_20_26)

	var_20_0.CDLRestrictionTag = var_20_26

	local var_20_27
	local var_20_28 = MenuBuilder.BuildRegisteredType("HappyHourNotificationWidget", {
		controllerIndex = var_20_1
	})

	var_20_28.id = "HappyHourNotificationWidget"

	var_20_28:SetAnchorsAndPosition(0, 1, 1, 0, _1080p * 1256, _1080p * 1384, _1080p * -364, _1080p * -274)
	var_20_0:addElement(var_20_28)

	var_20_0.HappyHourNotificationWidget = var_20_28

	local var_20_29

	if CONDITIONS.IsEventPromoActive() then
		local var_20_30 = MenuBuilder.BuildRegisteredType("EventPromoBanner", {
			controllerIndex = var_20_1
		})

		var_20_30.id = "EventPromoBanner"

		var_20_30:SetAlpha(0, 0)
		var_20_30:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 96, _1080p * 546, _1080p * 170, _1080p * 200)
		var_20_0:addElement(var_20_30)

		var_20_0.EventPromoBanner = var_20_30
	end
	...
	var_20_0._sequences.DefaultSequence = var_20_31

	local function var_20_32()
		return
	end

	var_20_0._sequences.MapFocused = var_20_32
	...
	var_20_8:RegisterAnimationSequence("MenuFocused", var_20_34)

	local function var_20_35()
		var_20_8:AnimateSequence("MenuFocused")
	end

	var_20_0._sequences.MenuFocused = var_20_35
	...
	var_20_22:RegisterAnimationSequence("HideChallenges", var_20_37)

	local function var_20_38()
		var_20_22:AnimateSequence("HideChallenges")
	end

	var_20_0._sequences.HideChallenges = var_20_38
	...
	var_20_22:RegisterAnimationSequence("ShowChallenges", var_20_40)

	local function var_20_41()
		var_20_22:AnimateSequence("ShowChallenges")
	end

	var_20_0._sequences.ShowChallenges = var_20_41
	...
	var_20_24:RegisterAnimationSequence("ShowTokenPrompt", var_20_43)

	local function var_20_44()
		var_20_24:AnimateSequence("ShowTokenPrompt")
	end

	var_20_0._sequences.ShowTokenPrompt = var_20_44
	...
	var_20_24:RegisterAnimationSequence("HideTokenPrompt", var_20_46)

	local function var_20_47()
		var_20_24:AnimateSequence("HideTokenPrompt")
	end

	var_20_0._sequences.HideTokenPrompt = var_20_47
	...
	var_20_26:RegisterAnimationSequence("ShowCDLRules", var_20_49)

	local function var_20_50()
		var_20_26:AnimateSequence("ShowCDLRules")
	end

	var_20_0._sequences.ShowCDLRules = var_20_50
