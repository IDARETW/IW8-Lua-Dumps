...
local function var_0_4(arg_6_0, arg_6_1)
	...
	if not Onboarding.MWBootCrossProgression.WasCompleted(arg_6_0, var_6_0) then
		if CONDITIONS.AreWZLoadoutsEnabled() and not CONDITIONS.IsLazeOrOutrun() then
			...
			LUI.FlowManager.RequestPopupMenu(arg_6_0, "onboardingpopup", false, var_6_0, false, ONBOARDING_DATA.GetOnboardingCH2BootMWLazeCrossProgressionData())
		end
...
local function var_0_6(arg_9_0, arg_9_1, arg_9_2)
	...
	if arg_9_2 and arg_9_2.isBR and not CONDITIONS.IsLaze() then
