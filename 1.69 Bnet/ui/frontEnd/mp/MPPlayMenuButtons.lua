...
local function var_0_7(arg_9_0)
	...
	if arg_9_0.CdlEntryButton then
		table.insert(var_9_0, arg_9_0.CdlEntryButton)
	end
...
local function var_0_8(arg_10_0, arg_10_1)
	...
	local function var_10_3()
		...
		if arg_10_0.QuickPlayButtonContainer.QuickPlayButton then
			...
			var_0_0(arg_10_0, arg_10_1, arg_10_0.QuickPlayButtonContainer.QuickPlayButton, var_11_0)
		end
		...
		if arg_10_0.TrialEventButton then
			...
			arg_10_0.TrialEventButton:SetButtonDisabled(var_11_0)
		end
...
local function var_0_9(arg_12_0, arg_12_1, arg_12_2)
	return (PlaylistUtils.BuildPlaylistEventButton(arg_12_0, arg_12_1, {
		eventAccessPeriodDvarName = "LQTOLLKQSS",
		eventRefIdDvarName = "LLKTPRPTMO",
		eventDataSource = CSV.brPlaylistEvents,
		eventButtonAction = function(arg_13_0, arg_13_1)
			CrossLaunchUtils.CrossLaunchWithDeepLink(arg_13_0, arg_13_1, {
				_useUpsellPopupIfNotOwned = true
			})
		end,
		elementToAddBefore = arg_12_0.QuickPlayButtonContainer
	}))
end

local function var_0_10(arg_14_0, arg_14_1, arg_14_2)
	assert(arg_14_0.QuickPlayButtonContainer.QuickPlayButton)

	arg_14_0.SetupFeaturedButtons = SetupFeaturedButtons
	arg_14_0.SetupQuickplayButton = var_0_6
	arg_14_0.SetupPromotedButtons = SetupPromotedButtons
	arg_14_0.SetQuickplayButtonFilteredDataSource = var_0_3
	arg_14_0.SetQuickplayButtonHardcoreDataSource = var_0_4
	arg_14_0.SetQuickplayButtonCDLDataSource = var_0_5
	arg_14_0.AddButtonTooltipData = var_0_0
	arg_14_0.InsertIntoButtonList = var_0_2
	arg_14_0.CheckSubscriptions = var_0_8
	arg_14_0.featuredButtonWidgets = {}
	arg_14_0.promotedButtonWidgets = {}

	var_0_1(arg_14_0, arg_14_1)

	if Dvar.IBEGCHEFE("MPNKRKSONP") then
		var_0_9(arg_14_0, arg_14_1, arg_14_2)
	end
	...
	arg_14_0.QuickPlayButtonContainer:dispatchEventToChildren({
		name = "play_menu_create"
	})

	if arg_14_0.QuickPlayButtonContainer.QuickPlayButton then
		arg_14_0.QuickPlayButtonContainer.QuickPlayButton:setGainFocusSFX(SOUND_SETS.mpMainMenu.move, var_14_0)
		arg_14_0.QuickPlayButtonContainer.QuickPlayButton:setGainFocusGamepadDifferentSFX(SOUND_SETS.mpMainMenu.moveUp, SOUND_SETS.mpMainMenu.moveDown, var_14_0)
	end

	if arg_14_0.TournamentButton then
		arg_14_0.TournamentButton:addEventHandler("button_action", function(arg_15_0, arg_15_1)
			TOURNAMENT.ButtonAction(arg_15_1.controller)
		end)
		arg_14_0.TournamentButton:setGainFocusSFX(SOUND_SETS.mpMainMenu.move, var_14_0)
		arg_14_0.TournamentButton:setGainFocusGamepadDifferentSFX(SOUND_SETS.mpMainMenu.moveUp, SOUND_SETS.mpMainMenu.moveDown, var_14_0)
	end

	if arg_14_0.TrialEventButton then
		arg_14_0.TrialEventButton:addEventHandler("button_action", function(arg_16_0, arg_16_1)
			TRIALS.OpenTrialEventMenu(arg_14_0, arg_16_1.controller)

			return true
		end)
		arg_14_0.TrialEventButton:setGainFocusSFX(SOUND_SETS.mpMainMenu.move, var_14_0)
		arg_14_0.TrialEventButton:setGainFocusGamepadDifferentSFX(SOUND_SETS.mpMainMenu.moveUp, SOUND_SETS.mpMainMenu.moveDown, var_14_0)
	end

	if arg_14_0.PrivateMatchButton then
		arg_14_0.PrivateMatchButton:addEventHandler("button_action", function(arg_17_0, arg_17_1)
			local var_17_0 = MenuBuilder.BuildRegisteredType("PrivateMatchPopup", arg_14_2)

			if CONDITIONS.AreTrialsEnabled(arg_14_0) or CONDITIONS.IsLocalPlayAllowed(arg_14_0) then
				LUI.FlowManager.RequestPopupMenu(nil, "FlyInPopup", false, arg_17_1.controller, false, {
				...
				Lobby.TryNavigateToLobby(var_17_1)
			end
		end)
		arg_14_0.PrivateMatchButton:setGainFocusSFX(SOUND_SETS.mpMainMenu.move, var_14_0)
		arg_14_0.PrivateMatchButton:setGainFocusGamepadDifferentSFX(SOUND_SETS.mpMainMenu.moveUp, SOUND_SETS.mpMainMenu.moveDown, var_14_0)
	end

	if arg_14_0.CdlEntryButton then
		arg_14_0.CdlEntryButton:addEventHandler("button_action", function(arg_19_0, arg_19_1)
			LUI.WebViewManager.Instance():OpenCdl()
		end)
	end
end

function MPPlayMenuButtons(arg_20_0, arg_20_1)
	local var_20_0 = LUI.UIVerticalList.new()

	var_20_0:SetAnchorsAndPosition(0, 1, 0, 1, 0, 430 * _1080p, 0, 757 * _1080p)

	var_20_0.id = "MPPlayMenuButtons"
	...
	var_20_0:SetSpacing(14 * _1080p)

	local var_20_3
	local var_20_4 = MenuBuilder.BuildRegisteredType("QuickPlayButtonContainer", {
		controllerIndex = var_20_1
	})

	var_20_4.id = "QuickPlayButtonContainer"

	var_20_4:SetAnchorsAndPosition(0, 1, 0, 1, 0, _1080p * 430, 0, _1080p * 50)
	var_20_0:addElement(var_20_4)

	var_20_0.QuickPlayButtonContainer = var_20_4

	local var_20_5

	if CONDITIONS.IsTournamentModeAllowed(var_20_0) then
		local var_20_6 = MenuBuilder.BuildRegisteredType("FeaturedAccordionButton", {
			controllerIndex = var_20_1
		})

		var_20_6.id = "TournamentButton"

		var_20_6.Background.BackgroundImage:setImage(RegisterMaterial("button_tournament"), 0)
		var_20_6.Text:setText(ToUpperCase(Engine.CBBHFCGDIC("LUA_MENU/TOURNAMENT")), 0)
		var_20_6.Description:setText(Engine.CBBHFCGDIC("LUA_MENU/TOURNAMENT_DESC"), 0)
		var_20_6.DisabledText:setText(Engine.CBBHFCGDIC("LUA_MENU_MP/BUTTON_DISABLED_NOT_HOST"), 0)
		var_20_6:SetAnchorsAndPosition(0, 1, 0, 1, 0, _1080p * 430, _1080p * 64, _1080p * 114)
		var_20_0:addElement(var_20_6)

		var_20_0.TournamentButton = var_20_6
	end

	local var_20_7

	if CONDITIONS.IsTrialEventAvailable(var_20_0) then
		local var_20_8 = MenuBuilder.BuildRegisteredType("TrialEventAccordionButton", {
			controllerIndex = var_20_1
		})

		var_20_8.id = "TrialEventButton"

		var_20_8.Text:setText(ToUpperCase(Engine.CBBHFCGDIC("TRIALEVENT/PLAY_MENU_BUTTON")), 0)
		var_20_8.Description:setText(Engine.CBBHFCGDIC("TRIALEVENT/MAIN_MENU_BUTTON_DESC"), 0)
		var_20_8.DisabledText:setText(Engine.CBBHFCGDIC("MENU/LOCKED"), 0)
		var_20_8:SetAnchorsAndPosition(0, 1, 0, 1, 0, _1080p * 430, _1080p * 128, _1080p * 178)
		var_20_0:addElement(var_20_8)

		var_20_0.TrialEventButton = var_20_8
	end

	local var_20_9

	if CONDITIONS.IsMPPrivateMatchEnabled(var_20_0) then
		local var_20_10 = MenuBuilder.BuildRegisteredType("TrialsButton", {
			controllerIndex = var_20_1
		})

		var_20_10.id = "PrivateMatchButton"

		var_20_10.TrialsButton.Background.BackgroundImage:setImage(RegisterMaterial("button_private"), 0)
		var_20_10.TrialsButton.Text:setText(ToUpperCase(Engine.CBBHFCGDIC("LUA_MENU/PRIVATE_MATCH_AND_TRIALS")), 0)
		var_20_10.TrialsButton.Description:setText(Engine.CBBHFCGDIC("PLATFORM/PRIVATE_MATCH_TRIALS_DESC"), 0)
		var_20_10.TrialsButton.DisabledText:setText(Engine.CBBHFCGDIC("LUA_MENU_MP/BUTTON_DISABLED_NOT_HOST"), 0)
		var_20_10:SetAnchorsAndPosition(0, 1, 0, 1, 0, _1080p * 430, _1080p * 192, _1080p * 242)
		var_20_0:addElement(var_20_10)

		var_20_0.PrivateMatchButton = var_20_10
	end

	var_0_10(var_20_0, var_20_1, arg_20_1)
