...
local function var_0_0(arg_1_0, arg_1_1)
	...
	if not arg_1_0._hasRedeemMessage or not arg_1_1.forceOpen then
		var_1_1[#var_1_1 + 1] = {
...
local function var_0_1(arg_3_0, arg_3_1, arg_3_2)
	...
	arg_3_0._hasRedeemMessage = false

	for iter_3_0, iter_3_1 in ipairs(arg_3_2.messageTable) do
		if iter_3_1.action and iter_3_1.action == "redeem" then
			arg_3_0._hasRedeemMessage = true
