...
local function var_0_34(arg_34_0, arg_34_1, arg_34_2, arg_34_3)
	...
	if not Engine.CJJAFGIFAC(arg_34_1) or Engine.CHDGBEFDHB() or Engine.CHBHFFFIGH() or Engine.EAABDHIDFJ() then
...
local function var_0_35(arg_35_0, arg_35_1, arg_35_2)
	if not Engine.CJJAFGIFAC(arg_35_1) or Engine.CHDGBEFDHB() or Engine.CHBHFFFIGH() or Engine.EAABDHIDFJ() then
