...
local function var_0_3(arg_4_0, arg_4_1)
	...
	arg_4_0.WatchSelectButton:SetButtonDisabled(true)

	local var_4_0 = {}

	LOOT.SetupSortingBehavior(var_4_0, arg_4_1)

	for iter_4_0, iter_4_1 in ipairs(WATCH.GetAllWatches(arg_4_1)) do
		if iter_4_1.isUnlocked or var_4_0.lockedSortingType == LOOT.lockedSortingOptions.SHOW then
			arg_4_0.WatchSelectButton:SetButtonDisabled(false)
