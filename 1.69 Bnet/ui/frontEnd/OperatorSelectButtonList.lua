...
local function var_0_3(arg_2_0, arg_2_1)
	...
	var_2_1:SetAnchorsAndPosition(0, 1, 0, 1, var_2_2 + _1080p * var_2_0 * var_0_0, var_2_2 + _1080p * (var_2_0 + 1) * var_0_0, _1080p * 0, _1080p * var_0_1)
...
local function var_0_5(arg_4_0, arg_4_1, arg_4_2)
	...
	arg_4_0.GetOperatorButtons = var_0_2
	arg_4_0.AddButtonToList = var_0_3
	arg_4_0.RemoveAllButtonsFromList = var_0_4
	arg_4_0.spacing = 3 * _1080p
