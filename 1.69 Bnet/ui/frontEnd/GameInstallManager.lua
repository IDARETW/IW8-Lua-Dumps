...
local function var_0_3(arg_2_0, arg_2_1)
	...
	local var_2_4 = {}
	local var_2_5
	local var_2_6 = "LTNRMQNNKN"
	local var_2_7 = Dvar.IBEGCHEFE(var_2_6)
	local var_2_8 = "wz"
	local var_2_9

	for iter_2_0, iter_2_1 in ipairs(arg_2_0) do
		local var_2_10 = false
		local var_2_11 = string.find(iter_2_1.productId, var_2_0)
		local var_2_12 = string.find(iter_2_1.productId, var_2_8)
		local var_2_13 = string.find(iter_2_1.productId, var_2_2)

		if var_2_12 and var_2_7 == true then
			var_2_10 = false
		elseif arg_2_1 == var_0_1.T9_GAME_PACKS and var_2_11 ~= nil then
			var_2_10 = true
		elseif arg_2_1 == var_0_1.MW_TEXTURE_PACKS and var_2_13 ~= nil then
			var_2_10 = true
		elseif arg_2_1 == var_0_1.MW_GAME_PACKS and var_2_11 == nil and var_2_13 == nil then
			var_2_10 = true
		end
