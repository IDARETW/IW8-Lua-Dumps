...
local function var_0_3(arg_5_0, arg_5_1, arg_5_2, arg_5_3)
	...
	local function var_5_24(arg_7_0, arg_7_1)
		...
		if arg_5_2 == LOOT.itemTypes.OPERATOR_TAUNT then
			var_0_2(arg_5_0)
		elseif arg_5_2 == LOOT.itemTypes.OPERATOR_EXECUTION and not Engine.FABABBDBA() and not arg_5_0._goreLootNotAllowed and not CONDITIONS.HideFinishingMovePreview() then
			var_5_23()
		end
	end
