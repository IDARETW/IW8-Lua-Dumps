...
local function var_0_0(arg_1_0, arg_1_1, arg_1_2)
	...
	if CONDITIONS.IsWZWipFlowEnabled() and Engine.DDJFBBJAIG() then
		arg_1_0.WZWipSnipeBackgroundSceneOverlay:UpdateSnipeOverlay({
			useGunsmithSetup = true,
			weaponRef = var_1_1
		})

		if Dvar.IBEGCHEFE("ui_ob_wz_show_weapon_challenges") and not Onboarding.WeaponCH2WZWeaponCustomization.WasCompleted(arg_1_0, arg_1_1) then
			LUI.FlowManager.RequestPopupMenu(arg_1_0, "onboardingpopup", true, arg_1_1, false, ONBOARDING_DATA.GetOnboardingCH2WZWeaponCustomizationData())
			Onboarding.WeaponCH2WZWeaponCustomization.MarkCompleted(arg_1_0, arg_1_1)
		end
	end
end
...
function GunsmithCustomize(arg_2_0, arg_2_1)
	...
	if CONDITIONS.IsWZWipFlowEnabled() then
		local var_2_6 = MenuBuilder.BuildRegisteredType("WZSnipeBackgroundSceneOverlay", {
			controllerIndex = var_2_1
		})

		var_2_6.id = "WZWipSnipeBackgroundSceneOverlay"

		var_2_6:SetAnchorsAndPosition(0, 0, 0, 0, 0, 0, 0, 0)
		var_2_0:addElement(var_2_6)

		var_2_0.WZWipSnipeBackgroundSceneOverlay = var_2_6
	end

	local var_2_7
	local var_2_8 = MenuBuilder.BuildRegisteredType("WeaponCustomizeButtons", {
		controllerIndex = var_2_1
	})

	var_2_8.id = "WeaponCustomizeButtons"

	var_2_8:SetAnchorsAndPosition(0, 1, 1, 0, _1080p * 130, _1080p * 1790, _1080p * -235, _1080p * -101)
	var_2_0:addElement(var_2_8)

	var_2_0.WeaponCustomizeButtons = var_2_8

	local var_2_9
	local var_2_10 = MenuBuilder.BuildRegisteredType("GunsmithWeaponLevel", {
		controllerIndex = var_2_1
	})

	var_2_10.id = "GunsmithWeaponLevel"

	var_2_10:SetAnchorsAndPosition(1, 0, 0, 1, _1080p * -643, _1080p * -447, _1080p * 61, _1080p * 85)
	var_2_0:addElement(var_2_10)

	var_2_0.GunsmithWeaponLevel = var_2_10
