...
local function var_0_0(arg_1_0, arg_1_1, arg_1_2)
	...
	local var_1_2 = BATTLEPASS.GetAllTiersData(arg_1_1, var_1_1 - 1, var_1_1 + 1)
	local var_1_3 = {}
	...
	local function var_1_10(arg_2_0, arg_2_1, arg_2_2)
		...
		arg_2_0:SetTopBanner(arg_2_0.itemData.isFree == "1", false, false, arg_2_0.itemData.isFree)

		if var_2_0 == 1 then
			local var_2_4 = arg_2_0.itemData.level ~= "0"

			arg_2_0:SetProgress(var_2_4 and 1 or 0, 0)
	...
	arg_1_0._menu = arg_1_2.sourceMenu

	if arg_1_0._menu and arg_1_0._menu.MPTabsMenu then
		arg_1_0._menu:saveState()
		arg_1_0.BattlePassButton:addEventHandler("button_action", function(arg_3_0, arg_3_1)
			arg_1_0._menu.MPTabsMenu:SetupOnRestoreFocusOverride({
	...
	arg_1_0.LeaveButton:addEventHandler("button_action", function(arg_7_0, arg_7_1)
		if arg_1_0._menu then
			arg_1_0._canOpenDailyPopup = true
		end
