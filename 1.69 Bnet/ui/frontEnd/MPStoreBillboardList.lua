...
local function var_0_8(arg_2_0, arg_2_1)
	...
	if var_2_0.previewBundleID then
		if STORE.IsBundleOwned(arg_2_0._controllerIndex, tonumber(var_2_0.previewBundleID)) then
			var_2_1 = arg_2_1
		end
...
local function var_0_11(arg_5_0, arg_5_1, arg_5_2)
	...
	if arg_5_2.idPubVar and var_5_1.layoutOnlyItem then
		...
		for iter_5_0 = 1, #var_5_4 do
			...
			if STORE.BundleAvailable(arg_5_1, var_5_6) then
				...
				var_5_7.description = STORE.GetBundleDescription(var_5_7.id, arg_5_0._totalCP)
	...
	if #var_5_0 == 0 then
		...
		if not var_5_11.usesFirstPartyStore then
			...
			var_5_11.asset = CONDITIONS.IsMagmaGameMode() and "wz_store_billboard_placeholder" or "mw_store_billboard_placeholder"
		end
...
local function var_0_13(arg_14_0, arg_14_1, arg_14_2, arg_14_3)
...
local function var_0_14(arg_15_0, arg_15_1)
	local var_15_0 = STORE.GetCategoryIndex(arg_15_0._controllerIndex, arg_15_1)
...
local function var_0_15(arg_16_0, arg_16_1, arg_16_2)
	function arg_16_0.FocusBundleByID(arg_17_0, arg_17_1, arg_17_2, arg_17_3)
		var_0_13(arg_16_0, arg_17_1, arg_17_2, arg_17_3)
	end
	...
	arg_16_0._totalCP = BATTLEPASS.GetCurrentCPRewards(arg_16_1).totalCP
	...
	local var_16_27 = {
		button_over = {
			...
			[StoreItemLayout.CUSTOM] = function(arg_44_0, arg_44_1, arg_44_2, arg_44_3)
				...
				local var_44_1 = Engine.GetLayoutData(var_44_0)
	...
	local var_16_33 = Engine.EHGIGBJJC(var_16_32)
	local var_16_34 = STORE.GetCategoryData(arg_16_1)

	arg_16_0._allCategoryData = var_16_34

	if CONDITIONS.PostSeasonAndMagma() then
		TrimForCortezCategory(arg_16_0)
	end
	...
	if not arg_16_0._recommendations then
		...
		var_16_35.isEnabled = false
		arg_16_0.recommendationData = var_16_35
	end

	for iter_16_0 = 1, #var_16_34 do
		local var_16_36 = var_16_34[iter_16_0]

		var_16_36.items = var_16_36.items or {}

		var_0_11(arg_16_0, arg_16_1, var_16_36)
	end
	...
	local var_16_37 = var_16_33.layoutType
	local var_16_38 = var_16_8(var_16_37)

	QUARTERMASTER.RecordStoreEnterEvent(arg_16_1, var_16_37, arg_16_0.recommendationData)
	var_16_30(var_16_37)

	if var_16_38.storeCustomizations then
		var_16_9(var_16_38.storeCustomizations.pre, var_16_34, var_16_38)
	end

	for iter_16_1 = 1, #var_16_34 do
		local var_16_39 = var_16_34[iter_16_1]

		var_16_39.categoryIndex = iter_16_1

		if var_16_39.name then
			local var_16_40 = var_16_31(var_16_39.layoutType or var_16_37, var_16_39)

			var_16_29(var_16_40, var_16_39.layoutType or var_16_37, var_16_38.categoryButton, var_16_39)
			var_16_9(var_16_38.categoryButton.buttonCustomizations, var_16_39, var_16_38, {
				categoryButton = var_16_40
			})
			var_16_40:addEventHandler("button_over", function(arg_58_0, arg_58_1)
	...
	if var_16_38.storeCustomizations then
		var_16_9(var_16_38.storeCustomizations.post, var_16_34, var_16_38, {
	...
	local var_16_41 = LUI.UITimer.new({
		interval = 1000,
	...
	arg_16_0.bindButton:addEventHandler("button_alt1", function(arg_63_0, arg_63_1)
		...
		arg_16_0.BillboardCategoryButtonAction(arg_16_0._currentButton, arg_63_1, arg_16_0._allCategoryData[arg_16_0._categoryIndex], var_16_38)
	end)
