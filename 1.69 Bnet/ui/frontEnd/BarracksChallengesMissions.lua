...
local function var_0_6(arg_15_0, arg_15_1, arg_15_2)
	if not arg_15_0._isIntel then
		...
		arg_15_0.Grid:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 96, _1080p * 696, _1080p * 216, _1080p * 937)
		...
		for iter_15_3, iter_15_4 in ipairs(arg_15_0._challenges) do
			...
			if not var_15_6[var_15_7] then
				...
				arg_15_0.Grid:AddElement(var_0_5(arg_15_1, SEASON.GetLocalizedName({
					seasonDataNumToUse = var_15_7
				})))
			end
	...
	arg_15_0:Wait(1).onComplete = function()
		arg_15_0.Grid:UpdateNumbersArrowsAndScrolling()
	end
end

local function var_0_7(arg_20_0, arg_20_1, arg_20_2)
	arg_20_0._challengeWhitelist = arg_20_2.challengeWhitelist
	arg_20_0._activationCategory = arg_20_2.activationCategory
	arg_20_0._isIntel = arg_20_0._challengeWhitelist == Challenge.IntelMissionsWhitelist
	arg_20_0._isCPChallenge = arg_20_0._challengeWhitelist == Challenge.CPMissionsWhitelist
	arg_20_0._challenges = var_0_0(arg_20_0, arg_20_1)

	local var_20_0 = LUI.FlowManager.GetScopedData(arg_20_0)

	if not arg_20_0._challenges or #arg_20_0._challenges <= 0 then
		ACTIONS.AnimateSequence(arg_20_0, "HideChallenges")
		arg_20_0.Grid:SetNumChildren(0)

		return
	end

	if not arg_20_0._isIntel then
		var_0_2(arg_20_0, arg_20_1)
	end

	arg_20_0:registerEventHandler("challenges_update_mission_details", function(arg_21_0, arg_21_1)
		local var_21_0

		if var_20_0 and var_20_0.focussedMissionIndex then
			var_21_0 = var_20_0.focussedMissionIndex
		end

		if arg_21_1.index and arg_20_0._challenges[arg_21_1.index] and arg_21_0:GetCurrentMenu() then
			arg_21_0._buttonOverIndex = arg_21_1.index

			arg_21_0.MissionDetails:SetData(arg_20_0._challenges[arg_21_1.index], var_21_0)

			var_20_0.focussedMissionIndex = nil

			if not arg_20_0._isIntel then
				var_0_1(arg_21_0, arg_21_1.index)
			end
		end
	end)

	if not arg_20_0._isIntel then
		arg_20_0:registerEventHandler("challenges_mission_activation", function(arg_22_0, arg_22_1)
			if arg_22_1.index and arg_22_0._challenges[arg_22_1.index] then
				var_0_3(arg_22_0, arg_20_1, arg_22_1.index)
			end
		end)
	end

	arg_20_0:registerEventHandler("restore_focus", function(arg_23_0, arg_23_1)
		if not arg_20_0._isIntel and var_20_0._missionActivated then
			arg_20_0.Grid:SetFocusedPosition({
				x = 0,
				y = arg_20_0._activeIndex - 1
			}, false, nil, false)
			arg_20_0._scrollbar:GetWidget():processEvent({
				name = "scrollbar_force_show",
				controller = arg_23_1.controller
			})
			arg_20_0.Grid:dispatchEventToChildren(arg_23_1)

			var_20_0._missionActivated = nil

			return true
		end

		if var_20_0.lastFocusedIndex then
			arg_20_0.Grid:SetFocusedPosition({
				x = 0,
				y = var_20_0.lastFocusedIndex
			}, true, nil, false)
			arg_20_0._scrollbar:GetWidget():processEvent({
				name = "scrollbar_force_show",
				controller = arg_23_1.controller
			...
			var_20_0.lastFocusedIndex = nil

			return true
		end
	end)
	var_0_6(arg_20_0, arg_20_1, arg_20_2)

	if Dvar.IBEGCHEFE("NPOLQSQMNO") then
		arg_20_0.SeasonText:setText(Engine.CBBHFCGDIC("CHALLENGE/SEASON_MISSIONS", SEASON.GetLocalizedName()))
		Challenge.SetupSeasonEndsTimer(arg_20_0, arg_20_0.SeasonEnd, "CHALLENGE/SEASON_ENDS")
	end

	if not Onboarding.MissionChallenges.WasCompleted(arg_20_0, arg_20_1) then
		local var_20_1 = ONBOARDING_DATA.GetOnboardingMissionChallengesData()

		local function var_20_2(arg_24_0, arg_24_1)
			ACTIONS.LeaveMenu(arg_24_0)
		end

		var_20_1.confirmButton.action = var_20_2

		LUI.FlowManager.RequestPopupMenu(arg_20_0, "onboardingpopup", true, arg_20_1, false, var_20_1)
		Onboarding.MissionChallenges.MarkCompleted(arg_20_0, arg_20_1)
	end
end
...
function BarracksChallengesMissions(arg_25_0, arg_25_1)
	...
	var_25_5:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 96, _1080p * 696, _1080p * 216, _1080p * 937)
	...
	var_25_9:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 702, _1080p * 713, _1080p * 216, _1080p * 937)
