...
local function var_0_1(arg_2_0)
	local var_2_0 = #arg_2_0._stickerTable
	local var_2_1 = arg_2_0.StickerGrid:GetNumColumns()
	local var_2_2 = {}
	...
	for iter_2_0, iter_2_1 in ipairs(var_2_2) do
		local var_2_9 = arg_2_0._stickerTable[iter_2_1]
...
local function var_0_2(arg_3_0)
	...
	local var_3_1 = 0
	local var_3_2 = 0
	local var_3_3 = StringTable.BFHCAIIDA(CSV.stickers.file)

	for iter_3_0 = 0, var_3_3 - 1 do
		local var_3_4 = CSV.ReadRow(CSV.stickers, iter_3_0)

		if var_3_4 and var_3_4.hideInUI ~= "1" then
			var_3_4.isUnlocked = LOOT.IsUnlocked(arg_3_0._controllerIndex, LOOT.itemTypes.STICKER, var_3_4.ref) or var_3_4.ref == WEAPON.StickerNoneValue
			var_3_4.rarity = LOOT.GetItemQuality(LOOT.itemTypes.STICKER, var_3_4.ref)
			var_3_4.season, var_3_4.event, var_3_4.isPremium = LOOT.GetItemSeason(LOOT.itemTypes.STICKER, var_3_4.ref)
			var_3_4.lootID = LOOT.GetItemID(LOOT.itemTypes.STICKER, var_3_4.ref)
			...
			if var_3_4.ref ~= WEAPON.StickerNoneValue then
...
local function var_0_3(arg_4_0, arg_4_1)
	if not arg_4_0._allStickersTable or #arg_4_0._allStickersTable == 0 then
		arg_4_0._allStickersTable = var_0_2(arg_4_0)
	end

	arg_4_0._stickerTable = {}

	for iter_4_0 = 1, #arg_4_0._allStickersTable do
		local var_4_0 = true

		if iter_4_0 > 1 then
			local var_4_1 = arg_4_0.weaponPlayerData.weapon:get()

			var_4_0 = LOOT.ItemIDsMatchGameSourceIDs(LOOT.GetBaseWeaponItemID(var_4_1), arg_4_0._allStickersTable[iter_4_0].lootID)
		end

		if var_4_0 and (arg_4_0._allStickersTable[iter_4_0].isUnlocked or arg_4_0.lockedSortingType == LOOT.lockedSortingOptions.SHOW) then
			local var_4_2 = arg_4_0._allStickersTable[iter_4_0]

			table.insert(arg_4_0._stickerTable, var_4_2)

			arg_4_0._weaponTable.stickers[arg_4_0._slotIndex] = var_4_2.ref
	...
	table.insert(var_4_3, {
		...
		sortFuncParams = {
			favoritesTable = arg_4_0._favoriteStickers
		}
	})
	table.insert(var_4_3, {
	...
	MenuUtils.SortTableViaOptions(arg_4_0._stickerTable, var_4_3)
...
local function var_0_9(arg_12_0)
	...
	LUI.FlowManager.RequestAddMenu("WeaponPreview", true, arg_12_0._controllerIndex, nil, var_12_0, true)
end
...
local function var_0_13(arg_19_0)
	return function(arg_20_0, arg_20_1, arg_20_2)
		...
		var_0_11(arg_19_0, arg_20_0, var_20_1.name, var_20_3)
	end
end
...
local function var_0_14(arg_21_0, arg_21_1, arg_21_2)
	...
	arg_21_0._allStickersTable = var_0_2(arg_21_0)
	...
	arg_21_0.StickerGrid:SetRefreshChild(var_0_13(arg_21_0))
...
function StickerSelect(arg_26_0, arg_26_1)
	...
	var_26_0.StickerGrid = var_26_11
	...
	var_26_15.MenuTitle:setText(Engine.CBBHFCGDIC("LUA_MENU/STICKER_SELECT_TITLE"), 0)
