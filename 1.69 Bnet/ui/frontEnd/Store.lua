...
local function var_0_5(arg_6_0, arg_6_1, arg_6_2)
	...
	local function var_6_5(arg_9_0)
		for iter_9_0, iter_9_1 in ipairs(arg_9_0) do
			local var_9_0 = string.match(iter_9_1.image, "%d+")

			iter_9_1.title = Engine.CBBHFCGDIC("INGAMESTORE/PRODUCT_CODPOINTS_LAZE_" .. var_9_0)
			iter_9_1.contentLong = Engine.CBBHFCGDIC("INGAMESTORE/PRODUCT_CODPOINTS_" .. var_9_0 .. "_LAZE_DESC")
		end
	end

	local function var_6_6(arg_10_0)
		for iter_10_0 = 1, #arg_10_0 do
			local var_10_0 = arg_10_0[iter_10_0]
			local var_10_1 = InGameStore.GetCategoryProducts(arg_6_1, var_10_0.categoryId)
			local var_10_2 = var_10_0.categoryId == STORE.TitlesCategory or var_10_0.categoryId == STORE.ZeusCategory

			if var_10_2 then
				var_10_1 = var_0_4(var_10_1, arg_6_1)
			end

			if CONDITIONS.IsLaze() and var_10_0.categoryId == STORE.CODPointsCategory then
				var_6_5(var_10_1)
			end

			var_6_4(var_10_1, var_10_0.isFeatured, var_10_2)

			if var_10_0.categoryRows then
				for iter_10_1, iter_10_2 in ipairs(var_10_0.categoryRows) do
					iter_10_2:UpdateStoreItemButtons(arg_6_1, var_10_1)
				end
			end

			var_10_0.items = var_10_1
		end
	end
	...
	if var_6_3 then
		...
		local var_6_7 = STORE.GetActiveCODPointsCategory()

		for iter_6_0 = 1, #var_6_3 do
			local var_6_8 = var_6_3[iter_6_0]
			local var_6_9 = var_6_8.title
			local var_6_10 = var_6_8.categoryId
			local var_6_11 = var_6_10 == STORE.TitlesCategory or var_6_10 == STORE.ZeusCategory
			local var_6_12 = (not arg_6_2.onlyCODPoints or var_6_10 == var_6_7) and var_6_10 ~= STORE.GameDLCCategory

			if var_6_10 == STORE.CODPointsCategory or var_6_10 == STORE.WZCODPointsCategory then
				var_6_12 = var_6_12 and var_6_10 == var_6_7
			end

			if var_6_12 then
				local var_6_13 = InGameStore.GetCategoryProducts(arg_6_1, var_6_10)
				local var_6_14 = true

				if var_6_11 then
					var_6_13 = var_0_4(var_6_13, arg_6_1)
					var_6_14 = #var_6_13 > 0
				end

				if var_6_13 and #var_6_13 > 0 and var_6_14 then
					local var_6_15 = MenuBuilder.BuildRegisteredType("StoreCategoryHeaderRow", {
						controllerIndex = arg_6_1
					})

					arg_6_0.itemsGrid:AddElement(var_6_15)
					var_6_15.Label:setText(var_6_9)

					if CONDITIONS.IsLaze() and var_6_10 == STORE.CODPointsCategory then
						var_6_5(var_6_13)
					end
					...
					if not var_6_2 and not var_6_11 then
						var_6_16 = MenuBuilder.BuildRegisteredType("StoreFeaturedRow", {
							controllerIndex = arg_6_1,
							store = arg_6_0
						})
						var_6_16.id = "StoreFeaturedRow"

						arg_6_0.itemsGrid:AddElement(var_6_16)

						var_6_2 = true
						var_6_8.isFeatured = true
					else
						var_6_16 = MenuBuilder.BuildRegisteredType("Store4ItemsRow", {
							controllerIndex = arg_6_1,
							store = arg_6_0
						})
						var_6_16.id = "Store4ItemsRow_" .. iter_6_0 .. "_0"

						arg_6_0.itemsGrid:AddElement(var_6_16)
					end

					table.insert(var_6_17, var_6_16)

					local var_6_18 = #var_6_13 < STORE.maxButtonsPerCategoryRow and #var_6_13 or STORE.maxButtonsPerCategoryRow

					if var_6_18 < #var_6_13 then
						local var_6_19 = 1
						local var_6_20 = #var_6_13 - var_6_18

						while var_6_20 > 0 do
							local var_6_21 = MenuBuilder.BuildRegisteredType("Store4ItemsRow", {
								controllerIndex = arg_6_1,
								store = arg_6_0,
								rowIndex = var_6_19
							})

							var_6_21.id = "Store4ItemsRow_" .. iter_6_0 .. "_" .. var_6_19

							arg_6_0.itemsGrid:AddElement(var_6_21)

							if var_6_20 > STORE.maxButtonsPerCategoryRow then
								var_6_20 = var_6_20 - STORE.maxButtonsPerCategoryRow
							else
								var_6_20 = 0
							end

							table.insert(var_6_17, var_6_21)

							var_6_19 = var_6_19 + 1
						end
					end

					var_6_4(var_6_13, var_6_8.isFeatured, var_6_11)

					for iter_6_1, iter_6_2 in ipairs(var_6_17) do
						iter_6_2:UpdateStoreItemButtons(arg_6_1, var_6_13)
					end

					var_6_8.items = var_6_13
					var_6_8.categoryRows = var_6_17
				end
			end
		end
	else
	...
	local var_6_22 = LUI.UIBindButton.new()

	var_6_22.id = "bindButton"

	arg_6_0:addElement(var_6_22)
	var_6_22:addEventHandler("button_secondary", function(arg_11_0, arg_11_1)
	...
	arg_6_0:addEventHandler("menu_close", function(arg_12_0, arg_12_1)
	...
	local var_6_23 = LUI.FlowManager.GetScopedData(arg_6_0)

	arg_6_0:addEventHandler("lose_focus", function(arg_13_0, arg_13_1)
		if Engine.CIEGIACHAE() and not var_6_23.previewProductID then
			InGameStore.ShowStoreIcon(false)
		end
	end)
	arg_6_0:addEventHandler("restore_focus", function(arg_14_0, arg_14_1)
		if Engine.CIEGIACHAE() and var_6_1 then
			InGameStore.ShowStoreIcon(true, InGameStoreStoreIconPosition.CENTER)
		end
		...
		var_6_23 = LUI.FlowManager.GetScopedData(arg_6_0)

		if var_6_23.previewProductID then
			arg_6_0.itemsGrid:SetNotifyOnLayoutInit(true)
			arg_6_0.itemsGrid:addEventHandler("layout_initialized", function()
				var_0_3(arg_6_0, var_6_23.previewProductID, var_6_3)

				var_6_23.previewProductID = nil
			end)

			return true
		end

		if var_6_23.restoreFocusProduct then
			arg_6_0.itemsGrid:addEventHandler("restore_focus", function()
				var_0_3(arg_6_0, var_6_23.restoreFocusProduct, var_6_3)

				var_6_23.restoreFocusProduct = nil
			end)
		end
	end)
	arg_6_0:registerEventHandler("closing_quick_access_menu", function(arg_17_0, arg_17_1)
	...
	if LUI.IsLastInputMouseNavigation(arg_6_1) then
		local var_6_24 = arg_6_0.itemsGrid:GetFirstFocusablePosition()

		arg_6_0.itemsGrid:SetFocusedPosition(var_6_24)
	end

	ACTIONS.ScaleFullscreen(arg_6_0.Background)
end

function var_0_0(arg_19_0, arg_19_1)
	...
	var_19_4:SetAlpha(0.95, 0)
	var_19_4:setImage(RegisterMaterial("widg_gradient_bottom_to_top"), 0)
	var_19_4:SetVMin(0.5, 0)
	...
	var_19_6.MenuTitle:setText(Engine.CBBHFCGDIC("LUA_MENU/STORE_CAPS"), 0)
	...
	local var_19_7
	local var_19_8 = MenuBuilder.BuildRegisteredType("MPPlayerDetails", {
		controllerIndex = var_19_1
	})

	var_19_8.id = "PlayerDetails"

	var_19_8:SetAnchorsAndPosition(1, 0, 0, 1, _1080p * -596, _1080p * -96, _1080p * 54, _1080p * 114)
	var_19_0:addElement(var_19_8)

	var_19_0.PlayerDetails = var_19_8

	local var_19_9
	local var_19_10 = MenuBuilder.BuildRegisteredType("StoreItemDetails", {
		controllerIndex = var_19_1
	})

	var_19_10.id = "StoreItemDetails"

	var_19_10:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 1490, _1080p * 1790, _1080p * 216, _1080p * 916)
	var_19_0:addElement(var_19_10)

	var_19_0.StoreItemDetails = var_19_10

	local var_19_11
	local var_19_12 = MenuBuilder.BuildRegisteredType("VerticalMinimalScrollbar", {
		controllerIndex = var_19_1
	})

	var_19_12.id = "VerticalScrollbar"

	var_19_12:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 1455, _1080p * 1467, _1080p * 216, _1080p * 916)
	var_19_0:addElement(var_19_12)

	var_19_0.VerticalScrollbar = var_19_12
	...
	var_19_14:SetAnchorsAndPosition(0.5, 0.5, 0.5, 0.5, _1080p * -400, _1080p * 400, _1080p * -24, _1080p * 24)
	...
	var_19_10:RegisterAnimationSequence("NoItems", var_19_16)
	...
	var_19_12:RegisterAnimationSequence("NoItems", var_19_17)
	...
	var_19_14:RegisterAnimationSequence("NoItems", var_19_18)

	local function var_19_19()
		var_19_10:AnimateSequence("NoItems")
		var_19_12:AnimateSequence("NoItems")
		var_19_14:AnimateSequence("NoItems")
	end

	var_19_0._sequences.NoItems = var_19_19
	...
	local var_19_20 = LUI.UIBindButton.new()

	var_19_20.id = "selfBindButton"

	var_19_0:addElement(var_19_20)

	var_19_0.bindButton = var_19_20
