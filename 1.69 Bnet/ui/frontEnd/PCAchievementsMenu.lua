...
local function var_0_1(arg_2_0, arg_2_1, arg_2_2)
	if Engine.EAABDHIDFJ() then
		arg_2_0.MenuTitle:SetTitle(Engine.CBBHFCGDIC("MSSTORE_PLATFORM/ACHIEVEMENT"))
		arg_2_0.MenuTitle.MenuTitle:setText(ToUpperCase(Engine.CBBHFCGDIC("MSSTORE_PLATFORM/ACHIEVEMENT")), 0)
	else
