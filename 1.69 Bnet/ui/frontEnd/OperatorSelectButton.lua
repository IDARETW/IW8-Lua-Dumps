...
local function var_0_0(arg_1_0, arg_1_1, arg_1_2, arg_1_3)
	...
	local var_1_0 = OPERATOR.IsRandomOperator(arg_1_1)

	if var_1_0 then
		local var_1_1 = RANDOM.GetItemData(arg_1_2, {
			itemType = LOOT.itemTypes.OPERATOR
		})

		arg_1_0.OperatorIcon:setImage(RegisterMaterial(var_1_1.lootImage))
	else
		local var_1_2 = StringTable.DIFCHIGDFB(CSV.operators.file, CSV.operators.cols.ref, arg_1_1, CSV.operators.cols.icon)

		assert(var_1_2)
		arg_1_0.OperatorIcon:setImage(RegisterMaterial(var_1_2))
	end

	local var_1_3 = {
		operatorFaction = arg_1_3
	}
	local var_1_4 = RANDOM.IsEnabled(arg_1_2, LOOT.itemTypes.OPERATOR, var_1_3)
	local var_1_5 = PlayerData.BFFBGAJGD(arg_1_2, LOADOUT.GetLoadoutStatsGroup()).customizationSetup.operators[arg_1_3]:get() == arg_1_1 and not var_1_4 or var_1_4 and var_1_0

	arg_1_0:SetSelected(var_1_5)
...
function OperatorSelectButton(arg_14_0, arg_14_1)
	...
	var_14_6:SetAnchorsAndPosition(0, 0, 0, 0, _1080p * -37, _1080p * 35, 0, 0)
