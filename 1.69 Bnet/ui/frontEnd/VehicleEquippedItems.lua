...
local function var_0_0(arg_1_0, arg_1_1, arg_1_2)
	...
	if tonumber(arg_1_2.hideHornTab) == 0 then
		ACTIONS.AnimateSequence(arg_1_0, "ShowAllCategories")

		local var_1_1 = VEHICLE.GetEquippedHorn(arg_1_1, arg_1_2.ref).name
	...
	if tonumber(arg_1_2.hideTrackTab) == 0 then
		arg_1_0.TrackName:SetAlpha(1)
		arg_1_0.TrackText:SetAlpha(1)

		local var_1_2 = ""
		local var_1_3 = VEHICLE.GetEquippedTrack(arg_1_1, arg_1_2.ref)
		local var_1_4 = StringTable.DIFCHIGDFB(CSV.vehiclePacks.file, CSV.vehiclePacks.cols.ref, var_1_3, CSV.vehiclePacks.cols.name)

		if var_1_4 == "" then
			var_1_4 = "MENU/NONE"
		end

		arg_1_0.TrackName:setText(Engine.CBBHFCGDIC(var_1_4))
	else
...
function VehicleEquippedItems(arg_3_0, arg_3_1)
	...
	var_3_4:setText(ToUpperCase(Engine.CBBHFCGDIC("LUA_MENU/EQUIPPED")), 0)
	...
	var_3_14:SetAnchorsAndPosition(0, 1, 0, 1, 0, _1080p * 500, _1080p * 81, _1080p * 109)
	...
	var_3_16:SetAnchorsAndPosition(0, 1, 0, 1, 0, _1080p * 500, _1080p * 170, _1080p * 198)
	...
	var_3_18:SetAnchorsAndPosition(0, 1, 0, 1, 0, _1080p * 500, _1080p * 250, _1080p * 278)
	...
	var_3_4:RegisterAnimationSequence("WZSetup", var_3_33)
	...
	var_3_6:RegisterAnimationSequence("WZSetup", var_3_34)
	...
	var_3_8:RegisterAnimationSequence("WZSetup", var_3_35)
	...
	var_3_10:RegisterAnimationSequence("WZSetup", var_3_36)
	...
	var_3_12:RegisterAnimationSequence("WZSetup", var_3_37)
	...
	var_3_14:RegisterAnimationSequence("WZSetup", var_3_38)
	...
	var_3_16:RegisterAnimationSequence("WZSetup", var_3_39)
