...
local function var_0_0(arg_1_0, arg_1_1)
	...
	local var_1_2 = arg_1_1.controller or controllerIndex

	if Dvar.IBEGCHEFE("LQSTPOPKRO") then
		local var_1_3 = Engine.EAHFCIGDIG(var_1_2)
		local var_1_4 = Engine.DDGCFIDIHJ(var_1_2)
		local var_1_5 = Engine.JBFICJJHG(var_1_2)
		local var_1_6 = Engine.HFFCCEIAB(var_1_2)

		if var_1_3 or var_1_4 or var_1_5 or var_1_6 then
			local var_1_7 = false
			local var_1_8 = Engine.DBFFAEEFGJ()

			if var_1_8 ~= nil then
				local var_1_9 = var_1_8.flowManager:GetStackTop(true)

				if var_1_9 and var_1_9.name == "MainMenu" then
					var_1_7 = true
				end
			end

			local var_1_10 = Engine.BECCFCBIAA("hasSeenCOPPANoticeMessage", var_1_2) == 1

			if var_1_7 and not var_1_10 then
				Dvar.DHEGHJJJHI("cl_voice", false)
				Lobby.HCCAGAJGJ(var_1_2, MuteStrategy.MuteStrategyMuteAll)
				Engine.DFJDIFJEGA("textChatEnabled", 0, var_1_2)
				Dvar.DHEGHJJJHI("LKSKPKTOON", false)
				LUI.FlowManager.RequestPopupMenu(arg_1_0, "COPPAMenuNotice", true, var_1_2, false, nil, nil, true, true)
			end
		end
	end

	if CONDITIONS.IsPCMSStore() and Engine.CDFCHEJJE(var_1_2) then
		Dvar.DHEGHJJJHI("cl_voice", false)
		Lobby.HCCAGAJGJ(var_1_2, MuteStrategy.MuteStrategyMuteAll)
	end
...
local function var_0_11(arg_54_0, arg_54_1)
	...
	if Dvar.IBEGCHEFE("LNTLOLLNQN") then
		...
		if var_54_3 and var_54_3.name == "MainMenu" then
			...
			if var_54_4 == "wz" and CONDITIONS.IsLaze() then
				var_54_4 = "mp"
			end
			...
			if var_54_5 then
				if Engine.ECHHDAIBD(var_54_5) == ContentProgressState.INSTALLED then
					if var_54_5 == MAIN_MENU.GameModeEnumValues.MP then
						...
						var_54_0 = true
					elseif var_54_5 == MAIN_MENU.GameModeEnumValues.BR and not CONDITIONS.IsLaze() then
					...
					MAIN_MENU.InstallAction(arg_54_1, var_54_5)
				end
			end
...
local function var_0_13(arg_56_0, arg_56_1)
	local var_56_0 = CONDITIONS.IsLaze() and "MOLLOLN" or "OLMTRQORKQ"
	local var_56_1 = CONDITIONS.IsLaze() and "OMPKLTKSKT" or "MTLSRSQQRK"
	...
	elseif arg_56_0._overrideMenu and arg_56_0._overrideMenu == "MW" then
		...
		ACTIONS.AnimateSequence(arg_56_0, "KronosLayout")
	elseif Dvar.IBEGCHEFE(var_56_0) then
	...
	elseif Dvar.IBEGCHEFE(var_56_1) then
...
local function var_0_15(arg_58_0, arg_58_1, arg_58_2)
	...
	if CONDITIONS.ArePartiesEnabledInMainMenu() then
		...
		if CONDITIONS.IsLaze() and (var_58_0 == "wz" or var_58_0 == "br" or var_58_0 == "brtdm") then
			var_58_0 = nil
		end
...
local function var_0_17(arg_88_0, arg_88_1, arg_88_2)
	...
	Dvar.DHEGHJJJHI("MLQNQTRRTK", not CONDITIONS.IsLazeOrOutrun())
