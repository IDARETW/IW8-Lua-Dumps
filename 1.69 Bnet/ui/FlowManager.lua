...
function LUI.FlowManager.DoAutomaticNavigation(arg_99_0, arg_99_1, arg_99_2, arg_99_3)
	...
	if (var_99_1 ~= var_99_2 or var_99_3) and var_99_1 ~= CoD.PlayMode.None then
		local var_99_4 = LUI.FlowManager.GetMenuByName(LUI.FlowManager.FlowMenus[PartyUIRoot.MAIN_MENU])

		if var_99_4 ~= nil and var_99_4.fenced then
			return false
		end

		local var_99_5 = Engine.IJEBHJIJF()
	...
	local var_99_6 = LUI.FlowManager.FlowMenus[arg_99_1]
	...
	if Dvar.IBEGCHEFE("MMQLNQRRLO") then
		local var_99_7 = arg_99_0:GetStackTop().name

		if LUI.FlowManager.IgnoreFollowHostMenus[var_99_7] then
			local var_99_8 = arg_99_0:CreateMenuInfo(var_99_6, nil, true, var_99_0)

			arg_99_0:swapPartyUIRoot(var_99_8, var_99_0)
	...
	local var_99_9 = arg_99_0:StackContains(var_99_6)
	local var_99_10 = false

	for iter_99_0 = arg_99_1 + 1, PartyUIRoot.LAST do
		local var_99_11 = LUI.FlowManager.FlowMenus[iter_99_0]

		if arg_99_0:StackContains(var_99_11) then
			var_99_10 = true
	...
	if var_99_9 and not var_99_10 then
		arg_99_0.isPartyUIRootDirty = false

		return true
	end

	DebugPrint("LUI.FlowManager.FollowPartyHost to " .. var_99_6)
	arg_99_0:closeAllMenus()
	arg_99_0:addMenu({
		menu = var_99_6,
		controller = var_99_0
