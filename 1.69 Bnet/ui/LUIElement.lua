...
function LUI.UIElement.IsPositionInside(arg_21_0, arg_21_1, arg_21_2)
	...
	if arg_21_1 == nil or arg_21_2 == nil or var_21_1 == nil or var_21_2 == nil or var_21_3 == nil or var_21_4 == nil then
		return var_21_0
	end
...
function LUI.UIElement.GetNextFocusableElement(arg_26_0, arg_26_1, arg_26_2, arg_26_3, arg_26_4)
	...
	if arg_26_0.navigation and arg_26_0.navigation[arg_26_2] then
		local var_26_0 = arg_26_0.navigation[arg_26_2]

		if type(var_26_0) ~= "userdata" then
			assert(type(var_26_0) == "table")
...
function LUI.UIElement.AddButtonHelperTextToElement(arg_73_0, arg_73_1, arg_73_2)
	assert(arg_73_2, "AddButtonHelperText requires that promptData is not nil")
...
function LUI.UIElement.RemoveButtonHelperTextFromElement(arg_75_0, arg_75_1, arg_75_2, arg_75_3)
	assert(arg_75_2, "RemoveButtonHelperText requires a valid buttonRef value")
	...
	if arg_75_0._helperTextAdditions and arg_75_0._helperTextAdditions[arg_75_2] then
		arg_75_0._helperTextAdditions[arg_75_2] = nil
	end
end

function LUI.UIElement.RemoveButtonHelperText(arg_76_0, arg_76_1, arg_76_2)
	arg_76_0:RemoveButtonHelperTextFromElement(arg_76_0:GetCurrentMenu(), arg_76_1, arg_76_2)
end

function LUI.UIElement.AddButtonPrompt(arg_77_0, arg_77_1, arg_77_2)
	arg_77_2 = arg_77_2 or {}

	local var_77_0 = arg_77_2.menu or arg_77_0:GetCurrentMenu(arg_77_0)

	arg_77_0:AddButtonHelperTextToElement(var_77_0, arg_77_1)
end

function LUI.UIElement.RemoveButtonPrompt(arg_78_0, arg_78_1, arg_78_2)
	arg_78_2 = arg_78_2 or {}

	local var_78_0 = arg_78_2.menu or arg_78_0:GetCurrentMenu(arg_78_0)

	arg_78_0:RemoveButtonHelperTextFromElement(var_78_0, arg_78_1.button_ref, arg_78_1.side)
end

function LUI.UIElement.SetupContextualMenu(arg_79_0, arg_79_1)
	local var_79_0 = arg_79_1 and arg_79_1.title
	local var_79_1 = arg_79_1 and arg_79_1.battlenetData

	arg_79_0._contextualMenuData = {
		title = var_79_0,
		battlenetData = var_79_1,
		buttonsData = {}
	}
end

function LUI.UIElement.AddContextualMenuAction(arg_80_0, arg_80_1)
	assert(arg_80_0._contextualMenuData, "Called AddContextualMenuAction without calling SetupContextualMenu first")
	assert(arg_80_1.isSeparator or arg_80_1.id, "Called AddContextualMenuAction without an id, every new actions need to have an associated id that should also be added to MetricsUtility.lua and dlog_routes.dlog")

	local var_80_0 = {
		actionName = arg_80_1.actionName,
		actionNameFunction = arg_80_1.actionNameFunction,
		actionFunction = arg_80_1.actionFunction,
		actionParams = arg_80_1.actionParams,
		conditionFunction = arg_80_1.conditionFunction,
		conditionParams = arg_80_1.conditionParams,
		id = arg_80_1.id,
		isSeparator = arg_80_1.isSeparator
	}

	table.insert(arg_80_0._contextualMenuData.buttonsData, var_80_0)
end

function LUI.UIElement.AddTooltipData(arg_81_0, arg_81_1, arg_81_2)
	arg_81_0._tooltipData = {
		title = arg_81_2.tooltipTitle,
		description = arg_81_2.tooltipDescription,
		promptsData = arg_81_2.promptsData,
		horizontalAlignment = arg_81_2.horizontalAlignment,
		verticalAlignment = arg_81_2.verticalAlignment
	}

	LUI.MouseCursorTooltipLayer.AddTooltipMouseHandlerToElement(arg_81_0)

	if arg_81_2.focusableChildrenRefresh then
		LUI.MouseCursorTooltipLayer.AddTootlipMouseHandlerToFocusableChildren(arg_81_0)
	end

	arg_81_0:registerEventHandler("on_close", function(arg_82_0)
		if arg_81_0._tooltipData then
			local var_82_0 = Engine.DBFFAEEFGJ().cursor

			if var_82_0 then
				local var_82_1 = var_82_0._controllerIndex

				if var_82_1 then
					LUI.MouseCursorTooltipLayer.TooltipElementClosed(var_82_1, arg_82_0)
				end
			end
		end
	end)
...
function LUI.UIElement.RefreshTooltipData(arg_83_0, arg_83_1, arg_83_2)
	assert(arg_83_0._tooltipData, "Called RefreshTooltipData without calling AddTooltipData first")

	arg_83_0._tooltipData.title = arg_83_2.tooltipTitle or arg_83_0._tooltipData.title or nil
	arg_83_0._tooltipData.description = arg_83_2.tooltipDescription or arg_83_0._tooltipData.description or nil
	arg_83_0._tooltipData.promptsData = arg_83_2.promptsData or arg_83_0._tooltipData.promptsData or nil
	arg_83_0._tooltipData.horizontalAlignment = arg_83_2.horizontalAlignment or arg_83_0._tooltipData.horizontalAlignment or nil
	arg_83_0._tooltipData.verticalAlignment = arg_83_2.verticalAlignment or arg_83_0._tooltipData.verticalAlignment or nil

	LUI.MouseCursorTooltipLayer.RefreshTooltip(arg_83_1)
end

function LUI.UIElement.RemoveToolTipData(arg_84_0)
	arg_84_0._tooltipData = nil
end

function LUI.UIElement.GetDebuggerInfo(arg_85_0, arg_85_1)
	local var_85_0 = "LUIElement = {"
	local var_85_1, var_85_2, var_85_3, var_85_4 = arg_85_0:getLocalRect()

	if var_85_1 and var_85_2 and var_85_3 and var_85_4 then
		var_85_0 = var_85_0 .. "localRect = { left = " .. var_85_1 .. ", right = " .. var_85_3 .. ", top = " .. var_85_2 .. ", bottom = " .. var_85_4 .. " },"
	end

	local var_85_5, var_85_6, var_85_7, var_85_8 = arg_85_0:getCurrentGlobalRect()

	if var_85_5 and var_85_6 and var_85_7 and var_85_8 then
		var_85_0 = var_85_0 .. "globalRect = { left = " .. var_85_5 .. ", right = " .. var_85_7 .. ", top = " .. var_85_6 .. ", bottom = " .. var_85_8 .. " },"
	end

	local var_85_9, var_85_10, var_85_11, var_85_12 = arg_85_0:getRect()

	if var_85_9 and var_85_10 and var_85_11 and var_85_12 then
		var_85_0 = var_85_0 .. "screenSpaceRect = { left = " .. var_85_9 .. ", right = " .. var_85_11 .. ", top = " .. var_85_10 .. ", bottom = " .. var_85_12 .. " },"
	end

	if arg_85_0.GetAnchorData then
		local var_85_13, var_85_14, var_85_15, var_85_16 = arg_85_0:GetAnchorData()

		if var_85_13 and var_85_15 and var_85_14 and var_85_16 then
			var_85_0 = var_85_0 .. "anchors = { left = " .. var_85_13 .. ", right = " .. var_85_14 .. ", top = " .. var_85_15 .. ", bottom = " .. var_85_16 .. " },"
		end
	end

	local var_85_17, var_85_18, var_85_19, var_85_20 = arg_85_0:getCurrentRGBA()
	local var_85_21 = var_85_0 .. "color = { red = " .. var_85_17 .. ", green = " .. var_85_18 .. ",blue = " .. var_85_19 .. ", alpha = " .. var_85_20 .. "},"
	local var_85_22 = arg_85_0:GetScale()
	local var_85_23 = var_85_21 .. "scale = " .. var_85_22 .. ","
	local var_85_24 = arg_85_0:getHeight()
	local var_85_25 = arg_85_0:getWidth()
	local var_85_26 = var_85_23 .. "dimensions = { height = " .. var_85_24 .. ", width = " .. var_85_25 .. "},"
	local var_85_27, var_85_28, var_85_29 = arg_85_0:GetRotation()
	local var_85_30 = var_85_26 .. "rotation = { x = " .. var_85_27 .. ", y = " .. var_85_28 .. ", z = " .. var_85_29 .. "},"
	local var_85_31 = arg_85_0:GetDepth()
	local var_85_32 = var_85_30 .. "depth = " .. var_85_31 .. ","
	local var_85_33 = {
	...
	local var_85_34 = arg_85_0:GetBlendMode()
	local var_85_35 = var_85_32 .. "blendMode = '" .. var_85_33[var_85_34] .. "',"

	if arg_85_0:Is3DTransform() or arg_85_0:GetIsQuadCacheDisabled() then
		var_85_35 = var_85_35 .. "usageFlags = {"

		if arg_85_0:Is3DTransform() then
			var_85_35 = var_85_35 .. "TRANSFORM_3D = true,"
		end

		if arg_85_0:GetIsQuadCacheDisabled() then
			var_85_35 = var_85_35 .. "DISABLE_QUADCACHE = true,"
		end

		var_85_35 = var_85_35 .. "}"
	end

	local var_85_36 = var_85_35 .. "}"

	arg_85_1[#arg_85_1 + 1] = var_85_36
end

function LUI.UIElement.SetupImageTableStreamer(arg_86_0, arg_86_1, arg_86_2)
	if arg_86_0.isStreamer == nil then
		arg_86_0.isStreamer = true
	end

	arg_86_0:SetupImageStreamer(arg_86_1, arg_86_2 and true or false)
end

function LUI.UIElement.GetStreamedImageTable(arg_87_0)
	local var_87_0 = {}
	local var_87_1 = arg_87_0:GetStreamedImageNameTable()

	for iter_87_0 = 1, #var_87_1 do
		table.insert(var_87_0, RegisterMaterial(var_87_1[iter_87_0]))
	end

	return var_87_0
end

function LUI.UIElement.GetStreamingImageNameTable(arg_88_0)
	return arg_88_0:GetStreamedImageTable()
end
...
function DataLink.init(arg_89_0, arg_89_1)
	assert(type(arg_89_1.source) == "userdata")
	assert(type(arg_89_1.target) == "userdata")
	assert(arg_89_1.source ~= arg_89_1.target or arg_89_1.type == DataLink.TYPES.model or arg_89_1.type == DataLink.TYPES.dataSourceCallback)

	arg_89_0._source = arg_89_1.source
	arg_89_0._target = arg_89_1.target
	arg_89_0._relativeDataSourcePath = {}
	arg_89_0._callback = arg_89_1.callback
	arg_89_0._type = arg_89_1.type

	if arg_89_1.relativeDataSourcePath then
		arg_89_0._relativeDataSourcePath = LUI.Split(arg_89_1.relativeDataSourcePath, "\\.")
	end

	arg_89_0._source._dataLinksAsSource = arg_89_0._source._dataLinksAsSource or {}
	arg_89_0._target._dataLinksAsTarget = arg_89_0._target._dataLinksAsTarget or {}
end

function DataLink.Refresh(arg_90_0)
	...
	local var_90_0, var_90_1 = arg_90_0._source:GetDataSource()

	if var_90_0 then
		assert(type(var_90_1) == "number")

		local var_90_2 = var_90_0

		if #arg_90_0._relativeDataSourcePath > 0 then
			for iter_90_0, iter_90_1 in ipairs(arg_90_0._relativeDataSourcePath) do
				assert(var_90_2[iter_90_1])

				var_90_2 = var_90_2[iter_90_1]
			end
		end

		if arg_90_0._type == DataLink.TYPES.model then
			local var_90_3 = var_90_2:GetModel(var_90_1)

			if var_90_3 then
				arg_90_0._subscription = arg_90_0._target:SubscribeToModel(var_90_3, arg_90_0._callback)
			end
		elseif arg_90_0._type == DataLink.TYPES.selfDataSource then
			arg_90_0._target:SetDataSource(var_90_2, var_90_1)
		elseif arg_90_0._type == DataLink.TYPES.gridDataSource then
			arg_90_0._target:SetGridDataSource(var_90_2)
		elseif arg_90_0._type == DataLink.TYPES.tabManagerDataSource then
			arg_90_0._target:SetTabManagerDataSource(var_90_2)
		elseif arg_90_0._type == DataLink.TYPES.dataSourceCallback then
			arg_90_0._callback(var_90_2)

			if arg_90_0.unlinkOnCallback then
				arg_90_0:Unlink()
			end
		else
			assert(false)
...
function DataLink.Link(arg_91_0)
	for iter_91_0, iter_91_1 in pairs(arg_91_0._target._dataLinksAsTarget) do
		if iter_91_0._type == arg_91_0._type and arg_91_0._type ~= DataLink.TYPES.model and arg_91_0._type ~= DataLink.TYPES.dataSourceCallback then
			iter_91_0:Unlink()
		end
	end

	arg_91_0._source._dataLinksAsSource[arg_91_0] = true
	arg_91_0._target._dataLinksAsTarget[arg_91_0] = true
end

function DataLink.Unlink(arg_92_0)
	if arg_92_0._subscription then
		arg_92_0._target:UnsubscribeFromModel(arg_92_0._subscription)

		arg_92_0._subscription = nil
	end

	arg_92_0._source._dataLinksAsSource[arg_92_0] = nil
	arg_92_0._target._dataLinksAsTarget[arg_92_0] = nil
end

function LUI.UIElement.GetDataSource(arg_93_0)
	return arg_93_0._dataSource, arg_93_0._dataSourceControllerIndex
end

function LUI.UIElement.SetDataSource(arg_94_0, arg_94_1, arg_94_2)
	assert(type(arg_94_2) == "number" or arg_94_1 == nil)

	arg_94_0._dataSource = arg_94_1
	arg_94_0._dataSourceControllerIndex = arg_94_2

	if arg_94_0._dataLinksAsSource then
		local var_94_0 = LUI.ShallowCopy(arg_94_0._dataLinksAsSource)
...
function LUI.UIElement.SubscribeToModel(arg_95_0, arg_95_1, arg_95_2, arg_95_3)
	arg_95_0._subscriptions = arg_95_0._subscriptions or LUI.SubscriptionsHolder.new()

	return arg_95_0._subscriptions:SubscribeToModel(arg_95_1, arg_95_2, arg_95_3)
end

function LUI.UIElement.UnsubscribeFromModel(arg_96_0, arg_96_1)
	if arg_96_0._subscriptions then
		return arg_96_0._subscriptions:UnsubscribeFromModel(arg_96_1)
	end
end

function LUI.UIElement.RemoveDataLinks(arg_97_0)
	if arg_97_0._dataLinksAsTarget then
		for iter_97_0, iter_97_1 in pairs(arg_97_0._dataLinksAsTarget) do
			iter_97_0._source._dataLinksAsSource[iter_97_0] = nil
			iter_97_0._target._dataLinksAsTarget[iter_97_0] = nil
		end
	end

	if arg_97_0._dataLinksAsSource then
		for iter_97_2, iter_97_3 in pairs(arg_97_0._dataLinksAsSource) do
			iter_97_2._source._dataLinksAsSource[iter_97_2] = nil
			iter_97_2._target._dataLinksAsTarget[iter_97_2] = nil
		end
	end
end

function LUI.UIElement.UnsubscribeFromAllModels(arg_98_0)
	if arg_98_0._subscriptions then
		arg_98_0._subscriptions:UnsubscribeFromAllModels()
	end

	if arg_98_0._dataLinksAsSource then
		for iter_98_0, iter_98_1 in pairs(arg_98_0._dataLinksAsSource) do
			if iter_98_0._subscription then
				iter_98_0._target:UnsubscribeFromModel(iter_98_0._subscription)
			end
		end
	end
end

function LUI.UIElement.SubscribeToDataSourceThroughElement(arg_99_0, arg_99_1, arg_99_2, arg_99_3)
...
function LUI.UIElement.SubscribeToModelThroughElement(arg_100_0, arg_100_1, arg_100_2, arg_100_3)
	local var_100_0 = DataLink.new({
		target = arg_100_0,
		source = arg_100_1,
		relativeDataSourcePath = arg_100_2,
		callback = arg_100_3,
...
function LUI.UIElement.SetDataSourceThroughElement(arg_101_0, arg_101_1, arg_101_2)
	local var_101_0 = DataLink.new({
		target = arg_101_0,
		source = arg_101_1,
		relativeDataSourcePath = arg_101_2,
...
function LUI.UIElement.UnsubscribeFromModelThroughElement(arg_102_0, arg_102_1)
	local var_102_0 = arg_102_1

	assert(var_102_0._target == arg_102_0)
	var_102_0:Unlink()
end

function LUI.UIElement.BindAlphaToModel(arg_103_0, arg_103_1)
	arg_103_0._subscriptions = arg_103_0._subscriptions or LUI.SubscriptionsHolder.new()

	return arg_103_0._subscriptions:BindElementAlphaToModel(arg_103_0, arg_103_1)
end

function LUI.UIElement.BindColorToModel(arg_104_0, arg_104_1)
	arg_104_0._subscriptions = arg_104_0._subscriptions or LUI.SubscriptionsHolder.new()

	return arg_104_0._subscriptions:BindElementColorToModel(arg_104_0, arg_104_1)
end

function LUI.UIElement.BindScaleToModel(arg_105_0, arg_105_1)
	arg_105_0._subscriptions = arg_105_0._subscriptions or LUI.SubscriptionsHolder.new()

	return arg_105_0._subscriptions:BindElementScaleToModel(arg_105_0, arg_105_1)
end

function LUI.UIElement.BindZRotationToModel(arg_106_0, arg_106_1)
	arg_106_0._subscriptions = arg_106_0._subscriptions or LUI.SubscriptionsHolder.new()

	return arg_106_0._subscriptions:BindElementZRotationToModel(arg_106_0, arg_106_1)
end

function LUI.UIElement.BindLeftToModel(arg_107_0, arg_107_1)
	arg_107_0._subscriptions = arg_107_0._subscriptions or LUI.SubscriptionsHolder.new()

	return arg_107_0._subscriptions:BindElementLeftToModel(arg_107_0, arg_107_1)
end

function LUI.UIElement.BindRightToModel(arg_108_0, arg_108_1)
	arg_108_0._subscriptions = arg_108_0._subscriptions or LUI.SubscriptionsHolder.new()

	return arg_108_0._subscriptions:BindElementRightToModel(arg_108_0, arg_108_1)
end

function LUI.UIElement.BindTopToModel(arg_109_0, arg_109_1)
	arg_109_0._subscriptions = arg_109_0._subscriptions or LUI.SubscriptionsHolder.new()

	return arg_109_0._subscriptions:BindElementTopToModel(arg_109_0, arg_109_1)
end

function LUI.UIElement.BindBottomToModel(arg_110_0, arg_110_1)
	arg_110_0._subscriptions = arg_110_0._subscriptions or LUI.SubscriptionsHolder.new()

	return arg_110_0._subscriptions:BindElementBottomToModel(arg_110_0, arg_110_1)
end

function LUI.UIElement.Shake(arg_111_0, arg_111_1)
	if arg_111_0.shakeable == false then
		return
	end

	local var_111_0, var_111_1, var_111_2, var_111_3 = arg_111_0:GetAnchorData()
	local var_111_4, var_111_5, var_111_6, var_111_7 = arg_111_0:getLocalRect()
	local var_111_8 = 3 * (arg_111_1 or 1)
	local var_111_9 = 3
	local var_111_10 = 20 + 50 * math.random()
	local var_111_11 = var_111_8 * (0 - var_111_9 + math.random() * 2 * var_111_9)
	local var_111_12 = var_111_8 * (0 - var_111_9 + math.random() * 2 * var_111_9)
	local var_111_13 = arg_111_0:SetAnchorsAndPosition(var_111_0, var_111_2, var_111_1, var_111_3, var_111_11, var_111_6, var_111_12, var_111_7, var_111_10, LUI.EASING.outQuadratic)

	if var_111_13 then
		function var_111_13.onComplete()
			arg_111_0:Shake(arg_111_1)
		end
	end
end

function LUI.UIElement.StopShake(arg_113_0)
	arg_113_0:SetAnchorsAndPosition(arg_113_0.defaultAnchorLeft, arg_113_0.defaultAnchorRight, arg_113_0.defaultAnchorTop, arg_113_0.defaultAnchorBottom, arg_113_0.defaultRectLeft, arg_113_0.defaultRectRight, arg_113_0.defaultRectTop, arg_113_0.defaultRectBottom, 0, LUI.EASING.inOutQuadratic)
end

function LUI.UIElement.build(arg_114_0, arg_114_1)
...
function LUI.UIElement.init(arg_116_0)
	arg_116_0._scoped = LUI.ActiveScoped
	arg_116_0.m_eventHandlers = {}
	arg_116_0.m_references = {}

	if Engine.EABCCIBFIG() then
		arg_116_0:registerEventHandler("mousemove", LUI.UIElement.MouseMoveEvent)
		arg_116_0:registerEventHandler("mousedown", LUI.UIElement.MouseButtonEvent)
		arg_116_0:registerEventHandler("mouseup", LUI.UIElement.MouseButtonEvent)
		arg_116_0:registerEventHandler("popup_active", LUI.UIElement.PopupActive)
	end

	arg_116_0:registerEventHandler("restore_focus", LUI.UIElement.restoreFocus)
end

function LUI.UIElement.isElementVisible(arg_117_0)
	local var_117_0 = arg_117_0

	while var_117_0 do
		if var_117_0:GetAlpha() <= 0 then
			return false
		end

		var_117_0 = var_117_0:getParent()
	end
