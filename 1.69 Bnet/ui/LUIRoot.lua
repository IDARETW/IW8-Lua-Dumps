...
function LUI.UIRoot.HandleErrors(arg_28_0)
	...
	local var_28_6 = LUI.FlowManager.IsInStack("ControllerRemovedPopup")
	local var_28_7 = Engine.FJCIBEDII()
	...
	if arg_28_0._controllerIndex == nil then
		...
		local var_28_8 = arg_28_0._controllerIndex

		var_28_3 = Engine.EACCHAIHIB(var_28_8)

		if var_28_3 == true then
			var_28_2 = var_28_8
		end

		var_28_5 = Engine.JDFDCGCIJ(var_28_8)
	end

	local var_28_9 = LUI.IsLastInputGamepad(var_28_2)

	if var_28_3 and not var_28_6 and (not var_28_5 or var_28_7 and var_28_9) then
		Engine.CGACCJCHEC(var_28_2)
		LUI.FlowManager.RequestPopupMenu(nil, "ControllerRemovedPopup", false, nil, false, {
			missingControllerIndex = var_28_2
		}, nil, true)
	elseif var_28_6 and (not var_28_3 or var_28_5 and not var_28_7) then
		if arg_28_0._controllerIndex then
			LUI.FlowManager.RequestLeaveMenuByNameWithController("ControllerRemovedPopup", arg_28_0._controllerIndex, true)
		else
	...
	local var_28_10 = Engine.BHBHCBJACC()
	local var_28_11 = LUI.FlowManager.IsInStack("WaitingForTransientsPopMenu")

	if var_28_10 and not var_28_11 then
		LUI.FlowManager.RequestPopupMenu(nil, "WaitingForTransientsPopMenu", false, nil, false, {}, nil, true)
	elseif var_28_11 and not var_28_10 then
...
function LUI.UIRoot.UpdateGameMode(arg_30_0, arg_30_1)
	local var_30_0 = arg_30_1.currentGameMode

	CoD.UpdateGameMode(var_30_0, arg_30_1.previousGameMode)
	THEMES.UpdateTheme({
		currentGameMode = var_30_0,
		isMainMenu = var_30_0 == 0
	})
	LUI.UIRoot.UpdateClansNotificationHandler(arg_30_0, var_30_0, arg_30_1.previousGameMode)
...
function LUI.UIRoot.InventoryAddItem(arg_32_0, arg_32_1)
	Challenge.ActivateAchievementForNewItem(arg_32_1.controller, arg_32_1.id)
end

function LUI.UIRoot.InventoryUpdateItem(arg_33_0, arg_33_1)
	return
end

function LUI.UIRoot.InventoryDeleteItem(arg_34_0, arg_34_1)
	return
end

function LUI.UIRoot.InventoryDownloadComplete(arg_35_0, arg_35_1)
	if arg_35_1.type == "player" then
		Challenge.FixupActivationTokens(arg_35_1.controller)
	end
end

function LUI.UIRoot.PreviewItem(arg_36_0, arg_36_1)
	local var_36_0 = LOOT.GetTypeForID(arg_36_1.lootID)

	if LOOT.CanPreview(var_36_0, arg_36_1.lootID) then
		STORE.PreviewItem(arg_36_1.controller, var_36_0, arg_36_1.lootID)
	end
end

function LUI.UIRoot.UpdateInputType(arg_37_0, arg_37_1)
	arg_37_0:UpdateInputConnected(arg_37_1)

	if not Engine.EABCCIBFIG() then
		return
	end

	assert(arg_37_1.controller)

	local var_37_0 = arg_37_1.inputType and arg_37_1.inputType or Engine.CBCJDCHCCD(arg_37_1.controller)

	if arg_37_0.lastInputType ~= var_37_0 then
		arg_37_0.lastInputType = var_37_0

		arg_37_0:processEvent({
			name = "update_input_type",
			controllerIndex = arg_37_1.controller
		})
	end
end

function LUI.UIRoot.UpdateInputConnected(arg_38_0, arg_38_1)
	local var_38_0 = arg_38_0._controllerIndex or Engine.IJEBHJIJF()
	local var_38_1 = OPTIONS.IsGamepadConnected(var_38_0)
	local var_38_2 = Engine.JDFDCGCIJ(var_38_0)

	if arg_38_0.keyboardConnected ~= var_38_2 then
		local var_38_3 = Engine.IEJEJEI()

		if not var_38_3 and not arg_38_0.systemUiOpened then
			arg_38_0.keyboardConnected = var_38_2
			arg_38_0.connectionChanged = true

			arg_38_0:dispatchEventToChildren({
				name = "input_connection",
				controllerIndex = var_38_0
			})
		elseif var_38_3 then
			arg_38_0.systemUiOpened = true
		else
			arg_38_0.systemUiOpened = false
		end
	elseif arg_38_0.gamepadConnected ~= var_38_1 then
		arg_38_0.gamepadConnected = var_38_1
		arg_38_0.connectionChanged = true
...
function LUI.UIRoot.ConnectionPopups(arg_39_0)
	local var_39_0 = CONDITIONS.IsGamepadEnabled()

	if arg_39_0.connectionChanged or var_39_0 and not arg_39_0.gamepadConnected or not var_39_0 and not arg_39_0.keyboardConnected then
		local var_39_1 = LUI.FlowManager.IsInStack("keyboardremoved_inputswap_popup")
		local var_39_2 = LUI.FlowManager.IsInStack("controllerremoved_inputswap_popup")
		local var_39_3 = MenuUtils.CanShowConnectionPopups()
		local var_39_4 = not arg_39_0.keyboardConnected and arg_39_0.gamepadConnected
		local var_39_5 = not arg_39_0.gamepadConnected and arg_39_0.keyboardConnected

		if var_39_4 and not var_39_0 then
			if not var_39_1 and var_39_3 then
				LUI.FlowManager.RequestPopupMenu(nil, "keyboardremoved_inputswap_popup")
			end
		elseif var_39_5 and var_39_0 then
			if not var_39_2 and var_39_3 then
				LUI.FlowManager.RequestPopupMenu(nil, "controllerremoved_inputswap_popup")
			end
		else
			arg_39_0.connectionChanged = false
		end

		if var_39_1 and (arg_39_0.keyboardConnected or not var_39_3) then
			LUI.FlowManager.RequestLeaveMenuByName("keyboardremoved_inputswap_popup", true)
		elseif var_39_2 and (arg_39_0.gamepadConnected or not var_39_3) then
			LUI.FlowManager.RequestLeaveMenuByName("controllerremoved_inputswap_popup", true)
		end
	end
end

function LUI.UIRoot.SetLuiLayerKeycatch(arg_40_0, arg_40_1, arg_40_2)
	...
	if var_40_0.layerLUIKeycatch[arg_40_1] == nil then
		var_40_0.layerLUIKeycatch[arg_40_1] = {}
	end

	local var_40_1 = var_40_0.layerLUIKeycatch[arg_40_1]
	...
	if arg_40_2 then
		...
		var_40_1[arg_40_0.id] = var_40_1[arg_40_0.id] and var_40_1[arg_40_0.id] + 1 or 1

		if not var_40_2 then
			Engine.CECBDGIHED(arg_40_1, arg_40_2)
			var_40_0:TryAddMouseCursor("layerKeyCatch")
		end
	elseif var_40_1[arg_40_0.id] then
		var_40_1[arg_40_0.id] = var_40_1[arg_40_0.id] and var_40_1[arg_40_0.id] - 1

		if var_40_1[arg_40_0.id] > 0 then
			return
		end

		var_40_1[arg_40_0.id] = nil
		...
		if var_40_3 then
			Engine.CECBDGIHED(arg_40_1, arg_40_2)
			var_40_0:RemoveMouseCursor("layerKeyCatch")
		end
	end
end

function LUI.UIRoot.init(arg_41_0, arg_41_1, arg_41_2)
	LUI.UIRoot.super.init(arg_41_0)
	arg_41_0:SetAnchors(0.5, 0.5, 0.5, 0.5)

	local var_41_0 = arg_41_1 or Engine.IJEBHJIJF()

	THEMES.UpdateTheme()

	arg_41_0._flagCursor = {
		layerKeyCatch = false,
		base = false
	}
	arg_41_0.id = "LUIRoot"
	arg_41_0.isaroot = true
	arg_41_0._controllerIndex = arg_41_1
	arg_41_0.name = arg_41_2
	arg_41_0.layers = {}
	arg_41_0.eventQueue = {}
	arg_41_0.inputQueue = {}
	arg_41_0.lastInputType = Engine.CBCJDCHCCD(var_41_0)
	arg_41_0.layerLUIKeycatch = {}
	arg_41_0.keyboardConnected = Engine.JDFDCGCIJ(var_41_0)
	arg_41_0.gamepadConnected = OPTIONS.IsGamepadConnected(var_41_0)
	arg_41_0.systemUiOpened = false
	arg_41_0.connectionChanged = false
	arg_41_0.focusStack = {}
	arg_41_0.debugPrintIgnoreEvents = {
		mousemove = true,
		gamepad_sticks = true,
		process_events = true
	}

	Engine.BHICHBJEHH(var_41_0, false)
	Dvar.DHEGHJJJHI("NRSSTPLOSQ", false)

	LUI.roots[arg_41_2] = arg_41_0

	if LUI.primaryRoot == nil then
		LUI.primaryRoot = arg_41_0
	end

	arg_41_0.processEvent = LUI.UIRoot.ProcessEvent

	arg_41_0:registerEventHandler("run_frame", LUI.UIRoot.Frame)
	arg_41_0:registerEventHandler("update_game_mode", LUI.UIRoot.UpdateGameMode)
	arg_41_0:registerEventHandler("update_publisher_variables", LUI.UIRoot.UpdatePublisherVariables)
	arg_41_0:addEventHandler("empty_menu_stack", LUI.UIRoot.ClearFocusStack)
	arg_41_0:registerEventHandler("gamer_profile_input_type_updated", LUI.UIRoot.UpdateInputType)
	arg_41_0:registerEventHandler("playerdata_available", LUI.UIRoot.PlayerDataAvailable)
	arg_41_0:registerEventHandler("Inventory_AddItem", LUI.UIRoot.InventoryAddItem)
	arg_41_0:registerEventHandler("Inventory_UpdateItem", LUI.UIRoot.InventoryUpdateItem)
	arg_41_0:registerEventHandler("Inventory_DeleteItem", LUI.UIRoot.InventoryDeleteItem)
	arg_41_0:registerEventHandler("Inventory_DownloadComplete", LUI.UIRoot.InventoryDownloadComplete)
	arg_41_0:registerEventHandler("PreviewItem", LUI.UIRoot.PreviewItem)

	if UIDebugOverlayUtils and LUI.primaryRoot == arg_41_0 then
		arg_41_0:registerEventHandler("debug_overlay_frame", UIDebugOverlayUtils.FrameEvent)
	end

	arg_41_0.eventCatcher = EventCatcher.new()

	arg_41_0.eventCatcher:setupRoot(arg_41_0)

	local var_41_1 = Engine.DDJFBBJAIG()
	local var_41_2 = Engine.EAAHGICFBD()
	local var_41_3 = Engine.EAIICIFIFA()
	local var_41_4 = Engine.CGABICJHAI()
	local var_41_5 = Engine.BHICADFIHA()
	local var_41_6 = Engine.DBFCJBDJEC()
	local var_41_7 = Engine.ECHCFGDDDF()

	if var_41_1 or var_41_2 then
		arg_41_0.fadeManager = arg_41_0:AddLayer(LUI.FadeManager.new(arg_41_0._controllerIndex))
	end

	if not var_41_1 then
		arg_41_0.inWorldManager = arg_41_0:AddLayer(LUI.InWorldManager.new(arg_41_0._controllerIndex))
		arg_41_0.hudManager = arg_41_0:AddLayer(LUI.HudManager.new({
			root = arg_41_0
		}))

		if var_41_2 then
			local var_41_8 = Dvar.DHEEJCCJBH("MOLPOSLOMO")
			local var_41_9 = var_41_8 == "br" and not CONDITIONS.IsLaze()

			if var_41_7 and not var_41_9 then
				arg_41_0.codcasterLayer = arg_41_0:AddLayer(LUI.CodcasterLayer.new(arg_41_0._controllerIndex), {
					exclusive = false
				})
			end

			arg_41_0.reportPlayerLayer = arg_41_0:AddLayer(LUI.ReportPlayerLayer.new(arg_41_0._controllerIndex), {
				exclusive = false
			})
			arg_41_0.loadingScreenManager = arg_41_0:AddLayer(LUI.LoadingScreenManager.new(arg_41_0._controllerIndex), {
				exclusive = false
			})

			if var_41_8 == "arm" then
				arg_41_0.tacOpsLayer = arg_41_0:AddLayer(LUI.TacOpsLayer.new(arg_41_0._controllerIndex), {
					exclusive = false
				})
			end

			arg_41_0.postGameManager = arg_41_0:AddLayer(LUI.PostGameManager.new(arg_41_0._controllerIndex), {
				priority = var_0_0.POST_GAME
			})

			if var_41_9 then
				arg_41_0.squadEliminatedLayer = arg_41_0:AddLayer(LUI.SquadEliminatedLayer.new(arg_41_0._controllerIndex), {
					exclusive = false
				})

				if not Dvar.IBEGCHEFE("ui_disable_quick_inventory") then
					arg_41_0.brQuickInventoryLayer = arg_41_0:AddLayer(LUI.BRQuickInventoryLayer.new(arg_41_0._controllerIndex), {
						exclusive = false
					})
				end

				if CONDITIONS.IsBRTutorialMap() or CONDITIONS.IsBMTutorialMap() then
					arg_41_0.brTutorialEndGameFlowLayer = arg_41_0:AddLayer(LUI.BRTutorialEndGameFlowLayer.new(arg_41_0._controllerIndex), {
						exclusive = false
					})
				end
			end

			arg_41_0.scoreboardLayer = arg_41_0:AddLayer(LUI.ScoreboardLayer.new(arg_41_0._controllerIndex), {
				exclusive = false
			})
			arg_41_0.hostMigrationManager = arg_41_0:AddLayer(LUI.HostMigrationManager.new(), {
				exclusive = true,
				priority = var_0_0.HOST_MIGRATION
			})

			if var_41_5 then
				arg_41_0.gunsmithDebug = arg_41_0:AddLayer(LUI.GunsmithDebug.new(arg_41_0._controllerIndex))
			end
		end

		if Engine.CAADCDEEIA() then
			arg_41_0.binkSkipPromptLayer = arg_41_0:AddLayer(LUI.BinkSkipPromptLayer.new(arg_41_0._controllerIndex), {
				exclusive = false
			})
			arg_41_0.Snakecam = arg_41_0:AddLayer(LUI.Snakecam.new(arg_41_0._controllerIndex), {
				exclusive = false
			})
		end
	end

	if not var_41_1 and var_41_2 and Dvar.DHEEJCCJBH("MOLPOSLOMO") == "br" and not CONDITIONS.IsLaze() then
		arg_41_0.brTransitionManager = arg_41_0:AddLayer(LUI.BrTransitionManager.new(arg_41_0._controllerIndex))
	end

	arg_41_0.flowManager = arg_41_0:AddLayer(LUI.FlowManager.new(arg_41_0, arg_41_1))

	if not var_41_1 and not CONDITIONS.IsThirdGameMode() then
		arg_41_0.subtitlesLayer = arg_41_0:AddLayer(LUI.SubtitlesLayer.new(arg_41_0._controllerIndex), {
			exclusive = false
		})
	end

	if Engine.CIEGIACHAE() and not var_41_1 then
		arg_41_0.ps4LightbarManager = arg_41_0:AddLayer(LUI.PS4LightbarManager.new(arg_41_0._controllerIndex))
	end

	if not var_41_1 and var_41_2 then
		arg_41_0.radialMenuLayer = arg_41_0:AddLayer(LUI.RadialMenuLayer.new(arg_41_0._controllerIndex), {
			exclusive = false
		})
	end

	if var_41_3 and not var_41_1 and not GameX.IsSplitscreen() and Dvar.DHEEJCCJBH("NSQLTTMRMP") == "cp_town" then
		arg_41_0.townIntro = arg_41_0:AddLayer(LUI.TownIntro.new(arg_41_0._controllerIndex), {
			exclusive = false
		})
	end

	if var_41_3 and not var_41_1 and not CONDITIONS.IsWaveGameType() and not CONDITIONS.IsSpecOpsGameType() then
		arg_41_0.dpadPopupLayer = arg_41_0:AddLayer(LUI.DpadPopupLayer.new(arg_41_0._controllerIndex), {
			exclusive = false
		})
		arg_41_0.birdsEyeLayer = arg_41_0:AddLayer(LUI.BirdsEyeLayer.new(arg_41_0._controllerIndex), {
			exclusive = false
		})

		if Dvar.DHEEJCCJBH("NSQLTTMRMP") == "cp_raid_complex" then
			arg_41_0.timedUseMeterLayer = arg_41_0:AddLayer(LUI.TimedUseMeterLayer.new(arg_41_0._controllerIndex), {
				exclusive = false
			})
		end
	end

	local var_41_10 = (var_41_6 or var_41_1 or var_41_2 or var_41_3) and Dvar.IBEGCHEFE("LKSKPKTOON") and not CONDITIONS.IsSplitscreen()

	var_41_10 = var_41_10 and not CONDITIONS.IsLaunchChunk()

	if var_41_10 then
		arg_41_0.textChat = arg_41_0:AddLayer(LUI.TextChat.new({
			controllerIndex = var_41_0
		}))
	end

	if var_41_4 then
		arg_41_0.fadeFrameLayer = arg_41_0:AddLayer(LUI.AspectRatioFadeFrameLayer.new(arg_41_0._controllerIndex))
	end

	if var_41_1 or var_41_2 then
		arg_41_0.uiFadeManager = arg_41_0:AddLayer(LUI.UIFadeManager.new(arg_41_0._controllerIndex))
	end

	if var_41_1 then
		local var_41_11 = MenuBuilder.BuildRegisteredType("BuildAndServerText")

		arg_41_0:addElement(var_41_11)
	elseif var_41_7 and not IsSystemLink() and not Dvar.IBEGCHEFE("LMKKMPMOSO") and not Dvar.IBEGCHEFE("lui_footage_capture_enabled") then
		arg_41_0:addElement(MenuBuilder.BuildRegisteredType("MatchID"))
	end

	if var_41_4 or var_41_5 then
		local var_41_12 = LUI.UIElement.new()

		var_41_12:SetupFPSCounter()
		var_41_12:SetAlignment(LUI.Alignment.Right)
		var_41_12:SetRGBFromTable(SWATCHES.genericButton.highlight, 0)
		var_41_12:SetAnchorsAndPosition(1, 0, 0, 1, _1080p * -510, _1080p * -10, _1080p * 10, _1080p * 48)
		var_41_12:SetFont(FONTS.GetFont(FONTS.MainRegular.File))
		var_41_12:SetFontSize(38 * _1080p)
		var_41_12:SetWordWrap(false)

		var_41_12.id = "FPSCounter"

		arg_41_0:addElement(var_41_12)
	end

	if var_41_5 then
		local var_41_13 = MenuBuilder.BuildRegisteredType("DataSourceDebug", {
			controllerIndex = var_41_0
		})

		arg_41_0:addElement(var_41_13)
	end

	if CONDITIONS.IsLaunchChunk() then
		arg_41_0.launchChunk = arg_41_0:AddLayer(LUI.LaunchChunkLayer.new({
			controllerIndex = var_41_0
		}))
	end

	arg_41_0.toastManager = arg_41_0:AddLayer(LUI.ToastManager.new({
		controllerIndex = var_41_0
	}))

	if var_41_4 then
		if var_41_6 or Engine.ECAJCAJJGF() or CONDITIONS.IsLazeOrOutrun() then
			arg_41_0.telemetryLayer = arg_41_0:AddLayer(LUI.TelemetryLayer.new({
				controllerIndex = var_41_0
			}))

			if not CONDITIONS.IsLazeOrOutrun() then
				arg_41_0.achievementsManager = arg_41_0:AddLayer(LUI.AchievementsManager.new({
					controllerIndex = var_41_0
				}))
			end
		end
		...
		if var_41_1 then
			arg_41_0.clearCacheLayer = arg_41_0:AddLayer(LUI.ClearCacheLayer.new({
				controllerIndex = var_41_0
			}))

			if ShaderUpload then
				arg_41_0.shaderPreloadLayer = arg_41_0:AddLayer(LUI.ShaderPreloadLayer.new({
					controllerIndex = var_41_0
				}))
			end
		end
	...
	arg_41_0.mouseCursorTooltipLayer = arg_41_0:AddLayer(LUI.MouseCursorTooltipLayer.new({
		controllerIndex = var_41_0
	}))
	arg_41_0.mouseCursorContextualMenuLayer = arg_41_0:AddLayer(LUI.MouseCursorContextualMenuLayer.new({
		controllerIndex = var_41_0
	}))

	if var_41_1 then
		arg_41_0.webviewManager = arg_41_0:AddLayer(LUI.WebViewManager.new({
			controllerIndex = var_41_0
		}))

		arg_41_0.webviewManager:PostInit()
	end

	arg_41_0.debugLayer = arg_41_0:AddLayer(LUI.DebugLayer.new({
		controllerIndex = var_41_0
	}))

	if var_41_5 then
		arg_41_0.uiDebugLayer = arg_41_0:AddLayer(LUI.UIDebugLayer.new({
			controllerIndex = var_41_0
		}))
	end
end
...
function LUI.UIRoot.ReloadChatForDebugOption()
	...
	if var_42_0.textChat then
		var_42_0:RemoveElement(var_42_0.textChat)

		var_42_0.textChat = nil
	end

	if Dvar.IBEGCHEFE("LKSKPKTOON") then
		var_42_0.textChat = var_42_0:AddLayer(LUI.TextChat.new({
			controllerIndex = var_42_0._controllerIndex or Engine.IJEBHJIJF()
		}))
	end
end

function LUI.UIRoot.GetControllerIndex(arg_43_0)
	return arg_43_0._controllerIndex
end

function LUI.UIRoot.GetRootFromName(arg_44_0)
	local var_44_0 = LUI.roots[arg_44_0]
...
function LUI.UIRoot.GetRootForControllerIndex(arg_45_0)
	for iter_45_0, iter_45_1 in pairs(LUI.roots) do
		if iter_45_1._controllerIndex == arg_45_0 then
			return iter_45_1
		end
	end
...
function LUI.UIRoot.UpdateClansNotificationHandler(arg_46_0, arg_46_1, arg_46_2)
	local var_46_0 = arg_46_1 == CoD.PlayMode.Core

	if var_46_0 and arg_46_1 ~= arg_46_2 then
		arg_46_0:registerEventHandler(CLANS.CLAN_EVENTS.NOTIFICATION, LUI.UIRoot.ClanNotification)
	elseif not isClanUIEnabled or not var_46_0 then
		arg_46_0:registerEventHandler(CLANS.CLAN_EVENTS.NOTIFICATION, nil)
	end
end

function LUI.UIRoot.RefreshSocialMenu(arg_47_0)
	if Engine.DDJFBBJAIG() and CONDITIONS.IsMenuInStack("SocialMenu") then
		LUI.FlowManager.RequestRestoreMenu("SocialMenu", true, arg_47_0)
		LUI.FlowManager.RequestLeaveMenuByName("SocialMenu", true, true)
		LUI.FlowManager.RequestAddMenu("SocialMenu", true, arg_47_0, false, nil, true)
	end
end

function LUI.UIRoot.ClanNotification(arg_48_0, arg_48_1)
	local var_48_0 = arg_48_1.options
	local var_48_1 = var_48_0.controllerIndex
	local var_48_2 = var_48_0.clanTag or ""
	local var_48_3 = var_48_0.clanName or ""
	local var_48_4 = Engine.CBBHFCGDIC("CLANS/NAME_AND_TAG", Engine.JCBDICCAH(var_48_2), Engine.JCBDICCAH(var_48_3))

	if CONDITIONS.IsClanUIEnabled() then
		if var_48_0.genEventName == CLANS.CLAN_EVENTS.ACTIVE_CLAN_CHANGE then
			local var_48_5 = var_48_0.clanId
		elseif var_48_0.genEventName == CLANS.CLAN_EVENTS.LEFT_CLAN_ACTIVE then
			CLANS.RemoveClanCosmetics(var_48_1)
			CLANS.DispatchClanNotification(arg_48_0, Engine.CBBHFCGDIC("CLANS/CLAN_LEFT"), var_48_4)
			LUI.UIRoot.RefreshSocialMenu(var_48_1)
		elseif var_48_0.genEventName == CLANS.CLAN_EVENTS.DELETED then
			CLANS.RemoveClanCosmetics(var_48_1)
			CLANS.DispatchClanNotification(arg_48_0, Engine.CBBHFCGDIC("CLANS/CLAN_DISBANDED"), var_48_4)
			LUI.UIRoot.RefreshSocialMenu(var_48_1)
		elseif var_48_0.genEventName == CLANS.CLAN_EVENTS.INITIALIZED or var_48_0.genEventName == CLANS.CLAN_EVENTS.KICKED then
			LUI.FlowManager.RequestLeaveMenuByName("ClanPreviewScreen", false, true)
			LUI.UIRoot.RefreshSocialMenu(var_48_1)
			CLANS.RemoveClanCosmetics(var_48_1)

			local var_48_6 = var_48_0.genEventName == CLANS.CLAN_EVENTS.INITIALIZED and "CLANS/JOINING_CLAN" or "CLANS/KICKED"

			CLANS.DispatchClanNotification(arg_48_0, Engine.CBBHFCGDIC(var_48_6), var_48_4)
			LUI.UIRoot.RefreshSocialMenu(var_48_1)
		elseif var_48_0.genEventName == CLANS.CLAN_EVENTS.CREATED then
			CLANS.DispatchClanNotification(arg_48_0, Engine.CBBHFCGDIC("CLANS/CREATED_CLAN"), var_48_4)
			LUI.UIRoot.RefreshSocialMenu(var_48_1)
		elseif var_48_0.genEventName == CLANS.CLAN_EVENTS.TAG_UPDATED then
			if Engine.DIHDIGEBJF(var_48_1) == ClanTagType.OFFICIAL then
				Engine.GGIHFEAGD(var_48_1, ClanTagType.OFFICIAL)
			end
		elseif var_48_0.genEventName == CLANS.CLAN_EVENTS.INVITE_RECEIVED then
			if Engine.DDJFBBJAIG() then
				CLANS.DispatchClanNotification(arg_48_0, Engine.CBBHFCGDIC("CLANS/INVITE_RECEIVED"), "")
			end
		elseif var_48_0.genEventName == CLANS.CLAN_EVENTS.INVITE_SENT then
			if Engine.DDJFBBJAIG() then
				CLANS.DispatchClanNotification(arg_48_0, Engine.CBBHFCGDIC("LUA_MENU/CLAN_INVITE_SENT"), "")
			end
		else
			local var_48_7 = CLANS.GetRoleChangeEventData(var_48_0.genEventName)

			if var_48_7 then
				CLANS.DispatchClanNotification(arg_48_0, var_48_7.header, var_48_7.description)
			end

			if CLANS.IsRemoveCosmeticsEvent(var_48_0.genEventName) then
				CLANS.RemoveClanCosmetics(var_48_1)
			end
		end
	elseif CLANS.IsRemoveCosmeticsEvent(var_48_0.genEventName) then
		CLANS.RemoveClanCosmetics(var_48_1)
	end
end
