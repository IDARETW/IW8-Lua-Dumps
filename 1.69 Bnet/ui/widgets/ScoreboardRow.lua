...
local function var_0_24(arg_14_0)
	...
	return {
		...
		isCrossplayPlayer = arg_14_0._isCrossplayPlayer,
...
local function var_0_30(arg_24_0, arg_24_1, arg_24_2)
	assert(arg_24_2.fullNameWithHash or arg_24_2.name)

	local var_24_0 = arg_24_2.fullNameWithHash or arg_24_2.name

	if CONDITIONS.InGame() and not CONDITIONS.IsLaunchChunk() and CONDITIONS.IsDisplayNameTag() and Game.DDHAAEGIEI(arg_24_0._controllerIndex) and arg_24_2.fullNameWithHash and #arg_24_2.fullNameWithHash > 0 then
		var_24_0 = arg_24_2.fullNameWithHash
	end
...
local function var_0_31(arg_25_0, arg_25_1, arg_25_2)
	...
	if var_25_1 then
		...
		if arg_25_0._isCurrentPlayer then
			var_25_2 = PROGRESSION.GetPlayerProgressionData({
				_controllerIndex = arg_25_1
			})
		else
			local var_25_3
			local var_25_4

			if CONDITIONS.IsThirdGameMode() and not SCOREBOARD.IsAARScoreboard() then
				var_25_3 = Game.BDHJABHDDC(arg_25_0._clientNum)
				var_25_4 = Game.DJEIFEHACJ(arg_25_0._clientNum)
			else
				var_25_3 = arg_25_2.rank
				var_25_4 = arg_25_2.prestige
			end

			var_25_3 = var_25_3 or PROGRESSION.FIRST_VALID_RANK

			local var_25_5 = PROGRESSION.ValidatePrestigeLevel(var_25_4, {
				_isBackendPrestigeLevel = true
			})

			var_25_2 = PROGRESSION.GetPlayerProgressionData({
				_combinedRankNum = var_25_3,
				_prestigeLevel = var_25_5
			})
		end

		var_25_0 = var_25_2._rankIcon
		arg_25_0._isElder = var_25_2._isUsingSeasonalRank

		arg_25_0.scoreboardRow:SetFieldAndPosition(var_0_8, var_25_2._rankDisplay, var_0_6 * _1080p, LUI.Alignment.Center)
...
function RefreshRowContent(arg_28_0, arg_28_1, arg_28_2)
	...
	local var_28_0 = arg_28_0._controllerIndex
	local var_28_1 = SCOREBOARD.IsAARScoreboard()
	local var_28_2

	if arg_28_0._row ~= nil then
		if var_28_1 then
			var_28_2 = PostMatch.DGCJIFGJBD(arg_28_0._controllerIndex, arg_28_0._team)

			if not var_28_2 then
				return
			end

			var_28_2 = var_28_2[arg_28_0._row]
		else
			var_28_2 = var_0_14(arg_28_0, var_28_0)
		end
	end

	if var_28_2 then
		if CONDITIONS.IsDevelopmentBuild() then
			SCOREBOARD.PrintDebugRowDataString(var_28_2)
		end

		arg_28_0._clientNum = var_28_2.clientNum
		arg_28_0._name = var_28_2.fullNameWithHash or var_28_2.name

		if CONDITIONS.IsCoreMultiplayer() then
			arg_28_0._isBot = var_28_2.isBot or false
		elseif CONDITIONS.IsThirdGameMode() then
			arg_28_0._isBot = false
		end

		arg_28_0._xuid = var_28_2.xuid
		...
		if CONDITIONS.IsCoreMultiplayer() and (arg_28_0._gameType == MP.GameMode.HardpointGameType or arg_28_0._gameType == MP.GameMode.TDefGameType or arg_28_0._gameType == MP.GameMode.InfectGameType or arg_28_0._gameType == MP.GameMode.GrndGameType) then
			assert(var_28_2.extraScore0)

			var_28_2.extraScore0 = string.format("%.1d:%.2d", math.floor(var_28_2.extraScore0 / 60 % 60), var_28_2.extraScore0 % 60)
		end

		assert(var_28_2)
		assert(var_28_2.clientNum or var_28_1)
		assert(var_28_2.xuid or not var_28_1)

		arg_28_0._isCrossplayPlayer = var_28_2.isCrossplayPlayer
		arg_28_0._xuid = var_28_2.xuid
		...
		if CONDITIONS.IsCoreMultiplayer() then
			if var_28_1 then
				if not (Engine.JEDFGECDJ() > 1) then
					arg_28_0._isCurrentPlayer = var_28_2.isMe
				else
					arg_28_0._localClientNum = var_28_2.localClientNum and var_28_2.localClientNum or -1
					arg_28_0._isCurrentPlayer = var_28_2.localClientNum ~= -1
				end
			else
				arg_28_0._clientNum = var_28_2.clientNum and var_28_2.clientNum or -1
				arg_28_0._isCurrentPlayer = arg_28_0._clientNum == Game.DBACJGFHDD(arg_28_0._controllerIndex)
			end
		elseif CONDITIONS.IsThirdGameMode() then
			arg_28_0._clientNum = var_28_2.clientNum and var_28_2.clientNum or -1
			arg_28_0._isCurrentPlayer = not var_28_1 and arg_28_0._clientNum == Game.DBACJGFHDD()
		end
		...
		if not Engine.DDJFBBJAIG() and CONDITIONS.IsArenaGameType() then
			...
			var_28_4 = var_28_6 + 345 + 35

			local var_28_7 = 85

			var_28_5[1] = var_28_4 + var_28_7
			var_28_5[2] = var_28_5[1] + var_28_7
			var_28_5[3] = var_28_5[2] + var_28_7
			var_28_5[4] = var_28_5[3] + var_28_7

			local var_28_8 = 32
			local var_28_9 = var_28_6 + 285

			arg_28_0.scoreboardRow:SetImagePosition(SCOREBOARD.RowImageType.DEATH, _1080p * var_28_9, _1080p * (var_28_9 + var_28_8), _1080p * -16, _1080p * 16)
		end

		if CONDITIONS.IsCoreMultiplayer() then
			assert(var_28_2.kills)
			assert(var_28_2.deaths)

			var_28_2.kdRatio = SCOREBOARD.CalculateKillDeathRatio(var_28_2.kills, var_28_2.deaths)
		end

		local var_28_10

		if not MLG.IsCDLActive(var_28_0) then
			var_28_10 = var_0_31(arg_28_0, var_28_0, var_28_2)
		end

		var_0_30(arg_28_0, var_28_0, var_28_2)
		var_0_29(arg_28_0, var_28_0, var_28_2)
		var_0_26(arg_28_0, var_28_0, var_28_2)
		var_0_25(arg_28_0, var_28_0, var_28_2, var_28_5)

		if CONDITIONS.IsCoreMultiplayer() then
			assert(var_28_2.score)

			local var_28_11 = string.format("%d", var_28_2.score)

			arg_28_0.scoreboardRow:SetFieldAndPosition(var_0_10, var_28_11, var_28_4 * _1080p, LUI.Alignment.Center)
			var_0_32(arg_28_0, var_28_0, var_28_2, var_28_5)
			var_0_28(arg_28_0, var_28_0, var_28_2, var_28_10)
		...
		elseif CONDITIONS.IsThirdGameMode() then
			assert(var_28_2.kills)
			assert(var_28_2.revives)
			assert(var_28_2.downs)

			if var_28_2.kills then
				arg_28_0.scoreboardRow:SetFieldAndPosition(3, string.format("%d", var_28_2.kills), 592 * _1080p, LUI.Alignment.Center)
			end

			if var_28_2.revives then
				arg_28_0.scoreboardRow:SetFieldAndPosition(4, string.format("%d", var_28_2.revives), 717 * _1080p, LUI.Alignment.Center)
			end

			if var_28_2.downs then
				arg_28_0.scoreboardRow:SetFieldAndPosition(5, string.format("%d", var_28_2.downs), 832 * _1080p, LUI.Alignment.Center)
			end
		end
	end
...
function PostLoadFunc(arg_31_0, arg_31_1, arg_31_2)
	...
	arg_31_0.bindButton:addEventHandler("button_left", function(arg_33_0, arg_33_1)
		if arg_33_1.qualifier == "dpad" and (#arg_33_0:getParent():getAllFocusedChildren() > 0 or arg_33_0:getParent():isInFocus()) then
			if not arg_31_0._isCrossplayPlayer and (Engine.HDGDBCJFG() or Engine.EAABDHIDFJ()) and not CONDITIONS.IsSystemLink(arg_31_0) and arg_31_0._isBot == false then
				...
				elseif var_33_0 and not Engine.DDJFBBJAIG() and arg_31_0._xuid then
	...
	arg_31_0:addEventHandler("button_over", function(arg_35_0, arg_35_1)
		...
		if var_35_1 ~= nil then
			...
			if arg_31_0._isBot == true then
				...
				local var_35_4 = Engine.EAABDHIDFJ() and (LUI.IsLastInputGamepad(arg_31_1) or CONDITIONS.IsGamepadEnabled()) or not Engine.CGABICJHAI()

				if not arg_31_0._isCrossplayPlayer and not CONDITIONS.IsSystemLink(arg_31_0) and var_35_4 and not Engine.DDJFBBJAIG() then
					local var_35_5 = "right"

					if not Engine.DDJFBBJAIG() then
						var_35_5 = Engine.EAIICIFIFA() and not LUI.PostGameManager.IsPostGame(arg_31_1) and "left" or "right"
					end
				...
				if SCOREBOARD.IsAARScoreboard() then
					var_35_7 = Lobby.BBDICGHE()
				elseif arg_31_0._clientNum ~= nil then
					var_35_8 = Game.CJHJAFIEFF(arg_31_0._clientNum)
				end

				if var_35_3 ~= true and var_35_7 == true and var_35_8 == true and not Engine.DDJFBBJAIG() then
					var_35_0:AddButtonHelperTextToElement(var_35_1, {
						priority = 2,
						ignoreTooltip = true,
				...
				elseif var_35_3 ~= true and var_35_7 == true and var_35_8 == true and Engine.DDJFBBJAIG() and not SCOREBOARD.IsAARScoreboard() then
					var_35_0:AddButtonHelperTextToElement(var_35_1, {
						side = "left",
						priority = 2,
						ignoreTooltip = true,
		...
		local var_35_9 = LUI.DataSourceInGlobalModel.new("alwaysLoaded.activeParty.members.maxCount"):GetValue(arg_31_1)
	...
	arg_31_0.bindButton:addEventHandler("button_right_stick", function(arg_37_0, arg_37_1)
		if LUI.IsLastInputGamepad(arg_31_1) then
			if arg_31_0:isInFocus() and not Engine.DDJFBBJAIG() and arg_31_0._isBot == false and not arg_31_0._isCurrentPlayer then
...
function ScoreboardRow(arg_40_0, arg_40_1)
	...
	var_40_17:SetRGBFromTable(SWATCHES.HUD.enemyTeam, 0)
