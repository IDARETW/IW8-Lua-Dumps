...
function AARContentHeader(arg_2_0, arg_2_1)
	...
	var_2_6:SetAnchorsAndPosition(0, 0, 0.5, 0.5, 0, 0, _1080p * -12, _1080p * 12)
	...
	var_2_6:RegisterAnimationSequence("LeftAligned", var_2_29)

	local function var_2_30()
		var_2_6:AnimateSequence("LeftAligned")
	end

	var_2_0._sequences.LeftAligned = var_2_30
	...
	var_2_6:RegisterAnimationSequence("ARLeftAligned", var_2_32)

	local function var_2_33()
		var_2_6:AnimateSequence("ARLeftAligned")
	end

	var_2_0._sequences.ARLeftAligned = var_2_33
	...
	var_2_6:RegisterAnimationSequence("WideTextAdjustment", var_2_35)

	local function var_2_36()
		var_2_6:AnimateSequence("WideTextAdjustment")
	end

	var_2_0._sequences.WideTextAdjustment = var_2_36
