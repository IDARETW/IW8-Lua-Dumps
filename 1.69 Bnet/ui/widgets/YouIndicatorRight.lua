...
local function var_0_2(arg_1_0)
	...
	arg_1_0.Point:SetLeft(arg_1_0.Point:GetCurrentAnchorsAndPositions().right - var_1_0)
end
...
function YouIndicatorRight(arg_4_0, arg_4_1)
	local var_4_0 = LUI.UIElement.new()

	var_4_0:SetAnchorsAndPosition(0, 1, 0, 1, 0, 75 * _1080p, 0, 30 * _1080p)

	var_4_0.id = "YouIndicatorRight"
	...
	var_4_4:SetAnchorsAndPosition(1, 0, 0.5, 0.5, _1080p * -48, 0, _1080p * -13, _1080p * 13)
	...
	var_4_6:SetAnchorsAndPosition(1, 0, 0, 1, _1080p * -47, _1080p * -17, _1080p * 3, _1080p * 25)
	...
	var_4_4:RegisterAnimationSequence("Rectangle", var_4_13)
	...
	var_4_6:RegisterAnimationSequence("Rectangle", var_4_14)

	local function var_4_15()
		var_4_4:AnimateSequence("Rectangle")
		var_4_6:AnimateSequence("Rectangle")
	end

	var_4_0._sequences.Rectangle = var_4_15
