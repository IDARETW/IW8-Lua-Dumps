...
local function var_0_0(arg_1_0, arg_1_1, arg_1_2)
	...
	arg_1_0:addEventHandler("mouseleave", function(arg_3_0, arg_3_1)
		if not arg_3_0.sliderArea.slider.mouseWheelTarget:IsPositionInside(arg_3_1.x, arg_3_1.y) then
...
function VerticalScrollbar(arg_4_0, arg_4_1)
	local var_4_0 = LUI.UIElement.new()

	var_4_0:SetAnchorsAndPosition(0, 1, 0, 1, 0, 11 * _1080p, 0, 400 * _1080p)

	var_4_0.id = "VerticalScrollbar"
	...
	local var_4_3
	local var_4_4 = MenuBuilder.BuildRegisteredType("VerticalScrollbarSliderArea", {
