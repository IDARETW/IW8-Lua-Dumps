...
local function var_0_0(arg_1_0, arg_1_1)
	...
	if var_1_0 and var_1_0 > -1 then
		...
		arg_1_0.RarityIcon:setImage(RegisterMaterial(LOOT.GetRarityImage(var_1_0)))
		arg_1_0.QualityText:setText(var_1_2)
		arg_1_0.QualityText:SetRGBFromTable(var_1_1)
		LOOT.ApplyRarityIconColoring(arg_1_0.RarityIcon, var_1_0)
	else
		arg_1_0:SetAlpha(0)
	end
end
...
function QualityWithText(arg_4_0, arg_4_1)
	...
	var_4_4:SetRGBFromTable(SWATCHES.HUD.disabled, 0)
