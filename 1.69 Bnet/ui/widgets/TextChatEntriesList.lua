...
local function var_0_0(arg_1_0, arg_1_1, arg_1_2)
	...
	local function var_1_2(arg_13_0, arg_13_1)
		...
		local var_13_9 = LUI.TextChat.GetMessagesFadeOutTimeInMs(arg_13_0, arg_1_1)
		local var_13_10 = -1

		if var_13_9 ~= -1 then
			var_13_10 = arg_13_1 and (arg_13_0.chatInUse == nil or arg_13_0.chatInUse == false) and Engine.BFBIDEGDFB() + var_13_9
		end

		local var_13_11

		if not arg_13_0.localPlayer or var_13_3 then
			local var_13_12, var_13_13, var_13_14, var_13_15 = GetTextDimensions(var_13_2, arg_1_0._messagesFont, arg_1_0._messageLineHeight)

			var_13_11 = var_13_14 - var_13_12
		end
	...
	function arg_1_0.resetMessagesFadeTimerOnNewMessage(arg_20_0)
		if arg_20_0.ShouldSetFadeTimers() and #arg_20_0.chatMessages > 0 then
			for iter_20_0, iter_20_1 in ipairs(arg_20_0.chatMessages) do
				local var_20_0 = {
					localPlayer = false,
					chatType = iter_20_1.chatType
				}

				if Engine.BFBIDEGDFB() < iter_20_1.startFadeTime then
					local var_20_1 = LUI.TextChat.GetMessagesFadeOutTimeInMs(var_20_0, arg_1_1)
					local var_20_2 = -1

					if var_20_1 ~= -1 then
						var_20_2 = Engine.BFBIDEGDFB() + var_20_1
					end

					iter_20_1.startFadeTime = var_20_2
				end
			end
		end
	end

	function arg_1_0.redisplayMessages(arg_21_0)
		arg_21_0:ScrollListToEnd()

		for iter_21_0, iter_21_1 in ipairs(arg_21_0.chatMessages) do
			iter_21_1.startFadeTime = -1
		end

		local var_21_0 = arg_21_0.messagesGrid:getFirstChild()

		while var_21_0 do
			if var_21_0.NameHighlight.currentMessageIndex then
				ACTIONS.AnimateSequence(var_21_0, "FadeIn")
			end

			var_21_0 = var_21_0:getNextSibling()
		end
	end

	function arg_1_0.SetScrollbarWantedVisibility(arg_22_0)
		if arg_1_0._scrollbarVisibility == arg_22_0 then
			return
		end
		...
		arg_1_0._scrollbarVisibility = arg_22_0
	end

	arg_1_0:SetHandleMouseMove(true)
	arg_1_0:addEventHandler("mouseenter", function(arg_23_0, arg_23_1)
		if not arg_23_0._scrollbarVisibility then
			ACTIONS.AnimateSequence(arg_1_0, "ShowScrollbar")
		end
	end)
	arg_1_0:addEventHandler("mouseleave", function(arg_24_0, arg_24_1)
		if not arg_24_0._scrollbarVisibility then
			ACTIONS.AnimateSequence(arg_1_0, "HideScrollbar")
		end
	end)
	arg_1_0:registerEventHandler("gamepad_button", function(arg_25_0, arg_25_1)
		if arg_25_1.qualifier and arg_25_1.qualifier == "gamepad" and (arg_25_1.button == "up" or arg_25_1.button == "down") then
			arg_25_1.qualifier = "mousewheel"
			arg_25_1.forceScrollMove = true

			arg_25_0.messagesGrid:processEvent(arg_25_1)
...
function TextChatEntriesList(arg_26_0, arg_26_1)
	local var_26_0 = LUI.UIElement.new()

	var_26_0:SetAnchorsAndPosition(0, 1, 0, 1, 0, 515 * _1080p, 0, 160 * _1080p)

	var_26_0.id = "TextChatEntriesList"
	...
	var_26_0:setUseStencil(true)

	local var_26_3
	local var_26_4 = MenuBuilder.BuildRegisteredType("VerticalMinimalScrollbar", {
		controllerIndex = var_26_1
	})

	var_26_4.id = "MessagesVerticalScrollbar"

	var_26_4:SetAnchorsAndPosition(1, 0, 0, 0, _1080p * -10, _1080p * 5, _1080p * 1, _1080p * -4)
	var_26_0:addElement(var_26_4)

	var_26_0.MessagesVerticalScrollbar = var_26_4

	local function var_26_5()
		return
	end

	var_26_0._sequences.DefaultSequence = var_26_5
	...
	var_26_4:RegisterAnimationSequence("HideScrollbar", var_26_6)

	local function var_26_7()
		var_26_4:AnimateSequence("HideScrollbar")
	end

	var_26_0._sequences.HideScrollbar = var_26_7
	...
	var_26_4:RegisterAnimationSequence("ShowScrollbar", var_26_8)

	local function var_26_9()
		var_26_4:AnimateSequence("ShowScrollbar")
	end

	var_26_0._sequences.ShowScrollbar = var_26_9

	var_0_0(var_26_0, var_26_1, arg_26_1)
