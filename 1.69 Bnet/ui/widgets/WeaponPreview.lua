...
local function var_0_4(arg_2_0, arg_2_1)
	...
	local var_2_0 = arg_2_1.storePreviewItemType
	local var_2_1 = var_2_0 == LOOT.itemTypes.WEAPON and arg_2_1.weaponTable.lootID or LOOT.GetItemID(var_2_0, arg_2_1.itemRef)
	local var_2_2 = LOOT.GetItemClassName(var_2_0, arg_2_1.itemRef)

	if arg_2_1.itemRef and (var_2_0 == LOOT.itemTypes.WATCH or var_2_0 == LOOT.itemTypes.CHARM) then
		local var_2_3 = arg_2_1.storeFlavor
		local var_2_4 = Engine.CBBHFCGDIC(var_2_3)

		if var_2_4 ~= var_2_3 then
			arg_2_0.FlavorText:setText(var_2_4)
		end
	end
	...
	if var_2_2 and #var_2_2 > 0 then
		arg_2_0.ItemType:setText(var_2_2)
	end

	local var_2_5 = LOOT.GetItemQuality(var_2_0, arg_2_1.itemRef, var_2_1)

	arg_2_0.ItemQuality:UpdateQualityText(var_2_5)
	Engine.EBHIFJCGBH("set_ui_rarity_image", var_2_5 and var_2_5 + 1 or 0)

	arg_2_0._isWeaponCosmetic = var_2_0 == LOOT.itemTypes.CHARM or var_2_0 == LOOT.itemTypes.STICKER
	...
	arg_2_0:addEventHandler("menu_create", function(arg_3_0, arg_3_1)
		...
		if Loot.DEBEIFJEEG(arg_2_0._controllerIndex, var_2_1) > 0 then
...
local function var_0_6(arg_5_0, arg_5_1, arg_5_2)
	arg_5_0:addEventHandler("menu_close", function()
		if arg_5_0.WeaponRotator and arg_5_0._isWeapon then
			local var_6_0 = arg_5_0.weaponModel:GetCurrentOffsetsAndRotations()
	...
	arg_5_0.bindButton:addEventHandler("button_secondary", function(arg_7_0, arg_7_1)
		if not arg_5_0._previewSceneForWeaponCosmetic then
			...
			local var_7_0 = arg_5_0.weaponModel:GetCurrentOffsetsAndRotations()
...
local function var_0_7(arg_11_0, arg_11_1, arg_11_2)
	...
	if arg_11_2.isStorePreview then
		if arg_11_2.storePreviewItemType == LOOT.itemTypes.CHARM or arg_11_2.storePreviewItemType == LOOT.itemTypes.STICKER then
			...
			local var_11_1 = arg_11_2.storePreviewItemType == LOOT.itemTypes.CHARM and LOOT.itemTypes.CHARM or LOOT.itemTypes.STICKER
			local var_11_2 = LOOT.GetItemID(var_11_1, arg_11_2.itemRef)
			local var_11_3 = LOOT.GetBaseWeaponItemID(arg_11_2.weaponTable.weapon)

			if not LOOT.ItemIDsMatchGameSourceIDs(var_11_2, var_11_3) then
				local var_11_4 = "s4_ar_stango44"
				local var_11_5 = LOOT.GetBaseWeaponItemID(var_11_4)

				arg_11_2.weaponTable = WEAPON.GenerateWeaponTableFromID(arg_11_1, var_11_5)

				if var_11_1 == LOOT.itemTypes.CHARM then
					arg_11_2.weaponTable.cosmeticAttachment = arg_11_2.itemRef
				else
					arg_11_2.weaponTable.stickers = {
						arg_11_2.itemRef,
						arg_11_2.itemRef,
						arg_11_2.itemRef,
						arg_11_2.itemRef
		...
		elseif arg_11_2.storePreviewItemType == LOOT.itemTypes.CAMO then
			local var_11_6 = LOOT.GetItemID(LOOT.itemTypes.CAMO, arg_11_2.itemRef)
			local var_11_7 = LOOT.GetBaseWeaponItemID(arg_11_2.weaponTable.weapon)

			if not LOOT.ItemIDsMatchGameSourceIDs(var_11_6, var_11_7) then
				local var_11_8 = "s4_ar_stango44"
				local var_11_9 = LOOT.GetBaseWeaponItemID(var_11_8)

				arg_11_2.weaponTable = WEAPON.GenerateWeaponTableFromID(arg_11_1, var_11_9)
				arg_11_2.weaponTable.camo = arg_11_2.itemRef
			else
	...
	if arg_11_2.weaponTable then
		...
		local function var_11_10(arg_12_0, arg_12_1, arg_12_2)
			return function()
				...
				WEAPON.SetModelIfLoaded(arg_12_1, arg_12_0.weaponModel, arg_12_0.weaponModelName, {
					...
					modelWeaponTable = arg_12_0.weaponTable
				})
			end
		end
		...
		arg_11_0.weaponID = arg_11_2.weaponTable.lootID
		arg_11_0.weaponTable = arg_11_2.weaponTable

		arg_11_0.WeaponName:setText(WEAPON.GetName(arg_11_0.weaponRef, {
			dataTable = arg_11_0.weaponTable
		}))
		...
		local var_11_11 = LOOT.GetBaseWeaponItemID(arg_11_0.weaponRef)

		if var_11_11 then
			local var_11_12 = LUI.GetAnimForGameSource(LOOT.GetGameSourceIDFromItemID(var_11_11))

			ACTIONS.AnimateSequence(arg_11_0, var_11_12)
			ACTIONS.AnimateSequence(arg_11_0.SnipeIcon, var_11_12)
		end

		WEAPON.SetPreviewSceneForWeapon(arg_11_0.weaponRef)
		MenuUtils.SetupSceneChangeCallback(arg_11_0, var_11_10(arg_11_0, arg_11_1, arg_11_2))
		ACTIONS.AnimateSequence(arg_11_0, "ShowSnipeAndName")
	elseif arg_11_2.watchRef then
		arg_11_0.PreviewControlsLegend:SetupLegend(arg_11_0, LOOT.itemTypes.WATCH)

		local function var_11_13(arg_15_0, arg_15_1, arg_15_2)
			return function()
				local function var_16_0()
					ClientWeapon.BHDGACCFEF(FrontEndScene.ClientWeapons.Preview, true)
					ClientWeapon.CFJGGIAEJF(FrontEndScene.ClientWeapons.Preview, true)

					if arg_15_2.watchRef == "accessory098" then
						ClientWeapon.BIJBFGJAHF(FrontEndScene.ClientWeapons.Preview, "vfx/iw8_mp/watches/vfx_mp_holo_watch.vfx", "tag_watch_fx")
					elseif arg_15_2.watchRef == "accessory106" then
						ClientWeapon.BIJBFGJAHF(FrontEndScene.ClientWeapons.Preview, "vfx/iw8_mp/watches/vfx_mp_holo_watch_orange.vfx", "tag_watch_fx")
					elseif arg_15_2.watchRef == "accessoryt9116" then
						ClientWeapon.BIJBFGJAHF(FrontEndScene.ClientWeapons.Preview, "vfx/iw8_mp/watches/vfx_mp_holo_watch_red.vfx", "tag_watch_fx")
					elseif arg_15_2.watchRef == "accessoryt9126" then
						ClientWeapon.BIJBFGJAHF(FrontEndScene.ClientWeapons.Preview, "vfx/iw8_mp/watches/vfx_mp_holo_watch.vfx", "tag_watch_fx")
					elseif arg_15_2.watchRef == "accessoryt9201" then
						ClientWeapon.BIJBFGJAHF(FrontEndScene.ClientWeapons.Preview, "vfx/iw8_mp/watches/vfx_mp_holo_watch_red.vfx", "tag_watch_fx")
					end
		...
		MenuUtils.SetupSceneChangeCallback(arg_11_0, var_11_13(arg_11_0, arg_11_1, arg_11_2))
		ACTIONS.AnimateSequence(arg_11_0, "HideSnipeAndName")
	else
	...
	if CONDITIONS.IsMagmaGameMode() then
		ACTIONS.AnimateSequence(arg_11_0, "WZSetup")
	end
end
...
function WeaponPreview(arg_18_0, arg_18_1)
	...
	local var_18_24
	local var_18_25 = MenuBuilder.BuildRegisteredType("WZWeaponButtonSnipeIcon", {
		controllerIndex = var_18_1
	})

	var_18_25.id = "SnipeIcon"

	var_18_25:SetAlpha(0, 0)
	var_18_25:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 95, _1080p * 186, _1080p * 94, _1080p * 142)
	var_18_0:addElement(var_18_25)

	var_18_0.SnipeIcon = var_18_25

	local var_18_26
	local var_18_27 = LUI.UIStyledText.new()

	var_18_27.id = "WeaponName"

	var_18_27:SetRGBFromTable(SWATCHES.WZGlobalSwatches.WZText, 0)
	var_18_27:SetAlpha(0, 0)
	var_18_27:setText("", 0)
	var_18_27:SetFont(FONTS.GetFont(FONTS.MainRegular.File))
	var_18_27:SetWordWrap(false)
	var_18_27:SetAlignment(LUI.Alignment.Left)
	var_18_27:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 201, _1080p * 1755, _1080p * 94, _1080p * 142)
	var_18_0:addElement(var_18_27)

	var_18_0.WeaponName = var_18_27

	local function var_18_28()
		return
	end

	var_18_0._sequences.DefaultSequence = var_18_28
	...
	var_18_8:RegisterAnimationSequence("ControlsHidden", var_18_30)

	local function var_18_31()
		var_18_8:AnimateSequence("ControlsHidden")
	end

	var_18_0._sequences.ControlsHidden = var_18_31
	...
	var_18_4:RegisterAnimationSequence("FadeIn", var_18_33)

	local function var_18_34()
		var_18_4:AnimateSequence("FadeIn")
	end

	var_18_0._sequences.FadeIn = var_18_34
	...
	var_18_6:RegisterAnimationSequence("FromStore", var_18_36)
	...
	var_18_8:RegisterAnimationSequence("FromStore", var_18_37)
	...
	var_18_10:RegisterAnimationSequence("FromStore", var_18_38)
	...
	var_18_12:RegisterAnimationSequence("FromStore", var_18_39)
	...
	var_18_14:RegisterAnimationSequence("FromStore", var_18_40)
	...
	var_18_16:RegisterAnimationSequence("FromStore", var_18_41)
	...
	var_18_0._sequences.FromStore = var_18_42
	...
	var_18_25:RegisterAnimationSequence("VG", var_18_44)
	...
	var_18_27:RegisterAnimationSequence("VG", var_18_45)

	local function var_18_46()
		var_18_25:AnimateSequence("VG")
		var_18_27:AnimateSequence("VG")
	end

	var_18_0._sequences.VG = var_18_46
	...
	var_18_25:RegisterAnimationSequence("MW", var_18_48)
	...
	var_18_27:RegisterAnimationSequence("MW", var_18_49)

	local function var_18_50()
		var_18_25:AnimateSequence("MW")
		var_18_27:AnimateSequence("MW")
	end

	var_18_0._sequences.MW = var_18_50
	...
	var_18_25:RegisterAnimationSequence("CW", var_18_52)
	...
	var_18_27:RegisterAnimationSequence("CW", var_18_53)

	local function var_18_54()
		var_18_25:AnimateSequence("CW")
		var_18_27:AnimateSequence("CW")
	end

	var_18_0._sequences.CW = var_18_54
	...
	var_18_25:RegisterAnimationSequence("ShowSnipeAndName", var_18_56)
	...
	var_18_27:RegisterAnimationSequence("ShowSnipeAndName", var_18_57)

	local function var_18_58()
		var_18_25:AnimateSequence("ShowSnipeAndName")
		var_18_27:AnimateSequence("ShowSnipeAndName")
	end

	var_18_0._sequences.ShowSnipeAndName = var_18_58
	...
	var_18_25:RegisterAnimationSequence("HideSnipeAndName", var_18_60)
	...
	var_18_27:RegisterAnimationSequence("HideSnipeAndName", var_18_61)

	local function var_18_62()
		var_18_25:AnimateSequence("HideSnipeAndName")
		var_18_27:AnimateSequence("HideSnipeAndName")
	end

	var_18_0._sequences.HideSnipeAndName = var_18_62
	...
	var_18_12:RegisterAnimationSequence("WZSetup", var_18_64)

	local function var_18_65()
		var_18_12:AnimateSequence("WZSetup")
	end

	var_18_0._sequences.WZSetup = var_18_65
