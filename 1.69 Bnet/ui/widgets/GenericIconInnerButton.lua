...
local function var_0_0(arg_1_0, arg_1_1, arg_1_2)
	local var_1_0 = WZWIP.CheckForApplyPrependWZWipPrefix("GainFocus", CONDITIONS.IsWZWipDvarEnabled())
	local var_1_1 = WZWIP.CheckForApplyPrependWZWipPrefix("LoseFocus", CONDITIONS.IsWZWipDvarEnabled())
	...
	arg_1_0:addEventHandler("active", function(arg_5_0, arg_5_1)
		WZWIP.AnimateThemeElement(arg_5_0, "Active")
	end)
	...
	arg_1_0:addEventHandler("button_active", function(arg_7_0, arg_7_1)
		WZWIP.AnimateThemeElement(arg_7_0, "ButtonUpActive")
	end)
...
function GenericIconInnerButton(arg_8_0, arg_8_1)
	...
	var_8_6:RegisterAnimationSequence("WZWipButtonOver", var_8_41)
	...
	var_8_6:RegisterAnimationSequence("WZWipSetup", var_8_44)

	local function var_8_45()
		var_8_6:AnimateSequence("WZWipSetup")
	end

	var_8_0._sequences.WZWipSetup = var_8_45
	...
	var_8_6:RegisterAnimationSequence("WZWipButtonOverActive", var_8_47)

	local function var_8_48()
		var_8_6:AnimateSequence("WZWipButtonOverActive")
	end

	var_8_0._sequences.WZWipButtonOverActive = var_8_48
	...
	var_8_6:RegisterAnimationSequence("WZWipButtonUp", var_8_50)

	local function var_8_51()
		var_8_6:AnimateSequence("WZWipButtonUp")
	end

	var_8_0._sequences.WZWipButtonUp = var_8_51
	...
	var_8_6:RegisterAnimationSequence("WZWipDown", var_8_53)

	local function var_8_54()
		var_8_6:AnimateSequence("WZWipDown")
	end

	var_8_0._sequences.WZWipDown = var_8_54
	...
	var_8_6:RegisterAnimationSequence("WZWipUp", var_8_56)

	local function var_8_57()
		var_8_6:AnimateSequence("WZWipUp")
	end

	var_8_0._sequences.WZWipUp = var_8_57

	local function var_8_58()
		return
	end

	var_8_0._sequences.WZWipLoseFocus = var_8_58
