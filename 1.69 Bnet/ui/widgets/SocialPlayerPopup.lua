...
local function var_0_1(arg_1_0)
	...
	if arg_1_0._playerData.platformId and arg_1_0._playerData.selectedTab then
		var_1_0 = Friends.CCBABDAGGJ(arg_1_0._playerData.controllerIndex, arg_1_0._playerData.xuid, arg_1_0._playerData.platformId, arg_1_0._playerData.selectedTab)
	end

	if var_1_0 and not var_1_0.isValidEntry then
		LUI.FlowManager.RequestLeaveMenu(arg_1_0, true)

		return
	end

	arg_1_0._playerData.background = var_1_0 and var_1_0.background
	arg_1_0._playerData.presence = var_1_0 and var_1_0.presence
	arg_1_0._playerData.presencePlatform = var_1_0 and var_1_0.presencePlatform
	arg_1_0._playerData.inputType = var_1_0 and var_1_0.inputType
	arg_1_0._playerData.isMuted = var_1_0 and var_1_0.isMuted

	if Engine.CHDGBEFDHB() and Friends.DIIAFCGBDA(arg_1_0._playerData.controllerIndex, arg_1_0._playerData.xuid, arg_1_0._playerData.platformId or "0") then
		arg_1_0._playerData.presencePlatform = PresencePlatform.STEAM
	end
	...
	if arg_1_0._playerData.selectedTab == FRIENDS.TabIDs.PRIVATE_PARTY then
		arg_1_0.MuteStatusIcon:SetAlpha(1)
		arg_1_0.MuteStatusIcon:setImage(RegisterMaterial(arg_1_0._playerData.isMuted and "icon_mic_muted" or "icon_mic_on"))
	else
		arg_1_0.MuteStatusIcon:SetAlpha(0)
	end
...
local function var_0_2(arg_3_0, arg_3_1, arg_3_2)
	...
	if Engine.CHDGBEFDHB() or Engine.EAABDHIDFJ() then
		arg_3_0.MenuTitle:SetTitle(ToUpperCase(arg_3_2.crossplayGamertag or arg_3_2.fullName))
	else
		arg_3_0.MenuTitle:SetTitle(ToUpperCase(arg_3_2.fullName or arg_3_2.name))
	end
...
function SocialPlayerPopup(arg_5_0, arg_5_1)
	...
	var_5_14.id = "MuteStatusIcon"

	var_5_14:SetRGBFromTable(SWATCHES.genericMenu.mainTitle, 0)
	var_5_14:setImage(RegisterMaterial("icon_mic_muted"), 0)
	var_5_14:SetAnchorsAndPosition(1, 0, 0.5, 0.5, _1080p * -216, _1080p * -184, _1080p * -348, _1080p * -316)
	var_5_0:addElement(var_5_14)

	var_5_0.MuteStatusIcon = var_5_14
	...
	var_5_10:RegisterAnimationSequence("AR", var_5_17)
	...
	var_5_12:RegisterAnimationSequence("AR", var_5_18)
	...
	var_5_0._sequences.AR = var_5_19
