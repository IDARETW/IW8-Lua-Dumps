...
local function var_0_8(arg_11_0, arg_11_1, arg_11_2)
	...
	if CONDITIONS.IsFifthWheelActive() then
		local var_11_2 = CONDITIONS.IsLaze() and arg_11_2.isOnline and arg_11_2.presence ~= Engine.CBBHFCGDIC("XBOXLIVE/OFFLINE")

		if not arg_11_2.isOnline or var_11_2 then
			ACTIONS.AnimateSequence(arg_11_0, "OfflinePlayer")
		else
			ACTIONS.AnimateSequence(arg_11_0, "OnlinePlayer")
		end
	else
