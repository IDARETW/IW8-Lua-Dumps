...
local function var_0_0(arg_1_0, arg_1_1)
	...
	local var_1_1 = arg_1_1.fullName or arg_1_1.name

	if arg_1_0.FullName:getText() ~= var_1_1 then
		arg_1_0.FullName:setText(var_1_1)
	end

	if arg_1_1.emblemIndex ~= nil then
		local var_1_2 = EmblemEditorUtils.GetEmblemImageFromID(arg_1_1.emblemIndex)

		arg_1_0.Emblem:setImage(RegisterMaterial(var_1_2))
	end

	if arg_1_1.presencePlatform then
		arg_1_0.PlatformPresence:SetAtviFriend(arg_1_1.isAtviFriend)
	...
	elseif arg_1_1.baseRank and arg_1_1.prestige then
		local var_1_3 = arg_1_1.baseRank
		local var_1_4 = PROGRESSION.ValidatePrestigeLevel(arg_1_1.prestige, {
			_isBackendPrestigeLevel = true
		})
		local var_1_5 = PROGRESSION.GetPlayerProgressionData({
			_combinedRankNum = var_1_3,
			_prestigeLevel = var_1_4
		})
		local var_1_6 = var_1_5._rankIcon

		if var_1_6 and #var_1_6 > 0 then
			arg_1_0.RankIcon:SetAlpha(1)
			arg_1_0.RankIcon:setImage(RegisterMaterial(var_1_6))
		end

		arg_1_0.RankNumber:SetAlpha(1)
		arg_1_0.RankNumber:setText(var_1_5._rankDisplay)
	else
		arg_1_0.RankIcon:SetAlpha(0)
		arg_1_0.RankNumber:SetAlpha(0)
	end
