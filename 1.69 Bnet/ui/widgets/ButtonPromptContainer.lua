...
function ButtonPromptContainer(arg_2_0, arg_2_1)
	...
	if CONDITIONS.AlwaysFalse() then
		...
		var_2_3:SetRGBFromTable(SWATCHES.WZGlobalSwatches.WZText, 0)
	...
	if CONDITIONS.AlwaysFalse() then
		...
		var_2_3:RegisterAnimationSequence("AR", var_2_6)
	end
	...
	if CONDITIONS.AlwaysFalse() then
		...
		var_2_3:RegisterAnimationSequence("JP", var_2_9)
	end

	local function var_2_10()
		if CONDITIONS.AlwaysFalse() then
			var_2_3:AnimateSequence("JP")
		end
	end
