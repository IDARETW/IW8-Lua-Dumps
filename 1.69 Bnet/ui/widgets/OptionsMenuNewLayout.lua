...
local function var_0_32(arg_32_0, arg_32_1, arg_32_2)
	if arg_32_2 and not arg_32_0.NetworkInfoWidget and not arg_32_0.ConnectionMeter and not CONDITIONS.IsSplitscreen() and not CONDITIONS.IsStreamingFromCloud() then
		local var_32_0
		...
		if iter_45_3.visible == nil or iter_45_3.visible then
			table.insert(var_45_7, {
				...
				focusFunction = function(arg_47_0, arg_47_1, arg_47_2, arg_47_3)
					...
					if not Engine.CAADCDEEIA() and not CONDITIONS.IsStreamingFromCloud() then
					...
					if not CONDITIONS.IsStreamingFromCloud() then
...
function OptionsMenuNewLayout(arg_109_0, arg_109_1)
	...
	if Engine.CGABICJHAI() and not CONDITIONS.IsStreamingFromCloud() then
