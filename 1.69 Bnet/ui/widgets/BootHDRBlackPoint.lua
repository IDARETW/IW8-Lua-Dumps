...
function BootHDRBlackPoint(arg_9_0, arg_9_1)
	local var_9_0 = LUI.UIVerticalNavigator.new()

	var_9_0.id = "BootHDRBlackPoint"
	...
	local var_9_5
	local var_9_6 = MenuBuilder.BuildRegisteredType("HDRBlackPointGuide", {
		controllerIndex = var_9_1
	})

	var_9_6.id = "HDRBlackPointGuide"

	var_9_6:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 585, _1080p * 1335, _1080p * 365, _1080p * 615)
	var_9_0:addElement(var_9_6)

	var_9_0.HDRBlackPointGuide = var_9_6
	...
	var_9_8:SetRGBFromTable(SWATCHES.genericMenu.bodycopy, 0)
	var_9_8:setText(Engine.CBBHFCGDIC("MENU/HDR_CALIBRATION_DESC"), 0)
	var_9_8:SetFont(FONTS.GetFont(FONTS.MainRegular.File))
	var_9_8:SetAlignment(LUI.Alignment.Center)
	var_9_8:SetAnchorsAndPosition(0.5, 0.5, 0, 1, _1080p * -500, _1080p * 500, _1080p * 744, _1080p * 768)
	var_9_0:addElement(var_9_8)

	var_9_0.HelpText = var_9_8
	...
	var_9_10:setText(Engine.CBBHFCGDIC("MENU/HDR_BLACK_POINT"), 0)
	...
	local var_9_11
	local var_9_12 = MenuBuilder.BuildRegisteredType("GenericButton", {
		controllerIndex = var_9_1
	})

	var_9_12.id = "Continue"

	var_9_12.Text:SetLeft(_1080p * 20, 0)
	var_9_12.Text:setText(Engine.CBBHFCGDIC("MENU/CONTINUE"), 0)
	var_9_12.Text:SetAlignment(LUI.Alignment.Center)
	var_9_12:SetAnchorsAndPosition(0.5, 0.5, 0, 1, _1080p * -188, _1080p * 172, _1080p * 903, _1080p * 941)
	var_9_0:addElement(var_9_12)

	var_9_0.Continue = var_9_12
	...
	var_9_14:SetRGBFromTable(SWATCHES.genericMenu.bodycopy, 0)
	var_9_14:setText("", 0)
	var_9_14:SetFont(FONTS.GetFont(FONTS.MainRegular.File))
	var_9_14:SetAlignment(LUI.Alignment.Center)
	var_9_14:SetVerticalAlignment(LUI.Alignment.Center)
	var_9_14:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 885, _1080p * 1035, _1080p * 230, _1080p * 254)
	var_9_0:addElement(var_9_14)

	var_9_0.Step = var_9_14
	...
	var_9_6:RegisterAnimationSequence("Splitscreen", var_9_25)
	...
	var_9_8:RegisterAnimationSequence("Splitscreen", var_9_26)
	...
	var_9_10:RegisterAnimationSequence("Splitscreen", var_9_27)
	...
	var_9_12:RegisterAnimationSequence("Splitscreen", var_9_28)
	...
	var_9_14:RegisterAnimationSequence("Splitscreen", var_9_29)
	...
	var_9_16:RegisterAnimationSequence("Splitscreen", var_9_30)
	...
	var_9_18:RegisterAnimationSequence("Splitscreen", var_9_31)
	...
	var_9_20:RegisterAnimationSequence("Splitscreen", var_9_32)

	local function var_9_33()
		var_9_6:AnimateSequence("Splitscreen")
		var_9_8:AnimateSequence("Splitscreen")
		var_9_10:AnimateSequence("Splitscreen")
		var_9_12:AnimateSequence("Splitscreen")
		var_9_14:AnimateSequence("Splitscreen")
		var_9_16:AnimateSequence("Splitscreen")
		var_9_18:AnimateSequence("Splitscreen")
		var_9_20:AnimateSequence("Splitscreen")
	end

	var_9_0._sequences.Splitscreen = var_9_33
