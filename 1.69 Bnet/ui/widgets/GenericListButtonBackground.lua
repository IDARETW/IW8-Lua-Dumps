...
local function var_0_2(arg_3_0)
	...
	arg_3_0.Gradient:SetRGBFromTable(SWATCHES.itemRarity.quality3, 0)
	arg_3_0.Gradient:SetAnchorsAndPosition(0, 0, 0, 0, 0, 20 * _1080p, 0, 0, 0)
	arg_3_0.Gradient:SetAlpha(0.2, 400, LUI.EASING.inQuartic)
	arg_3_0.Gradient:SetRGBFromTable(SWATCHES.itemRarity.quality3, 400, LUI.EASING.inQuartic)
...
function GenericListButtonBackground(arg_16_0, arg_16_1)
	...
	var_16_6:SetRGBFromTable(SWATCHES.splashNotifications.splashAlternativeColor1Dark, 0)
	...
	var_16_8:SetRGBFromTable(SWATCHES.HUD.warning, 0)
	...
	var_16_10:SetRGBFromTable(SWATCHES.HUD.warning, 0)
	...
	var_16_12:SetRGBFromTable(SWATCHES.HUD.warning, 0)
	...
	var_16_16:SetRGBFromTable(SWATCHES.Reticles.Highlight, 0)
