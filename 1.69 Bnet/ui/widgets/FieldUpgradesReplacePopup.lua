...
function FieldUpgradesReplacePopup(arg_7_0, arg_7_1)
	...
	var_7_6.PopupBackground:SetAlpha(0.85, 0)
	...
	var_7_14:RegisterAnimationSequence("Splitscreen", var_7_36)

	local function var_7_37()
		var_7_6:AnimateSequence("Splitscreen")
		var_7_14:AnimateSequence("Splitscreen")
	end

	var_7_0._sequences.Splitscreen = var_7_37
	...
	local var_7_38 = LUI.UIBindButton.new()

	var_7_38.id = "selfBindButton"

	var_7_0:addElement(var_7_38)

	var_7_0.bindButton = var_7_38
