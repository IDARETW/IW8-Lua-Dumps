...
local function var_0_1(arg_2_0, arg_2_1, arg_2_2)
	...
	arg_2_0.MenuLayout:SetRefreshChildFuncByTab(FRIENDS.TabIDs.RECENT_SQUAD_PLAYERS)
	arg_2_0.MenuLayout:UpdateNoFriends(0)
	arg_2_0.MenuLayout.NoFriendsLabel:setText(Engine.CBBHFCGDIC("LUA_MENU/NO_RECENT_SQUADS"))
	arg_2_0.MenuLayout:SetPlayerGridWrapping(nil, false)
end

function SocialSquadMenu(arg_3_0, arg_3_1)
	local var_3_0 = LUI.UIElement.new()

	var_3_0.id = "SocialSquadMenu"
