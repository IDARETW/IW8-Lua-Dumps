...
local function var_0_1(arg_1_0, arg_1_1, arg_1_2)
	...
	ACTIONS.AnimateSequence(var_1_0, arg_1_0._sourceMenu._tokenInputBlocked and "SetLocked" or "SetUnLocked")
...
local function var_0_2(arg_3_0, arg_3_1, arg_3_2)
	...
	if arg_3_2 and arg_3_2.isTokenTypeOperator then
		assert(var_3_0.SubHeader)
		var_3_0.SubHeader:setText(ToUpperCase(Engine.CBBHFCGDIC("LUA_MENU/VANGUARD_OPERATORS_ONLY")), 0)
		ACTIONS.AnimateSequence(var_3_0, "ShowSubHeaderDisclaimer")
	end
...
local function var_0_3(arg_4_0, arg_4_1, arg_4_2, arg_4_3)
	...
	elseif arg_4_2 == LOOT.doubleXpTypes.OPERATOR then
		var_4_0 = Engine.CBBHFCGDIC("LUA_MENU/OPERATOR_XPTOKEN")
		var_4_1 = true
	end

	arg_4_0.TokenGrid:AddElement(var_0_2(arg_4_1, var_4_0, {
		isTokenTypeOperator = var_4_1
	}))

	for iter_4_0, iter_4_1 in ipairs(arg_4_3) do
		local var_4_2 = var_0_1(arg_4_0, arg_4_1, iter_4_1)

		if var_4_1 then
			ACTIONS.AnimateSequence(var_4_2, "ShowVGSnipe")
		end

		arg_4_0.TokenGrid:AddElement(var_4_2)
	end
end
...
local function var_0_4(arg_5_0, arg_5_1)
	...
	var_5_1.id = "TokenGrid"

	var_5_1:setUseStencil(true)
	var_5_1:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 92, _1080p * 522, _1080p * 215, _1080p * 1015)
	arg_5_0:addElement(var_5_1)

	arg_5_0.TokenGrid = var_5_1

	local var_5_2
	local var_5_3 = MenuBuilder.BuildRegisteredType("VerticalMinimalScrollbar", {
		controllerIndex = arg_5_1
	})

	var_5_3.id = "VerticalMinimalScrollbar"

	var_5_3:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 532, _1080p * 543, _1080p * 215, _1080p * 1015)
	arg_5_0:addElement(var_5_3)

	arg_5_0.VerticalMinimalScrollbar = var_5_3

	local var_5_4 = LUI.UIScrollbar.new({
		direction = LUI.DIRECTION.vertical,
		eventListener = var_5_3,
		startCap = var_5_3.startCap,
		endCap = var_5_3.endCap,
		sliderArea = var_5_3.sliderArea,
		slider = var_5_3.sliderArea and var_5_3.sliderArea.slider,
		fixedSizeSlider = var_5_3.sliderArea and var_5_3.sliderArea.fixedSizeSlider
	})

	arg_5_0.TokenGrid:AddScrollbar(var_5_4)
end
...
local function var_0_6(arg_7_0, arg_7_1)
	...
	local var_7_1 = StringTable.BJJBBCJGEJ(CSV.consumablesIDs.file, CSV.consumablesIDs.cols.id, arg_7_0)

	var_7_0.XPName = Engine.CBBHFCGDIC(StringTable.CBGJCDIHCE(CSV.consumablesIDs.file, var_7_1, CSV.consumablesIDs.cols.name))
	var_7_0.ref = StringTable.CBGJCDIHCE(CSV.consumablesIDs.file, var_7_1, CSV.consumablesIDs.cols.ref)
	var_7_0.achievementID = StringTable.CBGJCDIHCE(CSV.consumablesIDs.file, var_7_1, CSV.consumablesIDs.cols.AE_ID)
	var_7_0.tokenCount = arg_7_1
	var_7_0.tokenAmount = Engine.CBBHFCGDIC("LUA_MENU_MP/RULES_MULTIPLIER", arg_7_1)
	var_7_0.image = StringTable.CBGJCDIHCE(CSV.consumablesIDs.file, var_7_1, CSV.consumablesIDs.cols.image)
	var_7_0.duration = Engine.CBBHFCGDIC(StringTable.CBGJCDIHCE(CSV.consumablesIDs.file, var_7_1, CSV.consumablesIDs.cols.duration))
	var_7_0.rarity = tonumber(StringTable.CBGJCDIHCE(CSV.consumablesIDs.file, var_7_1, CSV.consumablesIDs.cols.quality))
...
local function var_0_7(arg_8_0, arg_8_1)
	...
	table.sort(var_8_2, function(arg_9_0, arg_9_1)
		if arg_9_0.rarity and arg_9_1.rarity then
			if arg_9_0.rarity == arg_9_1.rarity then
				return tonumber(arg_9_0.achievementID) < tonumber(arg_9_1.achievementID)
			else
	...
	for iter_8_2, iter_8_3 in ipairs(var_8_2) do
		if iter_8_3.rarity == var_8_6 then
			local var_8_7 = var_8_5[#var_8_5]

			var_8_7.tokenCount = var_8_7.tokenCount + iter_8_3.tokenCount
			var_8_7.tokenAmount = Engine.CBBHFCGDIC("LUA_MENU_MP/RULES_MULTIPLIER", var_8_7.tokenCount)
		else
			table.insert(var_8_5, iter_8_3)

			var_8_6 = iter_8_3.rarity
		end
	end
...
local function var_0_9(arg_11_0, arg_11_1, arg_11_2)
	...
	arg_11_0.MenuTitle:SetTitle(ToUpperCase(Engine.CBBHFCGDIC("LUA_MENU/AVAILABLE_TOKENS")))
...
function TokenMenu(arg_14_0, arg_14_1)
	...
	var_14_4.MenuTitle:setText(ToUpperCase(Engine.CBBHFCGDIC("LUA_MENU/AVAILABLE_TOKENS")), 0)
	...
	var_14_10.id = "TimerWarningLabel"
	...
	var_14_0.TimerWarningLabel = var_14_10
	...
	local var_14_21 = {
		{
			...
			child = var_14_0.MenuTitle.MenuTitle
		}
	}

	var_14_4:RegisterAnimationSequence("WZWipSetup", var_14_21)
	...
	var_14_10:RegisterAnimationSequence("WZWipSetup", var_14_22)

	local function var_14_23()
		var_14_4:AnimateSequence("WZWipSetup")
		var_14_10:AnimateSequence("WZWipSetup")
	end

	var_14_0._sequences.WZWipSetup = var_14_23
