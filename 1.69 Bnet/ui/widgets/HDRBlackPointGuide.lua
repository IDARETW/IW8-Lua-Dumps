...
local function var_0_0(arg_1_0, arg_1_1)
	local var_1_0 = Dvar.BJJCJHDBII("LLTNTOTMMT") + arg_1_0.colorModifier
...
function PostLoadFunc(arg_2_0, arg_2_1, arg_2_2)
	...
	arg_2_0:SetAlpha(0)
	arg_2_0:addEventHandler("black_point_over", function(arg_3_0, arg_3_1)
		arg_2_0:SetAlpha(1)
		arg_2_0:dispatchEventToChildren({
			name = "calibration_updated"
		})
	end)
	arg_2_0:addEventHandler("black_point_up", function(arg_4_0, arg_4_1)
		arg_2_0:SetAlpha(0)
	end)
	arg_2_0:addEventHandler("black_point_updated", function(arg_5_0, arg_5_1)
		arg_2_0:dispatchEventToChildren({
			name = "calibration_updated"
		})
	end)
...
function HDRBlackPointGuide(arg_6_0, arg_6_1)
	local var_6_0 = LUI.UIElement.new()

	var_6_0:SetAnchorsAndPosition(0, 1, 0, 1, 0, 750 * _1080p, 0, 250 * _1080p)

	var_6_0.id = "HDRBlackPointGuide"
