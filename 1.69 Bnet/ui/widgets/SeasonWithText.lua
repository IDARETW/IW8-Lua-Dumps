...
local function var_0_0(arg_1_0, arg_1_1)
	...
	if var_1_0 then
		if var_1_0 > 0 then
			var_1_1 = SEASON.GetLocalizedSimpleName({
				seasonDataNumToUse = var_1_0
			})
	...
	arg_1_0.SeasonText:setText(var_1_1)
...
function SeasonWithText(arg_3_0, arg_3_1)
	...
	var_3_4:SetRGBFromTable(SWATCHES.HUD.disabled, 0)
	...
	var_3_6:RegisterAnimationSequence("WZWipSetup", var_3_14)
	...
	var_3_8:RegisterAnimationSequence("WZWipSetup", var_3_15)

	local function var_3_16()
		var_3_6:AnimateSequence("WZWipSetup")
		var_3_8:AnimateSequence("WZWipSetup")
	end

	var_3_0._sequences.WZWipSetup = var_3_16
