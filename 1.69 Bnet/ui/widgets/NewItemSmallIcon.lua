...
function NewItemSmallIcon(arg_5_0, arg_5_1)
	...
	if not CONDITIONS.IsWZWipDvarEnabled() then
		...
		var_5_3:SetRGBFromTable(SWATCHES.genericMenu.newIndicator, 0)
		var_5_3:SetPixelGridEnabled(true)
		var_5_3:SetPixelGridContrast(0.2, 0)
		var_5_3:SetPixelGridBlockWidth(1, 0)
		var_5_3:SetPixelGridBlockHeight(1, 0)
		var_5_3:SetPixelGridGutterWidth(1, 0)
		var_5_3:SetPixelGridGutterHeight(1, 0)
		var_5_3:setImage(RegisterMaterial("icon_new_pulse"), 0)
		var_5_3:SetAnchorsAndPosition(0, 0, 0, 0, _1080p * -10, _1080p * 10, _1080p * -10, _1080p * 10)
		var_5_0:addElement(var_5_3)

		var_5_0.DotImage = var_5_3
	end

	local var_5_4

	if CONDITIONS.IsWZWipDvarEnabled() then
		var_5_4 = LUI.UIImage.new()
		var_5_4.id = "WZWipDotImage"
	...
	if not CONDITIONS.IsWZWipDvarEnabled() then
		...
		var_5_3:RegisterAnimationSequence("DefaultSequence", var_5_6)
	end

	local function var_5_7()
		if not CONDITIONS.IsWZWipDvarEnabled() then
			var_5_3:AnimateSequence("DefaultSequence")
		end
	end
	...
	if not CONDITIONS.IsWZWipDvarEnabled() then
		...
		var_5_3:RegisterAnimationSequence("Store", var_5_9)
	end
	...
	if CONDITIONS.IsWZWipDvarEnabled() then
		...
		var_5_4:RegisterAnimationSequence("Store", var_5_10)
	end

	local function var_5_11()
		if not CONDITIONS.IsWZWipDvarEnabled() then
			var_5_3:AnimateSequence("Store")
		end
	...
	var_5_0._sequences.Store = var_5_11
