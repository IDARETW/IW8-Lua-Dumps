...
function TextChatFooter(arg_3_0, arg_3_1)
	...
	var_3_9:SetRGBFromTable(SWATCHES.WZGlobalSwatches.WZHighlight, 0)
	...
	var_3_9:RegisterAnimationSequence("DefaultSequence", var_3_11)

	local function var_3_12()
		var_3_9:AnimateSequence("DefaultSequence")
	end

	var_3_0._sequences.DefaultSequence = var_3_12
	...
	var_3_9:RegisterAnimationSequence("ChatActive", var_3_14)

	local function var_3_15()
		var_3_9:AnimateSequence("ChatActive")
	end

	var_3_0._sequences.ChatActive = var_3_15
	...
	var_3_9:RegisterAnimationSequence("GainFocus", var_3_17)

	local function var_3_18()
		var_3_9:AnimateSequence("GainFocus")
	end

	var_3_0._sequences.GainFocus = var_3_18
	...
	var_3_9:RegisterAnimationSequence("AutocompleteActive", var_3_20)

	local function var_3_21()
		var_3_9:AnimateSequence("AutocompleteActive")
	end

	var_3_0._sequences.AutocompleteActive = var_3_21
