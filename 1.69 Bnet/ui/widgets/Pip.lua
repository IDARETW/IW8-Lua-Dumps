	...
	arg_1_0:registerEventHandler("focus_tab", function(arg_5_0, arg_5_1)
		if arg_5_1.index == arg_5_0.index then
			if CONDITIONS.IsMagmaGameMode() then
				ACTIONS.AnimateSequence(arg_5_0, "WZHighlighted")
			else
...
function Pip(arg_6_0, arg_6_1)
	...
	var_6_4:RegisterAnimationSequence("Highlighted", var_6_7)

	local function var_6_8()
		var_6_4:AnimateSequence("Highlighted")
	end

	var_6_0._sequences.Highlighted = var_6_8
	...
	var_6_4:RegisterAnimationSequence("NotHighlighted", var_6_10)

	local function var_6_11()
		var_6_4:AnimateSequence("NotHighlighted")
	end

	var_6_0._sequences.NotHighlighted = var_6_11
	...
	var_6_4:RegisterAnimationSequence("Default", var_6_13)

	local function var_6_14()
		var_6_4:AnimateSequence("Default")
	end

	var_6_0._sequences.Default = var_6_14
	...
	var_6_4:RegisterAnimationSequence("NotDefault", var_6_16)

	local function var_6_17()
		var_6_4:AnimateSequence("NotDefault")
	end

	var_6_0._sequences.NotDefault = var_6_17
	...
	var_6_4:RegisterAnimationSequence("WZHighlighted", var_6_19)

	local function var_6_20()
		var_6_4:AnimateSequence("WZHighlighted")
	end

	var_6_0._sequences.WZHighlighted = var_6_20

	var_6_0:addEventHandler("scrollbar_pip_highlighted", function(arg_13_0, arg_13_1)
	...
	var_6_0:addEventHandler("scrollbar_pip_not_highlighted", function(arg_14_0, arg_14_1)
	...
	var_6_0:addEventHandler("scrollbar_pip_is_default", function(arg_15_0, arg_15_1)
	...
	var_6_0:addEventHandler("scrollbar_pip_is_not_default", function(arg_16_0, arg_16_1)
