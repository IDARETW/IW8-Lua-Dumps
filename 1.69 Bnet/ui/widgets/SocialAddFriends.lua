...
local function var_0_5(arg_7_0, arg_7_1, arg_7_2)
	...
	if arg_7_0.RecentPlayersGrid then
		...
		local function var_7_3(arg_15_0, arg_15_1)
			local var_15_0 = Engine.FHHBECDJA() and arg_15_0._playerData.presencePlatform == arg_15_0._currentPlatform
			local var_15_1 = (Engine.EAABDHIDFJ() or Engine.FJCIBEDII()) and Friends.DJGEFEAJCI(PresencePlatformToClientPlatform[arg_15_0._playerData.presencePlatform], PresencePlatformToClientPlatform[arg_15_0._currentPlatform])

			return (Engine.HDGDBCJFG() or Engine.EAABDHIDFJ()) and (var_15_0 or var_15_1)
		end
	...
	if Engine.HDGDBCJFG() then
		table.insert(var_7_6.buttons, var_7_5(arg_7_0, ClientPlatform.BNET, "LUA_MENU/FRIENDS_PC_OTHER_NAME", "LUA_MENU/PC_OTHER_NAME_FRIEND_SEARCH_HINT"))
	...
	elseif Engine.EAABDHIDFJ() then
		table.insert(var_7_6.buttons, var_7_5(arg_7_0, ClientPlatform.BNET, "LUA_MENU/FRIENDS_PC_OTHER_NAME", "LUA_MENU/PC_OTHER_NAME_FRIEND_SEARCH_HINT"))
		table.insert(var_7_6.buttons, var_7_5(arg_7_0, ClientPlatform.PS4, "LUA_MENU/OTHER_CONSOLE", "LUA_MENU/INVITE_ACCOUNT_NAME_HINT"))
		table.insert(var_7_6.buttons, var_7_5(arg_7_0, ClientPlatform.XBOX_ONE, "MSSTORE_PLATFORM/XBOX_GAMERTAG", "LUA_MENU/XB3_ADD_FRIEND_HINT"))
	else
		table.insert(var_7_6.buttons, var_7_5(arg_7_0, ClientPlatform.BNET, "LUA_MENU/FRIENDS_PC_OTHER_NAME", "LUA_MENU/PC_OTHER_NAME_FRIEND_SEARCH_HINT"))
		table.insert(var_7_6.buttons, var_7_5(arg_7_0, ClientPlatform.PS4, "LUA_MENU/GAMERTAG_LONG_PS4", "LUA_MENU/PS4_ADD_FRIEND_HINT"))
		table.insert(var_7_6.buttons, var_7_5(arg_7_0, ClientPlatform.XBOX_ONE, "LUA_MENU/GAMERTAG_LONG_XBONE", "LUA_MENU/XB3_ADD_FRIEND_HINT"))
