...
function GenericKeybindInnerButton(arg_6_0, arg_6_1)
	...
	var_6_0._sequences.ButtonOver = var_6_12
	...
	var_6_6:RegisterAnimationSequence("ButtonUp", var_6_14)

	local function var_6_15()
		var_6_6:AnimateSequence("ButtonUp")
	end

	var_6_0._sequences.ButtonUp = var_6_15
	...
	var_6_8:RegisterAnimationSequence("GainFocus", var_6_17)
	...
	var_6_8:RegisterAnimationSequence("LoseFocus", var_6_20)

	local function var_6_21()
		var_6_8:AnimateSequence("LoseFocus")
	end

	var_6_0._sequences.LoseFocus = var_6_21
	...
	var_6_6:RegisterAnimationSequence("NoLeftLine", var_6_23)

	local function var_6_24()
		var_6_6:AnimateSequence("NoLeftLine")
	end

	var_6_0._sequences.NoLeftLine = var_6_24

	local function var_6_25()
		return
	end

	var_6_0._sequences.ButtonUpActive = var_6_25

	local function var_6_26()
		return
	end

	var_6_0._sequences.ButtonOverActive = var_6_26

	local function var_6_27()
		return
	end

	var_6_0._sequences.Binding = var_6_27
	...
	var_6_8:RegisterAnimationSequence("BindingLoop", var_6_29)

	local function var_6_30()
		var_6_8:AnimateLoop("BindingLoop")
	end

	var_6_0._sequences.BindingLoop = var_6_30
	...
	var_6_8:RegisterAnimationSequence("BindingSuccess", var_6_32)

	local function var_6_33()
		var_6_8:AnimateSequence("BindingSuccess")
	end

	var_6_0._sequences.BindingSuccess = var_6_33
	...
	var_6_8:RegisterAnimationSequence("Empty", var_6_35)

	local function var_6_36()
		var_6_8:AnimateSequence("Empty")
	end

	var_6_0._sequences.Empty = var_6_36
	...
	var_6_8:RegisterAnimationSequence("ResetText", var_6_38)

	local function var_6_39()
		var_6_8:AnimateSequence("ResetText")
	end

	var_6_0._sequences.ResetText = var_6_39
	...
	var_6_6:RegisterAnimationSequence("AR", var_6_41)
	...
	var_6_0._sequences.AR = var_6_43
	...
	var_6_6:RegisterAnimationSequence("WZWipSetup", var_6_45)

	local function var_6_46()
		var_6_6:AnimateSequence("WZWipSetup")
	end

	var_6_0._sequences.WZWipSetup = var_6_46

	local function var_6_47()
		return
	end

	var_6_0._sequences.WZWipButtonOver = var_6_47

	var_6_0:addEventHandler("lose_focus", function(arg_23_0, arg_23_1)
	...
	var_6_0:addEventHandler("button_active", function(arg_24_0, arg_24_1)
	...
	var_6_0:addEventHandler("button_over_active", function(arg_25_0, arg_25_1)
		if not arg_25_1.controller then
			local var_25_0 = var_6_1
		end

		ACTIONS.AnimateSequence(var_6_0, "ButtonOverActive")
	end)
	var_6_0:addEventHandler("button_over", function(arg_26_0, arg_26_1)
		if not arg_26_1.controller then
			local var_26_0 = var_6_1
		end
