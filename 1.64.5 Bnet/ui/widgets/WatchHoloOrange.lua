...
local function var_0_1(arg_1_0, arg_1_1, arg_1_2)
	local var_1_0 = {
		digit = SWATCHES.Reticles.Orange,
		base = SWATCHES.Reticles.Orange
	}
	local var_1_1 = {
		arg_1_0.Digit1,
		arg_1_0.Digit2,
	...
	arg_1_0:registerOmnvarHandler("ui_pet_watch_state", function(arg_2_0)
		if Game.BFEEGCHICA(arg_1_1, "ui_pet_watch_state") ~= 0 then
			...
			arg_2_0.Colon:SetRGBFromInt(9262080, 0)
		end
	end)
...
function WatchHoloOrange(arg_5_0, arg_5_1)
	...
	var_5_12:SetRGBFromTable(SWATCHES.Reticles.Orange, 0)
...
MenuBuilder.registerType("WatchHoloOrange", WatchHoloOrange)
LockTable(_M)
