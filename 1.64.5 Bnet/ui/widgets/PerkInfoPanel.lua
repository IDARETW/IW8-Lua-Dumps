...
local function var_0_2(arg_3_0, arg_3_1)
	...
	if CONDITIONS.UsingWZLoadouts() and arg_3_1.weaponRef and arg_3_1.selected ~= nil then
		WEAPON.DisplaySnipeIconByWeaponRef(arg_3_0, arg_3_1.weaponRef, {
	...
	elseif arg_3_1.unlockThroughSeasonalEvent then
		arg_3_0.UnlockRequirements:SetAlpha(1, 300)
		arg_3_0.UnlockCriteria:SetAlpha(0)
		arg_3_0.UnlockRequirements:SetupSeasonalEvent(arg_3_1.unlockText)
	...
	if not arg_3_1.isUnlocked and (arg_3_1.challengeInfo or arg_3_1.unlockThroughSeasonalEvent) then
...
function PerkInfoPanel(arg_9_0, arg_9_1)
	...
	var_9_8:SetAnimMoveTime(1500)
	var_9_8:SetAnimMoveSpeed(1500)
	...
	var_9_8:SetAnchorsAndPosition(0, 0, 0, 1, _1080p * 34, _1080p * -127, _1080p * 16, _1080p * 52)
	...
	var_9_10:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 34, _1080p * 495, _1080p * 59, _1080p * 87)
	...
	if CONDITIONS.InFrontendOrWaveMode() then
		...
		var_9_13:SetAnchorsAndPosition(0, 1, 1, 0, _1080p * 34, _1080p * 495, _1080p * 4, _1080p * 28)
	...
	if CONDITIONS.InFrontendOrWaveMode() then
		...
		var_9_18:SetAnchorsAndPosition(0, 1, 1, 0, _1080p * 34, _1080p * 495, _1080p * 33, _1080p * 57)
	...
	local var_9_25
	local var_9_26 = MenuBuilder.BuildRegisteredType("WZWeaponButtonSnipeIcon", {
		controllerIndex = var_9_1
	})

	var_9_26.id = "SnipeIcon"

	var_9_26:SetScale(-0.1, 0)
	var_9_26:SetAnchorsAndPosition(1, 0, 0, 1, _1080p * -98, _1080p * -20, _1080p * 14, _1080p * 55)
	var_9_0:addElement(var_9_26)

	var_9_0.SnipeIcon = var_9_26

	local function var_9_27()
		return
	end

	var_9_0._sequences.DefaultSequence = var_9_27
	...
	var_9_8:RegisterAnimationSequence("AR", var_9_29)
	...
	var_9_10:RegisterAnimationSequence("AR", var_9_30)
	...
	if CONDITIONS.InFrontendOrWaveMode() then
		...
		var_9_13:RegisterAnimationSequence("AR", var_9_31)
	end
	...
	var_9_17:RegisterAnimationSequence("AR", var_9_32)
	...
	if CONDITIONS.InFrontendOrWaveMode() then
		...
		var_9_18:RegisterAnimationSequence("AR", var_9_33)
	end
	...
	var_9_26:RegisterAnimationSequence("AR", var_9_34)
	...
	local function var_9_35()
		...
		var_9_26:AnimateSequence("AR")
	end

	var_9_0._sequences.AR = var_9_35
	...
	var_9_8:RegisterAnimationSequence("WZSetup", var_9_37)
	...
	var_9_10:RegisterAnimationSequence("WZSetup", var_9_38)
	...
	if CONDITIONS.InFrontendOrWaveMode() then
		...
		var_9_13:RegisterAnimationSequence("WZSetup", var_9_39)
	end
	...
	if CONDITIONS.InFrontendOrWaveMode() then
		...
		var_9_18:RegisterAnimationSequence("WZSetup", var_9_40)
	end

	local function var_9_41()
		var_9_8:AnimateSequence("WZSetup")
		var_9_10:AnimateSequence("WZSetup")

		if CONDITIONS.InFrontendOrWaveMode() then
			var_9_13:AnimateSequence("WZSetup")
		end

		if CONDITIONS.InFrontendOrWaveMode() then
			var_9_18:AnimateSequence("WZSetup")
		end
	end

	var_9_0._sequences.WZSetup = var_9_41
	...
	var_9_26:RegisterAnimationSequence("VG", var_9_43)

	local function var_9_44()
		var_9_26:AnimateSequence("VG")
	end

	var_9_0._sequences.VG = var_9_44
	...
	var_9_26:RegisterAnimationSequence("CW", var_9_46)

	local function var_9_47()
		var_9_26:AnimateSequence("CW")
	end

	var_9_0._sequences.CW = var_9_47
	...
	var_9_26:RegisterAnimationSequence("MW", var_9_49)

	local function var_9_50()
		var_9_26:AnimateSequence("MW")
	end

	var_9_0._sequences.MW = var_9_50
	...
	var_9_26:RegisterAnimationSequence("CWAR", var_9_52)

	local function var_9_53()
		var_9_26:AnimateSequence("CWAR")
	end

	var_9_0._sequences.CWAR = var_9_53
	...
	var_9_26:RegisterAnimationSequence("MWAR", var_9_55)

	local function var_9_56()
		var_9_26:AnimateSequence("MWAR")
	end

	var_9_0._sequences.MWAR = var_9_56
	...
	var_9_26:RegisterAnimationSequence("VGAR", var_9_58)

	local function var_9_59()
		var_9_26:AnimateSequence("VGAR")
	end

	var_9_0._sequences.VGAR = var_9_59
