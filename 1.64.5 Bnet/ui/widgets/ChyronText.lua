...
function ChyronText(arg_7_0, arg_7_1)
	...
	var_7_6:RegisterAnimationSequence("CursorFlash", var_7_11)

	local function var_7_12()
		var_7_6:AnimateSequence("CursorFlash")
	end

	var_7_0._sequences.CursorFlash = var_7_12
	...
	var_7_4:RegisterAnimationSequence("DarkChyron", var_7_14)
	...
	var_7_6:RegisterAnimationSequence("DarkChyron", var_7_15)
	...
	var_7_8:RegisterAnimationSequence("DarkChyron", var_7_16)

	local function var_7_17()
		var_7_4:AnimateSequence("DarkChyron")
		var_7_6:AnimateSequence("DarkChyron")
		var_7_8:AnimateSequence("DarkChyron")
	end

	var_7_0._sequences.DarkChyron = var_7_17
