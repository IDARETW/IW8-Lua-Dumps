...
local function var_0_2(arg_3_0, arg_3_1, arg_3_2)
	...
	if Engine.CHDGBEFDHB() then
		local var_3_0 = Social.CFEIHAADEI(arg_3_2.platformId)
		local var_3_1 = arg_3_2.fullName or arg_3_2.name

		if var_3_0 then
			var_3_1 = var_3_0.fullName
		end

		arg_3_0.MenuTitle:SetTitle(var_3_1)
	else
