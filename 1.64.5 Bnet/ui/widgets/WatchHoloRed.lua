...
local function var_0_1(arg_1_0, arg_1_1, arg_1_2)
	...
	arg_1_0:registerOmnvarHandler("ui_pet_watch_state", function(arg_2_0)
		if Game.BFEEGCHICA(arg_1_1, "ui_pet_watch_state") ~= 0 then
			arg_2_0.Digit1:SetRGBFromInt(3684408)
			arg_2_0.Digit2:SetRGBFromInt(3684408)
			arg_2_0.Digit3:SetRGBFromInt(3684408)
			arg_2_0.Digit4:SetRGBFromInt(3684408)
			arg_2_0.Colon:SetRGBFromInt(4980736)
		end
	end)
...
function WatchHoloRed(arg_5_0, arg_5_1)
	...
	var_5_12:SetRGBFromTable(SWATCHES.Reticles.Red, 0)
