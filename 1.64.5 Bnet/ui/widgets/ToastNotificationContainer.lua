...
local function var_0_0(arg_1_0, arg_1_1)
	...
	if arg_1_1.icon then
		local var_1_0 = type(arg_1_1.icon) == "userdata" and arg_1_1.icon or RegisterMaterial(arg_1_1.icon)
...
local function var_0_1(arg_2_0, arg_2_1)
	...
	if arg_2_1.header then
		...
		elseif not arg_2_1.callback then
			...
			arg_2_0.ToastNotification:SetupButtonsTooltipData(arg_2_1)
	...
	if Engine.DBFFAEEFGJ().flowManager:IsStackEmpty() and not var_2_0 then
		arg_2_0.ToastNotification.MenuButtonLeft.Text:SetWordWrap(false)
		arg_2_0.ToastNotification.MenuButtonRight.Text:SetWordWrap(false)
...
function ToastNotificationContainer(arg_5_0, arg_5_1)
	...
	var_5_4:RegisterAnimationSequence("SlideInFromRight", var_5_7)

	local function var_5_8()
		var_5_4:AnimateSequence("SlideInFromRight")
	end

	var_5_0._sequences.SlideInFromRight = var_5_8
	...
	var_5_4:RegisterAnimationSequence("HideAll", var_5_10)

	local function var_5_11()
		var_5_4:AnimateSequence("HideAll")
	end

	var_5_0._sequences.HideAll = var_5_11
	...
	var_5_4:RegisterAnimationSequence("Reset", var_5_13)

	local function var_5_14()
		var_5_4:AnimateSequence("Reset")
	end

	var_5_0._sequences.Reset = var_5_14
	...
	var_5_4:RegisterAnimationSequence("WZWipSetup", var_5_16)

	local function var_5_17()
		var_5_4:AnimateSequence("WZWipSetup")
	end

	var_5_0._sequences.WZWipSetup = var_5_17
