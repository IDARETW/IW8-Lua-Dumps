...
function DiagonalCorners(arg_1_0, arg_1_1)
	...
	var_1_5:SetRGBFromTable(SWATCHES.CAC.border, 0)
	var_1_5:SetBorderThicknessRight(_1080p * 0, 0)
	var_1_5:SetBorderThicknessBottom(_1080p * 0, 0)
	var_1_5:SetAnchorsAndPosition(0, 1, 0, 1, 0, _1080p * 8, 0, _1080p * 8)
	...
	var_1_8.id = "LowerRight"

	var_1_8:SetRGBFromTable(SWATCHES.CAC.border, 0)
	var_1_8:SetBorderThicknessLeft(_1080p * 0, 0)
	var_1_8:SetBorderThicknessTop(_1080p * 0, 0)
	var_1_8:SetAnchorsAndPosition(1, 0, 1, 0, _1080p * -8, 0, _1080p * -8, 0)
	var_1_0:addElement(var_1_8)

	var_1_0.LowerRight = var_1_8
