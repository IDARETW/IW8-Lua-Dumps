...
function MenuRightArrow(arg_1_0, arg_1_1)
	...
	var_1_4:RegisterAnimationSequence("MovedRight", var_1_10)

	local function var_1_11()
		var_1_4:AnimateSequence("MovedRight")
	end

	var_1_0._sequences.MovedRight = var_1_11
	...
	var_1_4:RegisterAnimationSequence("NotBlockedStatic", var_1_12)

	local function var_1_13()
		var_1_4:AnimateSequence("NotBlockedStatic")
	end

	var_1_0._sequences.NotBlockedStatic = var_1_13

	var_1_0:addEventHandler("grid_focus_right_blocked", function(arg_7_0, arg_7_1)
	...
	var_1_0:addEventHandler("grid_focus_right_not_blocked", function(arg_8_0, arg_8_1)
	...
	var_1_0:addEventHandler("arrow_button_right_moved", function(arg_9_0, arg_9_1)
		if not arg_9_1.controller then
			local var_9_0 = var_1_1
		end

		ACTIONS.AnimateSequence(var_1_0, "MovedRight")
	end)
	var_1_0:addEventHandler("arrow_button_right_blocked", function(arg_10_0, arg_10_1)
	...
	var_1_0:addEventHandler("arrow_button_right_not_blocked", function(arg_11_0, arg_11_1)
