function LUI.AddEditBoxLogic(arg_1_0, arg_1_1, arg_1_2)
	...
	local var_1_3 = arg_1_2.isNumeric or arg_1_2.isNumericEmpty or false
	...
	assert(not var_1_3 or arg_1_2.max, "No maximum value set for numeric EditBox")
	assert(not var_1_3 or arg_1_2.max > arg_1_2.min, "Min > Max for numeric EditBox.")
