...
local function var_0_9(arg_12_0, arg_12_1, arg_12_2)
	...
	local var_12_1 = CONDITIONS.IsBattleNet() and arg_12_1.friendsListType == FRIENDS.FriendsListType.FIRST_PARTY
	...
	elseif arg_12_1.joinable ~= nil then
		...
		if not Engine.HDGDBCJFG() then
			if arg_12_1.crossplayGamertag ~= nil and arg_12_1.crossplayGamertag ~= "" then
				...
				if Engine.CHDGBEFDHB() then
					arg_12_0.BNetFriendIcon:setImage(RegisterMaterial(FRIENDS.PlatformIcon[PresencePlatform.STEAM]))
				end
	...
	local function var_12_4(arg_13_0, arg_13_1)
		arg_12_0.PlatformIcon:SetAlpha(0.75)

		if arg_13_0 then
			arg_12_0.PlatformIcon:setImage(RegisterMaterial("icon_social_friend_atvi"))
		else
			local var_13_0 = FRIENDS.GetFriendPlatformId(arg_13_1)
	...
	local var_12_5 = arg_12_0._tabID == FRIENDS.TabIDs.PRIVATE_PARTY and arg_12_0._subTabID == FRIENDS.ManagePartyTabIDs.INVITE_PLAYERS and CONDITIONS.InFrontend()

	arg_12_1.showPlatformIcon = false

	if arg_12_0._tabID == FRIENDS.TabIDs.REGIMENTS then
		arg_12_1.showPlatformIcon = arg_12_1.presencePlatform ~= nil
	else
		arg_12_1.showPlatformIcon = (arg_12_0._tabID == FRIENDS.TabIDs.FRIENDS or var_12_5) and arg_12_1.isAtviFriend ~= nil
	end

	if arg_12_1.showPlatformIcon then
		var_12_4(arg_12_1.isAtviFriend, arg_12_1)
	elseif arg_12_0._subTabID == FRIENDS.ManageFriendsTabIDs.FRIEND_REQUESTS and arg_12_1.playerDataType then
		local var_12_6 = arg_12_1.playerDataType

		var_12_4(var_12_6 == FRIENDS.FriendsListType.ACTIVISION, arg_12_1)
	else
		arg_12_0.PlatformIcon:SetAlpha(0)
	end

	if arg_12_1.emblemIndex and arg_12_1.valid then
		local var_12_7 = EmblemEditorUtils.GetEmblemImageFromID(arg_12_1.emblemIndex)

		arg_12_0.Emblem:setImage(RegisterMaterial(var_12_7))
	...
	if var_12_1 then
		...
		local var_12_8 = Social.CFEIHAADEI(arg_12_1.platformId)

		if var_12_8 and var_12_0 ~= BattleNetOnlineStatus.APPEAR_OFFLINE then
			local var_12_9 = FRIENDS.BattleNetGameInfo[var_12_8.clientProgramID]

			if var_12_9 then
				arg_12_0.BnetGameIcon:setImage(RegisterMaterial(var_12_9.icon))
	...
	if CONDITIONS.IsClanUIEnabled() then
		local var_12_10 = Engine.EAGGAEGHHA(arg_12_0._controllerIndex)

		if arg_12_0._tabID == FRIENDS.TabIDs.CLANS then
			if var_12_10 ~= arg_12_1.xuid then
				local var_12_11 = CLANS.GetClanMembersScreenActions(arg_12_0._subTabID, arg_12_1.viewerMemberRole, arg_12_1)

				var_0_2(arg_12_0, {
					_clanCallbacks = var_12_11
				})
			end
		else
			local var_12_12 = CLANS.GetSocialMenuScreenActions({
	...
	if CONDITIONS.IsClanUIEnabled() then
		if arg_12_0._tabID == FRIENDS.TabIDs.CLANS and arg_12_0._subTabID == CLANS.CLAN_TAB_IDs.MEMBERS then
			local var_12_13 = Clans2.CFDHGBFICH(arg_12_0._controllerIndex, arg_12_1.clanId, arg_12_1.xuid)
			local var_12_14 = CLANS.GetClanMemberRoleIconByRole(var_12_13)

			if var_12_14 and var_12_14.icon and var_12_14.icon ~= "" then
				arg_12_0.ClanStatusIcon:setImage(RegisterMaterial(var_12_14.icon))
				arg_12_0.ClanStatusIcon:SetAlpha(1)
			else
				arg_12_0.ClanStatusIcon:SetAlpha(0)
			end
		else
			local var_12_15 = arg_12_1.xuid or arg_12_1.inviterXuid
			local var_12_16 = tonumber(Engine.DEIDGHDBHD())
			local var_12_17 = var_12_16 - arg_12_0._clanStatusUpdateRequestTime

			if arg_12_0._playerXuid ~= var_12_15 or var_12_17 > var_0_0 then
				local var_12_18 = CLANS.CLAN_DATA.GetXUIDClanData(arg_12_0._controllerIndex, var_12_15, arg_12_0)

				if var_12_18 ~= arg_12_0._clanDetails then
					arg_12_0._contextualMenuIsAdded = false
					arg_12_0._contextualMenuHandlerAdded = false
				end

				arg_12_0._clanDetails = var_12_18

				if var_12_18 then
					arg_12_0:SetClanMemberStatus(var_12_18)
				else
					arg_12_0:ClearClanMemberStatus(var_12_18)
				end

				arg_12_0._clanStatusUpdateRequestTime = var_12_16
				arg_12_0._playerXuid = var_12_15
			end
		end
