...
local function var_0_4(arg_6_0, arg_6_1, arg_6_2)
	...
	if arg_6_0._expanded then
		...
		WZWIP.AnimateThemeElement(arg_6_0._expandButton, "Expanded")
		WZWIP.AnimateThemeElement(arg_6_0, "ExpandedGlow")
	else
		...
		WZWIP.AnimateThemeElement(arg_6_0._expandButton, "Collapsed")
		WZWIP.AnimateThemeElement(arg_6_0, "ExpandedIdle")
	end
...
local function var_0_11(arg_13_0, arg_13_1)
	if arg_13_0._expanded then
		WZWIP.AnimateThemeElement(arg_13_0, "ExpandedGlow")
	end
...
local function var_0_12(arg_14_0, arg_14_1)
	if arg_14_0._expanded then
		WZWIP.AnimateThemeElement(arg_14_0, "ExpandedIdle")
	end
