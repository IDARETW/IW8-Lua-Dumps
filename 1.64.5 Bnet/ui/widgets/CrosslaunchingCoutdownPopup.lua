...
function CrosslaunchingCoutdownPopup(arg_10_0, arg_10_1)
	...
	local var_10_1 = arg_10_1 and arg_10_1.controllerIndex or arg_10_1.controller
	...
	var_10_6:setImage(RegisterMaterial("mw_bocw_logo"), 0)
	var_10_6:SetAnchorsAndPosition(0.5, 0.5, 0.5, 0.5, _1080p * -599, _1080p * 599, _1080p * -301, _1080p * 301)
	...
	var_10_8:SetAnimMoveSpeed(150)
	var_10_8:SetEndDelay(2000)
	var_10_8:SetCrossfadeTime(250)
	var_10_8:SetFadeInTime(300)
	var_10_8:SetFadeOutTime(300)
	var_10_8:SetMaxVisibleLines(1)
	var_10_8:SetAnchorsAndPosition(0.5, 0.5, 0.5, 0.5, _1080p * -830, _1080p * 830, _1080p * 72, _1080p * 100)
	...
	var_10_10:SetAnchorsAndPosition(0.5, 0.5, 0.5, 0.5, _1080p * -830, _1080p * 830, _1080p * 132, _1080p * 168)
	var_10_0:addElement(var_10_10)

	var_10_0.Timer = var_10_10
	...
	var_10_12:setText("", 0)
	var_10_12:SetFont(FONTS.GetFont(FONTS.MainLight.File))
	var_10_12:SetAlignment(LUI.Alignment.Center)
	var_10_12:SetAnchorsAndPosition(0.5, 0.5, 0.5, 0.5, _1080p * -802, _1080p * 802, _1080p * -192, _1080p * -132)
	var_10_0:addElement(var_10_12)

	var_10_0.Title = var_10_12
	...
	var_10_20:setImage(RegisterMaterial("logo_cod_wz2"), 0)
	var_10_20:SetAnchorsAndPosition(0.5, 0.5, 0.5, 0.5, _1080p * -138, _1080p * 138, _1080p * -97, _1080p * 41)
	var_10_0:addElement(var_10_20)

	var_10_0.WZ2 = var_10_20

	local var_10_21
	local var_10_22 = MenuBuilder.BuildRegisteredType("FenceSpinner", {
		controllerIndex = var_10_1
	})

	var_10_22.id = "Spinner"

	var_10_22:SetAnchorsAndPosition(0.5, 0.5, 0.5, 0.5, _1080p * -170, _1080p * 170, _1080p * 111, _1080p * 121)
	var_10_0:addElement(var_10_22)

	var_10_0.Spinner = var_10_22

	local var_10_23
	local var_10_24 = MenuBuilder.BuildRegisteredType("ButtonHelperBar", {
		controllerIndex = var_10_1
	})

	var_10_24.id = "ButtonHelperBar"

	var_10_24.Background:SetAlpha(0, 0)
	var_10_24:SetAnchorsAndPosition(0.5, 0.5, 0.5, 0.5, _1080p * -855, _1080p * 855, _1080p * 230, _1080p * 290)
	var_10_0:addElement(var_10_24)

	var_10_0.ButtonHelperBar = var_10_24

	local var_10_25
	local var_10_26 = MenuBuilder.BuildRegisteredType("GenericCycleList", {
		controllerIndex = var_10_1
	})

	var_10_26.id = "PlatformSelection"

	var_10_26:SetAlpha(0, 0)
	var_10_26.GenericOptionButtonBase.Title:setText(Engine.CBBHFCGDIC("LUA_MENU_EAGLE/CROSSLAUNCH_PLATFORM_SELECTION_TITLE"), 0)
	var_10_26.Text:setText(Engine.CBBHFCGDIC("LUA_MENU_EAGLE/CROSSLAUNCH_PLATFORM_SELECTION_PS4"), 0)
	var_10_26:SetAnchorsAndPosition(0.5, 0.5, 0, 1, _1080p * -315, _1080p * 315, _1080p * 711, _1080p * 765)
	var_10_0:addElement(var_10_26)

	var_10_0.PlatformSelection = var_10_26
	...
	var_10_8:RegisterAnimationSequence("ButtonVer", var_10_29)
	...
	var_10_10:RegisterAnimationSequence("ButtonVer", var_10_30)
	...
	var_10_16:RegisterAnimationSequence("ButtonVer", var_10_31)
	...
	var_10_22:RegisterAnimationSequence("ButtonVer", var_10_32)

	local function var_10_33()
		var_10_8:AnimateSequence("ButtonVer")
		var_10_10:AnimateSequence("ButtonVer")
		var_10_16:AnimateSequence("ButtonVer")
		var_10_22:AnimateSequence("ButtonVer")
	end

	var_10_0._sequences.ButtonVer = var_10_33
	...
	var_10_6:RegisterAnimationSequence("WZWipSetup", var_10_35)
	...
	var_10_12:RegisterAnimationSequence("WZWipSetup", var_10_36)
	...
	var_10_26:RegisterAnimationSequence("PlatformSelectionShow", var_10_39)

	local function var_10_40()
		var_10_26:AnimateSequence("PlatformSelectionShow")
	end

	var_10_0._sequences.PlatformSelectionShow = var_10_40
