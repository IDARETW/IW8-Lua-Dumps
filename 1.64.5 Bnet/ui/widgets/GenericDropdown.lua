...
local function var_0_13(arg_17_0, arg_17_1, arg_17_2)
	...
	if arg_17_0.onRefresh then
		arg_17_0.onRefresh(arg_17_0, arg_17_1, arg_17_0.defaultValue, addToModified)
	end
...
local function var_0_17(arg_21_0, arg_21_1, arg_21_2)
	...
	function arg_21_0.SetCurrentValue(arg_23_0, arg_23_1, arg_23_2, arg_23_3, arg_23_4)
		for iter_23_0 = 1, #arg_23_0.labels do
			if iter_23_0 == arg_23_2 then
				...
				if arg_23_0.applyable == false or arg_23_4 then
	...
	arg_21_0:addEventHandler("reset_value", function(arg_26_0, arg_26_1)
		if arg_26_0.defaultValueGetter and not arg_26_0.dropdownButton.disabled then
			arg_26_0:SetCurrentValue(arg_26_1.controllerIndex or arg_21_1, arg_26_0.defaultValueGetter(arg_26_1.controllerIndex or arg_21_1), nil, true)
	...
	arg_21_0:addEventHandler("update_value", function(arg_31_0, arg_31_1)
		if arg_31_1.value then
			arg_31_0:SetCurrentValue(arg_31_1.controller, arg_31_1.value)
...
local function var_0_18(arg_32_0, arg_32_1, arg_32_2)
	arg_32_0.labels = {}
	arg_32_0._dropdownState = false
	arg_32_0.SetupButtonData = var_0_17
	arg_32_0.UpdateCurrentTextDropdown = var_0_15
	arg_32_0.UpdateLabels = var_0_16
end

function GenericDropdown(arg_33_0, arg_33_1)
	local var_33_0 = LUI.UIElement.new()

	var_33_0:SetAnchorsAndPosition(0, 1, 0, 1, 0, 201 * _1080p, 0, 150 * _1080p)

	var_33_0.id = "GenericDropdown"
	...
	var_0_18(var_33_0, var_33_1, arg_33_1)
