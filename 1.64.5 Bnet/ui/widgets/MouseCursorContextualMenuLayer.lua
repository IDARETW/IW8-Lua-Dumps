...
local function var_0_8(arg_5_0, arg_5_1, arg_5_2)
	...
	if var_5_1 == nil or var_5_1(var_5_2, arg_5_1) then
		...
		if arg_5_2.actionNameFunction and type(arg_5_2.actionNameFunction) == "function" then
			arg_5_2.actionName = arg_5_2.actionNameFunction()
		end
...
local function var_0_14(arg_12_0, arg_12_1, arg_12_2, arg_12_3)
	...
	if arg_12_2 and arg_12_3 then
		if Engine.CHDGBEFDHB() then
			ACTIONS.AnimateSequence(var_12_0, "GenericAndLaze")
		else
	...
	elseif arg_12_3 then
		if Engine.CHDGBEFDHB() then
			ACTIONS.AnimateSequence(var_12_0, "LazeOnly")
		else
	...
	if not arg_19_0:IsOpened() then
		if arg_19_1.button == "right" and arg_19_1.name == "mouseup" then
			...
			if var_19_1 then
				...
				if var_19_3 and var_0_11(var_19_3, arg_19_1) and var_19_3:isElementVisible() and var_19_2 and arg_19_0:AnyValidContextualDataConditions(nil, arg_19_1.controller, var_19_2) then
