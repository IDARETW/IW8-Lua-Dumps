...
function Reticle_t908(arg_2_0, arg_2_1)
	...
	var_2_4:setImage(RegisterMaterial("t9_hud_reticle_t908"), 0)
...
MenuBuilder.registerType("Reticle_t908", Reticle_t908)
LockTable(_M)
