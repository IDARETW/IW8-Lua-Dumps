...
function CoD.GetIconForButton(arg_12_0)
	if ButtonMap[arg_12_0].ui_button then
		local var_12_0 = StringTable.DIFCHIGDFB(CSV.fontIcons.file, CSV.fontIcons.cols.ref, ButtonMap[arg_12_0].ui_button, CSV.fontIcons.cols.unicodeCodePoint)

		return string.char(var_12_0)
	else
		return Engine.CBBHFCGDIC(ButtonMap[arg_12_0].string)
	end
end

function CoD.GetTextForButton(arg_13_0)
	if ButtonMap[arg_13_0].ui_button then
		local var_13_0 = StringTable.DIFCHIGDFB(CSV.fontIcons.file, CSV.fontIcons.cols.ref, ButtonMap[arg_13_0].ui_button, CSV.fontIcons.cols.keyName)
...
function CoD.GetButtonForCurrentInput(arg_14_0, arg_14_1)
	if LUI.IsLastInputGamepad(arg_14_0) then
		return CoD.GetIconForButton(arg_14_1)
	else
		return CoD.GetTextForButton(arg_14_1)
	end
end

CoD.currentGameMode = nil

function CoD.UpdateGameMode(arg_15_0, arg_15_1)
	CSV.UpdateCSVsByGameMode(arg_15_0)

	if Engine.DDJFBBJAIG() then
		UpdateDataSourcesByMode(arg_15_0, arg_15_1)
		CLIENT_MODEL.UpdateModifiablesByMode()
	end

	Cac.NumAttachments = Engine.CAADCDEEIA() and 3 or 6
	CoD.currentGameMode = arg_15_0
end
...
function CoD.GetWorldBlur()
	...
	var_17_0:SetBlurStrength(5)
	var_17_0:setupWorldBlur()
...
function CoD.PrintModuleLoad(arg_18_0)
	return
end
...
if var_0_1 then
	function run_gc(arg_23_0)
		local var_23_0 = arg_23_0 and " (" .. arg_23_0 .. ")" or ""
		local var_23_1 = collectgarbage("count")

		collectgarbage("collect")

		local var_23_2 = collectgarbage("count")
		local var_23_3 = var_23_1 - var_23_2

		DebugPrint("LUI - Ran GC cycle, cleared " .. var_23_3 .. "kb. " .. var_23_2 .. "kb remaining." .. var_23_0)
	end
else
	function run_gc()
		collectgarbage("collect")
...
function CoD.FormatInfectedTime(arg_29_0, arg_29_1)
	local var_29_0 = Engine.CBBHFCGDIC("@LUA_MENU/S_FOR_SECONDS")
	local var_29_1 = Engine.CBBHFCGDIC("@LUA_MENU/M_FOR_MINUTES")
	local var_29_2 = math.floor(arg_29_0 / 60)
	local var_29_3 = ""

	if not arg_29_1 then
		if var_29_2 < 1 then
			var_29_3 = arg_29_0 .. var_29_0
		else
			var_29_3 = var_29_2 .. var_29_1
		...
		arg_29_0 = arg_29_0 - var_29_2 * 60

		if arg_29_0 >= 10 then
			var_29_3 = var_29_2 .. ":" .. arg_29_0
		else
			var_29_3 = var_29_2 .. ":0" .. arg_29_0
		end
	end
...
function IsPrivateMatch()
	local var_32_0 = Dvar.IBEGCHEFE("LTSNLQNRKO")
	local var_32_1 = Dvar.IBEGCHEFE("LSTLQTSSRM")

	if var_32_0 == true and var_32_1 == true then
		return true
	end
...
function IsPublicMatch()
	...
	if var_33_0 == true and var_33_1 == false then
		return true
	end
...
function isAliensSolo()
	local var_37_0 = Engine.EAIICIFIFA()
	local var_37_1 = Dvar.IBEGCHEFE("LSTLQTSSRM")
	local var_37_2 = Dvar.IBEGCHEFE("LNQLRSNMQS")

	return var_37_0 and var_37_1 and var_37_2
end

function CoD.AspectRatioCompare(arg_38_0)
	arg_38_0 = arg_38_0 or 1.7777777777777777

	local var_38_0 = 0.01
	local var_38_1 = Engine.CEGEEHGGBA()

	if var_38_0 > math.abs(arg_38_0 - var_38_1) then
		return LUI.COMPARE.equal
	elseif math.abs(var_38_1) < math.abs(arg_38_0) then
...
function CoD.IsUsingAspectRatio(arg_39_0)
	arg_39_0 = arg_39_0 or 1.7777777777777777

	local var_39_0 = 0.01
	local var_39_1 = Engine.CEGEEHGGBA()

	return var_39_0 > math.abs(arg_39_0 - var_39_1)
end

function CoD.GetAspectRatioScaleAdjust(arg_40_0, arg_40_1)
	return CoD.IsUsingAspectRatio(arg_40_1) and 0 or arg_40_0
end

function CoD.GetAdjustedCurrency(arg_41_0)
	return math.floor(arg_41_0 / 100)
end

function CoD.GetPercentToNextCurrency(arg_42_0)
	local var_42_0 = arg_42_0 / 100
	local var_42_1 = 10

	return var_42_0 % var_42_1 / var_42_1
end
...
function CoD.GetBreadcrumbCreateAClass()
	...
	if IsSystemLink() then
		var_43_0 = ToUpperCase(Engine.CBBHFCGDIC("LUA_MENU/BREADCRUMB_2_ITEMS", "EXE/LOCAL_PLAY", "MENU/MULTIPLAYER"))
	elseif not IsPrivateMatch() then
		var_43_0 = ToUpperCase(Engine.CBBHFCGDIC("LUA_MENU/BREADCRUMB_2_ITEMS", "MENU/MULTIPLAYER", "LUA_MENU/PUBLIC_MATCH_CAPS"))
	elseif IsMlgGameBattlesMatch() then
		var_43_0 = ToUpperCase(Engine.CBBHFCGDIC("LUA_MENU/BREADCRUMB_2_ITEMS", "MENU/MULTIPLAYER", "LUA_MENU/MLG_GAMEBATTLES_CAPS"))
	else
		var_43_0 = ToUpperCase(Engine.CBBHFCGDIC("LUA_MENU/BREADCRUMB_2_ITEMS", "MENU/MULTIPLAYER", "LUA_MENU/CUSTOM_GAME_CAPS"))
	end
...
function CoD.GrantAllT9ItemsAction(arg_51_0)
	for iter_51_0, iter_51_1 in ipairs(CSV.itemSourceTable.fileList) do
		for iter_51_2 = 0, CSV.MultiTableGetRowCount(CSV.itemSourceTable.fileList, iter_51_0) do
			local var_51_0 = CSV.MultiFileReadRow(CSV.itemSourceTable, iter_51_0, iter_51_2)
			local var_51_1 = tonumber(var_51_0.marketPlaceID) or 0
			local var_51_2 = var_51_0.gameSourceID or ""

			if var_51_1 > 0 and var_51_2 == "t9" and not (Loot.DEBEIFJEEG(arg_51_0, var_51_1) > 0) then
				Loot.DFGDFABGBE(arg_51_0, var_51_1)
			end
		end
	end
end

function CoD.SendDailyChallengeCompletion(arg_52_0, arg_52_1)
	arg_52_1:dispatchEventToRoot({
...
function CoD.IsClientConnectionActive(arg_54_0)
	return Engine.EEGHCCDG(arg_54_0) > 0
end
