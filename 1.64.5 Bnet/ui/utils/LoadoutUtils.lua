...
function LOADOUT.LookupDefaultClassItem(arg_15_0, arg_15_1, arg_15_2)
	if CONDITIONS.IsSnipersOnlyClasses() then
		return StringTable.DIFCHIGDFB(CSV.snipersOnlyClassTable:GetFile(arg_15_0), CSV.snipersOnlyClassTable.cols.itemRef, arg_15_2, CSV.snipersOnlyClassTable.cols.class1 + arg_15_1)
	end
...
function LOADOUT.GetDefaultLoadouts(arg_16_0)
	local var_16_0 = {}
	local var_16_1 = LOADOUT.DefaultClassCount

	if CONDITIONS.IsSnipersOnlyClasses() then
		var_16_1 = LOADOUT.SnipersOnlyClassCount
	end
	...
	for iter_16_0 = 0, var_16_1 - 1 do
		...
		for iter_16_1 = 0, 1 do
			local var_16_3 = iter_16_1 == WEAPON.PrimarySlot and "Primary" or "Secondary"
			local var_16_4 = {
				ref = LOADOUT.LookupDefaultClassItem(arg_16_0, iter_16_0, "loadout" .. var_16_3),
				camo = LOADOUT.LookupDefaultClassItem(arg_16_0, iter_16_0, "loadout" .. var_16_3 .. "Camo"),
				reticle = LOADOUT.LookupDefaultClassItem(arg_16_0, iter_16_0, "loadout" .. var_16_3 .. "Reticle"),
				attachments = {}
			}

			for iter_16_2 = 0, 5 do
				table.insert(var_16_4.attachments, LOADOUT.LookupDefaultClassItem(arg_16_0, iter_16_0, "loadout" .. var_16_3 .. "Attachment" .. iter_16_2 + 1))
			end

			table.insert(var_16_2.weapons, var_16_4)
		end

		var_16_2.role = "none"
		var_16_2.munitions = "none"
		var_16_2.lethal = LOADOUT.LookupDefaultClassItem(arg_16_0, iter_16_0, "loadoutEquipment" .. "Primary")
		var_16_2.tactical = LOADOUT.LookupDefaultClassItem(arg_16_0, iter_16_0, "loadoutEquipment" .. "Secondary")
		var_16_2.perks = {}

		for iter_16_3 = 1, Cac.NumLoadoutPerks do
			local var_16_5 = LOADOUT.LookupDefaultClassItem(arg_16_0, iter_16_0, "loadoutPerk" .. iter_16_3)

			table.insert(var_16_2.perks, var_16_5)
		end
		...
		if LOADOUT.LookupDefaultClassItem(arg_16_0, iter_16_0, "loadoutSpecialist") == "TRUE" then
			...
			for iter_16_4 = 1, Cac.NumLoadoutExtraPerks do
				local var_16_6 = LOADOUT.LookupDefaultClassItem(arg_16_0, iter_16_0, "loadoutExtraPerk" .. iter_16_4)

				table.insert(var_16_2.extraPerks, var_16_6)
			end
		end

		var_16_2.name = LOADOUT.LookupDefaultClassItem(arg_16_0, iter_16_0, "loadoutName")
		var_16_2.role = LOADOUT.LookupDefaultClassItem(arg_16_0, iter_16_0, "loadoutRole")
...
function LOADOUT.MATCHRULES.LoadoutHasRestrictedItem(arg_34_0)
	...
	for iter_34_0, iter_34_1 in ddlpairs(var_34_0.attachmentSetup) do
		...
		if MLG.IsAttachmentRestricted(var_34_2, var_34_1) then
			return true
		end
	end
	...
	for iter_34_2, iter_34_3 in ddlpairs(var_34_3.attachmentSetup) do
		...
		if MLG.IsAttachmentRestricted(var_34_5, var_34_4) then
			return true
		end
	end
	...
	for iter_34_6, iter_34_7 in ddlpairs(arg_34_0.loadoutPerks) do
		if Restrictions.IsPerkRestricted(iter_34_7:get()) then
			return true
		end
	end

	for iter_34_8, iter_34_9 in ddlpairs(arg_34_0.extraPerks) do
		if Restrictions.IsPerkRestricted(iter_34_9:get()) then
			return true
		end
	end
...
function LOADOUT.MATCHRULES.WeaponHasRestrictedAttachment(arg_35_0, arg_35_1)
	for iter_35_0, iter_35_1 in ddlpairs(arg_35_0) do
		...
		if MLG.IsAttachmentRestricted(var_35_0, arg_35_1) then
			return true
		end
	end
