...
function STORE.GetIndexForBundle(arg_27_0, arg_27_1, arg_27_2)
	arg_27_2 = arg_27_2 or STORE.GetCategoryData(arg_27_1)
...
function STORE.GetCategoryData(arg_100_0, arg_100_1)
	...
	if not arg_100_1 then
		local var_100_1 = Store.DBFHBBIDHD()

		var_100_0 = Engine.DBFHBBIDHD(var_100_1)
	end

	if Dvar.IBEGCHEFE("TNMTRNOQT") and CONDITIONS.IsT9PremiumPlayer(arg_100_0) == false and STORE.IsZeusOwned(arg_100_0) == false and not STORE.GetCategoryIndexWithFanchiseItems(var_100_0, STORE.ZeusCategoryID) and #STORE.GetZeusCategoryData(arg_100_0) > 0 then
		table.insert(var_100_0, STORE.GetZeusCategoryIndex(), {
	...
	if Dvar.IBEGCHEFE("online_store_x2_category_enabled") and (STORE.IsX2Owned(arg_100_0) == false or STORE.IsVanguardUpgradeToUltimateExisteAndNotOwned(arg_100_0)) and not STORE.GetCategoryIndexWithFanchiseItems(var_100_0, STORE.X2CategoryID) and #STORE.GetVanguardCategoryData(arg_100_0) > 0 then
		table.insert(var_100_0, STORE.GetX2CategoryIndex(), {
	...
	if Dvar.IBEGCHEFE("LMMPLKNTMP") and (STORE.IsCortezOwned(arg_100_0) == false or STORE.IsCortezUpgradeToUltimateExistentAndNotOwned(arg_100_0)) and not STORE.GetCategoryIndexWithFanchiseItems(var_100_0, STORE.CortezCategoryID) and #STORE.GetCortezCategoryData(arg_100_0) > 0 then
		table.insert(var_100_0, STORE.GetCortezCategoryIndex(), {
