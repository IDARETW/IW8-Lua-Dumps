...
function FenceSignIn.UpdateState(arg_9_0)
	...
	for iter_9_0 = 0, Engine.DCJGJDDEHE() - 1 do
		...
		if var_9_6 and not var_9_7 then
			assert(Engine.BAHIIBFDDG() or Engine.DEHJIFFID() or Engine.BEFACAIFDD())
...
function PopupForce2FABlock(arg_14_0, arg_14_1)
	assert(arg_14_1)
	...
	var_14_0.imageOverride = "logo_wz_shadow"
	var_14_0.buttons[1].label = Engine.CBBHFCGDIC("CODACCOUNT/TFA_BTN_ENROLL")
	var_14_0.buttons[1].action = function()
		Engine.BHECIAHGC(arg_14_1.controllerIndex, WebBrowserType.FULLSCREEN, CODACCOUNT.AccountSettingsURL)
		Engine.DJEDDFJEIG()
	end
	var_14_0.buttons[2].label = Engine.CBBHFCGDIC("LUA_MENU/QUIT_DESKTOP")
	var_14_0.buttons[2].action = function()
		Engine.DJEDDFJEIG()
	end

	local var_14_1 = MenuBuilder.BuildRegisteredType("GenericImagePopup", var_14_0)

	var_14_1.id = "popup_force_2fa_block"

	return var_14_1
end

function SMSResetBlock(arg_17_0, arg_17_1)
	assert(arg_17_1)

	local var_17_0 = {
		message = Engine.CBBHFCGDIC("CODACCOUNT/SMS_RESET_BODY", Engine.JCBDICCAH(arg_17_1.url)),
	...
	var_17_0.imageOverride = "logo_cod_warzone_mw_shadow"
	var_17_0.buttons[1].label = Engine.CBBHFCGDIC("CODACCOUNT/SMS_RESET_BTN")
	var_17_0.buttons[1].action = function()
		Engine.BHECIAHGC(arg_17_1.controllerIndex, WebBrowserType.FULLSCREEN, arg_17_1.url)
		Engine.DJEDDFJEIG()
	end

	local var_17_1 = MenuBuilder.BuildRegisteredType("GenericImagePopup", var_17_0)

	var_17_1.id = "popup_sms_reset_block"
