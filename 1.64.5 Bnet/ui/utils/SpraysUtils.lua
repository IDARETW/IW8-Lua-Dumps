...
function SPRAYS.GetAllSprays(arg_1_0, arg_1_1)
	local var_1_0 = {}
	...
	for iter_1_0 = 0, var_1_1 - 1 do
		...
		local var_1_3 = LOOT.GetItemID(LOOT.itemTypes.SPRAYS, var_1_2.ref)
		local var_1_4 = not (arg_1_1 and arg_1_1.shouldOnlyIncludeCurrentTitle) or LOOT.IsItemIDEquippableByCurrentTitle(arg_1_0, var_1_3)

		if var_1_2 and var_1_2.hideInUI ~= "1" and var_1_4 then
			...
			var_1_2.lootID = var_1_3
			var_1_2.isNew = Loot.HDJCADADF(arg_1_0, var_1_2.lootID)
			var_1_2.lootType = LOOT.itemTypes.SPRAYS

			local var_1_5 = true

			if var_1_2.lootID == 1 then
				var_1_5 = false
			end
