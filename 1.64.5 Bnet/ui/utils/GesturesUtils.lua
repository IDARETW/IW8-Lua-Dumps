	...
	for iter_3_0 = 0, GESTURES.numRadialSlots - 1 do
		...
		if var_3_2 > LOOT.emptyID then
			...
			if var_3_3 then
				...
				var_3_1.radial[iter_3_0]:set(LOOT.emptyID)
			end
		end
	end
...
function GESTURES.GetAllGestures(arg_4_0, arg_4_1)
	local var_4_0 = {}
	...
	for iter_4_0 = 0, var_4_1 - 1 do
		...
		if Engine.FABABBDBA() and var_4_2.ref == "gesture049" then
			var_4_3 = true
		end

		local var_4_4 = LOOT.GetItemID(LOOT.itemTypes.GESTURES, var_4_2.ref)
		local var_4_5 = not (arg_4_1 and arg_4_1.shouldOnlyIncludeCurrentTitle) or LOOT.IsItemIDEquippableByCurrentTitle(arg_4_0, var_4_4)

		if var_4_2 and var_4_2.hideInUI ~= "1" and var_4_3 == false and var_4_5 then
			...
			var_4_2.lootID = var_4_4
			var_4_2.isNew = Loot.HDJCADADF(arg_4_0, var_4_2.lootID)
			var_4_2.gameSourceID = LOOT.GetGameSourceIDFromItemID(var_4_2.lootID)
			var_4_2.lootType = LOOT.itemTypes.GESTURES
...
function GESTURES.SetEquippedByRef(arg_10_0, arg_10_1, arg_10_2, arg_10_3)
	local var_10_0 = LOOT.GetItemID(LOOT.itemTypes.GESTURES, arg_10_2)

	GESTURES.SetEquippedByID(arg_10_0, arg_10_1, var_10_0, arg_10_3)
end

function GESTURES.SetEquippedByID(arg_11_0, arg_11_1, arg_11_2, arg_11_3)
