...
function StoreConfirmPurchaseKoreaLegalPupup(arg_7_0, arg_7_1)
	...
	var_7_4:SetAnchorsAndPosition(0.5, 0.5, 0.5, 0.5, _1080p * -911, _1080p * 911, _1080p * -339, _1080p * 137)
	...
	var_7_6:SetRGBFromTable(SWATCHES.WZGlobalSwatches.WZTitle, 0)
	var_7_6:setText("", 0)
	var_7_6:SetFont(FONTS.GetFont(FONTS.MainLight.File))
	var_7_6:SetAlignment(LUI.Alignment.Left)
	var_7_6:SetAnchorsAndPosition(0.5, 0.5, 0.5, 0.5, _1080p * -240, _1080p * 805, _1080p * -290, _1080p * -230)
	...
	var_7_8:setImage(RegisterMaterial("icon_empty_x"), 0)
	var_7_8:SetAnchorsAndPosition(0, 1, 0.5, 0.5, _1080p * 130, _1080p * 642, _1080p * -224, _1080p * 32)
	...
	var_7_10:SetAnchorsAndPosition(0.5, 0.5, 0.5, 0.5, _1080p * -240, _1080p * 587, _1080p * -203, _1080p * -173)
	var_7_0:addElement(var_7_10)

	var_7_0.Message = var_7_10

	local var_7_11
	local var_7_12 = MenuBuilder.BuildRegisteredType("GenericCheckBoxButton", {
		controllerIndex = var_7_1
	})

	var_7_12.id = "AcceptPolicy"

	var_7_12.Fill:SetRGBFromInt(10201779, 0)
	var_7_12:SetAnchorsAndPosition(0, 1, 0.5, 0.5, _1080p * 720, _1080p * 749, _1080p * -51, _1080p * -23)
	var_7_0:addElement(var_7_12)

	var_7_0.AcceptPolicy = var_7_12
	...
	var_7_14.Text:setText(ToUpperCase(Engine.CBBHFCGDIC("LUA_MENU/BUY_NOW")), 0)
	var_7_14.Text:SetAlignment(LUI.Alignment.Center)
	var_7_14:SetAnchorsAndPosition(0, 1, 0.5, 0.5, _1080p * 720, _1080p * 886, _1080p * 47, _1080p * 85)
	...
	var_7_16.Text:setText(ToUpperCase(Engine.CBBHFCGDIC("MENU/CANCEL")), 0)
	var_7_16.Text:SetAlignment(LUI.Alignment.Center)
	var_7_16:SetAnchorsAndPosition(0, 1, 0.5, 0.5, _1080p * 914, _1080p * 1080, _1080p * 47, _1080p * 85)
	...
	var_7_18.id = "TermsButton"

	var_7_18.Text:SetLeft(_1080p * 20, 0)
	var_7_18.Text:setText(ToUpperCase(Engine.CBBHFCGDIC("LUA_MENU/STORE_TERMS_OF_USE")), 0)
	var_7_18.Text:SetAlignment(LUI.Alignment.Center)
	var_7_18:SetAnchorsAndPosition(0, 1, 0.5, 0.5, _1080p * 1192, _1080p * 1360, _1080p * 47, _1080p * 85)
	var_7_0:addElement(var_7_18)

	var_7_0.TermsButton = var_7_18
	...
	var_7_20.id = "RefundPolicyButton"

	var_7_20.Text:SetLeft(_1080p * 20, 0)
	var_7_20.Text:setText(ToUpperCase(Engine.CBBHFCGDIC("LUA_MENU/STORE_REFUND_POLICY")), 0)
	var_7_20.Text:SetAlignment(LUI.Alignment.Center)
	var_7_20:SetAnchorsAndPosition(0, 1, 0.5, 0.5, _1080p * 1388, _1080p * 1554, _1080p * 47, _1080p * 85)
	var_7_0:addElement(var_7_20)

	var_7_0.RefundPolicyButton = var_7_20

	local var_7_21
	local var_7_22 = MenuBuilder.BuildRegisteredType("ButtonPromptContainerHorizontal", {
		controllerIndex = var_7_1
	})
	...
	if CONDITIONS.AlwaysFalse() then
		var_7_22.Label:setText("Back/Select", 0)
	end

	var_7_22:SetAnchorsAndPosition(0, 1, 0.5, 0.5, _1080p * 155, _1080p * 255, _1080p * 147, _1080p * 178)
	var_7_0:addElement(var_7_22)

	var_7_0.Prompts = var_7_22

	local var_7_23
	local var_7_24 = MenuBuilder.BuildRegisteredType("MPPlayerDetails", {
		controllerIndex = var_7_1
	})

	var_7_24.id = "PlayerDetails"

	var_7_24:SetAnchorsAndPosition(1, 0, 0, 1, _1080p * -596, _1080p * -96, _1080p * 54, _1080p * 114)
	var_7_0:addElement(var_7_24)

	var_7_0.PlayerDetails = var_7_24

	local var_7_25
	local var_7_26 = LUI.UIText.new()

	var_7_26.id = "ServiceDuration"

	var_7_26:SetRGBFromTable(SWATCHES.genericMenu.progressBackground, 0)
	var_7_26:setText(Engine.CBBHFCGDIC("LUA_MENU/STORE_DURATION_OF_SERVICE"), 0)
	var_7_26:SetFont(FONTS.GetFont(FONTS.MainRegular.File))
	var_7_26:SetAlignment(LUI.Alignment.Left)
	var_7_26:SetAnchorsAndPosition(0, 1, 0.5, 0.5, _1080p * 720, _1080p * 1547, _1080p * -135, _1080p * -115)
	var_7_0:addElement(var_7_26)

	var_7_0.ServiceDuration = var_7_26

	local var_7_27
	local var_7_28 = LUI.UIText.new()

	var_7_28.id = "RefundPolicy"

	var_7_28:SetRGBFromTable(SWATCHES.genericMenu.title, 0)
	var_7_28:setText(Engine.CBBHFCGDIC("LUA_MENU/STORE_KOREA_REFOUND_POLICY"), 0)
	var_7_28:SetFont(FONTS.GetFont(FONTS.MainRegular.File))
	var_7_28:SetAlignment(LUI.Alignment.Left)
	var_7_28:SetAnchorsAndPosition(0, 1, 0.5, 0.5, _1080p * 756, _1080p * 1547, _1080p * -52, _1080p * -34)
	var_7_0:addElement(var_7_28)

	var_7_0.RefundPolicy = var_7_28

	local function var_7_29()
		return
	end

	var_7_0._sequences.DefaultSequence = var_7_29
	...
	var_7_8:RegisterAnimationSequence("BattlepassTier", var_7_31)

	local function var_7_32()
		var_7_8:AnimateSequence("BattlepassTier")
	end

	var_7_0._sequences.BattlepassTier = var_7_32
	...
	var_7_6:RegisterAnimationSequence("WZSetup", var_7_34)
	...
	var_7_10:RegisterAnimationSequence("WZSetup", var_7_35)
	...
	var_7_26:RegisterAnimationSequence("WZSetup", var_7_36)
	...
	var_7_28:RegisterAnimationSequence("WZSetup", var_7_37)

	local function var_7_38()
		var_7_6:AnimateSequence("WZSetup")
		var_7_10:AnimateSequence("WZSetup")
		var_7_26:AnimateSequence("WZSetup")
		var_7_28:AnimateSequence("WZSetup")
	end

	var_7_0._sequences.WZSetup = var_7_38
	...
	local var_7_39 = LUI.UIBindButton.new()

	var_7_39.id = "selfBindButton"

	var_7_0:addElement(var_7_39)

	var_7_0.bindButton = var_7_39

	var_7_0.bindButton:addEventHandler("button_secondary", function(arg_11_0, arg_11_1)
