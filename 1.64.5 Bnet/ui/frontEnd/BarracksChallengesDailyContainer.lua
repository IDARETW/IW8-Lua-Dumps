...
local function var_0_0(arg_1_0, arg_1_1, arg_1_2)
	...
	if CONDITIONS.IsWZWipFlowEnabled() then
		assert(arg_1_2 and arg_1_2.forceSelectedChallengeRow, "BarracksChallengesDailyContainer - Postload: options.forceSelectedChallengeRow is invalid and must be specified")
		arg_1_0.WZWipBarracksChallengesDaily:SetForceSelectedDailyChallengeRow(arg_1_2.forceSelectedChallengeRow)
	end
...
function BarracksChallengesDailyContainer(arg_3_0, arg_3_1)
	...
	if not CONDITIONS.IsWZWipFlowEnabled() then
		local var_3_9 = MenuBuilder.BuildRegisteredType("BarracksChallengesDaily", {
			controllerIndex = var_3_1
		})

		var_3_9.id = "BarracksChallengesDaily"

		var_3_9:SetAnchorsAndPosition(0, 0, 0, 0, 0, 0, 0, 0)
		var_3_0:addElement(var_3_9)

		var_3_0.BarracksChallengesDaily = var_3_9
	end

	local var_3_10

	if CONDITIONS.IsWZWipFlowEnabled() then
		local var_3_11 = MenuBuilder.BuildRegisteredType("WZBarracksChallengesDaily", {
			controllerIndex = var_3_1
		})

		var_3_11.id = "WZWipBarracksChallengesDaily"

		var_3_11:SetAnchorsAndPosition(0, 0, 0, 0, 0, 0, 0, 0)
		var_3_0:addElement(var_3_11)

		var_3_0.WZWipBarracksChallengesDaily = var_3_11
	end

	local var_3_12
	local var_3_13 = MenuBuilder.BuildRegisteredType("TabBacker", {
		controllerIndex = var_3_1
	})

	var_3_13.id = "TabBacker"

	var_3_13:SetAnchorsAndPosition(0, 0, 0, 1, 0, 0, 0, _1080p * 160)
	var_3_0:addElement(var_3_13)

	var_3_0.TabBacker = var_3_13

	local var_3_14
	local var_3_15 = MenuBuilder.BuildRegisteredType("MenuTitle", {
		controllerIndex = var_3_1
	})

	var_3_15.id = "MenuTitle"

	var_3_15.MenuTitle:setText(Engine.CBBHFCGDIC("CHALLENGE/DAILY"), 0)
	var_3_15.Line:SetLeft(0, 0)
	var_3_15:SetAnchorsAndPosition(0, 1, 0, 1, 0, _1080p * 1020, 0, _1080p * 100)
	var_3_0:addElement(var_3_15)

	var_3_0.MenuTitle = var_3_15

	local var_3_16
	local var_3_17 = MenuBuilder.BuildRegisteredType("LobbyMembersFooter", {
		controllerIndex = var_3_1
	})

	var_3_17.id = "LobbyMembersFooter"

	var_3_17:SetAnchorsAndPosition(0, 0, 0, 1, 0, 0, 0, _1080p * 150)
	var_3_0:addElement(var_3_17)

	var_3_0.LobbyMembersFooter = var_3_17
	...
	local var_3_18 = LUI.UIBindButton.new()

	var_3_18.id = "selfBindButton"

	var_3_0:addElement(var_3_18)

	var_3_0.bindButton = var_3_18
