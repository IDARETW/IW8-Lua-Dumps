...
local function var_0_1(arg_1_0, arg_1_1, arg_1_2)
	...
	if arg_1_2 ~= SEASON.GetCurrentSeasonDataNum() then
		ACTIONS.AnimateSequence(arg_1_0, "PrevSeason")
	end

	arg_1_0.SeasonName:setText(SEASON.GetLocalizedName({
		seasonDataNumToUse = arg_1_2
	}))
	arg_1_0.RadialRankProgressBar:UpdateRankDisplay(arg_1_1, arg_1_2)
	arg_1_0.RankResetText:SetAlpha(arg_1_2 == SEASON.GetCurrentSeasonDataNum() and 1 or 0)
end
...
local function var_0_2(arg_2_0, arg_2_1, arg_2_2)
	...
	local var_2_0 = SEASON.GetCurrentSeasonDataNum()
	local var_2_1 = PROGRESSION.GetPlayerProgressionData({
		_controllerIndex = arg_2_1
	})

	arg_2_0.MWLevel:setText(Engine.CBBHFCGDIC("LUA_MENU/MW_LEVEL", var_2_1._rankDisplay))
