...
local function var_0_1(arg_1_0, arg_1_1)
	...
	if arg_1_0._state == BATTLEPASS.FullScreenPopupStates.BATTLE_PASS_UNLOCKED then
		...
		if arg_1_0._currentSeason and arg_1_0._currentSeason == var_0_0 then
			ACTIONS.AnimateSequence(arg_1_0, "ShowHeaderAlt")
		end
	elseif arg_1_0._state == BATTLEPASS.FullScreenPopupStates.TIERS_UNLOCKED then
		...
		if arg_1_0._currentSeason and arg_1_0._currentSeason == var_0_0 then
			ACTIONS.AnimateSequence(arg_1_0, "ShowHeaderAlt")
			ACTIONS.AnimateSequence(arg_1_0, "ShowTierAlt")
		end
	...
	elseif arg_1_0._state == BATTLEPASS.FullScreenPopupStates.BATTLE_PASS_COMPLETE then
		...
		if arg_1_0._currentSeason and arg_1_0._currentSeason == var_0_0 then
			ACTIONS.AnimateSequence(arg_1_0, "CompleteBattlePassAlt")
		else
			ACTIONS.AnimateSequence(arg_1_0, "CompleteBattlePass")
		end

		ACTIONS.AnimateSequence(arg_1_0, "CompleteBPTierPos")
	...
	elseif arg_1_0._state == BATTLEPASS.FullScreenPopupStates.BATTLE_PASS_GIFTED then
		ACTIONS.AnimateSequence(arg_1_0, "BattlePassGifting")
		Engine.DFCGFCGBFD("mp_battlepass_celebration_purchase")
		Engine.BJDBIAGIDA(SOUND_SETS.battlePass.bpPurchase)

		local var_1_0 = arg_1_0._controllerIndex
		local var_1_1 = arg_1_0._recipentXuidString
		local var_1_2 = Friends.HCAFBJBHC(arg_1_0._controllerIndex, arg_1_0._recipentXuidString)

		arg_1_0.BattlePass:setText(ToUpperCase(MarkLocalized(Engine.CBBHFCGDIC("LUA_MENU_MP/BATTLE_PASS_GIFTED_TITLE"))))
		arg_1_0.UnlockText:setText(ToUpperCase(Engine.CBBHFCGDIC("LUA_MENU_MP/BATTLE_PASS_GIFTED_DESC", Engine.JCBDICCAH(var_1_2.gamertag))))
	else
...
local function var_0_2(arg_2_0, arg_2_1, arg_2_2)
	...
	if arg_2_0._currentSeason and arg_2_0._currentSeason == 6 then
		arg_2_0._displayTime = arg_2_2.state == BATTLEPASS.FullScreenPopupStates.BATTLE_PASS_COMPLETE and 3500 or 6500
	end

	arg_2_0._recipentXuidString = arg_2_2.recipentXuidString

	var_0_1(arg_2_0, arg_2_2.state)
	...
	elseif Engine.CGABICJHAI() and var_2_0 == 3 then
		if arg_2_2.state == BATTLEPASS.FullScreenPopupStates.BATTLE_PASS_COMPLETE then
			ACTIONS.AnimateSequence(arg_2_0, "CompleteBPTierAspect")
		else
...
function BattlePassFullScreenPopup(arg_5_0, arg_5_1)
	...
	var_5_8:SetAnchorsAndPosition(0, 0, 1, 0, 0, 0, _1080p * -280, _1080p * -210)
	...
	var_5_12:SetAnchorsAndPosition(0, 0, 0, 1, 0, 0, _1080p * 148, _1080p * 184)
	...
	var_5_8:RegisterAnimationSequence("WideAspectRatioFrame", var_5_39)
	...
	var_5_16:RegisterAnimationSequence("WideAspectRatioFrame", var_5_40)
	...
	var_5_18:RegisterAnimationSequence("WideAspectRatioFrame", var_5_41)

	local function var_5_42()
		var_5_8:AnimateSequence("WideAspectRatioFrame")
		var_5_16:AnimateSequence("WideAspectRatioFrame")
		var_5_18:AnimateSequence("WideAspectRatioFrame")
	end

	var_5_0._sequences.WideAspectRatioFrame = var_5_42
	...
	var_5_8:RegisterAnimationSequence("TierAspectRatio", var_5_44)

	local function var_5_45()
		var_5_8:AnimateSequence("TierAspectRatio")
	end

	var_5_0._sequences.TierAspectRatio = var_5_45
	...
	var_5_8:RegisterAnimationSequence("CompleteBattlePassAlt", var_5_47)
	...
	var_5_10:RegisterAnimationSequence("CompleteBattlePassAlt", var_5_48)
	...
	var_5_12:RegisterAnimationSequence("CompleteBattlePassAlt", var_5_49)

	local function var_5_50()
		var_5_8:AnimateSequence("CompleteBattlePassAlt")
		var_5_10:AnimateSequence("CompleteBattlePassAlt")
		var_5_12:AnimateSequence("CompleteBattlePassAlt")
	end

	var_5_0._sequences.CompleteBattlePassAlt = var_5_50
	...
	var_5_8:RegisterAnimationSequence("ColorAlt", var_5_52)
	...
	var_5_10:RegisterAnimationSequence("ColorAlt", var_5_53)
	...
	var_5_12:RegisterAnimationSequence("ColorAlt", var_5_54)

	local function var_5_55()
		var_5_8:AnimateSequence("ColorAlt")
		var_5_10:AnimateSequence("ColorAlt")
		var_5_12:AnimateSequence("ColorAlt")
	end

	var_5_0._sequences.ColorAlt = var_5_55
	...
	var_5_10:RegisterAnimationSequence("ShowHeaderAlt", var_5_57)
	...
	var_5_12:RegisterAnimationSequence("ShowHeaderAlt", var_5_58)

	local function var_5_59()
		var_5_10:AnimateSequence("ShowHeaderAlt")
		var_5_12:AnimateSequence("ShowHeaderAlt")
	end

	var_5_0._sequences.ShowHeaderAlt = var_5_59
	...
	var_5_8:RegisterAnimationSequence("CompleteKerning", var_5_61)

	local function var_5_62()
		var_5_8:AnimateSequence("CompleteKerning")
	end

	var_5_0._sequences.CompleteKerning = var_5_62
	...
	var_5_8:RegisterAnimationSequence("ShowTierAlt", var_5_64)

	local function var_5_65()
		var_5_8:AnimateSequence("ShowTierAlt")
	end

	var_5_0._sequences.ShowTierAlt = var_5_65

	local function var_5_66()
		return
	end

	var_5_0._sequences.CompleteBPTierPos = var_5_66
	...
	var_5_8:RegisterAnimationSequence("CompleteBPTierAspect", var_5_68)

	local function var_5_69()
		var_5_8:AnimateSequence("CompleteBPTierAspect")
	end

	var_5_0._sequences.CompleteBPTierAspect = var_5_69
	...
	var_5_10:RegisterAnimationSequence("BattlePassGifting", var_5_71)
	...
	var_5_12:RegisterAnimationSequence("BattlePassGifting", var_5_72)

	local function var_5_73()
		var_5_10:AnimateSequence("BattlePassGifting")
		var_5_12:AnimateSequence("BattlePassGifting")
	end

	var_5_0._sequences.BattlePassGifting = var_5_73
