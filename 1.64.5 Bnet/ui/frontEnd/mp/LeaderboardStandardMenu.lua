...
function LeaderboardStandardMenu(arg_2_0, arg_2_1)
	local var_2_0 = LUI.UIElement.new()

	var_2_0.id = "LeaderboardStandardMenu"
	...
	var_2_0.bindButton:addEventHandler("button_alt1", function(arg_4_0, arg_4_1)
		local var_4_0 = arg_4_1.controller or var_2_1

		ACTIONS.OpenMenu("LeaderboardFilterMenu", true, var_4_0)
	end)
	var_2_0.bindButton:addEventHandler("button_alt2", function(arg_5_0, arg_5_1)
		local var_5_0 = arg_5_1.controller or var_2_1

		ACTIONS.OpenMenu("LeaderboardSelectModeMenu", true, var_5_0)
	end)
...
MenuBuilder.registerType("LeaderboardStandardMenu", LeaderboardStandardMenu)
LockTable(_M)
