	...
	function var_4_5.MakeDataSourceAtIndex(arg_5_0, arg_5_1)
		...
		function var_5_3.MakeDataSourceAtIndex(arg_6_0, arg_6_1)
			return {
				...
				operatorXpScale = LUI.DataSourceInGlobalModel.new(var_5_1 .. ".operatorXpScale." .. arg_6_1),
...
function PlaylistMenu(arg_11_0, arg_11_1)
	...
	var_11_10:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 650, _1080p * 1730, _1080p * 295, _1080p * 795)
