...
local function var_0_2(arg_3_0, arg_3_1, arg_3_2)
	...
	arg_3_0:registerEventHandler("update_lobby", function(arg_6_0, arg_6_1)
		Lobby.UpdateClientCharactersDelayed(arg_3_0, arg_3_1, var_3_0, function(arg_7_0)
			arg_3_0._clientCharacterMap = arg_7_0

			arg_3_0:UpdateClientCharacters(arg_3_1)
			arg_3_0:UpdateMatchStatusButton(arg_3_1)
		end)
	end)
...
function LobbyBattleRoyale(arg_8_0, arg_8_1)
	...
	local var_8_3
	local var_8_4 = MenuBuilder.BuildRegisteredType("LobbyBattleRoyaleButtons", {
		controllerIndex = var_8_1
	})

	var_8_4.id = "LobbyBattleRoyaleButtons"

	var_8_4:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 1523, _1080p * 1824, _1080p * 831, _1080p * 1026)
	var_8_0:addElement(var_8_4)

	var_8_0.LobbyBattleRoyaleButtons = var_8_4
	...
	var_8_4:RegisterAnimationSequence("MenuOpen", var_8_6)

	local function var_8_7()
		var_8_4:AnimateSequence("MenuOpen")
	end

	var_8_0._sequences.MenuOpen = var_8_7
