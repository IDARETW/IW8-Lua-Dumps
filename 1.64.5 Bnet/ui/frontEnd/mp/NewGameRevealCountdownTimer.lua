...
local function var_0_3(arg_6_0, arg_6_1)
	local var_6_0 = Dvar.DHEEJCCJBH("OLKNPPNSP")
...
local function var_0_4(arg_7_0, arg_7_1)
	...
	if arg_7_1.gameRevealType == MAIN_MENU.NGGameRevealType.Cortez then
		local var_7_5, var_7_6, var_7_7 = MAIN_MENU.GetCortezProductOwned(arg_7_1.controllerIndex, true)
		local var_7_8 = var_7_5.owned or var_7_6.owned

		if (STORE.IsCortezOwned(arg_7_1.controllerIndex) or var_7_8) and var_7_4 >= MAIN_MENU.NGBladeStates.CortezReleaseCountdown then
...
function NewGameRevealCountdownTimer(arg_17_0, arg_17_1)
	...
	var_17_10:SetAnchorsAndPosition(0, 0, 0, 0, _1080p * 18, _1080p * -249, _1080p * 16, _1080p * -14)
