...
local function var_0_1(arg_2_0, arg_2_1, arg_2_2)
	Lobby.ActivateBRTutorialInit(arg_2_2.tutorialType)
...
local function var_0_3(arg_4_0, arg_4_1, arg_4_2)
	local var_4_0 = Lobby.BRTutorialLobbyData[arg_4_2]
...
local function var_0_4(arg_5_0, arg_5_1, arg_5_2)
	...
	Lobby.StartBRTutorial(arg_5_1, arg_5_2)
end

local function var_0_5(arg_6_0, arg_6_1, arg_6_2)
	local var_6_0 = Lobby.BRTutorialLobbyData[arg_6_2.tutorialType]
	...
	if not var_6_1 then
		...
		arg_6_0.bindButton:addEventHandler("button_secondary", function(arg_7_0, arg_7_1)
			var_0_3(arg_6_0, arg_6_1, arg_6_2.tutorialType)
		...
		if arg_6_2.needContinue and var_6_4 then
			...
			LUI.AddUIHoldButtonLogic(arg_6_0.StartButton, arg_6_1, {
				...
				onFill = function()
					var_0_4(arg_6_0, arg_6_1, arg_6_2.tutorialType)
	...
	arg_6_0.Reward:SetFocusable(false)
...
function LobbyWarzoneTutorial(arg_10_0, arg_10_1)
	...
	var_10_6:SetAnchorsAndPosition(0.5, 0.5, 0.5, 0.5, _1080p * -864, _1080p * 864, _1080p * -428, _1080p * 428)
	...
	var_10_10:setText(ToUpperCase(Engine.CBBHFCGDIC("LUA_MENU/MAPNAME_BR_TUT2")), 0)
	...
	var_10_10:SetAnchorsAndPosition(0.5, 0.5, 0, 1, _1080p * -596, _1080p * 169, _1080p * 651, _1080p * 701)
	...
	var_10_12:SetRGBFromTable(SWATCHES.CH2.CH2DarkHilite, 0)
	...
	var_10_20.Frame:SetRGBFromTable(SWATCHES.CH2.CH2DarkHilite, 0)
	var_10_20.Fill:SetRGBFromTable(SWATCHES.CH2.CH2_Highlight, 0)
	...
	var_10_26:SetRGBFromTable(SWATCHES.CH2.CH2DarkHilite, 0)
	...
	var_10_30:SetRGBFromTable(SWATCHES.CH2.CH2_Highlight, 0)
	...
	var_10_32:SetRGBFromTable(SWATCHES.CH2.CH2DarkHilite, 0)
	...
	var_10_34:SetRGBFromTable(SWATCHES.CH2.CH2DarkHilite, 0)
...
LUI.FlowManager.RegisterStackPopBehaviour("LobbyWarzoneTutorial", var_0_0)
LockTable(_M)
