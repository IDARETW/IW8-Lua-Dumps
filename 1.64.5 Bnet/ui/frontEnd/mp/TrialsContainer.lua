...
local function var_0_1(arg_2_0)
	return Engine.CFHBIHABCB(arg_2_0) and Engine.DBEGJIECGB(MAIN_MENU.GameModeEnumValues.MP) and CSV.trialMissionTable or CSV.trialMissionTableF2P
end
...
local function var_0_7(arg_11_0, arg_11_1)
	...
	local var_11_1 = SEASON.GetLocalizedName()
	local var_11_2 = {}
	...
	for iter_11_0 = 0, var_11_3 - 1 do
		...
		if var_11_4.season and var_11_4.season ~= "" and not var_0_6(var_11_2, tonumber(var_11_4.season)) then
			local var_11_5 = {
				name = Engine.CFHBIHABCB(arg_11_1) and SEASON.GetLocalizedName({
					seasonDataNumToUse = tonumber(var_11_4.season)
				}) or var_11_1,
