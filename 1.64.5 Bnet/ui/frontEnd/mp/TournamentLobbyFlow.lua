...
local function var_0_2(arg_2_0, arg_2_1)
	...
	local var_2_0 = Tournament.BJGJIJIEGG()
	local var_2_1 = Tournament.DEADJEGBCJ()

	if Tournament.CFBFHBBI() and arg_2_0._state ~= var_0_0.versus and Tournament.DDDCCIHAJI(var_2_0, var_2_1) then
