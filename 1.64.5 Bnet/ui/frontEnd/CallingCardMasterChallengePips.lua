...
local function var_0_0(arg_1_0, arg_1_1)
	if arg_1_0._pips[arg_1_1] then
		if arg_1_0._pips[arg_1_0._selectedPip]:GetComplete() then
			WZWIP.AnimateThemeElement(arg_1_0._pips[arg_1_0._selectedPip], "Complete")
		elseif arg_1_0._currentTier == arg_1_0._selectedPip then
			WZWIP.AnimateThemeElement(arg_1_0._pips[arg_1_0._selectedPip], "Current")
		elseif arg_1_0._pips[arg_1_0._selectedPip]:GetUnlocked() then
			WZWIP.AnimateThemeElement(arg_1_0._pips[arg_1_0._selectedPip], "Unlocked")
		else
			WZWIP.AnimateThemeElement(arg_1_0._pips[arg_1_0._selectedPip], "Locked")
		end

		WZWIP.AnimateThemeElement(arg_1_0._pips[arg_1_1], "Select")
...
local function var_0_1(arg_2_0, arg_2_1, arg_2_2)
	local var_2_0 = arg_2_2.currentTier

	arg_2_0._currentTier = var_2_0
	...
	local var_2_1 = arg_2_0._pipHeight / 2

	arg_2_0._selectedPip = 1

	for iter_2_1 = 1, arg_2_1 do
		local var_2_2 = MenuBuilder.BuildRegisteredType("MasterChallengePip", {
			controllerIndex = arg_2_0._controllerIndex
		})

		var_2_2:SetAnchorsAndPosition(0, 1, 0, 1, 0, arg_2_0._pipWidth, 0, arg_2_0._pipHeight)
		arg_2_0._pipContainer:addElement(var_2_2)

		local var_2_3 = iter_2_1 < var_2_0 or var_2_0 == arg_2_1 and arg_2_2.barProgress == 1

		var_2_2.Tier:setText(Engine.JCBDICCAH(iter_2_1))

		if iter_2_1 == var_2_0 or var_2_3 then
			if iter_2_1 == var_2_0 then
				WZWIP.AnimateThemeElement(var_2_2, "Current")
			else
				WZWIP.AnimateThemeElement(var_2_2, "Unlocked")
			end

			var_2_2:SetUnlocked(true)
		else
			WZWIP.AnimateThemeElement(var_2_2, "Locked")
			var_2_2:SetUnlocked(false)
		end

		if var_2_3 then
			WZWIP.AnimateThemeElement(var_2_2, "Complete")
			var_2_2:SetComplete(true)
		end

		table.insert(arg_2_0._pips, var_2_2)
	end
end
