...
local function var_0_0(arg_1_0, arg_1_1, arg_1_2)
	...
	local var_1_1 = "BATTLEPASS/CURRENT_TIER"

	if var_1_0 == BATTLEPASS.GetMaxTier() then
		var_1_1 = "BATTLEPASS/CURRENT_TIER_MAX"
	end

	arg_1_0.TierLabel:setText(Engine.CBBHFCGDIC(var_1_1, var_1_0))
end
