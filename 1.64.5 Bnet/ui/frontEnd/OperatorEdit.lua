...
function OperatorEdit(arg_8_0, arg_8_1)
	...
	var_8_14:SetRGBFromTable(SWATCHES.CAC.nodeGlow, 0)
	...
	var_8_12:RegisterAnimationSequence("Preview", var_8_27)

	local function var_8_28()
		var_8_12:AnimateSequence("Preview")
	end

	var_8_0._sequences.Preview = var_8_28
