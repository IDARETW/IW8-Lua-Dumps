...
function ManageRegimentMenu(arg_4_0, arg_4_1)
	...
	if not CONDITIONS.InGameSPOrFrontendMP(var_4_0) then
		local var_4_9 = MenuBuilder.BuildRegisteredType("MenuBackgroundImage", {
			controllerIndex = var_4_1
		})

		var_4_9.id = "MenuBackgroundImage"

		var_4_9:SetAnchorsAndPosition(0, 0, 0, 0, 0, 0, 0, 0)
		var_4_0:addElement(var_4_9)

		var_4_0.MenuBackgroundImage = var_4_9
	end
