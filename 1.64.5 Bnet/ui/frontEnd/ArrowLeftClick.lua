...
local function var_0_0(arg_1_0, arg_1_1, arg_1_2)
	...
	arg_1_0:addEventHandler("button_action", function()
		local var_4_0 = "MovedLeft"
		local var_4_1 = "button_shoulderl"
...
function ArrowLeftClick(arg_5_0, arg_5_1)
	...
	var_5_4:setImage(RegisterMaterial("wdg_selection_arrow_left_1"), 0)
	...
	var_5_4:RegisterAnimationSequence("MovedLeft", var_5_12)

	local function var_5_13()
		var_5_4:AnimateSequence("MovedLeft")
	end

	var_5_0._sequences.MovedLeft = var_5_13

	var_5_0:addEventHandler("grid_focus_left_blocked", function(arg_11_0, arg_11_1)
	...
	var_5_0:addEventHandler("grid_focus_left_not_blocked", function(arg_12_0, arg_12_1)
	...
	var_5_0:addEventHandler("arrow_button_left_moved", function(arg_13_0, arg_13_1)
		if not arg_13_1.controller then
			local var_13_0 = var_5_1
		end

		ACTIONS.AnimateSequence(var_5_0, "MovedLeft")
	end)
	var_5_0:addEventHandler("arrow_button_left_blocked", function(arg_14_0, arg_14_1)
	...
	var_5_0:addEventHandler("arrow_button_left_not_blocked", function(arg_15_0, arg_15_1)
	...
	var_5_0:addEventHandler("grid_focus_left_moved", function(arg_16_0, arg_16_1)
...
MenuBuilder.registerType("ArrowLeftClick", ArrowLeftClick)
LockTable(_M)
