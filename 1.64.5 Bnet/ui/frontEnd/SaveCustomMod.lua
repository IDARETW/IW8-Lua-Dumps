...
local function var_0_4(arg_4_0, arg_4_1, arg_4_2)
	...
	LAYOUT.AddAspectRatioFadeFrameWithOptions(arg_4_0, arg_4_1, {
		addWorldBlur = true,
		darkenerOpacity = 0.9,
...
function SaveCustomMod(arg_9_0, arg_9_1)
	...
	if CONDITIONS.IsWZWipDvarEnabled() then
		var_9_6.BotBorderWZ:SetRGBFromTable(SWATCHES.CH2.WZGenericPopupFrame, 0)
	end

	if CONDITIONS.IsWZWipDvarEnabled() then
		var_9_6.TopBorderWZ:SetRGBFromTable(SWATCHES.CH2.WZGenericPopupFrame, 0)
	end
	...
	var_9_14:RegisterAnimationSequence("WZSetup", var_9_21)

	local function var_9_22()
		var_9_14:AnimateSequence("WZSetup")
	end

	var_9_0._sequences.WZSetup = var_9_22

	function var_9_0.addButtonHelperFunction(arg_12_0, arg_12_1)
	...
	local var_9_23 = LUI.UIBindButton.new()

	var_9_23.id = "selfBindButton"

	var_9_0:addElement(var_9_23)

	var_9_0.bindButton = var_9_23

	var_9_0.bindButton:addEventHandler("button_secondary", function(arg_13_0, arg_13_1)
