...
function VGPreOrderOperatorPackUltimate(arg_1_0, arg_1_1)
	local var_1_0 = LUI.UIElement.new()

	var_1_0:SetAnchorsAndPosition(0, 1, 0, 1, 0, 480 * _1080p, 0, 380 * _1080p)

	var_1_0.id = "VGPreOrderOperatorPackUltimate"
	...
	var_1_6:setText("VGPreOrderOperatorPackUltimate", 0)
