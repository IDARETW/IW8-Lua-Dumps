...
local function var_0_0(arg_1_0, arg_1_1)
	local var_1_0 = tonumber(Engine.DEIDGHDBHD() or Engine.DCJHCAFIIA())
	...
	if var_1_3 > 0 then
		...
		if var_1_3 > 86400 then
			if var_1_2 then
				arg_1_0.Time:SetCustomFormat(arg_1_1 and "TRIALEVENT/TIMER_ENDS_IN_DAYS" or "TRIALEVENT/TIMER_IN_DAYS")
			else
				arg_1_0.Time:SetCustomFormat(arg_1_1 and "TRIALEVENT/TIMER_NEXT_IN_DAYS" or "TRIALEVENT/TIMER_IN_DAYS")
			end

			arg_1_0.Time:SetCustomFormatType(LUI.UICountdown.CustomFormatType.DAYHRMIN)
		else
			if var_1_2 then
				arg_1_0.Time:SetCustomFormat(arg_1_1 and "TRIALEVENT/TIMER_ENDS_IN_HOURS" or "TRIALEVENT/TIMER_IN_HOURS")
			else
				arg_1_0.Time:SetCustomFormat(arg_1_1 and "TRIALEVENT/TIMER_NEXT_IN_HOURS" or "TRIALEVENT/TIMER_IN_HOURS")
			end

			arg_1_0.Time:SetCustomFormatType(LUI.UICountdown.CustomFormatType.HRMINSEC)
		end

		ACTIONS.AnimateSequence(arg_1_0, var_1_2 and "EventEnding" or "NextEvent")
...
function TrialEventAccorionTimer(arg_3_0, arg_3_1)
	...
	var_3_4:RegisterAnimationSequence("NextEvent", var_3_31)
	...
	var_3_6:RegisterAnimationSequence("NextEvent", var_3_32)

	local function var_3_33()
		var_3_4:AnimateSequence("NextEvent")
		var_3_6:AnimateSequence("NextEvent")
	end

	var_3_0._sequences.NextEvent = var_3_33
	...
	var_3_4:RegisterAnimationSequence("EventEnding", var_3_35)
	...
	var_3_6:RegisterAnimationSequence("EventEnding", var_3_36)

	local function var_3_37()
		var_3_4:AnimateSequence("EventEnding")
		var_3_6:AnimateSequence("EventEnding")
	end

	var_3_0._sequences.EventEnding = var_3_37
