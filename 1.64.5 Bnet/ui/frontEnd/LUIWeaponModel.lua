...
function LUI.UIWeaponModel.SetOffsetsAndRotations(arg_5_0, arg_5_1)
	...
	arg_5_0._currentOffsetData = var_5_1
end

function LUI.UIWeaponModel.GetCurrentOffsetsAndRotations(arg_6_0)
	return arg_6_0._currentOffsetData
end

function LUI.UIWeaponModel.GetOffsetsAndRotations(arg_7_0, arg_7_1)
	assert(arg_7_0._clientWeaponIndex)

	local var_7_0 = arg_7_0._clientWeaponIndex
	local var_7_1 = FrontEndScene.GetWeaponModelOffset(arg_7_1, arg_7_0._dataCSVFile)

	if Engine.BHICADFIHA() and Dvar.IBEGCHEFE("LPKPKPTMKR") then
		var_7_1.xOffset, var_7_1.yOffset, var_7_1.zOffset = arg_7_0:GetDebugOffsets(var_7_1.xOffset, var_7_1.yOffset, var_7_1.zOffset)
	end

	if Engine.BHICADFIHA() and Dvar.IBEGCHEFE("LPKPKPTMKR") then
		var_7_1.pitch, var_7_1.yaw, var_7_1.roll = arg_7_0:GetDebugRotations(var_7_1.pitch, var_7_1.yaw, var_7_1.roll)
	end

	return var_7_1
end

function LUI.UIWeaponModel.SetWeaponModel(arg_8_0, arg_8_1)
	assert(arg_8_0._clientWeaponIndex)

	local var_8_0 = arg_8_0._clientWeaponIndex

	FrontEndScene.SetWeaponModel(arg_8_0, var_8_0, arg_8_1)
	arg_8_0:SetOffsetsAndRotations(arg_8_1)
	ClientWeapon.BHDGACCFEF(var_8_0, true)
end

function LUI.UIWeaponModel.GetEntityNum(arg_9_0)
	assert(arg_9_0._clientWeaponIndex)

	local var_9_0 = arg_9_0._clientWeaponIndex

	return ClientWeapon.CJABBBHHFC(var_9_0)
end
