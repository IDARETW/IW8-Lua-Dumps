...
function CPIntelAARTemplate(arg_1_0, arg_1_1)
	...
	var_1_18:SetRGBFromTable(SWATCHES.genericMenu.scrollbarThumb, 0)
	...
	var_1_22:SetRGBFromTable(SWATCHES.genericMenu.scrollbarThumb, 0)
	...
	var_1_24:SetRGBFromTable(SWATCHES.HUD.HUDShadow, 0)
