...
function DecryptionHeader(arg_1_0, arg_1_1)
	...
	var_1_5:SetRGBFromTable(SWATCHES.text.secondaryText, 0)
	...
	var_1_7:SetRGBFromTable(SWATCHES.Scoreboard.background, 0)
	...
	var_1_10:SetRGBFromTable(SWATCHES.text.secondaryText, 0)
