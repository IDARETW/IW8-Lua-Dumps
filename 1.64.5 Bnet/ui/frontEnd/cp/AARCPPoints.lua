...
local function var_0_2(arg_1_0, arg_1_1, arg_1_2)
	...
	if CONDITIONS.IsCoreMultiplayerNotBr() then
		...
		arg_1_0.WZSmallPlayerCard:SetDataSource(var_1_1, arg_1_1)
	end
...
function AARCPPoints(arg_3_0, arg_3_1)
	...
	if CONDITIONS.IsCoreMultiplayerNotBr() then
		var_3_5 = MenuBuilder.BuildRegisteredType("SmallPlayerCard", {
			controllerIndex = var_3_1
		})
		var_3_5.id = "SmallPlayerCard"

		var_3_5.GradientBacker:SetAlpha(0, 0)
		var_3_5:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 702, _1080p * 1222, _1080p * 855, _1080p * 979)
		var_3_0:addElement(var_3_5)

		var_3_0.SmallPlayerCard = var_3_5
	end

	local var_3_6

	if not CONDITIONS.IsCoreMultiplayerNotBr() then
		var_3_6 = MenuBuilder.BuildRegisteredType("WZSmallPlayerCard", {
			controllerIndex = var_3_1
		})
		var_3_6.id = "WZSmallPlayerCard"
		...
		var_3_0.WZSmallPlayerCard = var_3_6
	end
	...
	if CONDITIONS.IsCoreMultiplayerNotBr() then
		...
		var_3_5:RegisterAnimationSequence("Intro", var_3_19)
	end
	...
	var_3_0._sequences.Outro = var_3_27
