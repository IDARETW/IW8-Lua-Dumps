...
function ExitFullscreenVideoButton(arg_2_0, arg_2_1)
	...
	local var_2_3
	local var_2_4 = MenuBuilder.BuildRegisteredType("ExitFullscreenButton", {
		controllerIndex = var_2_1
	})

	var_2_4.id = "ExitFullscreenButton"

	var_2_4:SetAnchorsAndPosition(1, 0, 1, 0, _1080p * -38, _1080p * -6, _1080p * -37, _1080p * -6)
	var_2_0:addElement(var_2_4)

	var_2_0.ExitFullscreenButton = var_2_4
