...
local function var_0_4(arg_6_0, arg_6_1)
	...
	return function(arg_7_0, arg_7_1, arg_7_2)
		...
		if not var_7_1.isUnlocked then
			local var_7_2 = BATTLEPASS.GetLootTierMap()[var_7_1.lootID]

			if var_7_2 then
				var_7_1.unlockText = Engine.CBBHFCGDIC("BATTLEPASS/LOCKED_INCOMPLETE_WITH_BATTLEPASS", var_7_2)
			end
		end
