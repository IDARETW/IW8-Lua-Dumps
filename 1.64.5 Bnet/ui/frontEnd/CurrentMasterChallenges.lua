...
local function var_0_3(arg_3_0, arg_3_1)
	...
	arg_3_0.ChallengeCompletionStatus:setText(ToUpperCase(Engine.CBBHFCGDIC("CHALLENGE/MASTER_CHALLENGE_COMPLETION", var_3_1, var_3_0)))
...
function CurrentMasterChallenges(arg_5_0, arg_5_1)
	...
	var_5_6:RegisterAnimationSequence("AR", var_5_9)

	local function var_5_10()
		var_5_6:AnimateSequence("AR")
	end

	var_5_0._sequences.AR = var_5_10
	...
	var_5_4:RegisterAnimationSequence("WZWipSetup", var_5_12)
	...
	var_5_6:RegisterAnimationSequence("WZWipSetup", var_5_13)
	...
	var_5_0._sequences.WZWipSetup = var_5_14
