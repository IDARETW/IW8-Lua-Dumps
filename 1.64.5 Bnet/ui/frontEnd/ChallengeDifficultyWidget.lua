...
function ChallengeDifficultyWidget(arg_1_0, arg_1_1)
	...
	var_1_4:RegisterAnimationSequence("GamesOfSummer", var_1_21)
	...
	var_1_6:RegisterAnimationSequence("GamesOfSummer", var_1_22)

	local function var_1_23()
		var_1_4:AnimateSequence("GamesOfSummer")
		var_1_6:AnimateSequence("GamesOfSummer")
	end

	var_1_0._sequences.GamesOfSummer = var_1_23
