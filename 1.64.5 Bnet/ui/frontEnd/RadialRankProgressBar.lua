...
local function var_0_0(arg_1_0, arg_1_1, arg_1_2)
	local var_1_0 = PROGRESSION.GetPlayerProgressionData({
		...
		_seasonNumOverride = arg_1_2
	})

	arg_1_0.RankIcon:setImage(RegisterMaterial(var_1_0._rankIcon))
	arg_1_0.RankName:setText(var_1_0._rankName)
	arg_1_0.RankNum:setText(var_1_0._rankDisplay)
	ACTIONS.AnimateSequence(arg_1_0, var_1_0._isUsingSeasonalRank and "ElderRank" or "StandardRank")
	arg_1_0.Progress:SetProgressInC(tonumber(var_1_0._rankPercentage), 0, 0)
end
...
local function var_0_1(arg_2_0, arg_2_1, arg_2_2)
	...
	var_0_0(arg_2_0, arg_2_1, SEASON.GetCurrentSeasonDataNum())
end
