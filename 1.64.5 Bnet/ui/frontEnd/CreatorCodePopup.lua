	...
	local function var_1_2(arg_4_0)
		if Loot.BCBJJICIBA(arg_1_0._controllerIndex, arg_4_0) == 1 then
			...
			if Dvar.IBEGCHEFE("MTQRRPSQLR") then
				var_4_2 = Engine.CBBHFCGDIC("CONTENT_CREATOR_CODES/" .. var_4_1)
			end
...
function CreatorCodePopup(arg_13_0, arg_13_1)
	...
	var_13_12.id = "CoDLogo"

	var_13_12:setImage(RegisterMaterial("logo_cod_title_ch2"), 0)
	var_13_12:SetAnchorsAndPosition(0.5, 0.5, 0.5, 0.5, _1080p * -813, _1080p * -281, _1080p * -66, _1080p * 66)
	var_13_0:addElement(var_13_12)

	var_13_0.CoDLogo = var_13_12
