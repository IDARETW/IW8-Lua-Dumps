...
function OperatorLootTauntVO(arg_4_0, arg_4_1)
	local var_4_0 = LUI.UIElement.new()

	var_4_0:SetAnchorsAndPosition(0, 1, 0, 1, 0, 380 * _1080p, 0, 200 * _1080p)

	var_4_0.id = "OperatorLootTauntVO"
	...
	var_4_4:SetAnchorsAndPosition(0, 1, 0, 1, 0, _1080p * 380, 0, _1080p * 200)
	var_4_0:addElement(var_4_4)

	var_4_0.Intro = var_4_4

	local var_4_5
	local var_4_6 = MenuBuilder.BuildRegisteredType("DiagonalCorners", {
		controllerIndex = var_4_1
	})

	var_4_6.id = "DiagonalCorners"

	var_4_6:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * -6, _1080p * 388, _1080p * -6, _1080p * 205)
	var_4_0:addElement(var_4_6)

	var_4_0.DiagonalCorners = var_4_6
	...
	var_4_8:SetAnchorsAndPosition(0, 0, 0, 1, 0, 0, 0, _1080p * 200)
	...
	var_4_11:SetRGBFromTable(SWATCHES.CAC.labelText, 0)
	var_4_11:SetAlpha(0.7, 0)
	var_4_11:SetAnchorsAndPosition(0, 0, 0, 1, _1080p * 380, _1080p * -380, 0, _1080p * 200)
	...
	var_4_13:SetAnchorsAndPosition(0, 1, 0, 1, 0, _1080p * 388, _1080p * 210, _1080p * 232)
...
MenuBuilder.registerType("OperatorLootTauntVO", OperatorLootTauntVO)
LockTable(_M)
