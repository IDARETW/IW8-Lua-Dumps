...
local function var_0_1(arg_1_0, arg_1_1, arg_1_2, arg_1_3, arg_1_4)
	...
	arg_1_0.StickerLocationButtonGrid:SetRefreshChild(function(arg_2_0, arg_2_1, arg_2_2)
		...
		local var_2_6 = LOOT.GetItemGameSource({
			type = LOOT.itemTypes.WEAPON,
			ref = var_1_0
		})
		local var_2_7 = LOOT.IsCategoryNew(arg_1_1, LOOT.itemTypes.STICKER, var_2_6)

		arg_2_0:UpdateBreadcrumb(var_2_7)
	end)
...
function StickerLocationSelect(arg_6_0, arg_6_1)
	...
	if CONDITIONS.IsWZWipFlowEnabled() then
		local var_6_6 = MenuBuilder.BuildRegisteredType("WZSnipeBackgroundSceneOverlay", {
			controllerIndex = var_6_1
		})

		var_6_6.id = "WZWipSnipeBackgroundSceneOverlay"

		var_6_6:SetAnchorsAndPosition(0, 0, 0, 0, 0, 0, 0, 0)
		var_6_0:addElement(var_6_6)

		var_6_0.WZWipSnipeBackgroundSceneOverlay = var_6_6
	end
	...
	var_6_9.id = "StickerLocationButtonGrid"

	var_6_9:setUseStencil(true)
	var_6_9:SetAnchorsAndPosition(0.5, 0.5, 1, 0, _1080p * -632, _1080p * 632, _1080p * -235, _1080p * -101)
	var_6_0:addElement(var_6_9)

	var_6_0.StickerLocationButtonGrid = var_6_9

	local var_6_10
	local var_6_11 = MenuBuilder.BuildRegisteredType("TabBacker", {
		controllerIndex = var_6_1
	})
	...
	local var_6_12
	local var_6_13 = MenuBuilder.BuildRegisteredType("MenuTitle", {
		controllerIndex = var_6_1
	})

	var_6_13.id = "MenuTitle"

	var_6_13.MenuTitle:setText(ToUpperCase(Engine.CBBHFCGDIC("LUA_MENU/STICKER_SELECT_TITLE")), 0)
	var_6_13.Line:SetLeft(0, 0)
	var_6_13:SetAnchorsAndPosition(0, 1, 0, 1, 0, _1080p * 1020, 0, _1080p * 100)
	var_6_0:addElement(var_6_13)

	var_6_0.MenuTitle = var_6_13
	...
	local var_6_16
	local var_6_17 = MenuBuilder.BuildRegisteredType("GunsmithWeaponLevel", {
		controllerIndex = var_6_1
	})

	var_6_17.id = "GunsmithWeaponLevel"

	var_6_17:SetAnchorsAndPosition(1, 0, 0, 1, _1080p * -643, _1080p * -447, _1080p * 61, _1080p * 85)
	var_6_0:addElement(var_6_17)

	var_6_0.GunsmithWeaponLevel = var_6_17
