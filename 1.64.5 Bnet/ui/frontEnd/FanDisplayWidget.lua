...
local function var_0_0(arg_1_0, arg_1_1, arg_1_2)
	...
	for iter_1_0 = 0, arg_1_2.numWidgets - 1 do
		...
		if arg_1_2.widget == "LootItemCardMini" then
			arg_1_0["Widget" .. iter_1_0]:registerEventHandler("gain_focus", function(arg_2_0, arg_2_1)
				local var_2_0 = arg_1_0:GetAlpha() > 0

				if arg_2_1.focusType == 1 and var_2_0 then
...
local function var_0_1(arg_3_0, arg_3_1, arg_3_2)
	arg_3_0.BuildWidgets = var_0_0
end

function FanDisplayWidget(arg_4_0, arg_4_1)
	local var_4_0 = LUI.UIElement.new()

	var_4_0:SetAnchorsAndPosition(0, 1, 0, 1, 0, 150 * _1080p, 0, 200 * _1080p)

	var_4_0.id = "FanDisplayWidget"
	...
	var_4_4.id = "PlacementBG"

	var_4_4:SetRGBFromTable(SWATCHES.Scoreboard.grayText, 0)
	var_4_4:SetAnchorsAndPosition(0, 1, 0, 1, 0, _1080p * 150, 0, _1080p * 200)
	var_4_0:addElement(var_4_4)

	var_4_0.PlacementBG = var_4_4
