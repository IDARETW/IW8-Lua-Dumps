...
local function var_0_4(arg_10_0, arg_10_1, arg_10_2)
	...
	arg_10_0.isQuickAccessShortcutsDisabled = true
end
...
function CODAccountSettings(arg_11_0, arg_11_1)
	...
	local var_11_25
	local var_11_26 = LUI.UIText.new()

	var_11_26.id = "TermsOfUse"

	var_11_26:SetRGBFromTable(SWATCHES.Popups.bodyTxt, 0)
	var_11_26:setText(Engine.CBBHFCGDIC("CODACCOUNT/TERMS_OF_USE_LINK"), 0)
	var_11_26:SetFont(FONTS.GetFont(FONTS.MainRegular.File))
	var_11_26:SetAlignment(LUI.Alignment.Left)
	var_11_26:SetAnchorsAndPosition(0.5, 0.5, 0.5, 0.5, _1080p * 302, _1080p * 830, _1080p * 104, _1080p * 122)
	var_11_0:addElement(var_11_26)

	var_11_0.TermsOfUse = var_11_26

	local var_11_27
	local var_11_28 = LUI.UIText.new()

	var_11_28.id = "PrivacyPolicy"

	var_11_28:SetRGBFromTable(SWATCHES.Popups.bodyTxt, 0)
	var_11_28:setText(Engine.CBBHFCGDIC("CODACCOUNT/PRIVACY_POLICY_LINK"), 0)
	var_11_28:SetFont(FONTS.GetFont(FONTS.MainRegular.File))
	var_11_28:SetAlignment(LUI.Alignment.Left)
	var_11_28:SetAnchorsAndPosition(0.5, 0.5, 0.5, 0.5, _1080p * 302, _1080p * 830, _1080p * 127, _1080p * 145)
	var_11_0:addElement(var_11_28)

	var_11_0.PrivacyPolicy = var_11_28
	...
	var_11_30:setText(Engine.CBBHFCGDIC("CODACCOUNT/UNLINK_LINK"), 0)
	var_11_30:SetFont(FONTS.GetFont(FONTS.MainRegular.File))
	var_11_30:SetAlignment(LUI.Alignment.Left)
	var_11_30:SetAnchorsAndPosition(0.5, 0.5, 0.5, 0.5, _1080p * 302, _1080p * 830, _1080p * -56, _1080p * -38)
	var_11_0:addElement(var_11_30)

	var_11_0.Unlink = var_11_30

	local var_11_31
	local var_11_32 = MenuBuilder.BuildRegisteredType("ButtonPromptContainerHorizontal", {
		controllerIndex = var_11_1
	})

	var_11_32.id = "Prompts"

	if CONDITIONS.AlwaysFalse(var_11_0) then
		var_11_32.Label:setText("Prompts", 0)
	end

	var_11_32:SetAnchorsAndPosition(0.5, 0.5, 0.5, 0.5, _1080p * -763, _1080p * -663, _1080p * 246, _1080p * 277)
	var_11_0:addElement(var_11_32)

	var_11_0.Prompts = var_11_32
	...
	var_11_12:RegisterAnimationSequence("Arabic", var_11_35)
	...
	var_11_14:RegisterAnimationSequence("Arabic", var_11_36)
	...
	var_11_16:RegisterAnimationSequence("Arabic", var_11_37)
	...
	var_11_18:RegisterAnimationSequence("Arabic", var_11_38)
	...
	var_11_20:RegisterAnimationSequence("Arabic", var_11_39)
	...
	var_11_22:RegisterAnimationSequence("Arabic", var_11_40)
	...
	var_11_26:RegisterAnimationSequence("Arabic", var_11_41)
	...
	var_11_28:RegisterAnimationSequence("Arabic", var_11_42)
	...
	var_11_30:RegisterAnimationSequence("Arabic", var_11_43)
	...
	local function var_11_44()
		...
		var_11_26:AnimateSequence("Arabic")
		var_11_28:AnimateSequence("Arabic")
		var_11_30:AnimateSequence("Arabic")
	end

	var_11_0._sequences.Arabic = var_11_44
	...
	var_11_8:RegisterAnimationSequence("Anonymous", var_11_46)
	...
	var_11_16:RegisterAnimationSequence("Anonymous", var_11_47)
	...
	var_11_18:RegisterAnimationSequence("Anonymous", var_11_48)
	...
	var_11_20:RegisterAnimationSequence("Anonymous", var_11_49)
	...
	var_11_22:RegisterAnimationSequence("Anonymous", var_11_50)
	...
	var_11_26:RegisterAnimationSequence("Anonymous", var_11_51)
	...
	var_11_28:RegisterAnimationSequence("Anonymous", var_11_52)
	...
	var_11_30:RegisterAnimationSequence("Anonymous", var_11_53)
	...
	var_11_0._sequences.Anonymous = var_11_54
	...
	local var_11_55 = LUI.UIBindButton.new()

	var_11_55.id = "selfBindButton"

	var_11_0:addElement(var_11_55)

	var_11_0.bindButton = var_11_55
