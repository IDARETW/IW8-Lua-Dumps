CONDITIONS = {
	...
	ShowWZSeasonalOpeningScreenPC = function(arg_303_0)
		local var_303_0 = Engine.BECCFCBIAA("hasSeenWZSeasonalOpeningScreenPC_Version", arg_303_0)
		local var_303_1 = Dvar.CFHDGABACF("NLPPPROSSP")

		return Dvar.IBEGCHEFE("MSQRKTTKSS") and var_303_0 < var_303_1 and not Dvar.IBEGCHEFE("MNPOQRNMTO")
	end,
	IsSpecificIntegerOmnvarEqualTo = function(arg_304_0, arg_304_1, arg_304_2)
		return Game.BFEEGCHICA(arg_304_0, arg_304_1) == arg_304_2
	end,
	IsSpecificIntegerOmnvarGreaterThan = function(arg_305_0, arg_305_1, arg_305_2)
		return arg_305_2 < Game.BFEEGCHICA(arg_305_0, arg_305_1)
	end,
	IsSpecificIntegerOmnvarGreaterThanOrEqualTo = function(arg_306_0, arg_306_1, arg_306_2)
		return arg_306_2 <= Game.BFEEGCHICA(arg_306_0, arg_306_1)
	end,
	IsSpecificIntegerOmnvarLessThan = function(arg_307_0, arg_307_1, arg_307_2)
		return arg_307_2 > Game.BFEEGCHICA(arg_307_0, arg_307_1)
	end,
	IsSpecificIntegerOmnvarLessThanOrEqualTo = function(arg_308_0, arg_308_1, arg_308_2)
		return arg_308_2 >= Game.BFEEGCHICA(arg_308_0, arg_308_1)
	end,
	IsSpecificOmnvarTrue = function(arg_309_0, arg_309_1)
		return Game.BFEEGCHICA(arg_309_0, arg_309_1)
	end,
	...
	IsUserAGuest = function(arg_336_0)
		return Engine.DBAEJAHFGJ(arg_336_0)
	end,
	IsUserSignedIn = function(arg_337_0)
		return Engine.CDCCDDJAJJ(arg_337_0)
	end,
	IsUserSignedInBnet = function(arg_338_0)
		return Engine.CDCCDDJAJJ(arg_338_0) and Engine.DBFCJBDJEC()
	end,
	IsUserSignedInBnetFrontend = function(arg_339_0)
		return Engine.CDCCDDJAJJ(arg_339_0) and Engine.DBFCJBDJEC() and Engine.DDJFBBJAIG()
	end,
	IsUserSignedInDemonware = function(arg_340_0)
		return Engine.BACCCIHGDG() and Engine.CJJAFGIFAC(arg_340_0)
	end,
	IsCplab = function()
	...
	IsCpRaidMode = function()
		local var_343_0 = Dvar.DHEEJCCJBH("NSQLTTMRMP")

		if Engine.EAIICIFIFA() and (var_343_0 == "cp_raid_complex" or var_343_0 == "cp_dntsk_raid") then
			return true
		else
			return false
		end
	...
	IsPearlHarbor = function()
		local var_347_0 = Game.ECIFCJJJIA()

		return var_347_0 == "phparade" or var_347_0 == "phstreets" or var_347_0 == "phspace"
	end,
	IsMoon = function()
		local var_348_0 = Game.ECIFCJJJIA()

		return var_348_0 == "moon_port" or var_348_0 == "moonjackal"
	end,
	IsTitan = function()
		local var_349_0 = Game.ECIFCJJJIA()

		return var_349_0 == "titan" or var_349_0 == "titanjackal"
	end,
	IsRogue = function()
	...
	IsHeist = function()
		...
		return var_352_0 == "heist" or var_352_0 == "heistspace"
	end,
	IsMars = function()
	...
	IsSPDummyTabletMap = function()
		local var_360_0 = Game.ECIFCJJJIA()

		return var_360_0 == "marines" or var_360_0 == "safehouse_finale"
	end,
	...
	IsBRQuarryTutorialMap = function()
		local var_366_0 = Dvar.DHEEJCCJBH("NSQLTTMRMP")

		if Game.GEAJDFCDC() then
			var_366_0 = Game.ECIFCJJJIA()
		end

		return var_366_0 == "mp_br_quarry"
	end,
	...
	IsBRSpectateEnabled = function(arg_370_0, arg_370_1)
		local var_370_0 = LUI.PostGameManager.IsBRExfilStarted(arg_370_1)

		return CONDITIONS.IsMagmaGameMode() and CONDITIONS.IsNotBloodMoneyAndIsNotRiskGametypeAndIsNotPayload() and not CONDITIONS.IsWZRumble() and not CONDITIONS.IsBRTutorial() and not var_370_0 and not CONDITIONS.IsBRX1Variant() and not CONDITIONS.IsBRRevealMode() and not CONDITIONS.IsBRRevealTwoMode()
	end,
	...
	IsSocialEnabledInMainMenu = function()
		local var_376_0 = Engine.FABABBDBA() and not Engine.GEHBEDCEC()

		return Dvar.IBEGCHEFE("MPNKQNOKKS") and not CONDITIONS.IsWeGameGovBanned() and not var_376_0
	end,
	...
	IsOnlineAndSignedIn = function(arg_382_0)
		return Engine.BACCCIHGDG() and Engine.BICHEEFHEC(arg_382_0) and Engine.CJJAFGIFAC(arg_382_0)
	end,
	...
	AreWeaponVariantsEnabled = function(arg_386_0)
		return Dvar.IBEGCHEFE("OLMOTLRSPK") == true and CONDITIONS.IsUserSignedInDemonware(arg_386_0)
	end,
	...
	ShouldDisplayUpsellPopup = function(arg_396_0)
		return Dvar.IBEGCHEFE("SSRQTKMLQ") and not Engine.CFHBIHABCB(arg_396_0) and not Engine.FABABBDBA() and Engine.BACCCIHGDG()
	end,
	ShouldDisplayAARUpsellPrompt = function(arg_397_0)
		return Dvar.IBEGCHEFE("MOMKSMKTOQ") and not Engine.CFHBIHABCB(arg_397_0) and not Engine.FABABBDBA()
	end,
	IsCampaignAllowed = function(arg_398_0)
		return Engine.CEGDBDIIIE(CoD.PlayMode.SP, arg_398_0)
	end,
	IsMultiplayerAllowed = function(arg_399_0)
		return Engine.CEGDBDIIIE(CoD.PlayMode.Core, arg_399_0)
	end,
	IsCoopAllowed = function(arg_400_0)
		return Engine.CEGDBDIIIE(CoD.PlayMode.Aliens, arg_400_0)
	end,
	...
	UsingWZLoadouts = function()
		if CONDITIONS.AreWZLoadoutsEnabled() then
			if Engine.DDJFBBJAIG() then
				...
				local var_405_0 = Dvar.DHEEJCCJBH("MOLPOSLOMO")

				return var_405_0 == "br" or var_405_0 == "brtdm"
			end
		end
	...
	IsBattlePassBundleTopperActive = function(arg_417_0)
		local var_417_0 = tonumber(Engine.DEIDGHDBHD())
		local var_417_1 = Dvar.CFHDGABACF("LKOKTLQSPT")

		return var_417_1 and var_417_0 < var_417_1 and not BATTLEPASS.IsOwned(arg_417_0)
	end,
	...
	AreTabletsFilteredOut = function()
		local var_425_0 = Dvar.DHEEJCCJBH("MSLKNNLLMN")

		for iter_425_0 in string.gmatch(var_425_0, "([^%s]+)") do
			if iter_425_0 == "tablet" then
				return true
			end
		end
	...
	PrivateListenAllowed = function(arg_433_0)
		local var_433_0 = LUI.FlowManager.GetScopedData(arg_433_0)
		local var_433_1 = Engine.EAIICIFIFA and not Dvar.IBEGCHEFE("MKQRLRTRNR")
		local var_433_2 = not Engine.CGABICJHAI() or Dvar.IBEGCHEFE("NRLPPKQTMN")

		return var_433_1 or var_433_2 or var_433_0.isTournament or Engine.BHICADFIHA()
	end,
	PrivateDsAllowed = function(arg_434_0)
		local var_434_0 = LUI.FlowManager.GetScopedData(arg_434_0)
		local var_434_1 = not Engine.EAIICIFIFA() or Dvar.IBEGCHEFE("MKQRLRTRNR")

		return Dvar.IBEGCHEFE("LMKKTLPSRN") == true and not var_434_0.isTournament and var_434_1
	end,
	...
	AreCPChallengesActive = function()
		local var_436_0 = Dvar.DHEEJCCJBH("MOLPOSLOMO")

		return IsPublicMatch() and var_436_0 == "cp_survival" or var_436_0 == "cp_wave_sv" and not IsSystemLink() or var_436_0 == "cp_specops" and not IsSystemLink()
	end,
	...
	IsArmoryEnabled = function(arg_440_0, arg_440_1)
		if Dvar.DHEEJCCJBH("MOLPOSLOMO") == "cp_wave_sv" and not Engine.DDJFBBJAIG() then
			return false
		else
			return Dvar.IBEGCHEFE("MRRPNNKKPO") and CONDITIONS.IsUserSignedInDemonware(arg_440_1)
		end
	end,
	...
	ShouldShowTFACodePopup = function(arg_452_0)
		local var_452_0 = Dvar.IBEGCHEFE("NMQSOPLONQ")

		if TwoFactorAuth.CCGEHFAJD(arg_452_0) then
			return false
		end

		return var_452_0
	end,
	IsDisplayingBattlePassAAR = function(arg_453_0)
		return arg_453_0 and arg_453_0._displayBattlePassInAAR
	end,
	...
	IsTierSaleEnabled = function()
		local var_457_0 = Dvar.DHEEJCCJBH("MQTOPKPMRS")

		if var_457_0 and var_457_0 ~= "" then
			local var_457_1 = Engine.CCEJJCCDEG(var_457_0)
			local var_457_2 = Dvar.CFHDGABACF("MOKSKKQRLK")

			return var_457_2 and var_457_2 > 0 and var_457_1 and var_457_1 > 0
		end
	end,
	...
	AreCompassEnemyElementsHidden = function(arg_483_0, arg_483_1)
		return Game.BFEEGCHICA(arg_483_1, "ui_compass_hide_enemy")
	end,
	...
	HasDoubleXPTokens = function(arg_496_0)
		return LOOT.HasDoubleXPToken(arg_496_0)
	end,
	...
	WeaponIndexIsPrimary = function(arg_498_0)
		return LUI.FlowManager.GetScopedData(arg_498_0).weaponSlot == WEAPON.PrimarySlot
	end,
	GunsmithCanMakeModification = function(arg_499_0, arg_499_1)
		if Engine.DDJFBBJAIG() and IsPublicMatch() and not MLG.IsCDLActive(arg_499_1) and not CONDITIONS.IsInGameBattlesMatch() then
			local var_499_0 = LUI.FlowManager.GetScopedData(arg_499_0)
			local var_499_1 = PlayerData.BFFBGAJGD(arg_499_1, LOADOUT.GetLoadoutStatsGroup()).squadMembers.loadouts[var_499_0.loadoutIndex].weaponSetups[var_499_0.weaponSlot]

			return GUNSMITH.CanMakeModification(arg_499_1, var_499_1.weapon:get())
		end

		return false
	end,
	AreInGameLoadoutTabsEnabled = function(arg_500_0, arg_500_1)
		return not Game.BFEEGCHICA(arg_500_1, "ui_only_default_loadouts") and Dvar.IBEGCHEFE("NTMRRKSKPQ") and PROGRESSION.AreCustomLoadoutsUnlocked(arg_500_1)
	end,
	...
	ShouldCreateKeybindLinkButton = function(arg_504_0)
		return arg_504_0._needKeybindLinkButton
	end,
	ShouldCreateMoreInfoInnerButton = function(arg_505_0)
		return arg_505_0._needMoreInfoInnerButton
	end,
	IsBrButtonLayoutActive = function(arg_506_0)
		return Engine.CAGFEHGHGH(arg_506_0)
	end,
	AreCDLRulesActive = function(arg_507_0)
		return MLG.IsCDLActive(arg_507_0)
	end,
	IsCODTvEnabled = function()
		return Dvar.IBEGCHEFE("LOOTSOTKLS")
	end,
	AreRestrictionsActive = function(arg_509_0)
		return CONDITIONS.AreCDLRulesActive(arg_509_0)
	end,
	...
	AreRestrictionsActiveAndBlueprintsAllowed = function(arg_515_0, arg_515_1)
		return CONDITIONS.AreRestrictionsActive(arg_515_1) and CONDITIONS.AllowBlueprintsWithRestriction()
	end,
	AreRestrictionsActiveAndBlueprintsBlocked = function(arg_516_0, arg_516_1)
		return CONDITIONS.AreRestrictionsActive(arg_516_1) and not CONDITIONS.AllowBlueprintsWithRestriction()
	end,
	EnableBlueprintsButton = function(arg_517_0, arg_517_1)
		return CONDITIONS.IsArmoryEnabled(arg_517_0, arg_517_1) and not CONDITIONS.AreRestrictionsActiveAndBlueprintsBlocked(arg_517_0, arg_517_1)
	end,
	EnableStoreBlueprintsButton = function(arg_518_0, arg_518_1)
		return CONDITIONS.IsBlueprintStoreEnabled() and not CONDITIONS.AreRestrictionsActiveAndBlueprintsBlocked(arg_518_0, arg_518_1)
	end,
	DynamicIconDebugEnabled = function()
		return Engine.BHICADFIHA() and Dvar.IBEGCHEFE("ui_debug_dynicons")
	end,
	IsEventPromoActive = function()
		local var_520_0 = Dvar.CFHDGABACF("RNNNLLQMN")

		return var_520_0 and var_520_0 ~= 0 or Dvar.IBEGCHEFE("lui_event_promo_banner_forced")
	end,
	...
	IsT9PremiumPlayer = function(arg_533_0)
		return OnlineProgression.CFEEHFADBE(arg_533_0, PROGRESSION.Title.T9)
	end,
	IsS4PremiumPlayer = function(arg_534_0)
		return OnlineProgression.CFEEHFADBE(arg_534_0, PROGRESSION.Title.S4)
	end,
	IsCortezPremiumPlayer = function(arg_535_0)
		return OnlineProgression.CFEEHFADBE(arg_535_0, PROGRESSION.Title.CORTEZ)
	end,
	IsOwnerOfCurrentUpsellTitle = function(arg_536_0)
		return OnlineProgression.CFEEHFADBE(arg_536_0, PROGRESSION.GetCurrentUpsellTitleIDNum())
	end,
	...
	SeasonalEventUseHorizontalLootGrid = function()
		local var_538_0 = SEASONAL_EVENT.GetCurrentSeasonalEventLootGridType()

		return var_538_0 == SEASONAL_EVENT.LOOT_GRID_TYPE.SCROLLING_LIST or var_538_0 == SEASONAL_EVENT.LOOT_GRID_TYPE.STACKED_CARDS
	end,
	...
	SeasonalEventDisplaysCurrentSpan = function()
		local var_542_0 = SEASONAL_EVENT.GetCurrentSeasonalEventData().displaySpanType

		return var_542_0 ~= nil and var_542_0 ~= SEASONAL_EVENT.SPAN_DISPLAY_TYPE.NONE
	end,
	IsVGPremiumPlayer = function(arg_543_0)
		if Engine.GEHBEDCEC() == true then
			return true
		end

		local var_543_0 = 33925432
		local var_543_1 = 33924432
		local var_543_2 = 33926432
		local var_543_3 = 33926434
		local var_543_4 = 33926433
		local var_543_5 = 33926435
		local var_543_6 = false

		if CONDITIONS.IsXboxLive() then
			var_543_6 = Loot.DEBEIFJEEG(arg_543_0, var_543_0) > 0 or Loot.DEBEIFJEEG(arg_543_0, var_543_3) > 0
		elseif CONDITIONS.IsSony() then
			var_543_6 = Loot.DEBEIFJEEG(arg_543_0, var_543_1) > 0 or Loot.DEBEIFJEEG(arg_543_0, var_543_4) > 0
		elseif CONDITIONS.IsBattleNet() then
			var_543_6 = Loot.DEBEIFJEEG(arg_543_0, var_543_2) > 0 or Loot.DEBEIFJEEG(arg_543_0, var_543_5) > 0
		end

		return var_543_6
	end,
	IsCZStandardOrCrossGenOwned = function(arg_544_0)
		local var_544_0 = 33926453
		local var_544_1 = 33926452
		local var_544_2 = 33926451
		local var_544_3

		if CONDITIONS.IsXbox() then
			var_544_3 = Loot.DEBEIFJEEG(arg_544_0, var_544_0) > 0
		elseif CONDITIONS.IsSony() then
			var_544_3 = Loot.DEBEIFJEEG(arg_544_0, var_544_1) > 0
		elseif CONDITIONS.IsPC() then
			var_544_3 = Loot.DEBEIFJEEG(arg_544_0, var_544_2) > 0
		end

		return var_544_3
	end,
	IsCZVaultOwned = function(arg_545_0)
		local var_545_0 = 371038
		local var_545_1 = 370038
		local var_545_2 = 33926454
		local var_545_3 = 341080
		local var_545_4 = 340080
		local var_545_5 = 342079
		local var_545_6

		if CONDITIONS.IsXbox() then
			var_545_6 = Loot.DEBEIFJEEG(arg_545_0, var_545_0) > 0 or Loot.DEBEIFJEEG(arg_545_0, var_545_3) > 0
		elseif CONDITIONS.IsSony() then
			var_545_6 = Loot.DEBEIFJEEG(arg_545_0, var_545_1) > 0 or Loot.DEBEIFJEEG(arg_545_0, var_545_4) > 0
		elseif CONDITIONS.IsPC() then
			var_545_6 = Loot.DEBEIFJEEG(arg_545_0, var_545_2) > 0 or Loot.DEBEIFJEEG(arg_545_0, var_545_5) > 0
		end
	...
	SeasonalEventIsWidgetIncludedInEvent = function(arg_551_0, arg_551_1)
		local var_551_0 = arg_551_0._typeName

		if var_551_0 == nil then
			var_551_0 = arg_551_0.id
		end

		return SEASONAL_EVENT.IsWidgetInCurrentEventIncludeList(var_551_0, arg_551_1)
	end,
	SeasonalEventIsWidgetNotExcludedFromEvent = function(arg_552_0, arg_552_1)
		local var_552_0 = arg_552_0._typeName

		if var_552_0 == nil then
			var_552_0 = arg_552_0.id
		end

		return not SEASONAL_EVENT.IsWidgetInCurrentEventExcludeList(var_552_0, arg_552_1)
	end,
	...
	IsSeasonalEventTacMapChecklistActive = function()
		if not Engine.DDJFBBJAIG() and (CONDITIONS.IsPublicMatch() or CONDITIONS.IsDemoBuildOrDevBuildOrAreDevFeaturesEnabled()) and CONDITIONS.IsMagmaGameMode() and CONDITIONS.IsSeasonalEventActive() then
			local var_554_0 = SEASONAL_EVENT.GetCurrentSeasonalEventData()

			if var_554_0 then
				if type(var_554_0.useTacMapChallengeTracker) == "function" then
					return var_554_0.useTacMapChallengeTracker()
				else
					return var_554_0.useTacMapChallengeTracker
				end
			end
	...
	ShouldCheckDLC = function()
		local var_570_0 = Dvar.IBEGCHEFE("LKSTRMKTML")
	...
	UserHasATexturePack = function()
		...
		for iter_571_0, iter_571_1 in ipairs(var_571_0) do
			if Engine.BAJHDFAJJF(iter_571_1) then
				return iter_571_0
			end
		end
	...
	PlayerHasZombieContainmentBombardmentKeycard = function(arg_574_0)
		local var_574_0 = false
		local var_574_1 = 7

		if CONDITIONS.IsMagmaGameMode() then
			var_574_0 = DataSources.inGame.player.BRData.PlayerStatusBunkerKeycardType:GetValue(arg_574_0) == var_574_1
		end

		return var_574_0
	end,
	ShouldAlwaysShowPrestigeKeyProgressionReward = function()
		local var_575_0 = Dvar.IBEGCHEFE("ui_t9_always_show_prestige_key_reward")

		if var_575_0 ~= nil then
			return var_575_0
		end

		return true
	end,
	IsCdlEnabled = function(arg_576_0)
		return LUI.WebViewManager.CdlEnabled() and CONDITIONS.IsUserSignedInDemonware(arg_576_0)
	end,
	IsWebMotdEnabled = function()
		return LUI.WebViewManager.MotdEnabled()
	end,
	IsBlueprintBlitzEnabled = function()
		local var_578_0 = Dvar.DHEEJCCJBH("scr_br_bblitz_event_period_utc")
		local var_578_1 = true

		if var_578_0 and type(var_578_0) == "string" then
			var_578_1 = Engine.CCEJJCCDEG(var_578_0) <= 0
		end

		return not var_578_1 and CONDITIONS.IsMagmaGameMode()
	end,
	...
	IsVanguardRevealEventLive = function()
		local var_581_0 = Dvar.DHEEJCCJBH("PTOSLOTSN")
		local var_581_1 = false

		if var_581_0 and type(var_581_0) == "string" then
			local var_581_2 = Engine.CCEJJCCDEG(var_581_0)

			if var_581_2 == nil then
				var_581_2 = 0
			end

			var_581_1 = var_581_2 <= 0
		end

		return var_581_1
	end,
	IsNewGameRevealEventLive = function()
		local var_582_0 = Dvar.DHEEJCCJBH("OLKNPPNSP")
		local var_582_1 = false

		if var_582_0 and type(var_582_0) == "string" then
			local var_582_2 = Engine.CCEJJCCDEG(var_582_0)

			if var_582_2 == nil then
				var_582_2 = 0
			end

			var_582_1 = var_582_2 <= 0
		end
	...
	IsCortezRevealEventLive = function()
		local var_589_0 = Dvar.DHEEJCCJBH("MMOPQOLLMQ")
		local var_589_1 = false

		if var_589_0 and #var_589_0 > 0 then
	...
	AreWZPlaylistRestrictionsEnabled = function()
		local var_595_0 = Dvar.CFHDGABACF("NMOQRNSLTM") ~= PlaylistUtils.RestrictionTypes.OFF
		local var_595_1 = PlaylistUtils.GetRestrictedPlaylistIds()

		return CONDITIONS.IsMagmaGameMode() and var_595_0 and var_595_1
	end,
	ShouldShowVanguardBPSplitTiersEvent = function(arg_596_0, arg_596_1)
		local var_596_0 = Dvar.IBEGCHEFE("lui_force_vg_bp_split_tier")
		local var_596_1 = Dvar.IBEGCHEFE("NKPPMRTRRK")
		local var_596_2 = Onboarding.VanguardBattlePassSplitTiers.WasCompleted(arg_596_0, arg_596_1)

		return var_596_0 or var_596_1 and not var_596_2
	end,
	IsBattlePassTopperActive = function()
		local var_597_0 = Dvar.CFHDGABACF("LKOKTLQSPT")

		if var_597_0 then
			local var_597_1 = Engine.DEIDGHDBHD()
			local var_597_2 = var_597_1 < var_597_0 and var_597_0 - var_597_1 or 0

			if var_597_2 and var_597_2 > 0 then
				return true
			end
		end
	...
	IsVaguardTrialEnabled = function()
		local var_603_0 = Dvar.CFHDGABACF("NRMNMOOLSM")
		local var_603_1 = false

		if var_603_0 then
			var_603_1 = Engine.CCEJJCCDEG(tostring(var_603_0)) <= 0
		end

		return not var_603_1 and CONDITIONS.IsWZPlaylistEventButtonActive() and CONDITIONS.IsMPPlaylistEventButtonActive()
	end,
	...
	IsUIReadyForOnlinePlayer = function(arg_612_0)
		return CONDITIONS.IsUserSignedInDemonware(arg_612_0) and Engine.JBAACDFEJ()
	end,
	ShouldShow2XP = function()
		return Dvar.IBEGCHEFE("NQLNSLPOMS") and (IsPublicMatch() or IsPrivateMatch())
	end,
	IsPrematch = function(arg_614_0)
		return Game.BFEEGCHICA(arg_614_0, "ui_prematch_period") > 0
	end,
	...
	ShouldBuystationCloseMenuOnPurchase = function(arg_619_0)
		return Engine.BECCFCBIAA("buystationCloseMenuOnPurchase", arg_619_0)
	end,
	IsStoreRefreshTimerEnabled = function()
		local var_620_0 = Dvar.BJJCJHDBII("ui_store_daily_reset_time")

		return var_620_0 ~= nil and var_620_0 ~= -1
	end,
	...
	ShouldFocusFirstItemInLoadoutDrop = function(arg_623_0)
		return Engine.BECCFCBIAA("defaultToFirstLoadoutItemInDrop", arg_623_0)
	end
}
