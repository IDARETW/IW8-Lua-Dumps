...
local function var_0_0(arg_1_0, arg_1_1, arg_1_2, arg_1_3)
	if CONDITIONS.AreRestrictionsActive(arg_1_0._controllerIndex) then
		return
	end
...
function WeaponButtonGroup(arg_11_0, arg_11_1)
	...
	if CONDITIONS.IsArmoryEnabled(var_11_0, var_11_1) then
	...
	if Engine.DDJFBBJAIG() and CONDITIONS.IsBlueprintStoreEnabled(var_11_0) then
