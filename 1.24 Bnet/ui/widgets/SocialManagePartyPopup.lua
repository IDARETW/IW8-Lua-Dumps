...
local function var_0_3(arg_3_0, arg_3_1, arg_3_2)
			...
			focusFunction = function(arg_4_0, arg_4_1, arg_4_2, arg_4_3)
				...
				if arg_3_0.activeTabID ~= var_4_0 then
					...
					if Engine.HDGDBCJFG() then
						arg_3_0:RemoveButtonHelperText("button_alt2", "left")
					end
	...
	arg_3_0.postGameHandler = arg_3_0:SubscribeToModel(DataSources.inGame.MP.match.postGameState:GetModel(arg_3_1), function(arg_7_0)
...
function SocialManagePartyPopup(arg_8_0, arg_8_1)
	...
	if not Engine.HDGDBCJFG() and CONDITIONS.IsUserSignedInBnetFrontend(var_8_1) then
		...
		var_8_5:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 459, _1080p * 659, _1080p * 69, _1080p * 209)
