...
local function var_0_10(arg_8_0, arg_8_1, arg_8_2)
	...
	arg_8_0.isBR = CONDITIONS.IsBRGameType()
	...
	arg_8_0:registerAndCallEventHandler("input_connection", function(arg_16_0, arg_16_1)
		...
		elseif not Engine.HDGDBCJFG() then
			if Engine.GGFCHCDDE(arg_16_1.controllerIndex) then
	...
	local function var_8_7()
		local var_19_0 = CoD.GetAspectRatioScaleAdjust(0.2)

		arg_8_0.Background:SetScale(var_19_0)
	end

	arg_8_0:addAndCallEventHandler("onVideoChange", var_8_7)

	if Engine.DDJFBBJAIG() then
		arg_8_0.BackgroundMP:SetAlpha(0)
		arg_8_0.Background:SetAlpha(1)
		LAYOUT.AddAspectRatioFadeFrame(arg_8_0, arg_8_1)
	else
		arg_8_0.BackgroundMP:SetAlpha(0.5)
		arg_8_0.Background:SetAlpha(0)
		ACTIONS.ScaleFullscreen(arg_8_0.BackgroundMP)
	end

	local var_8_8 = LUI.UIElement.new()

	var_8_8:SetBlurStrength(5)
	var_8_8:setupWorldBlur()

	var_8_8.id = "blur"

	arg_8_0:addElement(var_8_8)
...
function ButtonLayout(arg_20_0, arg_20_1)
	local var_20_0 = LUI.UIElement.new()

	var_20_0.id = "ButtonLayout"
	...
	var_20_4:setImage(RegisterMaterial("frontend_option_bg"), 0)
	var_20_4:SetAnchorsAndPosition(0.5, 0.5, 0, 0, _1080p * -1080, _1080p * 1080, 0, 0)
	...
	var_20_6.id = "BackgroundMP"

	var_20_6:SetRGBFromTable(SWATCHES.HUD.background, 0)
	var_20_6:SetAnchorsAndPosition(0.5, 0.5, 0, 0, _1080p * -1080, _1080p * 1080, 0, 0)
	var_20_0:addElement(var_20_6)

	var_20_0.BackgroundMP = var_20_6

	local var_20_7
	local var_20_8 = MenuBuilder.BuildRegisteredType("MenuTitle", {
		controllerIndex = var_20_1
	})

	var_20_8.id = "MenuTitle"

	var_20_8.MenuTitle:setText(Engine.CBBHFCGDIC("MENU/BUTTON_LAYOUT_CAPS"), 0)
	var_20_8.Line:SetLeft(0, 0)
	var_20_8:SetAnchorsAndPosition(0, 1, 0, 1, 0, _1080p * 1020, 0, _1080p * 100)
	var_20_0:addElement(var_20_8)

	var_20_0.MenuTitle = var_20_8

	local var_20_9

	if Engine.CIEGIACHAE() then
		var_20_9 = MenuBuilder.BuildRegisteredType("PS4VitaLayout", {
			controllerIndex = var_20_1
		})
		var_20_9.id = "PS4VitaLayout"

		if Engine.CIEGIACHAE() then
			var_20_9.ControllerImage:SetLeft(0, 0)
		end

		if Engine.CIEGIACHAE() then
			var_20_9.ControllerImage:SetRight(_1080p * 512, 0)
		end

		if Engine.CIEGIACHAE() then
			var_20_9.ControllerImage:SetTop(_1080p * 1, 0)
		end

		if Engine.CIEGIACHAE() then
			var_20_9.ControllerImage:SetBottom(_1080p * 513, 0)
		end

		var_20_9.Primary:SetLeft(_1080p * 538, 0)
		var_20_9.Primary:SetRight(_1080p * 742, 0)
		var_20_9:SetAnchorsAndPosition(0.5, 0.5, 0.5, 0.5, _1080p * 85.5, _1080p * 597.5, _1080p * -200, _1080p * 312)
		var_20_0:addElement(var_20_9)

		var_20_0.PS4VitaLayout = var_20_9
	end

	local var_20_10

	if CONDITIONS.IsPCOrPS4(var_20_0) then
		var_20_10 = MenuBuilder.BuildRegisteredType("PS4Layout", {
			controllerIndex = var_20_1
		})
		var_20_10.id = "PS4Layout"

		var_20_10:SetAnchorsAndPosition(0.5, 0.5, 0.5, 0.5, _1080p * 83.5, _1080p * 595.5, _1080p * -269, _1080p * 243)
		var_20_0:addElement(var_20_10)

		var_20_0.PS4Layout = var_20_10
	end

	local var_20_11

	if CONDITIONS.IsPCOrXB3(var_20_0) then
		var_20_11 = MenuBuilder.BuildRegisteredType("XB3Layout", {
			controllerIndex = var_20_1
		})
		var_20_11.id = "XB3Layout"

		var_20_11:SetAnchorsAndPosition(0.5, 0.5, 0.5, 0.5, _1080p * 83.5, _1080p * 597.5, _1080p * -256, _1080p * 256)
		var_20_0:addElement(var_20_11)

		var_20_0.XB3Layout = var_20_11
	end

	local var_20_12
	local var_20_13 = MenuBuilder.BuildRegisteredType("ButtonLayoutButtons", {
		controllerIndex = var_20_1
	})

	var_20_13.id = "ButtonLayoutButtons"

	var_20_13:SetAnchorsAndPosition(0.5, 0.5, 0.5, 0.5, _1080p * -864, _1080p * -264, _1080p * -302, _1080p * 338)
	var_20_0:addElement(var_20_13)

	var_20_0.ButtonLayoutButtons = var_20_13

	local var_20_14
	local var_20_15 = MenuBuilder.BuildRegisteredType("SwapTriggersPrompt", {
		controllerIndex = var_20_1
	})

	var_20_15.id = "SwapTriggersPrompt"

	var_20_15.Background:SetAlpha(0.13, 0)
	var_20_15:SetAnchorsAndPosition(0.5, 0.5, 0.5, 0.5, _1080p * -185, _1080p * 864, _1080p * -302, _1080p * -262)
	var_20_0:addElement(var_20_15)

	var_20_0.SwapTriggersPrompt = var_20_15

	local var_20_16
	local var_20_17 = LUI.UIText.new()

	var_20_17.id = "CurrentLayoutName"

	var_20_17:setText("", 0)
	var_20_17:SetFont(FONTS.GetFont(FONTS.MainBold.File))
	var_20_17:SetAlignment(LUI.Alignment.Center)
	var_20_17:SetAnchorsAndPosition(0.5, 0.5, 0.5, 0.5, _1080p * -185, _1080p * 864, _1080p * -293, _1080p * -269)
	var_20_0:addElement(var_20_17)

	var_20_0.CurrentLayoutName = var_20_17

	local function var_20_18()
		return
	end

	var_20_0._sequences.DefaultSequence = var_20_18
	...
	if Engine.CIEGIACHAE() then
		...
		var_20_9:RegisterAnimationSequence("Splitscreen", var_20_19)
	end
	...
	if CONDITIONS.IsPCOrPS4(var_20_0) then
		...
		var_20_10:RegisterAnimationSequence("Splitscreen", var_20_20)
	end
	...
	if CONDITIONS.IsPCOrXB3(var_20_0) then
		...
		var_20_11:RegisterAnimationSequence("Splitscreen", var_20_21)
	end
	...
	var_20_13:RegisterAnimationSequence("Splitscreen", var_20_22)
	...
	var_20_15:RegisterAnimationSequence("Splitscreen", var_20_23)
	...
	var_20_17:RegisterAnimationSequence("Splitscreen", var_20_24)

	local function var_20_25()
		if Engine.CIEGIACHAE() then
			var_20_9:AnimateSequence("Splitscreen")
		end

		if CONDITIONS.IsPCOrPS4(var_20_0) then
			var_20_10:AnimateSequence("Splitscreen")
		end

		if CONDITIONS.IsPCOrXB3(var_20_0) then
			var_20_11:AnimateSequence("Splitscreen")
		end

		var_20_13:AnimateSequence("Splitscreen")
		var_20_15:AnimateSequence("Splitscreen")
		var_20_17:AnimateSequence("Splitscreen")
	end

	var_20_0._sequences.Splitscreen = var_20_25
	...
	var_20_0.bindButton:addEventHandler("button_secondary", function(arg_23_0, arg_23_1)
	...
	if CONDITIONS.IsSplitscreen(var_20_0) then
		ACTIONS.AnimateSequence(var_20_0, "Splitscreen")
	end
