...
local function var_0_5(arg_5_0, arg_5_1, arg_5_2)
	...
	arg_5_0:registerAndCallEventHandler("input_connection", function(arg_11_0, arg_11_1)
		...
		elseif not Engine.HDGDBCJFG() then
			if Engine.GGFCHCDDE(arg_11_1.controllerIndex) then
	...
	local function var_5_6()
		local var_13_0 = CoD.GetAspectRatioScaleAdjust(0.2)

		arg_5_0.Background:SetScale(var_13_0)
	end

	arg_5_0:addAndCallEventHandler("onVideoChange", var_5_6)

	if Engine.DDJFBBJAIG() then
		arg_5_0.BackgroundMP:SetAlpha(0)
		arg_5_0.Background:SetAlpha(1)
		LAYOUT.AddAspectRatioFadeFrame(arg_5_0, arg_5_1)
	else
		arg_5_0.BackgroundMP:SetAlpha(0.5)
		arg_5_0.Background:SetAlpha(0)
		ACTIONS.ScaleFullscreen(arg_5_0.BackgroundMP)
	end

	local var_5_7 = LUI.UIElement.new()

	var_5_7:SetBlurStrength(5)
	var_5_7:setupWorldBlur()
...
function StickLayout(arg_14_0, arg_14_1)
	local var_14_0 = LUI.UIElement.new()

	var_14_0.id = "StickLayout"
	...
	if Engine.CIEGIACHAE() then
		var_14_7 = MenuBuilder.BuildRegisteredType("PS4VitaStickLayout", {
			controllerIndex = var_14_1
		})
		var_14_7.id = "PS4VitaLayout"

		var_14_7:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 937, _1080p * 1449, _1080p * 236, _1080p * 748)
		var_14_0:addElement(var_14_7)

		var_14_0.PS4VitaLayout = var_14_7
	end

	local var_14_8

	if CONDITIONS.IsPCOrPS4(var_14_0) then
		var_14_8 = MenuBuilder.BuildRegisteredType("PS4StickLayout", {
			controllerIndex = var_14_1
		})
		var_14_8.id = "PS4Layout"

		var_14_8:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 976, _1080p * 1488, _1080p * 216, _1080p * 728)
		var_14_0:addElement(var_14_8)

		var_14_0.PS4Layout = var_14_8
	end

	local var_14_9

	if CONDITIONS.IsPCOrXB3(var_14_0) then
		var_14_9 = MenuBuilder.BuildRegisteredType("XB3StickLayout", {
			controllerIndex = var_14_1
		})
		var_14_9.id = "XB3Layout"

		var_14_9:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 976, _1080p * 1488, _1080p * 200, _1080p * 712)
		var_14_0:addElement(var_14_9)

		var_14_0.XB3Layout = var_14_9
	end
	...
	var_14_11.MenuTitle:setText(Engine.CBBHFCGDIC("PLATFORM/THUMBSTICK_LAYOUT_CAPS"), 0)
	...
	local var_14_12
	local var_14_13 = MenuBuilder.BuildRegisteredType("StickLayoutButtons", {
		controllerIndex = var_14_1
	})

	var_14_13.id = "StickLayoutButtons"

	var_14_13:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 130, _1080p * 730, _1080p * 300, _1080p * 750)
	var_14_0:addElement(var_14_13)

	var_14_0.StickLayoutButtons = var_14_13
	...
	if Engine.CIEGIACHAE() then
		...
		var_14_7:RegisterAnimationSequence("Splitscreen", var_14_15)
	end
	...
	if CONDITIONS.IsPCOrPS4(var_14_0) then
		...
		var_14_8:RegisterAnimationSequence("Splitscreen", var_14_16)
	end
	...
	if CONDITIONS.IsPCOrXB3(var_14_0) then
		...
		var_14_9:RegisterAnimationSequence("Splitscreen", var_14_17)
	end
	...
	var_14_13:RegisterAnimationSequence("Splitscreen", var_14_18)

	local function var_14_19()
		if Engine.CIEGIACHAE() then
			var_14_7:AnimateSequence("Splitscreen")
		end

		if CONDITIONS.IsPCOrPS4(var_14_0) then
			var_14_8:AnimateSequence("Splitscreen")
		end

		if CONDITIONS.IsPCOrXB3(var_14_0) then
			var_14_9:AnimateSequence("Splitscreen")
		end

		var_14_13:AnimateSequence("Splitscreen")
	end

	var_14_0._sequences.Splitscreen = var_14_19
	...
	local var_14_20 = LUI.UIBindButton.new()

	var_14_20.id = "selfBindButton"

	var_14_0:addElement(var_14_20)

	var_14_0.bindButton = var_14_20

	var_14_0.bindButton:addEventHandler("button_secondary", function(arg_17_0, arg_17_1)
		if not arg_17_1.controller then
			local var_17_0 = var_14_1
		end
