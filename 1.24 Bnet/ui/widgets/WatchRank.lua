	...
	local function var_1_6()
		...
		if Engine.DBEJJAFIAI(arg_1_1) and CONDITIONS.IsPublicMatch(arg_1_0) then
			...
			if not Engine.DDJFBBJAIG() and CONDITIONS.InKillCam(arg_1_1) then
				...
				if PROGRESSION.IsElder(arg_1_1) or Dvar.IBEGCHEFE("lui_force_elder_progression_menu") then
					var_3_2 = PROGRESSION.GetSeasonRankPercentage(arg_1_1)

					ACTIONS.AnimateSequence(arg_1_0, "ElderProgression")

					var_3_0 = PROGRESSION.GetPlayerRank(arg_1_1) + 1
				else
					var_3_2 = PROGRESSION.GetRankPercentage(arg_1_1)
				...
				var_3_1 = RegisterMaterial(Engine.DDJFBBJAIG() and PROGRESSION.GetRankBigIcon(var_3_0) or PROGRESSION.GetPlayerRankIcon(arg_1_1))
			end
...
function WatchRank(arg_8_0, arg_8_1)
	...
	var_8_8:SetRGBFromInt(10069495, 0)
	...
	var_8_11:SetRGBFromInt(10069495, 0)
	...
	var_8_15:setImage(RegisterMaterial("icon_rank_53"), 0)
	...
	var_8_6:RegisterAnimationSequence("Offline", var_8_19)
	...
	var_8_8:RegisterAnimationSequence("Offline", var_8_20)
	...
	var_8_11:RegisterAnimationSequence("Offline", var_8_21)
	...
	var_8_13:RegisterAnimationSequence("Offline", var_8_22)
	...
	var_8_15:RegisterAnimationSequence("Offline", var_8_23)
	...
	var_8_17:RegisterAnimationSequence("Offline", var_8_24)
	...
	var_8_0._sequences.Offline = var_8_25
	...
	var_8_8:RegisterAnimationSequence("Radial", var_8_26)
	...
	var_8_11:RegisterAnimationSequence("Radial", var_8_27)
	...
	var_8_13:RegisterAnimationSequence("Radial", var_8_28)
	...
	var_8_15:RegisterAnimationSequence("Radial", var_8_29)
	...
	var_8_0._sequences.Radial = var_8_30
	...
	var_8_4:RegisterAnimationSequence("StandardProgression", var_8_31)
	...
	var_8_8:RegisterAnimationSequence("StandardProgression", var_8_32)
	...
	var_8_11:RegisterAnimationSequence("StandardProgression", var_8_33)

	local function var_8_34()
		var_8_4:AnimateSequence("StandardProgression")
		var_8_8:AnimateSequence("StandardProgression")
		var_8_11:AnimateSequence("StandardProgression")
	end

	var_8_0._sequences.StandardProgression = var_8_34
	...
	var_8_8:RegisterAnimationSequence("ElderProgression", var_8_35)
	...
	var_8_11:RegisterAnimationSequence("ElderProgression", var_8_36)

	local function var_8_37()
		var_8_8:AnimateSequence("ElderProgression")
		var_8_11:AnimateSequence("ElderProgression")
	end

	var_8_0._sequences.ElderProgression = var_8_37
	...
	var_8_8:RegisterAnimationSequence("RankUp", var_8_38)
	...
	var_8_13:RegisterAnimationSequence("RankUp", var_8_39)
	...
	var_8_15:RegisterAnimationSequence("RankUp", var_8_40)
	...
	var_8_0._sequences.RankUp = var_8_41
	...
	var_8_13:RegisterAnimationSequence("Screen2", var_8_46)
	...
	var_8_15:RegisterAnimationSequence("Screen2", var_8_47)
	...
	var_8_17:RegisterAnimationSequence("Screen2", var_8_48)
	...
	var_8_0._sequences.Screen2 = var_8_49
