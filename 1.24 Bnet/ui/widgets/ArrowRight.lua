...
function ArrowRight(arg_4_0, arg_4_1)
	...
	var_4_4:setImage(RegisterMaterial("wdg_selection_arrow_right_1"), 0)
	...
	var_4_4:RegisterAnimationSequence("MovedRight", var_4_8)

	local function var_4_9()
		var_4_4:AnimateSequence("MovedRight")
	end

	var_4_0._sequences.MovedRight = var_4_9
	...
	var_4_0:addEventHandler("grid_focus_right_moved", function(arg_10_0, arg_10_1)
		if not arg_10_1.controller then
			local var_10_0 = var_4_1
		end

		ACTIONS.AnimateSequence(var_4_0, "MovedRight")
	end)
