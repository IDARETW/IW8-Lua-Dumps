...
local function var_0_6(arg_2_0, arg_2_1)
	...
	elseif CONDITIONS.IsBRKingSlayer() then
		arg_2_0.Title1:setText(Engine.CBBHFCGDIC("LUA_MENU/KILLS"), 0)
		arg_2_0.Title2:setText(Engine.CBBHFCGDIC("LUA_MENU_MP/KINGSLAYER_KILLS"), 0)
		arg_2_0.Title3:setText(Engine.CBBHFCGDIC("LUA_MENU_MP/KINGSLAYER_DEATHS"), 0)
		arg_2_0.Title4:setText(Engine.CBBHFCGDIC("LUA_MENU_MP/CACHES"), 0)
...
function PostLoadFunc(arg_5_0, arg_5_1, arg_5_2)
	...
	arg_5_0.PlayerGrid:SetRefreshChild(function(arg_8_0, arg_8_1, arg_8_2)
		...
		if var_8_2 then
			...
			var_8_2.rankDisplay = PROGRESSION.GetRankDisplay(var_8_2.rank)
			var_8_2.rankIcon = PROGRESSION.GetRankIcon(var_8_2.rank, var_8_2.prestige)
			...
			local var_8_5 = SWATCHES.HUD.background

			if var_8_2.squadIndex and not SCOREBOARD.IsAARScoreboard() then
				var_8_5 = Game.BJGDCJHICE(var_8_2.squadIndex) or SWATCHES.HUD.background
			end

			arg_8_0.PlayerNumberBg:SetRGBFromTable(var_8_5)
			...
			arg_8_0.PlayerName:setText(var_8_2.name or var_0_2)
			...
			if CONDITIONS.IsBRKingSlayer() then
				...
				if SCOREBOARD.IsAARScoreboard() then
					var_8_6 = BitwiseOperators.band(var_8_2.extraScore4, 255)
				else
					var_8_6 = BitwiseOperators.band(var_8_2.extraScore0, 255)
				end

				arg_8_0.Stat2:setText(var_8_6 or var_0_1)

				local var_8_7 = 0

				if SCOREBOARD.IsAARScoreboard() then
					var_8_7 = BitwiseOperators.band(BitwiseOperators.rshift(var_8_2.extraScore4, 8), 255)
				else
					var_8_7 = BitwiseOperators.band(BitwiseOperators.rshift(var_8_2.extraScore0, 8), 255)
				end

				arg_8_0.Stat3:setText(var_8_7 or var_0_1)
			...
			elseif CONDITIONS.IsBloodMoney() or CONDITIONS.IsRiskGametype() then
				...
				if SCOREBOARD.IsAARScoreboard() then
					var_8_8 = BitwiseOperators.band(var_8_2.extraScore4, 4095)
				else
					var_8_8 = BitwiseOperators.band(var_8_2.extraScore0, 4095)
				end

				local var_8_9 = var_8_8

				if CONDITIONS.IsBloodMoney() then
					local var_8_10 = var_8_8 * 1000

					var_8_9 = "$" .. var_8_10
				end

				arg_8_0.Stat2:setText(var_8_9 or var_0_1)

				local var_8_11 = 0

				if SCOREBOARD.IsAARScoreboard() then
					var_8_11 = BitwiseOperators.band(BitwiseOperators.rshift(var_8_2.extraScore4, 12), 15)
				else
					var_8_11 = BitwiseOperators.band(BitwiseOperators.rshift(var_8_2.extraScore0, 12), 15)
				end
				...
				arg_8_0.Stat3:setText(var_8_11 or var_0_1)
			...
			if not SCOREBOARD.IsAARScoreboard() and CONDITIONS.IsSpectating(arg_5_1) then
				local var_8_12 = DataSources.inGame.player.BRData.spectatedIsMuted:GetValue(arg_5_1)

				if var_8_2.clientNum == DataSources.inGame.currentPlayerStateClientNum:GetValue(arg_5_1) and var_8_2.isMuted ~= var_8_12 then
