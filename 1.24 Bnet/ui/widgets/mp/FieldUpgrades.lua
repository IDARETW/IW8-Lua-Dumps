...
local function var_0_12(arg_10_0)
	...
	if Engine.DDJFBBJAIG() and not Onboarding.FieldUpgrade.WasCompleted(arg_10_0, arg_10_0._controllerIndex) then
		LUI.FlowManager.RequestPopupMenu(arg_10_0, "onboardingpopup", true, arg_10_0._controllerIndex, false, ONBOARDING_DATA.GetOnboardingFieldUpgradeData())
		Onboarding.FieldUpgrade.MarkCompleted(arg_10_0, arg_10_0._controllerIndex)
	end
end
...
local function var_0_26(arg_37_0, arg_37_1, arg_37_2)
	...
	if Engine.DDJFBBJAIG() then
		local function var_37_2(arg_45_0, arg_45_1)
			if not Onboarding.ProFieldUpgrade.WasCompleted(arg_45_0, arg_45_1) then
		...
		if not Onboarding.FieldUpgrade.WasCompleted(arg_37_0, arg_37_1) then
			local var_37_3 = ONBOARDING_DATA.GetOnboardingFieldUpgradeData()
...
function FieldUpgrades(arg_47_0, arg_47_1)
	...
	if CONDITIONS.InFrontend(var_47_0) then
	...
	if CONDITIONS.InGame(var_47_0) then
	...
	local var_47_18 = LUI.UIGrid.new(var_47_17)

	var_47_18.id = "Grid"

	var_47_18:setUseStencil(false)
	var_47_18:SetAnchorsAndPosition(0, 0, 1, 0, _1080p * 100, _1080p * -100, _1080p * -238, _1080p * -75)
	var_47_0:addElement(var_47_18)

	var_47_0.Grid = var_47_18

	local var_47_19
	local var_47_20 = MenuBuilder.BuildRegisteredType("UnlockCriteria", {
		controllerIndex = var_47_1
	})

	var_47_20.id = "UnlockCriteria"

	var_47_20.UnlockDesc:SetRight(_1080p * 340, 0)
	var_47_20.UnlockDesc:SetRGBFromTable(SWATCHES.genericButton.description, 0)
	var_47_20.UnlockDesc:setText("LOCKED", 0)
	var_47_20.UnlockDesc:SetAlignment(LUI.Alignment.Left)
	var_47_20:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 114, _1080p * 456, _1080p * 700, _1080p * 732)
	var_47_0:addElement(var_47_20)

	var_47_0.UnlockCriteria = var_47_20

	local var_47_21
	local var_47_22 = MenuBuilder.BuildRegisteredType("EquippedWidget", {
		controllerIndex = var_47_1
	})

	var_47_22.id = "EquippedWidget"

	var_47_22:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 114, _1080p * 250, _1080p * 747, _1080p * 777)
	var_47_0:addElement(var_47_22)

	var_47_0.EquippedWidget = var_47_22

	local var_47_23
	local var_47_24 = LUI.UIText.new()

	var_47_24.id = "EquippedSlot"

	var_47_24:SetRGBFromTable(SWATCHES.HUD.HUDMain, 0)
	var_47_24:setText("", 0)
	var_47_24:SetFont(FONTS.GetFont(FONTS.MainRegular.File))
	var_47_24:SetAlignment(LUI.Alignment.Left)
	var_47_24:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 114, _1080p * 572, _1080p * 787, _1080p * 805)
	var_47_0:addElement(var_47_24)

	var_47_0.EquippedSlot = var_47_24

	local var_47_25
	local var_47_26 = LUI.UIText.new()

	var_47_26.id = "FieldUpgradeName"

	var_47_26:SetRGBFromTable(SWATCHES.genericMenu.mainTitle, 0)
	var_47_26:setText("", 0)
	var_47_26:SetFont(FONTS.GetFont(FONTS.MainBold.File))
	var_47_26:SetAlignment(LUI.Alignment.Left)
	var_47_26:SetOptOutRightToLeftAlignmentFlip(true)
	var_47_26:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 114, _1080p * 967, _1080p * 514, _1080p * 564)
	var_47_0:addElement(var_47_26)

	var_47_0.FieldUpgradeName = var_47_26

	local var_47_27
	local var_47_28 = LUI.UIStyledText.new()

	var_47_28.id = "FieldUpgradeDescription"

	var_47_28:SetRGBFromTable(SWATCHES.genericMenu.bodycopy, 0)
	var_47_28:setText("", 0)
	var_47_28:SetFont(FONTS.GetFont(FONTS.MainRegular.File))
	var_47_28:SetAlignment(LUI.Alignment.Left)
	var_47_28:SetOptOutRightToLeftAlignmentFlip(true)
	var_47_28:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 114, _1080p * 661, _1080p * 568, _1080p * 588)
	var_47_0:addElement(var_47_28)

	var_47_0.FieldUpgradeDescription = var_47_28

	local var_47_29

	if CONDITIONS.InFrontendPublicMP(var_47_0) then
		local var_47_30 = MenuBuilder.BuildRegisteredType("MPPlayerDetails", {
			controllerIndex = var_47_1
		})

		var_47_30.id = "MPPlayerDetails"

		var_47_30:SetAnchorsAndPosition(1, 0, 0, 1, _1080p * -596, _1080p * -96, _1080p * 54, _1080p * 114)
		var_47_0:addElement(var_47_30)

		var_47_0.MPPlayerDetails = var_47_30
	end

	local var_47_31
	local var_47_32 = MenuBuilder.BuildRegisteredType("FieldUpgradesEquipped", {
		controllerIndex = var_47_1
	})

	var_47_32.id = "UpgradesEquipped"

	var_47_32:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 1387, _1080p * 1576, _1080p * 707, _1080p * 787)
	var_47_0:addElement(var_47_32)

	var_47_0.UpgradesEquipped = var_47_32

	local var_47_33
	local var_47_34 = MenuBuilder.BuildRegisteredType("MenuTitle", {
		controllerIndex = var_47_1
	})

	var_47_34.id = "MenuTitle"

	var_47_34.MenuTitle:setText(Engine.CBBHFCGDIC("LUA_MENU/FIELD_UPGRADES"), 0)
	var_47_34.Line:SetLeft(0, 0)
	var_47_34:SetAnchorsAndPosition(0, 1, 0, 1, 0, _1080p * 1024, 0, _1080p * 100)
	var_47_0:addElement(var_47_34)

	var_47_0.MenuTitle = var_47_34

	local var_47_35
	local var_47_36 = LUI.UIStyledText.new()

	var_47_36.id = "RechargeRate"

	var_47_36:SetRGBFromTable(SWATCHES.genericMenu.mainTitle, 0)
	var_47_36:setText("", 0)
	var_47_36:SetFont(FONTS.GetFont(FONTS.MainRegular.File))
	var_47_36:SetAlignment(LUI.Alignment.Left)
	var_47_36:SetOptOutRightToLeftAlignmentFlip(true)
	var_47_36:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 299, _1080p * 772, _1080p * 634, _1080p * 658)
	var_47_0:addElement(var_47_36)

	var_47_0.RechargeRate = var_47_36

	local var_47_37
	local var_47_38 = LUI.UIStyledText.new()

	var_47_38.id = "FieldUpgradeRechargeRate"

	var_47_38:SetRGBFromTable(SWATCHES.genericMenu.mainTitle, 0)
	var_47_38:setText(Engine.CBBHFCGDIC("LUA_MENU/RECHARGE_RATE"), 0)
	var_47_38:SetFont(FONTS.GetFont(FONTS.MainRegular.File))
	var_47_38:SetWordWrap(false)
	var_47_38:SetAlignment(LUI.Alignment.Left)
	var_47_38:SetOptOutRightToLeftAlignmentFlip(true)
	var_47_38:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 114, _1080p * 285, _1080p * 634, _1080p * 658)
	var_47_0:addElement(var_47_38)

	var_47_0.FieldUpgradeRechargeRate = var_47_38

	local var_47_39

	if CONDITIONS.InFrontend(var_47_0) then
		local var_47_40 = MenuBuilder.BuildRegisteredType("LobbyMembersFooter", {
			controllerIndex = var_47_1
		})

		var_47_40.id = "LobbyMembersFooter"

		var_47_40:SetAnchorsAndPosition(0, 0, 0, 1, 0, 0, 0, _1080p * 150)
		var_47_0:addElement(var_47_40)

		var_47_0.LobbyMembersFooter = var_47_40
	end

	local var_47_41

	if CONDITIONS.InGame(var_47_0) then
		var_47_41 = MenuBuilder.BuildRegisteredType("InGameMenuTimerStatus", {
			controllerIndex = var_47_1
		})
		var_47_41.id = "InGameMenuTimerStatus"

		var_47_41:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 820, _1080p * 1220, _1080p * 54, _1080p * 104)
		var_47_0:addElement(var_47_41)

		var_47_0.InGameMenuTimerStatus = var_47_41
	end

	local var_47_42
	local var_47_43 = MenuBuilder.BuildRegisteredType("NewItemNotification", {
		controllerIndex = var_47_1
	})

	var_47_43.id = "NewItemNotification"

	var_47_43:SetAlpha(0, 0)
	var_47_43:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 114, _1080p * 192, _1080p * 747, _1080p * 777)
	var_47_0:addElement(var_47_43)

	var_47_0.NewItemNotification = var_47_43

	local var_47_44
	local var_47_45 = LUI.UIImage.new()

	var_47_45.id = "InfoMessageIcon"

	var_47_45:SetRGBFromTable(SWATCHES.genericButton.description, 0)
	var_47_45:setImage(RegisterMaterial("hud_info_alert"), 0)
	var_47_45:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 1347, _1080p * 1377, _1080p * 528, _1080p * 558)
	var_47_0:addElement(var_47_45)

	var_47_0.InfoMessageIcon = var_47_45

	local var_47_46
	local var_47_47 = LUI.UIStyledText.new()

	var_47_47.id = "InfoMessage"

	var_47_47:SetRGBFromTable(SWATCHES.genericButton.description, 0)
	var_47_47:setText(Engine.CBBHFCGDIC("LUA_MENU/TACTICAL_INSERTION_DISCLAIMER"), 0)
	var_47_47:SetFont(FONTS.GetFont(FONTS.MainBold.File))
	var_47_47:SetAlignment(LUI.Alignment.Left)
	var_47_47:SetOptOutRightToLeftAlignmentFlip(true)
	var_47_47:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 1387, _1080p * 1790, _1080p * 531, _1080p * 555)
	var_47_0:addElement(var_47_47)

	var_47_0.InfoMessage = var_47_47

	local var_47_48
	local var_47_49 = MenuBuilder.BuildRegisteredType("CDLRestricted", {
		controllerIndex = var_47_1
	})

	var_47_49.id = "CDLRestricted"

	var_47_49:SetAlpha(0, 0)
	var_47_49:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 114, _1080p * 403, _1080p * 787, _1080p * 817)
	var_47_0:addElement(var_47_49)

	var_47_0.CDLRestricted = var_47_49

	local var_47_50

	if CONDITIONS.IsMagmaGameMode(var_47_0) then
		var_47_50 = MenuBuilder.BuildRegisteredType("BRWarningInfo", {
			controllerIndex = var_47_1
		})
		var_47_50.id = "BRWarningInfo"

		var_47_50:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 114, _1080p * 739, _1080p * 478, _1080p * 508)
		var_47_0:addElement(var_47_50)

		var_47_0.BRWarningInfo = var_47_50
	end

	local var_47_51

	if CONDITIONS.IsMagmaGameMode(var_47_0) then
		var_47_51 = MenuBuilder.BuildRegisteredType("BRWarningInfo", {
			controllerIndex = var_47_1
		})
		var_47_51.id = "BRWarningInfoFEPro"

		var_47_51:SetAlpha(0, 0)
		var_47_51:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 114, _1080p * 739, _1080p * 478, _1080p * 508)
		var_47_0:addElement(var_47_51)

		var_47_0.BRWarningInfoFEPro = var_47_51
	end

	local var_47_52

	if Engine.DDJFBBJAIG() then
		local var_47_53 = MenuBuilder.BuildRegisteredType("CDLRestrictionTag", {
			controllerIndex = var_47_1
		})

		var_47_53.id = "CDLRestrictionTag"

		var_47_53.CDLInfo:SetAlpha(1, 0)
		var_47_53:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 1508, _1080p * 1824, _1080p * 170, _1080p * 200)
		var_47_0:addElement(var_47_53)

		var_47_0.CDLRestrictionTag = var_47_53
	end
	...
	var_47_45:RegisterAnimationSequence("DefaultSequence", var_47_55)
	...
	var_47_47:RegisterAnimationSequence("DefaultSequence", var_47_56)

	local function var_47_57()
		var_47_45:AnimateSequence("DefaultSequence")
		var_47_47:AnimateSequence("DefaultSequence")
	end

	var_47_0._sequences.DefaultSequence = var_47_57
	...
	var_47_20:RegisterAnimationSequence("Splitscreen", var_47_59)
	...
	var_47_22:RegisterAnimationSequence("Splitscreen", var_47_60)
	...
	var_47_24:RegisterAnimationSequence("Splitscreen", var_47_61)
	...
	var_47_26:RegisterAnimationSequence("Splitscreen", var_47_62)
	...
	var_47_28:RegisterAnimationSequence("Splitscreen", var_47_63)
	...
	var_47_32:RegisterAnimationSequence("Splitscreen", var_47_64)
	...
	var_47_36:RegisterAnimationSequence("Splitscreen", var_47_65)
	...
	var_47_38:RegisterAnimationSequence("Splitscreen", var_47_66)
	...
	if CONDITIONS.InGame(var_47_0) then
		...
		var_47_41:RegisterAnimationSequence("Splitscreen", var_47_67)
	end
	...
	var_47_45:RegisterAnimationSequence("Splitscreen", var_47_68)
	...
	var_47_47:RegisterAnimationSequence("Splitscreen", var_47_69)

	local function var_47_70()
		var_47_20:AnimateSequence("Splitscreen")
		...
		var_47_36:AnimateSequence("Splitscreen")
		var_47_38:AnimateSequence("Splitscreen")

		if CONDITIONS.InGame(var_47_0) then
			var_47_41:AnimateSequence("Splitscreen")
		end

		var_47_45:AnimateSequence("Splitscreen")
	...
	var_47_20:RegisterAnimationSequence("AR", var_47_72)
	...
	var_47_24:RegisterAnimationSequence("AR", var_47_73)
	...
	var_47_26:RegisterAnimationSequence("AR", var_47_74)
	...
	var_47_28:RegisterAnimationSequence("AR", var_47_75)
	...
	var_47_36:RegisterAnimationSequence("AR", var_47_76)
	...
	var_47_38:RegisterAnimationSequence("AR", var_47_77)

	local function var_47_78()
		var_47_20:AnimateSequence("AR")
		var_47_24:AnimateSequence("AR")
		var_47_26:AnimateSequence("AR")
		var_47_28:AnimateSequence("AR")
		var_47_36:AnimateSequence("AR")
		var_47_38:AnimateSequence("AR")
	end

	var_47_0._sequences.AR = var_47_78
	...
	var_47_20:RegisterAnimationSequence("CH", var_47_80)
	...
	var_47_26:RegisterAnimationSequence("CH", var_47_81)
	...
	var_47_28:RegisterAnimationSequence("CH", var_47_82)
	...
	var_47_36:RegisterAnimationSequence("CH", var_47_83)
	...
	var_47_38:RegisterAnimationSequence("CH", var_47_84)

	local function var_47_85()
		var_47_20:AnimateSequence("CH")
		var_47_26:AnimateSequence("CH")
		var_47_28:AnimateSequence("CH")
		var_47_36:AnimateSequence("CH")
		var_47_38:AnimateSequence("CH")
	end

	var_47_0._sequences.CH = var_47_85
	...
	var_47_45:RegisterAnimationSequence("ShowInfoMessage", var_47_87)
	...
	var_47_47:RegisterAnimationSequence("ShowInfoMessage", var_47_88)

	local function var_47_89()
		var_47_45:AnimateSequence("ShowInfoMessage")
		var_47_47:AnimateSequence("ShowInfoMessage")
	end

	var_47_0._sequences.ShowInfoMessage = var_47_89
	...
	var_47_45:RegisterAnimationSequence("HideInfoMessage", var_47_91)
	...
	var_47_47:RegisterAnimationSequence("HideInfoMessage", var_47_92)

	local function var_47_93()
		var_47_45:AnimateSequence("HideInfoMessage")
		var_47_47:AnimateSequence("HideInfoMessage")
	end

	var_47_0._sequences.HideInfoMessage = var_47_93
	...
	if CONDITIONS.IsMagmaGameMode(var_47_0) then
		...
		var_47_50:RegisterAnimationSequence("ShowProPerkWarning", var_47_95)
	end
	...
	if CONDITIONS.IsMagmaGameMode(var_47_0) then
		...
		var_47_51:RegisterAnimationSequence("ShowProPerkWarning", var_47_96)
	end

	local function var_47_97()
		if CONDITIONS.IsMagmaGameMode(var_47_0) then
			var_47_50:AnimateSequence("ShowProPerkWarning")
		end

		if CONDITIONS.IsMagmaGameMode(var_47_0) then
			var_47_51:AnimateSequence("ShowProPerkWarning")
		end
	end

	var_47_0._sequences.ShowProPerkWarning = var_47_97
	...
	local var_47_98 = LUI.UIBindButton.new()

	var_47_98.id = "selfBindButton"

	var_47_0:addElement(var_47_98)

	var_47_0.bindButton = var_47_98

	var_47_0.bindButton:addEventHandler("button_secondary", function(arg_57_0, arg_57_1)
		if not arg_57_1.controller then
			local var_57_0 = var_47_1
		end
	...
	if CONDITIONS.IsSplitscreen(var_47_0) then
