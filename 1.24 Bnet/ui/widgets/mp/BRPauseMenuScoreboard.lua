...
function PostLoadFunc(arg_6_0, arg_6_1, arg_6_2)
	...
	arg_6_0.PlayerGrid:SetRefreshChild(function(arg_7_0, arg_7_1, arg_7_2)
		...
		if var_7_4 then
			...
			var_7_4.rankDisplay = PROGRESSION.GetRankDisplay(var_7_4.rank)
			...
			if CONDITIONS.IsBRKingSlayer() then
				...
				arg_7_0.Score2:setText(var_7_9 or var_0_1)

				local var_7_10 = 0
				local var_7_11 = BitwiseOperators.band(BitwiseOperators.rshift(var_7_4.extraScore0, 8), 255)

				arg_7_0.Score3:setText(var_7_11 or var_0_1)
			...
			local var_7_18 = CallingCardUtils.GetCardTexture(Game.BABEFDCDIG(var_7_4.clientNum))

			arg_7_0.Playercard:setImage(RegisterMaterial(var_7_18))

			arg_7_0.rowData = var_7_4

			local function var_7_19(arg_8_0)
			...
			FRIENDS.SetupPlayerContextualMenuOptions(arg_7_0, arg_6_1, var_7_19)

			if CONDITIONS.IsSpectating(arg_6_1) then
				local var_7_20 = DataSources.inGame.player.BRData.spectatedIsMuted:GetValue(arg_6_1)

				if var_7_4.clientNum == DataSources.inGame.currentPlayerStateClientNum:GetValue(arg_6_1) and var_7_4.isMuted ~= var_7_20 then
