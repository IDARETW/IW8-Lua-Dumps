	...
	if var_4_1 then
		...
		if arg_4_0._clientNum then
			...
			if arg_4_0._clientNum >= 0 then
				if var_4_0 then
					var_4_3 = PROGRESSION.GetRankDisplay(var_4_1.rank)
					var_4_4 = PROGRESSION.GetRankIcon(var_4_1.rank, var_4_1.prestige)
		...
		arg_4_0.Player:setText(var_4_1.name)
		...
		local var_4_5 = var_4_1.isMuted and "icon_mic_muted" or "icon_mic_talking"

		arg_4_0.Speaker:setImage(RegisterMaterial(var_4_5))
		assert(var_4_1.isMicOn ~= nil)
		assert(var_4_1.isMuted ~= nil)

		local var_4_6
		local var_4_7 = (var_4_1.isMicOn or var_4_1.isMuted) and "MicOn" or "MicOff"

		if arg_4_0._micAnim ~= var_4_7 then
			ACTIONS.AnimateSequence(arg_4_0, var_4_7)

			arg_4_0._micAnim = var_4_7
		end
	end
end
...
local function var_0_2(arg_11_0, arg_11_1, arg_11_2)
	...
	arg_11_0.bindButton:addEventHandler("button_left", function(arg_13_0, arg_13_1)
		if arg_13_1.qualifier == "dpad" and (not LUI.ScoreboardLayer or not LUI.ScoreboardLayer:IsShowingCPMap()) and (#arg_13_0:getParent():getAllFocusedChildren() > 0 or arg_13_0:getParent():isInFocus()) then
			if (Engine.HDGDBCJFG() or Engine.BEFACAIFDD()) and not CONDITIONS.IsSystemLink(arg_11_0) then
	...
	arg_11_0:addEventHandler("button_over", function(arg_15_0, arg_15_1)
		...
		if var_15_0 ~= nil and var_15_0.ButtonHelperBar ~= nil and (not LUI.ScoreboardLayer or not LUI.ScoreboardLayer:IsShowingCPMap()) then
			...
			if arg_11_0._isBot == true then
				...
				if not CONDITIONS.IsSystemLink(arg_11_0) and Engine.HDGDBCJFG() and not LUI.ScoreboardLayer:IsShowingCPMap() then
					var_15_0:AddButtonHelperTextToElement(var_15_0.ButtonHelperBar, {
						clickable = false,
						priority = 1,
						side = "left",
...
function CPScoreboardRow(arg_19_0, arg_19_1)
	...
	var_19_31:SetRGBFromInt(15356755, 0)
