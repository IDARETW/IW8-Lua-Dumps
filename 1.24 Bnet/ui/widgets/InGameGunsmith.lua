...
local function var_0_1(arg_2_0, arg_2_1)
	...
	arg_2_0.EquippedCount.EquippedTxt:setText(Engine.CBBHFCGDIC("CAS/EQUIPPED_COUNT", var_2_0, ATTACHMENT.count))
	arg_2_0.EquippedCount:SetupCount(var_2_0)
end
...
local function var_0_4(arg_5_0, arg_5_1, arg_5_2)
	...
	if not var_5_2.startTime then
		...
		var_5_2.previousAttachmentConfig = ATTACHMENT.GetConfigString(arg_5_0._weaponTable)
		var_5_2.previousAttachmentConfig = ATTACHMENT.GetConfigString(arg_5_0._weaponTable)
		var_5_2.previousCosmeticConfig = WEAPON.GetCosmeticConfigString(arg_5_0._weaponTable)
		var_5_2.previousBlueprintString = WEAPON.GetWeaponBlueprintString(arg_5_1, arg_5_0._weaponTable, var_5_2.previousAttachmentConfig)
	end
	...
	if CONDITIONS.IsWaveGameType() then
		...
		arg_5_0.bindButton:addEventHandler("button_secondary", function(arg_13_0, arg_13_1)
			...
			METRICS.GunsmithSessionSendDLogEvent(arg_5_1, var_13_1.sessionID, arg_5_0._weaponTable, arg_5_2.loadoutIndex, var_13_2, var_13_3, var_5_2.previousAttachmentConfig, var_5_2.previousCosmeticConfig, var_5_2.previousBlueprintString)
		end)
	end
end
...
function InGameGunsmith(arg_14_0, arg_14_1)
	...
	if CONDITIONS.InGame(var_14_0) then
	...
	if CONDITIONS.AlwaysTrue(var_14_0) then
		local var_14_6 = LUI.UIImage.new()

		var_14_6.id = "Vignette"

		var_14_6:SetRGBFromTable(SWATCHES.genericMenu.blackBackground, 0)
		var_14_6:SetAlpha(0.5, 0)
		var_14_6:setImage(RegisterMaterial("widg_gradient_left_to_right"), 0)
		var_14_6:SetAnchorsAndPosition(0, 0, 0, 0, 0, _1080p * -900, 0, 0)
		var_14_0:addElement(var_14_6)

		var_14_0.Vignette = var_14_6
	end
	...
	local var_14_9
	local var_14_10 = MenuBuilder.BuildRegisteredType("DoubleNotchedBacker", {
		controllerIndex = var_14_1
	})

	var_14_10.id = "Background"

	var_14_10:SetAlpha(0.75, 0)
	var_14_10:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 740, _1080p * 1152, _1080p * 178, _1080p * 676)
	var_14_0:addElement(var_14_10)

	var_14_0.Background = var_14_10

	local var_14_11
	local var_14_12 = LUI.UIText.new()

	var_14_12.id = "WeaponName"

	var_14_12:SetRGBFromTable(SWATCHES.genericMenu.mainTitle, 0)
	var_14_12:setText("", 0)
	var_14_12:SetFont(FONTS.GetFont(FONTS.MainBold.File))
	var_14_12:SetAlignment(LUI.Alignment.Left)
	var_14_12:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 768, _1080p * 1132, _1080p * 200, _1080p * 230)
	var_14_0:addElement(var_14_12)

	var_14_0.WeaponName = var_14_12

	local var_14_13
	local var_14_14 = MenuBuilder.BuildRegisteredType("WeaponAttributes", {
		controllerIndex = var_14_1
	})

	var_14_14.id = "WeaponAttributes"

	var_14_14:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 740, _1080p * 1152, _1080p * 449, _1080p * 641)
	var_14_0:addElement(var_14_14)

	var_14_0.WeaponAttributes = var_14_14
	...
	local var_14_17 = LUI.UIGrid.new(var_14_16)

	var_14_17.id = "Categories"

	var_14_17:setUseStencil(true)
	var_14_17:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 96, _1080p * 520, _1080p * 178, _1080p * 979)
	var_14_0:addElement(var_14_17)

	var_14_0.Categories = var_14_17

	local var_14_18
	local var_14_19 = MenuBuilder.BuildRegisteredType("WeaponWithAttachments", {
		controllerIndex = var_14_1
	})

	var_14_19.id = "WeaponWithAttachments"

	var_14_19:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 840, _1080p * 1096, _1080p * 281, _1080p * 409)
	var_14_0:addElement(var_14_19)

	var_14_0.WeaponWithAttachments = var_14_19

	local var_14_20
	local var_14_21 = MenuBuilder.BuildRegisteredType("GunsmithEquippedSlots", {
		controllerIndex = var_14_1
	})

	var_14_21.id = "EquippedCount"

	var_14_21:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 130, _1080p * 462, _1080p * 126, _1080p * 158)
	var_14_0:addElement(var_14_21)

	var_14_0.EquippedCount = var_14_21

	local var_14_22

	if CONDITIONS.InGame(var_14_0) then
		local var_14_23 = MenuBuilder.BuildRegisteredType("InGameMenuTimerStatus", {
			controllerIndex = var_14_1
		})

		var_14_23.id = "InGameMenuTimerStatus"

		var_14_23:SetAnchorsAndPosition(0.5, 0.5, 0, 1, _1080p * -140, _1080p * 260, _1080p * 54, _1080p * 104)
		var_14_0:addElement(var_14_23)

		var_14_0.InGameMenuTimerStatus = var_14_23
	end

	local var_14_24

	if CONDITIONS.IsSplitscreen(var_14_0) then
		local var_14_25 = MenuBuilder.BuildRegisteredType("NavigationArrow", {
			controllerIndex = var_14_1
		})

		var_14_25.id = "ArrowUp"

		var_14_25:SetAnchorsAndPosition(0.5, 0.5, 0, 1, _1080p * -752, _1080p * -720, _1080p * 533, _1080p * 565)
		var_14_0:addElement(var_14_25)

		var_14_0.ArrowUp = var_14_25
	end

	local var_14_26

	if CONDITIONS.IsSplitscreen(var_14_0) then
		local var_14_27 = MenuBuilder.BuildRegisteredType("NavigationArrow", {
			controllerIndex = var_14_1
		})
	...
	if CONDITIONS.IsSplitscreen(var_14_0) then
		local var_14_29 = LUI.UIText.new()

		var_14_29.id = "ListCount"

		var_14_29:SetRGBFromTable(SWATCHES.text.primaryText, 0)
		var_14_29:setText("", 0)
		var_14_29:SetFont(FONTS.GetFont(FONTS.MainRegular.File))
		var_14_29:SetAlignment(LUI.Alignment.Center)
		var_14_29:SetVerticalAlignment(LUI.Alignment.Center)
		var_14_29:SetAnchorsAndPosition(0.5, 0.5, 0, 1, _1080p * -720, _1080p * -584, _1080p * 540, _1080p * 560)
		var_14_0:addElement(var_14_29)

		var_14_0.ListCount = var_14_29
	end

	local var_14_30

	if CONDITIONS.IsWaveGameType(var_14_0) then
		var_14_30 = MenuBuilder.BuildRegisteredType("PurchaseWidget", {
			controllerIndex = var_14_1
		})
		var_14_30.id = "PurchaseWidget"

		var_14_30:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 740, _1080p * 1190, _1080p * 785, _1080p * 929)
		var_14_0:addElement(var_14_30)

		var_14_0.PurchaseWidget = var_14_30
	end

	local var_14_31

	if CONDITIONS.IsWaveGameType(var_14_0) then
		var_14_31 = MenuBuilder.BuildRegisteredType("WaveTimer", {
			controllerIndex = var_14_1
		})
		var_14_31.id = "WaveTimer"

		var_14_31.ReinforcementsText:setText(Engine.CBBHFCGDIC("COOP_GAME_PLAY/RESPAWN_COUNTDOWN"), 0)
		var_14_31:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 1385, _1080p * 1670, _1080p * 240, _1080p * 374)
		var_14_0:addElement(var_14_31)

		var_14_0.WaveTimer = var_14_31
	end

	local var_14_32
	local var_14_33 = MenuBuilder.BuildRegisteredType("VerticalMinimalScrollbar", {
		controllerIndex = var_14_1
	})

	var_14_33.id = "Scrollbar"

	var_14_33:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 522, _1080p * 533, _1080p * 178, _1080p * 528)
	var_14_0:addElement(var_14_33)

	var_14_0.Scrollbar = var_14_33
	...
	var_14_10:RegisterAnimationSequence("Splitscreen", var_14_35)
	...
	var_14_12:RegisterAnimationSequence("Splitscreen", var_14_36)
	...
	var_14_14:RegisterAnimationSequence("Splitscreen", var_14_37)
	...
	var_14_19:RegisterAnimationSequence("Splitscreen", var_14_38)
	...
	if CONDITIONS.IsWaveGameType(var_14_0) then
		...
		var_14_30:RegisterAnimationSequence("Splitscreen", var_14_39)
	end
	...
	if CONDITIONS.IsWaveGameType(var_14_0) then
		...
		var_14_31:RegisterAnimationSequence("Splitscreen", var_14_40)
	end

	local function var_14_41()
		var_14_10:AnimateSequence("Splitscreen")
		...
		if CONDITIONS.IsWaveGameType(var_14_0) then
			var_14_31:AnimateSequence("Splitscreen")
		end
	end

	var_14_0._sequences.Splitscreen = var_14_41
	...
	local var_14_42 = LUI.UIScrollbar.new({
		direction = LUI.DIRECTION.vertical,
		eventListener = var_14_33,
		startCap = var_14_33.startCap,
		endCap = var_14_33.endCap,
		sliderArea = var_14_33.sliderArea,
		slider = var_14_33.sliderArea and var_14_33.sliderArea.slider,
		fixedSizeSlider = var_14_33.sliderArea and var_14_33.sliderArea.fixedSizeSlider
	})

	var_14_17:AddScrollbar(var_14_42)
	...
	local var_14_43 = LUI.UIBindButton.new()

	var_14_43.id = "selfBindButton"

	var_14_0:addElement(var_14_43)

	var_14_0.bindButton = var_14_43

	var_14_0.bindButton:addEventHandler("button_secondary", function(arg_19_0, arg_19_1)
