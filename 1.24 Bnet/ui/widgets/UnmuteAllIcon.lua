...
function UnmuteAllIcon(arg_1_0, arg_1_1)
	...
	var_1_4:setImage(RegisterMaterial("icon_mic_talking"), 0)
	var_1_4:SetBlendMode(BLEND_MODE.addWithAlpha)
	var_1_4:SetAnchorsAndPosition(0.5, 0.5, 0.5, 0.5, _1080p * -12, _1080p * 12, _1080p * -12, _1080p * 12)
