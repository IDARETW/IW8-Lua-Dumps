...
local function var_0_3(arg_4_0)
	if IsLanguageArabic() then
		...
		LAYOUT.SetTextBoxSize(arg_4_0.NewText, arg_4_0.Backer, arg_4_0.NewText:getText(), 9, nil, LUI.Alignment.Left, 0)
		...
		LAYOUT.SetTextBoxSize(arg_4_0.NewText, arg_4_0.Backer, arg_4_0.NewText:getText(), arg_4_0._isLeftAligned and 4 or 9, nil, arg_4_0._isLeftAligned and LUI.Alignment.Left or LUI.Alignment.Right, 0)
