...
function SocialPlayerButtonBackground(arg_1_0, arg_1_1)
	local var_1_0 = LUI.UIButton.new()

	var_1_0:SetAnchorsAndPosition(0, 1, 0, 1, 0, 370 * _1080p, 0, 44 * _1080p)

	var_1_0.id = "SocialPlayerButtonBackground"
