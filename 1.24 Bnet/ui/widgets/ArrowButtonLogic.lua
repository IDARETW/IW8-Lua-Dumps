...
local function var_0_2(arg_2_0, arg_2_1, arg_2_2, arg_2_3)
	...
	if arg_2_0.applyable == false and var_2_0 ~= arg_2_1 and arg_2_0.autoFunctionCall then
...
local function var_0_6(arg_6_0, arg_6_1, arg_6_2)
	...
	function arg_6_0.SetCurrentValue(arg_8_0, arg_8_1, arg_8_2)
		var_0_2(arg_8_0, arg_8_1, arg_6_1, arg_8_2)
	end
	...
	arg_6_0:addEventHandler("gain_focus", function(arg_10_0, arg_10_1)
		if not arg_6_0:IsDisabled() then
			arg_6_0.bindButton:ElementEnable()
		end
	end)
	...
	arg_6_0:addEventHandler("reset_value", function(arg_17_0, arg_17_1)
		if arg_17_0.defaultValueGetter and not arg_17_0.disabled and not arg_17_0.applyable then
			arg_17_0:SetCurrentValue(arg_17_0.defaultValueGetter(arg_17_1.controllerIndex or arg_6_1))
