...
local function var_0_1(arg_2_0)
	...
	local var_2_1 = 0
	local var_2_2 = 0
	local var_2_3 = StringTable.BFHCAIIDA(CSV.charms.file)

	for iter_2_0 = 0, var_2_3 - 1 do
		local var_2_4 = CSV.ReadRow(CSV.charms, iter_2_0)

		if var_2_4 and var_2_4.hideInUI ~= "1" then
			var_2_4.isUnlocked = LOOT.IsUnlocked(arg_2_0._controllerIndex, LOOT.itemTypes.CHARM, var_2_4.ref) or var_2_4.ref == WEAPON.CharmNoneValue
			var_2_4.rarity = LOOT.GetItemQuality(LOOT.itemTypes.CHARM, var_2_4.ref)
			var_2_4.season, var_2_4.event, var_2_4.isPremium = LOOT.GetItemSeason(LOOT.itemTypes.CHARM, var_2_4.ref)
			var_2_4.lootID = LOOT.GetItemID(LOOT.itemTypes.CHARM, var_2_4.ref)
			var_2_4.isNew = Loot.HDJCADADF(arg_2_0._controllerIndex, var_2_4.lootID)

			table.insert(var_2_0, var_2_4)

			if var_2_4.ref ~= WEAPON.CharmNoneValue then
...
local function var_0_2(arg_3_0, arg_3_1)
	if not arg_3_0._allCharmsTable or #arg_3_0._allCharmsTable == 0 then
		arg_3_0._allCharmsTable = var_0_1(arg_3_0)
	end

	arg_3_0._charmTable = {}

	for iter_3_0 = 1, #arg_3_0._allCharmsTable do
		if arg_3_0._allCharmsTable[iter_3_0].isUnlocked or arg_3_0.lockedSortingType == LOOT.lockedSortingOptions.SHOW then
			table.insert(arg_3_0._charmTable, arg_3_0._allCharmsTable[iter_3_0])
		end
	end

	table.sort(arg_3_0._charmTable, function(arg_4_0, arg_4_1)
		if arg_4_0.ref ~= WEAPON.CharmNoneValue and arg_4_1.ref == WEAPON.CharmNoneValue then
			return false
		elseif arg_4_0.ref == WEAPON.CharmNoneValue and not arg_4_1.ref == WEAPON.CharmNoneValue then
			return true
		end

		if arg_3_0._favoriteCharms[arg_4_0.ref] ~= arg_3_0._favoriteCharms[arg_4_1.ref] then
			return arg_3_0._favoriteCharms[arg_4_0.ref] and not arg_3_0._favoriteCharms[arg_4_1.ref]
		end
...
local function var_0_7(arg_11_0)
	...
	if Engine.DDJFBBJAIG() then
		...
		var_11_4.cosmeticAttachment = var_11_1.ref
...
local function var_0_11(arg_15_0, arg_15_1, arg_15_2, arg_15_3)
...
local function var_0_13(arg_21_0, arg_21_1, arg_21_2)
	...
	arg_21_0.CharmGrid:SetRefreshChild(var_0_12(arg_21_0))
...
function CharmSelect(arg_26_0, arg_26_1)
	...
	var_26_13.MenuTitle:setText(Engine.CBBHFCGDIC("LUA_MENU/CHARM_SELECT_TITLE"), 0)
