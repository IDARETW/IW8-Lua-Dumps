...
function GenericOptionSubcategoryTitle(arg_2_0, arg_2_1)
	...
	var_2_4:SetAnchorsAndPosition(0, 0, 1, 0, 0, 0, _1080p * -26, _1080p * -6)
	...
	var_2_4:RegisterAnimationSequence("KORZHJP", var_2_10)
	...
	var_2_6:RegisterAnimationSequence("KORZHJP", var_2_11)
	...
	var_2_0._sequences.KORZHJP = var_2_12
	...
	var_2_4:RegisterAnimationSequence("RU", var_2_13)

	local function var_2_14()
		var_2_4:AnimateSequence("RU")
	end

	var_2_0._sequences.RU = var_2_14
