...
local function var_0_1(arg_2_0, arg_2_1, arg_2_2, arg_2_3, arg_2_4, arg_2_5)
	...
	if not arg_2_0._data.unlocked then
		...
		local var_2_2 = {
			...
			level = PROGRESSION.GetRankDisplay(tonumber(var_2_1.level))
		}

		arg_2_0.GenericLock:Setup(var_2_2)
	end

	local var_2_3 = GUNSMITH.IsAttachVariantCategoryBlacklisted(arg_2_4.weapon, ATTACHMENT.GetCategory(arg_2_2.ref))
