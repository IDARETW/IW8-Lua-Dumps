...
function RefreshAnimation(arg_3_0, arg_3_1, arg_3_2)
	if arg_3_0._lastState ~= arg_3_1 then
		...
		if arg_3_2 then
			assert(arg_3_0._sequences and arg_3_0._sequences[arg_3_1 .. "Snap"])
			ACTIONS.AnimateSequence(arg_3_0, arg_3_1 .. "Snap")
		else
...
function GenericOptionButton(arg_13_0, arg_13_1)
	...
	var_13_10:SetAnchorsAndPosition(1, 0, 0.5, 0.5, _1080p * -28, _1080p * -20, _1080p * -4, _1080p * 4)
