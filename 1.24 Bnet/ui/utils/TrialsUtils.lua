...
function TRIALS.SetupEndGlobalTimer(arg_12_0)
	local var_12_0 = Dvar.CFHDGABACF("MOKTSOLQMP") - Engine.DCJHCAFIIA()
...
function TRIALS.GetNextStartingTrialEventTime()
	...
	local var_14_3 = tonumber(Engine.DCJHCAFIIA())
...
TRIALS.ParticipationLootID = 128
TRIALS.CompletionLootID = 128
