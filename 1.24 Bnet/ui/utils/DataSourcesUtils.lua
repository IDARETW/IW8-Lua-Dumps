...
function LUI.DataSourceFromOmnvar.FindModel(arg_18_0, arg_18_1)
	...
	assert(var_18_0, "Could not find a model for omnvar '" .. tostring(arg_18_0._omnvarName) .. "'. It is most likely missing from omnvars.csv.")
...
local var_0_0 = {
	GetDataSourceForField = function(arg_64_0, arg_64_1)
		...
		if not arg_64_0._cachedSubDataSources[arg_64_1] then
			...
			assert(var_64_0, "Error navigating playerdata, from field " .. tostring(arg_64_0._DDLState) .. " with key " .. tostring(arg_64_1))
...
function WipeGlobalModelsAtPath(arg_85_0)
	local var_85_0 = DataModel.DGADFJACCI(DataModel.CICAGFJFEH(), arg_85_0)

	if var_85_0 then
		DataModel.ECHJFCGHJI(var_85_0)
	end
end

function WipeControllerModelsAtPath(arg_86_0)
	for iter_86_0 = 0, Engine.DCJGJDDEHE() - 1 do
		local var_86_0 = DataModel.DGADFJACCI(DataModel.DJJHBDCEAB(iter_86_0), arg_86_0)
...
function WipeAllModelsAtPath(arg_87_0)
	WipeGlobalModelsAtPath(arg_87_0)
	WipeControllerModelsAtPath(arg_87_0)
end

function UpdateDataSourcesByMode(arg_88_0, arg_88_1)
	...
	if Engine.DDJFBBJAIG() then
		for iter_88_0, iter_88_1 in ipairs(var_88_0) do
			if iter_88_0 == arg_88_0 then
				assert(iter_88_1.initFunction)
				iter_88_1.initFunction()
			else
				assert(iter_88_1.modelPath)
				WipeAllModelsAtPath(iter_88_1.modelPath)
			end
		end
	end
end
