...
function CallingCardUtils.GetAllPlayerCards(arg_2_0, arg_2_1)
	...
	for iter_2_0 = 0, var_2_3 - 1 do
		...
		if var_2_4 and var_2_4.hideInUI ~= "1" then
			...
			if var_2_2 == CallingCardUtils.Categories.CORE and var_2_4.unlockType == "" or var_2_2 == tonumber(var_2_4.unlockType) then
...
function CallingCardUtils.GetCardTexture(arg_8_0)
	...
	if var_8_1 == nil or #var_8_1 == 0 then
		var_8_1 = StringTable.DIFCHIGDFB(CSV.callingCards.file, CSV.callingCards.cols.index, CallingCardUtils.DefaultCardIndex, CSV.callingCards.cols.image)
	end
...
function CallingCardUtils.GetChallengeEntry(arg_30_0, arg_30_1, arg_30_2)
	...
	assert(var_30_5 > 0, "Failed to get challenge data for " .. arg_30_0)
