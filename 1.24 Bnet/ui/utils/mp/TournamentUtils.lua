...
function TOURNAMENT.GetAllRewards(arg_48_0, arg_48_1, arg_48_2)
	local var_48_0

	if arg_48_1 then
		var_48_0 = Loot.DGJJHEHII(arg_48_0)
	else
		local var_48_1 = StringTable.DIFCHIGDFB(CSV.tournamentChallenges.file, CSV.tournamentChallenges.cols.id, TOURNAMENT.rewardChallenge, CSV.tournamentChallenges.cols.loot)

		var_48_0 = LUI.Split(var_48_1, "|")
	end

	local var_48_2 = StringTable.DIFCHIGDFB(CSV.tournamentChallenges.file, CSV.tournamentChallenges.cols.id, TOURNAMENT.rewardChallenge, CSV.tournamentChallenges.cols.XPReward)
	local var_48_3 = LUI.Split(var_48_2, "|")
	local var_48_4 = {}
	local var_48_5 = math.max(#var_48_0, #var_48_3)

	for iter_48_0 = 1, var_48_5 do
		local var_48_6 = {}

		if var_48_3[iter_48_0] and tonumber(var_48_3[iter_48_0]) > 0 then
			local var_48_7 = {}

			var_48_7.type = "xp"
			var_48_7.name = Engine.CBBHFCGDIC("CHALLENGE/N_XP", var_48_3[iter_48_0])
			var_48_7.image = "icon_xp_token"
			var_48_7.amount = tonumber(var_48_3[iter_48_0])
			var_48_6.xp = var_48_7

			if arg_48_1 and arg_48_2 and iter_48_0 <= #var_48_3 - (arg_48_2 - 1) then
				table.insert(var_48_4, var_48_7)
			end
		end

		if var_48_0[iter_48_0] then
			local var_48_8 = tonumber(var_48_0[iter_48_0])

			if var_48_8 ~= LOOT.emptyID then
				local var_48_9 = LOOT.IsUnlockedWithID(arg_48_0, var_48_8)
				local var_48_10 = {
					lootID = var_48_8,
					unlocked = var_48_9
				}

				var_48_10.type = LOOT.GetTypeForID(var_48_10.lootID)
				var_48_10.ref = LOOT.GetItemRef(var_48_10.type, var_48_10.lootID)
				var_48_10.name = LOOT.GetItemName(var_48_10.type, var_48_10.ref, var_48_10.lootID)
				var_48_10.rarity = LOOT.GetItemQuality(var_48_10.type, var_48_10.ref, var_48_10.lootID)
				var_48_10.rarityImage = LOOT.GetRarityImage(var_48_10.rarity)
				var_48_10.rarityColor = LOOT.GetRarityColor(var_48_10.rarity)
				var_48_10.image = LOOT.GetItemImage(var_48_10.type, var_48_10.ref, var_48_10.lootID)
				var_48_6.loot = var_48_10
		...
		if (var_48_6.loot or var_48_6.xp) and not arg_48_1 then
			table.insert(var_48_4, var_48_6)
		end
	end
...
function TOURNAMENT.GetMyReward(arg_49_0, arg_49_1, arg_49_2)
	local var_49_0 = TOURNAMENT.GetAllRewards(arg_49_0, arg_49_2)

	return arg_49_2 and var_49_0 or var_49_0[arg_49_1]
end

function TOURNAMENT.CanShowResults()
	local var_50_0 = Tournament.BEFJGJJBEI()

	return var_50_0 == MP.TournamentParticipationStatus.ELIMINATED or var_50_0 == MP.TournamentParticipationStatus.VICTORIOUS
end

function TOURNAMENT.CanReadyUp()
	local var_51_0 = Tournament.BEFJGJJBEI()
	local var_51_1 = TOURNAMENT.GetMyCurrentMatchInfo()

	if var_51_0 == MP.TournamentParticipationStatus.ACTIVE and var_51_1 then
		local var_51_2 = var_51_1.teams[1].teamID ~= -1 and var_51_1.teams[2].teamID ~= -1

		if not Tournament.DBEBAGHJCA() and not var_51_1.complete and var_51_2 then
			return true
		end
	end
...
function TOURNAMENT.GetMapPoolData()
	...
	if Dvar.DHEEJCCJBH("LLSSNNLTQM") then
		var_52_1[4] = Dvar.DHEEJCCJBH("LLSSNNLTQM")
	end

	for iter_52_0 = 1, #var_52_1 do
		local var_52_2 = var_52_1[iter_52_0]
		local var_52_3 = split(var_52_2, ",")

		for iter_52_1 = 1, #var_52_3 do
			local var_52_4 = var_52_3[iter_52_1]
			local var_52_5 = false
			local var_52_6 = {
				ref = var_52_3[iter_52_1],
				name = MP.GetMapName(var_52_4),
				image = MP.GetMapImage(var_52_4)
			}

			if #var_52_0 == 0 then
				table.insert(var_52_0, var_52_6)
			end

			for iter_52_2 = 1, #var_52_0 do
				if var_52_6.ref == var_52_0[iter_52_2].ref then
					var_52_5 = true
