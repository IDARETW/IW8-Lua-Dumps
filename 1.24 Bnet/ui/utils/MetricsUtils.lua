...
function METRICS.RecordGraphicOptionsDLog(arg_6_0)
	...
	if var_6_1 then
		...
		Engine.CEJJDJJHIJ(0, "dlog_event_graphics_options", {
			...
			use_compute_skinning = var_6_3.MLTKKKQMSN or false,
...
function METRICS.RecordSocialMenuOpeningFlow(arg_11_0, arg_11_1)
	Engine.CEJJDJJHIJ(arg_11_0, "dlog_event_socialmenu_opening", {
		has_used_shortcut = arg_11_1,
		triggered_on_gamepad = LUI.IsLastInputGamepad(arg_11_0),
		triggered_in_frontend = Engine.DDJFBBJAIG()
	})
end

function METRICS.RecordInGameDismissMenuUsage(arg_12_0, arg_12_1, arg_12_2)
	Engine.CEJJDJJHIJ(arg_12_0, "dlog_event_ingame_dismiss_menu_usage", {
		dismissed_menu_name = arg_12_1,
		has_used_shortcut = arg_12_2,
		triggered_on_gamepad = LUI.IsLastInputGamepad(arg_12_0)
	})
end

function METRICS.MatchEndDLogRecording(arg_13_0)
	local var_13_0 = Engine.BECCFCBIAA("matchEndShouldRecordDLogInt", arg_13_0)

	if var_13_0 and var_13_0 > 0 then
		if BitwiseOperators.band(var_13_0, METRICS.EndMatchDLog.KEYBINDS_GAMEPLAY) > 0 then
			Engine.CEIHBEDEDE(arg_13_0)
		end

		if Engine.CGABICJHAI() and BitwiseOperators.band(var_13_0, METRICS.EndMatchDLog.GRAPHICS) > 0 then
			METRICS.RecordGraphicOptionsDLog(arg_13_0)
		end

		if BitwiseOperators.band(var_13_0, METRICS.EndMatchDLog.GENERAL) > 0 then
			METRICS.RecordGeneralOptionsDLog(arg_13_0)
		end

		if BitwiseOperators.band(var_13_0, METRICS.EndMatchDLog.AUDIO) > 0 then
			METRICS.RecordAudioOptionsDLog(arg_13_0)
		end

		if BitwiseOperators.band(var_13_0, METRICS.EndMatchDLog.ACCOUNT) > 0 then
			METRICS.RecordAccountOptionsDLog(arg_13_0)
		end

		if BitwiseOperators.band(var_13_0, METRICS.EndMatchDLog.CONTROLLER) > 0 then
			METRICS.RecordControllerOptionsDLog(arg_13_0)
		end
	...
	if Engine.ECHCFGDDDF() and METRICS.FastLoadoutUsageCount > 0 then
		METRICS.RecordFastLoadoutUsage(arg_13_0)
	end
end

function METRICS.ContextualMenuDLogRecording(arg_14_0, arg_14_1)
	local var_14_0 = arg_14_1 or "none"
	local var_14_1 = METRICS.VOID_STRING
	local var_14_2 = Engine.DBFFAEEFGJ()
	local var_14_3 = var_14_2.flowManager
	local var_14_4 = LUI.UIRoot.GetActiveLayer(var_14_2)

	if var_14_4 then
		var_14_1 = var_14_4.id
	elseif var_14_3 and not var_14_3:IsStackEmpty() then
		local var_14_5 = var_14_3:GetTopMostOpenMenuInfo()

		var_14_1 = not var_14_5.isPopup and var_14_5.name or LUI.FlowManager.GetMenuNameAtIndex(-1)
	end

	Engine.CEJJDJJHIJ(0, "dlog_event_contextual_menu", {
		action_id = METRICS.ContextualActionIndexDLog[var_14_0],
		menu_name = var_14_1
	})
end

function METRICS.CacSessionStartSendDLogEvent(arg_15_0, arg_15_1)
	local var_15_0 = not Engine.DDJFBBJAIG()
	local var_15_1 = Lobby.BBDICGHE() or IsPrivateMatch()

	Engine.CEJJDJJHIJ(arg_15_0, "dlog_event_cac_session_start", {
		cac_session_id = arg_15_1,
...
function METRICS.CacSessionEndSendDLogEvent(arg_16_0, arg_16_1, arg_16_2, arg_16_3)
	local var_16_0 = not Engine.DDJFBBJAIG()
	local var_16_1 = Lobby.BBDICGHE() or IsPrivateMatch()
	local var_16_2 = Engine.BAHGDJFBEF(Engine.DCJHCAFIIA(), "-" .. arg_16_2)

	Engine.CEJJDJJHIJ(arg_16_0, "dlog_event_cac_session_end", {
		cac_session_id = arg_16_1,
		previous_screen_id = LUI.FlowManager.GetMenuNameAtIndex(-1),
		time_spent_ms = tonumber(var_16_2) * 1000,
		exit_reason = arg_16_3,
		lobby_flag = var_16_1,
		in_match = var_16_0
	})
end

function METRICS.LoadoutSessionSendDLogEvent(arg_17_0, arg_17_1, arg_17_2, arg_17_3)
	local var_17_0 = Engine.BAHGDJFBEF(Engine.DCJHCAFIIA(), "-" .. arg_17_2)

	Engine.CEJJDJJHIJ(arg_17_0, "dlog_event_cac_edit_loadout", {
		cac_session_id = arg_17_1,
		previous_screen_id = LUI.FlowManager.GetMenuNameAtIndex(-1),
		time_spent_ms = tonumber(var_17_0) * 1000,
		loadout_id = arg_17_3
	})
end

function METRICS.GunsmithSessionSendDLogEvent(arg_18_0, arg_18_1, arg_18_2, arg_18_3, arg_18_4, arg_18_5, arg_18_6, arg_18_7, arg_18_8)
	local var_18_0 = ATTACHMENT.GetConfigString(arg_18_2)
	local var_18_1 = WEAPON.GetCosmeticConfigString(arg_18_2)
	local var_18_2 = WEAPON.GetWeaponBlueprintString(arg_18_0, arg_18_2, var_18_0)

	Engine.CEJJDJJHIJ(arg_18_0, "dlog_event_cac_gunsmith", {
		cac_session_id = arg_18_1,
		previous_screen_id = LUI.FlowManager.GetMenuNameAtIndex(-1),
		attachment_time_spent_ms = tonumber(arg_18_4) * 1000,
		customize_time_spent_ms = tonumber(arg_18_5) * 1000,
		loadout_id = arg_18_3,
		weapon = arg_18_2.weapon,
		previous_attachment_config = arg_18_6,
		new_attachment_config = var_18_0,
		blueprint_id = arg_18_2.lootID,
		previous_cosmetic_config = arg_18_7,
		new_cosmetic_config = var_18_1,
		previous_attachment_blueprints = arg_18_8,
		new_attachment_blueprints = var_18_2
	})
end

function METRICS.CRMSendDlogEvent(arg_19_0, arg_19_1, arg_19_2, arg_19_3, arg_19_4)
	local var_19_0 = {}

	for iter_19_0 = 1, #arg_19_2 do
		local var_19_1 = arg_19_2[iter_19_0]
		local var_19_2 = {
			message_id = var_19_1[CRM.keys.MESSAGE_ID],
			grid_position_num = iter_19_0,
			channel_id = var_19_1[CRM.keys.LOCATION_ID],
			layout_id = var_19_1[CRM.keys.LAYOUT_TYPE],
			total_time_spent_ms = (var_19_1.timeSpent or 0) * 1000,
			more_details_time_spent_ms = (var_19_1.timeSpent or 0) * 1000
		}

		table.insert(var_19_0, var_19_2)
	end

	local var_19_3 = LUI.FlowManager.GetVisibleMenu()
	local var_19_4 = var_19_3 and var_19_3.id or ""
	local var_19_5 = LUI.FlowManager.GetMenuNameAtIndex(-1) or ""
	local var_19_6 = arg_19_2[arg_19_3 + 1][CRM.keys.MESSAGE_ID]
	local var_19_7 = #arg_19_2
	local var_19_8 = ""
	local var_19_9 = GetCurrentLanguage()

	arg_19_4 = arg_19_4 or ""

	Engine.CJIAHJHHDJ(arg_19_1, var_19_0, var_19_4, var_19_5, var_19_6, var_19_7, arg_19_4, var_19_8, var_19_9)
end

function METRICS.IdentityUsageSendDLogEvent(arg_20_0, arg_20_1, arg_20_2, arg_20_3, arg_20_4, arg_20_5)
	if arg_20_4 ~= arg_20_5 then
		arg_20_4 = tostring(arg_20_4)
		arg_20_5 = tostring(arg_20_5)

		local var_20_0 = arg_20_0:GetCurrentMenu().id
		local var_20_1 = Engine.BAHGDJFBEF(Engine.DCJHCAFIIA(), "-" .. arg_20_2)

		Engine.CEJJDJJHIJ(arg_20_1, "dlog_event_identity_usage", {
			cac_session_id = arg_20_2,
			previous_screen_id = var_20_0,
			time_spent_ms = tonumber(var_20_1) * 1000,
			item_category = arg_20_3,
			previous_item_ids = arg_20_4,
			new_item_ids = arg_20_5
		})
	end
end

function METRICS.OperatorUsageSendDLogEvent(arg_21_0, arg_21_1, arg_21_2, arg_21_3, arg_21_4)
	if arg_21_3 ~= arg_21_4 then
		arg_21_3 = tostring(arg_21_3)
		arg_21_4 = tostring(arg_21_4)

		local var_21_0 = arg_21_0:GetCurrentMenu().id
		local var_21_1 = Engine.BAHGDJFBEF(Engine.DCJHCAFIIA(), "-" .. arg_21_2)

		Engine.CEJJDJJHIJ(arg_21_1, "dlog_event_operator_usage", {
			cac_session_id = arg_21_2,
			previous_screen_id = var_21_0,
			time_spent_ms = tonumber(var_21_1) * 1000,
			previous_item_ids = arg_21_3,
			new_item_ids = arg_21_4
		})
	end
end

function METRICS.TextChatUsageSendDLogEvent(arg_22_0)
	local var_22_0 = LUI.IsLastInputGamepad(arg_22_0)

	Engine.CEJJDJJHIJ(arg_22_0, "dlog_event_textchat_usage", {
		chat_input_gamepad = var_22_0
	})
end

function METRICS.VehicleUsageSendDLogEvent(arg_23_0, arg_23_1, arg_23_2, arg_23_3, arg_23_4)
	if arg_23_3 ~= arg_23_4 then
		arg_23_3 = tostring(arg_23_3)
		arg_23_4 = tostring(arg_23_4)

		local var_23_0 = Engine.BAHGDJFBEF(Engine.DCJHCAFIIA(), "-" .. arg_23_2)

		Engine.CEJJDJJHIJ(arg_23_1, "dlog_event_vehicle_usage", {
			cac_session_id = arg_23_2,
			previous_screen_id = arg_23_0,
			time_spent_ms = tonumber(var_23_0) * 1000,
			previous_item_ids = arg_23_3,
			new_item_ids = arg_23_4
		})
	end
end

function METRICS.PlaylistFilterSendDLogEvent(arg_24_0, arg_24_1, arg_24_2, arg_24_3)
	local var_24_0 = tostring(arg_24_2) .. " " .. "( " .. Engine.CBBHFCGDIC(arg_24_3) .. ") "
	local var_24_1 = Dvar.CFHDGABACF("NLTOPSKPQM") or -1
	local var_24_2, var_24_3 = PlaylistUtils.GetCurrentFilterDetails(arg_24_1, arg_24_0)

	Engine.CEJJDJJHIJ(arg_24_0, "dlog_event_playlist_filter_selection", {
		selected_filter = arg_24_2,
		previous_match_playlist_id = var_24_1,
		selected_playlist_ids = var_24_2,
		unselected_playlist_ids = var_24_3
	})
end
