...
function CP.ClearWaveLoadout(arg_4_0, arg_4_1)
	...
	var_4_0.weaponSetups[0].weapon:set("iw8_pi_golf21")
	var_4_0.weaponSetups[1].weapon:set("iw8_pi_golf21")
	var_4_0.weaponSetups[2].weapon:set("none")
...
function CP.UpdateWeaponsFromScript(arg_7_0)
	...
	var_7_2.weaponSetups[0].weapon:set(var_7_0)
	var_7_2.weaponSetups[1].weapon:set(var_7_1)
end
