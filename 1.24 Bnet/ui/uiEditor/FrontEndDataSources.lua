...
function MissionCompletedFilter(arg_8_0, arg_8_1)
	return arg_8_0 >= 0
end

function MedalImageFilter(arg_9_0, arg_9_1)
	if arg_9_0 == 1 then
...
local function var_0_0(arg_14_0)
	return arg_14_0 == 1
end

local function var_0_1(arg_15_0, arg_15_1, arg_15_2)
	return function(arg_16_0)
		local var_16_0 = Engine.JCBDICCAH(arg_15_0:GetValue(arg_16_0))
		local var_16_1 = arg_15_1:GetValue(arg_16_0)
		local var_16_2 = arg_15_2:GetValue(arg_16_0)

		if var_16_1 then
			return Engine.CBBHFCGDIC("LUA_MENU_MP/HARDCORE_GAME_TYPE", var_16_0)
		elseif var_16_2 then
			return Engine.CBBHFCGDIC("LUA_MENU_MP/REALISM_GAME_TYPE", var_16_0)
		else
			return var_16_0
		end
	end
...
local function var_0_2(arg_17_0, arg_17_1)
	return function(arg_18_0)
		assert(arg_17_0, "GAMETYPE NOT FOUND")
		assert(arg_17_1, "ISHARDCORE DATA SOURCE NOT FOUND")

		local var_18_0 = arg_17_0:GetValue(arg_18_0)

		if not var_18_0 then
			return
		end

		local var_18_1 = arg_17_1:GetValue(arg_18_0)
		local var_18_2 = StringTable.DIFCHIGDFB(CSV.gameTypesTable.file, CSV.gameTypesTable.cols.ref, var_18_0, CSV.gameTypesTable.cols.image)

		if var_18_1 then
			local var_18_3 = StringTable.DIFCHIGDFB(CSV.gameTypesTable.file, CSV.gameTypesTable.cols.ref, var_18_0, CSV.gameTypesTable.cols.hardcoreImage)

			if var_18_3 == "" then
				var_18_3 = var_18_2
			end

			return var_18_3 ~= "" and var_18_3 or "icon_playlist_generic"
		else
			return var_18_2 ~= "" and var_18_2 or "icon_playlist_generic"
		end
	end
end
...
function InitLobbyDataSources()
	...
	local var_20_0 = DataSources.frontEnd.lobby.gameType
	local var_20_1 = DataSources.frontEnd.lobby.isHardcoreGameType
	local var_20_2 = DataSources.frontEnd.lobby.isRealismGameType

	DataSources.frontEnd.lobby.gameTypeImage = LUI.AggregateDataSource.new(var_20_0, {
		var_20_0,
		var_20_1
	}, "gameTypeImage", var_0_2(var_20_0, var_20_1))

	local var_20_3 = DataSources.frontEnd.lobby.gameTypeName

	DataSources.frontEnd.lobby.gameTypeNameWithModifier = LUI.AggregateDataSource.new(var_20_3, {
		var_20_3,
		var_20_1,
		var_20_2
	}, "gameTypeNameWithModifier", var_0_1(var_20_3, var_20_1, var_20_2))
