...
function LUI.List.GetIndexForElement(arg_14_0, arg_14_1)
	local var_14_0 = 1
	local var_14_1 = arg_14_0:getFirstChild()
	...
	while var_14_1 do
		...
		var_14_0 = var_14_0 + 1
		var_14_1 = var_14_1:getNextSibling()
	end

	return nil
end

function LUI.List.GetFocusedElementIndex(arg_15_0)
	local var_15_0 = 1
	local var_15_1 = arg_15_0:getFirstChild()

	while var_15_1 do
		if var_15_1:isInFocus() then
			return var_15_0
		end
...
function LUI.UIHorizontalList.init(arg_16_0, arg_16_1)
	arg_16_1 = arg_16_1 or {}
	arg_16_1.direction = LUI.DIRECTION.horizontal
	arg_16_1.handleNavigation = true
	arg_16_1.autoLayout = true

	LUI.UIHorizontalList.super.init(arg_16_0, arg_16_1)
end

function LUI.UIHorizontalNavigator.init(arg_17_0, arg_17_1)
	arg_17_1 = arg_17_1 or {}
	arg_17_1.direction = LUI.DIRECTION.horizontal
	arg_17_1.handleNavigation = true
	arg_17_1.autoLayout = false

	LUI.UIHorizontalNavigator.super.init(arg_17_0, arg_17_1)
end

function LUI.UIHorizontalStackedLayout.init(arg_18_0, arg_18_1)
	arg_18_1 = arg_18_1 or {}
	arg_18_1.direction = LUI.DIRECTION.horizontal
	arg_18_1.handleNavigation = false
	arg_18_1.autoLayout = true

	LUI.UIHorizontalStackedLayout.super.init(arg_18_0, arg_18_1)
end

function LUI.UIVerticalList.init(arg_19_0, arg_19_1)
	arg_19_1 = arg_19_1 or {}
	arg_19_1.direction = LUI.DIRECTION.vertical
	arg_19_1.handleNavigation = true
	arg_19_1.autoLayout = true

	LUI.UIVerticalList.super.init(arg_19_0, arg_19_1)
end

function LUI.UIVerticalNavigator.init(arg_20_0, arg_20_1)
	arg_20_1 = arg_20_1 or {}
	arg_20_1.direction = LUI.DIRECTION.vertical
	arg_20_1.handleNavigation = true
	arg_20_1.autoLayout = false

	LUI.UIVerticalNavigator.super.init(arg_20_0, arg_20_1)
end

function LUI.UIVerticalStackedLayout.init(arg_21_0, arg_21_1)
	arg_21_1 = arg_21_1 or {}
	arg_21_1.direction = LUI.DIRECTION.vertical
	arg_21_1.handleNavigation = false
	arg_21_1.autoLayout = true

	LUI.UIVerticalStackedLayout.super.init(arg_21_0, arg_21_1)
end

function LUI.UIHorizontalList.build(arg_22_0, arg_22_1)
	local var_22_0 = LUI.UIHorizontalList.new({})

	var_22_0:SetNoWrap(arg_22_1.noWrap)

	return var_22_0
end

function LUI.UIVerticalList.build(arg_23_0, arg_23_1)
	local var_23_0 = LUI.UIVerticalList.new(arg_23_1)
