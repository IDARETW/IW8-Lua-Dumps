...
local function var_0_0(arg_1_0, arg_1_1, arg_1_2)
	...
	local function var_1_4()
		...
		arg_1_0.Background:SetScale(var_9_0)
	end
	...
	arg_1_0.Continue:addEventHandler("gain_focus", function(arg_10_0, arg_10_1)
	...
	arg_1_0.Continue:addEventHandler("button_action", function(arg_11_0, arg_11_1)
	...
	local var_1_5 = OPTIONS.InitOptionsList(arg_1_0, arg_1_1)

	BOOT.CreateMasterVolumeLogic(arg_1_0, arg_1_1, var_1_5)
	arg_1_0:SetActiveParentBehavior()
end

function BootAudioMixPreset(arg_12_0, arg_12_1)
	local var_12_0 = LUI.UIVerticalNavigator.new()

	var_12_0.id = "BootAudioMixPreset"
	...
	var_12_4:setImage(RegisterMaterial("frontend_option_bg"), 0)
	var_12_4:SetAnchorsAndPosition(0.5, 0.5, 0, 0, _1080p * -1080, _1080p * 1080, 0, 0)
	...
	var_12_6.MenuTitle:setText(ToUpperCase(Engine.CBBHFCGDIC("LUA_MENU/AUDIO")), 0)
	...
	local var_12_7
	local var_12_8 = MenuBuilder.BuildRegisteredType("GenericSliderWithEditBox", {
		controllerIndex = var_12_1
	})

	var_12_8.id = "MasterVolume"

	var_12_8.GenericOptionButtonBase.Title:setText(ToUpperCase(Engine.CBBHFCGDIC("MENU/NEW")), 0)
	var_12_8:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 130, _1080p * 751, _1080p * 202, _1080p * 256)
	var_12_0:addElement(var_12_8)

	var_12_0.MasterVolume = var_12_8

	local var_12_9
	local var_12_10 = MenuBuilder.BuildRegisteredType("GenericOptionSubcategoryTitle", {
		controllerIndex = var_12_1
	})

	var_12_10.id = "AudioMixLabel"

	var_12_10.OptionSubcategory:setText(Engine.CBBHFCGDIC("LUA_MENU/MIX_PRESET"), 0)
	var_12_10:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 130, _1080p * 751, _1080p * 266, _1080p * 300)
	var_12_0:addElement(var_12_10)

	var_12_0.AudioMixLabel = var_12_10
	...
	var_12_13.id = "ButtonsList"

	var_12_13:setUseStencil(true)
	var_12_13:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 130, _1080p * 751, _1080p * 311, _1080p * 637)
	var_12_0:addElement(var_12_13)

	var_12_0.ButtonsList = var_12_13

	local var_12_14
	local var_12_15 = LUI.UIText.new()

	var_12_15.id = "PlayPrompt"

	var_12_15:SetRGBFromTable(SWATCHES.genericMenu.mainTitle, 0)
	var_12_15:setText(Engine.CBBHFCGDIC("LUA_MENU/PLAY_AUDIO_PROMPT"), 0)
	var_12_15:SetFont(FONTS.GetFont(FONTS.MainBold.File))
	var_12_15:SetAlignment(LUI.Alignment.Left)
	var_12_15:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 135, _1080p * 751, _1080p * 171, _1080p * 191)
	var_12_0:addElement(var_12_15)

	var_12_0.PlayPrompt = var_12_15

	local var_12_16
	local var_12_17 = LUI.UIText.new()

	var_12_17.id = "ButtonTitle"

	var_12_17:SetRGBFromTable(SWATCHES.genericMenu.mainTitle, 0)
	var_12_17:setText(ToUpperCase(""), 0)
	var_12_17:SetFont(FONTS.GetFont(FONTS.MainBold.File))
	var_12_17:SetAlignment(LUI.Alignment.Left)
	var_12_17:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 811, _1080p * 1603, _1080p * 190, _1080p * 240)
	var_12_0:addElement(var_12_17)

	var_12_0.ButtonTitle = var_12_17

	local var_12_18
	local var_12_19 = LUI.UIImage.new()

	var_12_19.id = "AudioPreview"

	var_12_19:setImage(RegisterMaterial("image_options_audio"), 0)
	var_12_19:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 811, _1080p * 1603, _1080p * 277, _1080p * 725)
	var_12_0:addElement(var_12_19)

	var_12_0.AudioPreview = var_12_19

	local var_12_20
	local var_12_21 = MenuBuilder.BuildRegisteredType("GenericButton", {
		controllerIndex = var_12_1
	})

	var_12_21.id = "Continue"
	var_12_21.buttonDescription = Engine.CBBHFCGDIC("LUA_MENU/CONTINUE_BOOT_DESC")

	var_12_21.Text:SetLeft(_1080p * 20, 0)
	var_12_21.Text:setText(Engine.CBBHFCGDIC("LUA_MENU/CONTINUE"), 0)
	var_12_21.Text:SetAlignment(LUI.Alignment.Left)
	var_12_21:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 130, _1080p * 751, _1080p * 682, _1080p * 722)
	var_12_0:addElement(var_12_21)

	var_12_0.Continue = var_12_21

	local var_12_22
	local var_12_23 = MenuBuilder.BuildRegisteredType("TabsSpacer", {
		controllerIndex = var_12_1
	})

	var_12_23.id = "ContinueSpacerTop"

	var_12_23.SpacerImage:SetAlpha(0, 0)
	var_12_23:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 130, _1080p * 751, _1080p * 643, _1080p * 648)
	var_12_0:addElement(var_12_23)

	var_12_0.ContinueSpacerTop = var_12_23

	local var_12_24
	local var_12_25 = LUI.UIImage.new()

	var_12_25.id = "LineSpacer"

	var_12_25:SetRGBFromTable(SWATCHES.tabManager.tabText, 0)
	var_12_25:SetAlpha(0.6, 0)
	var_12_25:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 318, _1080p * 563, _1080p * 659, _1080p * 660)
	var_12_0:addElement(var_12_25)

	var_12_0.LineSpacer = var_12_25

	local var_12_26
	local var_12_27 = MenuBuilder.BuildRegisteredType("TabsSpacer", {
		controllerIndex = var_12_1
	})

	var_12_27.id = "ContinueSpacerBottom"

	var_12_27.SpacerImage:SetAlpha(0, 0)
	var_12_27:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 130, _1080p * 751, _1080p * 671, _1080p * 676)
	var_12_0:addElement(var_12_27)

	var_12_0.ContinueSpacerBottom = var_12_27

	local var_12_28
	local var_12_29 = MenuBuilder.BuildRegisteredType("OptionDescription", {
		controllerIndex = var_12_1
	})

	var_12_29.id = "Description"

	var_12_29:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 811, _1080p * 1603, _1080p * 268, _1080p * 292)
	var_12_0:addElement(var_12_29)

	var_12_0.Description = var_12_29
	...
	var_12_19:RegisterAnimationSequence("DefaultSequence", var_12_30)
	...
	var_12_29:RegisterAnimationSequence("DefaultSequence", var_12_31)

	local function var_12_32()
		var_12_19:AnimateSequence("DefaultSequence")
		var_12_29:AnimateSequence("DefaultSequence")
	end
	...
	var_12_19:RegisterAnimationSequence("NoPreview", var_12_33)
	...
	var_12_29:RegisterAnimationSequence("NoPreview", var_12_34)

	local function var_12_35()
		var_12_19:AnimateSequence("NoPreview")
		var_12_29:AnimateSequence("NoPreview")
	end

	var_12_0._sequences.NoPreview = var_12_35
