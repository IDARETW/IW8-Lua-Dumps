...
local function var_0_2(arg_2_0, arg_2_1)
	...
	if arg_2_0._BRChallenges and #arg_2_0._BRChallenges > 0 then
...
function MagmaDailyPopup(arg_13_0, arg_13_1)
	...
	var_13_8:SetAnchorsAndPosition(0.5, 0.5, 0.5, 0.5, _1080p * -553, _1080p * 553, _1080p * -361, _1080p * -301)
	...
	var_13_10:SetAnchorsAndPosition(0.5, 0.5, 0.5, 0.5, _1080p * -50, _1080p * 50, _1080p * 455, _1080p * 486)
	...
	var_13_12:SetAnchorsAndPosition(0, 1, 0.5, 0.5, _1080p * 146, _1080p * 224, _1080p * -340, _1080p * -310)
	...
	var_13_15:SetAnchorsAndPosition(0.5, 0.5, 0.5, 0.5, _1080p * -814, _1080p * -300, _1080p * -197, _1080p * 425)
	...
	local var_13_18 = LUI.UIGrid.new(var_13_17)

	var_13_18.id = "Challenges2"

	var_13_18:setUseStencil(false)
	var_13_18:SetAnchorsAndPosition(0.5, 0.5, 0.5, 0.5, _1080p * -256, _1080p * 258, _1080p * -200, _1080p * 424)
	var_13_0:addElement(var_13_18)

	var_13_0.Challenges2 = var_13_18
	...
	local var_13_21 = LUI.UIGrid.new(var_13_20)

	var_13_21.id = "Challenges3"

	var_13_21:setUseStencil(false)
	var_13_21:SetAnchorsAndPosition(0.5, 0.5, 0.5, 0.5, _1080p * 289, _1080p * 803, _1080p * -200, _1080p * 424)
	var_13_0:addElement(var_13_21)

	var_13_0.Challenges3 = var_13_21

	local var_13_22
	local var_13_23 = MenuBuilder.BuildRegisteredType("ChallengeHeader", {
		controllerIndex = var_13_1
	})

	var_13_23.id = "MPHeader"

	var_13_23.Title:setText(Engine.CBBHFCGDIC("LUA_MENU/MULTIPLAYER_CAPS"), 0)
	var_13_23:SetAnchorsAndPosition(0.5, 0.5, 0.5, 0.5, _1080p * -257, _1080p * 258, _1080p * -255, _1080p * -215)
	var_13_0:addElement(var_13_23)

	var_13_0.MPHeader = var_13_23

	local var_13_24
	local var_13_25 = MenuBuilder.BuildRegisteredType("GenericButton", {
		controllerIndex = var_13_1
	})

	var_13_25.id = "ContinueButton"

	var_13_25.Text:SetLeft(_1080p * 20, 0)
	var_13_25.Text:setText(Engine.CBBHFCGDIC("MENU/CONTINUE"), 0)
	var_13_25.Text:SetAlignment(LUI.Alignment.Center)
	var_13_25:SetAnchorsAndPosition(0.5, 0.5, 0.5, 0.5, _1080p * -210, _1080p * 210, _1080p * 298, _1080p * 336)
	var_13_0:addElement(var_13_25)

	var_13_0.ContinueButton = var_13_25

	local var_13_26
	local var_13_27 = MenuBuilder.BuildRegisteredType("ChallengeHeader", {
		controllerIndex = var_13_1
	})

	var_13_27.id = "WZHeader"

	var_13_27.Title:setText(Engine.CBBHFCGDIC("LUA_MENU/WARZONE_CAPS"), 0)
	var_13_27:SetAnchorsAndPosition(0.5, 0.5, 0.5, 0.5, _1080p * -812, _1080p * -294, _1080p * -255, _1080p * -215)
	var_13_0:addElement(var_13_27)

	var_13_0.WZHeader = var_13_27

	local var_13_28
	local var_13_29 = MenuBuilder.BuildRegisteredType("ChallengeHeader", {
		controllerIndex = var_13_1
	})

	var_13_29.id = "CPHeader"

	var_13_29.Title:setText(Engine.CBBHFCGDIC("LUA_MENU/COOP_OPERATIONS_CAPS"), 0)
	var_13_29:SetAnchorsAndPosition(0.5, 0.5, 0.5, 0.5, _1080p * 289, _1080p * 803, _1080p * -255, _1080p * -215)
	var_13_0:addElement(var_13_29)

	var_13_0.CPHeader = var_13_29
	...
	var_13_0._sequences.Display1 = var_13_31

	local function var_13_32()
		return
	end

	var_13_0._sequences.Display2 = var_13_32

	local function var_13_33()
		return
	end

	var_13_0._sequences.Display3 = var_13_33
	...
	var_13_12:RegisterAnimationSequence("AR", var_13_35)

	local function var_13_36()
		var_13_12:AnimateSequence("AR")
	end

	var_13_0._sequences.AR = var_13_36
