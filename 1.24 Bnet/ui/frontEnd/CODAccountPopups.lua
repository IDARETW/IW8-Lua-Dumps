...
local function var_0_4(arg_20_0, arg_20_1)
	...
	arg_20_1.message = Engine.CBBHFCGDIC("CODACCOUNT/RESTARTING")

	local var_20_0 = MenuBuilder.BuildRegisteredType("FenceDialogPopup", arg_20_1)

	var_20_0.id = "CODAccountRestartingPopup"

	local var_20_1 = 3000

	var_20_0:Wait(var_20_1).onComplete = function()
		Engine.DAGFFDGFII("profile_SetHasEverSeen_CODAccount " .. arg_20_1.controllerIndex .. " 0")
		Engine.DAGFFDGFII("updategamerprofile " .. arg_20_1.controllerIndex)
...
local function var_0_5(arg_22_0, arg_22_1)
	assert(arg_22_1.title)
	assert(arg_22_1.message)

	arg_22_1.buttons = arg_22_1.buttons or {
		{
			label = Engine.CBBHFCGDIC("MENU/OK")
		}
	}

	local var_22_0 = MenuBuilder.BuildRegisteredType("GenericImagePopup", arg_22_1)

	var_22_0.id = "CODAccountSuccessPopup"

	return var_22_0
end

local function var_0_6(arg_23_0, arg_23_1)
	assert(arg_23_1.title)
	assert(arg_23_1.message)

	arg_23_1.buttons = arg_23_1.buttons or {
		{
			label = Engine.CBBHFCGDIC("MENU/OK")
		}
	}

	local var_23_0 = MenuBuilder.BuildRegisteredType("GenericImagePopup", arg_23_1)

	var_23_0.id = "CODAccountErrorPopup"
