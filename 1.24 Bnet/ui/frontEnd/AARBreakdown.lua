...
function PostLoadFunc(arg_2_0, arg_2_1, arg_2_2)
	...
	if FRIENDS.IsHappyHourActive(arg_2_1) then
		ACTIONS.AnimateSequence(arg_2_0, "ShowDoubleXP")
		arg_2_0.DoubleXP:setImage(RegisterMaterial("icon_regiments_happyhour"))
	elseif LOOT.IsDoubleXPActiveByType(arg_2_1, LOOT.doubleXPType.ANY) then
