...
local function var_0_2(arg_2_0, arg_2_1)
	...
	if CONDITIONS.IsLaunchChunk() then
		...
		if CONDITIONS.IsWaveGameType() and Engine.BAJHDFAJJF(CoD.CP_MAP_PACK_3_INDEX) == false then
			if Engine.CFHBIHABCB(var_2_0) then
				LUI.FlowManager.RequestAddMenu("GameInstallManager", true, var_2_0, false)
			end
	...
	local function var_7_6()
		...
		if arg_7_0.StartMatchButton then
			if arg_7_0._disableStartForCrossplay then
				...
				arg_7_0.StartMatchButton.DisabledText:SetAnimMoveTime(4000)
