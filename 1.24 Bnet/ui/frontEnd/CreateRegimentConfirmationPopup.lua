...
local function var_0_0(arg_1_0, arg_1_1, arg_1_2)
	...
	if arg_1_2.regimentTag and #arg_1_2.regimentTag > 0 then
		arg_1_0.RegimentTag:setText(Engine.CBBHFCGDIC("REGIMENTS/REGIMENT_TAG_CONFIRM", Engine.JCBDICCAH(arg_1_2.regimentTag)))
	end

	arg_1_0.OKButton:addEventHandler("button_action", function(arg_2_0, arg_2_1)
		if arg_1_2.IsInputValid(arg_2_0, arg_1_1, arg_1_2.regimentName, arg_1_2.regimentTag) then
			...
			if not Clans.DGAGIABGFJ(arg_1_1, arg_1_2.regimentName, arg_1_2.regimentTag) then
...
function CreateRegimentConfirmationPopup(arg_4_0, arg_4_1)
	...
	var_4_22.id = "RegimentTag"

	var_4_22:SetRGBFromTable(SWATCHES.genericMenu.bodycopy, 0)
	var_4_22:setText(Engine.CBBHFCGDIC("REGIMENTS/REGIMENT_TAG_CONFIRM"), 0)
	var_4_22:SetFont(FONTS.GetFont(FONTS.MainRegular.File))
	var_4_22:SetAlignment(LUI.Alignment.Left)
	var_4_22:SetAnchorsAndPosition(0.5, 0.5, 0.5, 0.5, _1080p * -250, _1080p * 716, _1080p * 24, _1080p * 44)
	var_4_0:addElement(var_4_22)

	var_4_0.RegimentTag = var_4_22
	...
	var_4_16:RegisterAnimationSequence("ConfirmOnly", var_4_25)
	...
	var_4_18:RegisterAnimationSequence("ConfirmOnly", var_4_26)
	...
	var_4_0._sequences.ConfirmOnly = var_4_27
	...
	var_4_8:RegisterAnimationSequence("AR", var_4_29)
	...
	var_4_20:RegisterAnimationSequence("AR", var_4_31)
	...
	var_4_22:RegisterAnimationSequence("AR", var_4_32)
	...
	var_4_0._sequences.AR = var_4_33

	var_4_18:addEventHandler("button_action", function(arg_8_0, arg_8_1)
	...
	var_4_0.bindButton:addEventHandler("button_secondary", function(arg_10_0, arg_10_1)
