...
function BattlePassArrowKBM(arg_3_0, arg_3_1)
	...
	var_3_4:RegisterAnimationSequence("ButtonOver", var_3_8)
	...
	var_3_6:RegisterAnimationSequence("ButtonOver", var_3_9)
	...
	var_3_0._sequences.ButtonOver = var_3_10
	...
	var_3_4:RegisterAnimationSequence("ButtonUp", var_3_11)
	...
	var_3_4:RegisterAnimationSequence("Disabled", var_3_14)

	local function var_3_15()
		var_3_4:AnimateSequence("Disabled")
	end

	var_3_0._sequences.Disabled = var_3_15
	...
	var_3_4:RegisterAnimationSequence("Enabled", var_3_16)

	local function var_3_17()
		var_3_4:AnimateSequence("Enabled")
	end

	var_3_0._sequences.Enabled = var_3_17

	local function var_3_18()
		return
	end

	var_3_0._sequences.ButtonOverDisabled = var_3_18
	...
	var_3_4:RegisterAnimationSequence("ButtonUpDisabled", var_3_19)

	local function var_3_20()
		var_3_4:AnimateSequence("ButtonUpDisabled")
	end

	var_3_0._sequences.ButtonUpDisabled = var_3_20
...
MenuBuilder.registerType("BattlePassArrowKBM", BattlePassArrowKBM)
LockTable(_M)
