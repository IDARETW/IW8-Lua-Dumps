...
function Item2x1Wide(arg_1_0, arg_1_1)
	local var_1_0 = LUI.UIButton.new()

	var_1_0:SetAnchorsAndPosition(0, 1, 0, 1, 0, 600 * _1080p, 0, 250 * _1080p)

	var_1_0.id = "Item2x1Wide"
	...
	var_1_11:SetAnchorsAndPosition(0, 1, 1, 0, _1080p * 485, _1080p * 579, _1080p * -52, _1080p * -22)
...
MenuBuilder.registerType("Item2x1Wide", Item2x1Wide)
LockTable(_M)
