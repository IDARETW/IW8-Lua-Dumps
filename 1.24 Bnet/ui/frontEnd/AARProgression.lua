...
local function var_0_0(arg_1_0, arg_1_1, arg_1_2)
	...
	local var_1_0 = PROGRESSION.IsElder(arg_1_1)
	local var_1_1 = PROGRESSION.IsPlayerLifeTimeRankMax(arg_1_1)
	local var_1_2 = var_1_0 and PROGRESSION.GetPlayerSeasonXP(arg_1_1) or PROGRESSION.GetPlayerXP(arg_1_1)
	local var_1_3 = var_1_0 and PROGRESSION.ElderRankToLifeTimeRank(PROGRESSION.GetPlayerSeasonRank(arg_1_1)) or PROGRESSION.GetPlayerRank(arg_1_1)
	local var_1_4 = PROGRESSION.GetRankName(var_1_3)
	local var_1_5 = PROGRESSION.GetRankBigIcon(var_1_3)
	local var_1_6 = PROGRESSION.GetRankDisplay(var_1_3)
	local var_1_7 = PROGRESSION.GetRankXPToNext(var_1_3)
	local var_1_8 = PROGRESSION.GetRankMinXP(var_1_3)
	local var_1_9 = PROGRESSION.GetRankMaxXP(var_1_3)

	assert(var_1_9 - var_1_8 > 0)

	local var_1_10 = (var_1_2 - var_1_8) / (var_1_9 - var_1_8)
	local var_1_11 = LUI.clamp(var_1_10, 0, 1)

	arg_1_0.RankValue:setText(Engine.JCBDICCAH(var_1_6))
	arg_1_0.RankName:setText(var_1_4)

	if var_1_5 and #var_1_5 > 0 then
		arg_1_0.RankIcon:setImage(RegisterMaterial(var_1_5))
	end

	if PROGRESSION.IsElder(arg_1_1) then
		local var_1_12 = 0

		if PROGRESSION.IsElder(arg_1_1, true) then
			var_1_12 = tonumber(PROGRESSION.GetSeasonRankPercentage(arg_1_1))
		else
			var_1_12 = tonumber(PROGRESSION.GetRankPercentage(arg_1_1))
		end

		arg_1_0.ElderProgressBar:SetProgress(0, 0, nil, true)
		arg_1_0.ElderProgressBar:SetProgress(var_1_12, 1000, nil, true)
		...
		local var_1_13 = var_1_2 - var_1_8

		arg_1_0.XPRequiredValue:setText(Engine.CBBHFCGDIC("MPUI/XP_NEXT_LEVEL", var_1_13, var_1_7))

		local var_1_14 = tonumber(PROGRESSION.GetRankPercentage(arg_1_1))

		arg_1_0.BorderlessFillBar:SetPercent(var_1_14)
