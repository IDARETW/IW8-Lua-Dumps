...
local function var_0_8(arg_9_0, arg_9_1, arg_9_2, arg_9_3, arg_9_4, arg_9_5)
	arg_9_0._menu = arg_9_5
	arg_9_0.IsUnlocked = var_0_7
	arg_9_0.GetRibbonRank = var_0_5
	arg_9_0.GetChallengeProgress = var_0_6
	arg_9_0.GetProgressionData = var_0_4
	arg_9_0._progressionData = arg_9_2
	arg_9_0._ribbonRank = arg_9_3 + PROGRESSION.GetMaxRank() + 1

	local var_9_0 = OnlineProgression.BHFJJDBEHG(arg_9_1, arg_9_2.challengeID)
	local var_9_1 = var_9_0 / PROGRESSION.GetElderChallengeAmount(arg_9_2.challengeID)

	arg_9_0.ProgressBar.Fill:SetRightAnchor(1 - var_9_1)

	arg_9_0._challengeProgress = var_9_0
	arg_9_0.challengeComplete = var_9_1 >= 1

	ACTIONS.AnimateSequence(arg_9_0, arg_9_0.challengeComplete and "Complete" or "Incomplete")

	local var_9_2 = arg_9_4 >= arg_9_0._ribbonRank

	arg_9_0:SetButtonDisabled(not var_9_2)

	arg_9_0._unlocked = var_9_2
	...
	arg_9_0.Ribbon:setImage(var_9_2 and RegisterMaterial(arg_9_2.ribbonImage) or RegisterMaterial("icon_lock"))
end
