...
local function var_0_5(arg_2_0, arg_2_1, arg_2_2)
	...
	if arg_2_0._isTopAligned then
		...
		if arg_2_0._isSpecial then
			...
			ACTIONS.AnimateSequence(arg_2_0, "DropShadow")
		else
...
function LabelWithLock(arg_4_0, arg_4_1)
	...
	var_4_4:SetRGBFromTable(SWATCHES.BattlePass.ShadowBody, 0)
	...
	var_4_6:SetRGBFromTable(SWATCHES.BattlePass.ShadowTitle, 0)
