...
local function var_0_0(arg_1_0, arg_1_1, arg_1_2)
	...
	arg_1_0.MenuTitle:SetTitle(Engine.CBBHFCGDIC("LUA_MENU_MP/COD_POINTS"))
end

function CODPointStore(arg_2_0, arg_2_1)
	local var_2_0 = LUI.UIVerticalNavigator.new()

	var_2_0.id = "CODPointStore"
	...
	var_2_4.MenuTitle:setText(Engine.CBBHFCGDIC("LUA_MENU_MP/COD_POINTS"), 0)
