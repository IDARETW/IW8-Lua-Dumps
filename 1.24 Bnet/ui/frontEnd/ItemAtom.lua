...
function ItemAtom(arg_1_0, arg_1_1)
	local var_1_0 = LUI.UIButton.new()

	var_1_0:SetAnchorsAndPosition(0, 1, 0, 1, 0, 250 * _1080p, 0, 250 * _1080p)
	...
	var_1_11:SetAnchorsAndPosition(0, 1, 1, 0, _1080p * 139, _1080p * 235, _1080p * -56, _1080p * -26)
