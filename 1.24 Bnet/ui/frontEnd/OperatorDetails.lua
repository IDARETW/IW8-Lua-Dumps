...
local function var_0_0(arg_1_0, arg_1_1, arg_1_2, arg_1_3)
	local var_1_0 = PlayerData.BFFBGAJGD(arg_1_3, LOADOUT.GetLoadoutStatsGroup()).customizationSetup.operators[arg_1_2]:get() == arg_1_1.ref

	if var_1_0 then
		ACTIONS.AnimateSequence(arg_1_0.EquippedWidget, "TurnOn")
	end

	arg_1_0.EquippedWidget:SetAlpha(var_1_0 and 1 or 0, 0)
end
...
local function var_0_1(arg_2_0, arg_2_1, arg_2_2, arg_2_3, arg_2_4, arg_2_5)
	...
	local var_2_0 = tonumber(arg_2_1.superfaction)

	arg_2_0.Name:setText(ToUpperCase(Engine.CBBHFCGDIC(arg_2_1.name)))

	local var_2_1 = OPERATOR.GetClientCharacterForSuperFaction(var_2_0)
	local var_2_2 = OPERATOR.GetEquippedSkinForOperator(arg_2_2, arg_2_1.ref)
	local var_2_3, var_2_4 = OPERATOR.GetWeaponDataFromLoadout(arg_2_2)
	local var_2_5 = OPERATOR.GetWeaponAccessoryModelFromLoadout(arg_2_2)
	local var_2_6 = OPERATOR.ValidateAccessoryModel(var_2_5, var_2_2.bodyModel)
	local var_2_7 = WEAPON.GetWeaponDetailsFromModel(var_2_4)

	if not OPERATOR.IsStowedWeaponAllowedInPreviewScreens(var_2_7.weaponAsset) then
		var_2_4 = WEAPON.NoneValue
	end
	...
	OPERATOR.UpdateClientCharacter(var_2_1, arg_2_2, var_2_2.bodyModel, var_2_2.headModel, arg_2_3, arg_2_0, var_2_3, var_2_4, arg_2_4, var_2_6)

	local var_2_8 = OPERATOR.GetExecutionForOperator(arg_2_2, arg_2_1.ref)
	local var_2_9 = OPERATOR.GetPetCharacterForSuperFaction(var_2_0)

	OPERATOR.UpdatePet(arg_2_2, var_2_9, {
		idle = true,
		execution = var_2_8,
		element = arg_2_0
	})
	ClientCharacter.DDHJHDEHFG(var_2_1, 0, 10, 0)

	if arg_2_5 == "OperatorShowcase" then
		ClientCharacter.DGGEBHHGJG(var_2_1, false)

		arg_2_0:Wait(50, true).onComplete = function()
			ClientCharacter.DGGEBHHGJG(var_2_1, true)
		end
	end

	local var_2_10 = var_2_0 == OPERATOR.SuperFaction.WEST and "West" or "East"

	ACTIONS.AnimateSequence(arg_2_0, var_2_10)

	local var_2_11 = LOOT.GetItemID(LOOT.itemTypes.OPERATOR, arg_2_1.ref)

	arg_2_0.NewItemNotification:UpdateBreadcrumbByID(arg_2_2, var_2_11, true)
end
