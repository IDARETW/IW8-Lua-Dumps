...
function Item3x1Wide(arg_1_0, arg_1_1)
	local var_1_0 = LUI.UIButton.new()

	var_1_0:SetAnchorsAndPosition(0, 1, 0, 1, 0, 1200 * _1080p, 0, 400 * _1080p)

	var_1_0.id = "Item3x1Wide"
	...
	var_1_11:SetAnchorsAndPosition(0, 1, 1, 0, _1080p * 1019, _1080p * 1116, _1080p * -52, _1080p * -22)
