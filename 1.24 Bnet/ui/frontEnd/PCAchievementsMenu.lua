...
local function var_0_1(arg_2_0, arg_2_1, arg_2_2)
	...
	local function var_2_6(arg_3_0, arg_3_1, arg_3_2)
		...
		if var_3_1.isCompleted then
			ACTIONS.AnimateSequence(arg_3_0, "Completed")
		else
			ACTIONS.AnimateSequence(arg_3_0, "Idle")
		end
	end
...
function PCAchievementsMenu(arg_4_0, arg_4_1)
	...
	local var_4_7
	local var_4_8 = MenuBuilder.BuildRegisteredType("TabBacker", {
		controllerIndex = var_4_1
	})

	var_4_8.id = "TabBacker"

	var_4_8:SetAnchorsAndPosition(0, 0, 0, 1, 0, 0, 0, _1080p * 160)
	var_4_0:addElement(var_4_8)

	var_4_0.TabBacker = var_4_8
	...
	var_4_10:SetAnchorsAndPosition(0, 0, 1, 0, 0, 0, _1080p * -85, 0)
	...
	var_4_12.MenuTitle:setText(ToUpperCase(Engine.CBBHFCGDIC("LUA_MENU/ACHIEVEMENT")), 0)
	...
	local var_4_13
	local var_4_14 = MenuBuilder.BuildRegisteredType("PCAchievementTotalScore", {
		controllerIndex = var_4_1
	})

	var_4_14.id = "TotalScore"

	var_4_14:SetAnchorsAndPosition(1, 0, 0, 1, _1080p * -735, _1080p * -95, _1080p * 53, _1080p * 93)
	var_4_0:addElement(var_4_14)

	var_4_0.TotalScore = var_4_14
	...
	local var_4_17 = LUI.UIGrid.new(var_4_16)

	var_4_17.id = "AchievementsList"

	var_4_17:setUseStencil(true)
	var_4_17:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 96, _1080p * 1796, _1080p * 243, _1080p * 925)
	var_4_0:addElement(var_4_17)

	var_4_0.AchievementsList = var_4_17

	local var_4_18
	local var_4_19 = MenuBuilder.BuildRegisteredType("VerticalMinimalScrollbar", {
		controllerIndex = var_4_1
	})

	var_4_19.id = "Scrollbar"

	var_4_19:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 1805, _1080p * 1816, _1080p * 243, _1080p * 925)
	var_4_0:addElement(var_4_19)

	var_4_0.Scrollbar = var_4_19

	local var_4_20

	if CONDITIONS.InFrontendMPOrCP(var_4_0) then
		local var_4_21 = MenuBuilder.BuildRegisteredType("LobbyMembersFooter", {
			controllerIndex = var_4_1
		})

		var_4_21.id = "LobbyMembersFooter"

		var_4_21:SetAnchorsAndPosition(0, 0, 0, 1, 0, 0, 0, _1080p * 150)
		var_4_0:addElement(var_4_21)

		var_4_0.LobbyMembersFooter = var_4_21
	end

	local var_4_22 = LUI.UIScrollbar.new({
		direction = LUI.DIRECTION.vertical,
		eventListener = var_4_19,
		startCap = var_4_19.startCap,
		endCap = var_4_19.endCap,
		sliderArea = var_4_19.sliderArea,
		slider = var_4_19.sliderArea and var_4_19.sliderArea.slider,
		fixedSizeSlider = var_4_19.sliderArea and var_4_19.sliderArea.fixedSizeSlider
	})

	var_4_17:AddScrollbar(var_4_22)
	...
	local var_4_23 = LUI.UIBindButton.new()

	var_4_23.id = "selfBindButton"

	var_4_0:addElement(var_4_23)

	var_4_0.bindButton = var_4_23
