...
local function var_0_2(arg_2_0, arg_2_1)
	...
	for iter_2_0 = 1, 2 do
		...
		local var_2_5 = FrontEndScene.ClientCharacters["ArenaLeft" .. iter_2_0]

		table.insert(var_2_2, var_2_5)
		OPERATOR.UpdateClientCharacter(var_2_5, arg_2_1, "body_mp_western_wyatt_1_1", "head_mp_western_wyatt_1_1", var_2_4, true)

		local var_2_6 = FrontEndScene.ClientCharacters["ArenaRight" .. iter_2_0]

		table.insert(var_2_2, var_2_6)
		OPERATOR.UpdateClientCharacter(var_2_6, arg_2_1, "body_mp_western_wyatt_1_1", "head_mp_western_wyatt_1_1", var_2_4, true)
	end
...
local function var_0_4(arg_6_0, arg_6_1)
	...
	OPERATOR.UpdateClientCharacter(arg_6_1, arg_6_0, var_6_3, var_6_4, var_6_9, self, var_6_5, var_6_6, true, var_6_8)

	local var_6_10 = Lobby.GetPetIndexForCharacter(arg_6_1)

	if var_6_10 then
		OPERATOR.UpdatePet(arg_6_0, var_6_10, {
