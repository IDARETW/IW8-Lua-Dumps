...
local function var_0_0(arg_1_0, arg_1_1, arg_1_2)
	...
	local function var_1_7(arg_3_0, arg_3_1, arg_3_2)
		local var_3_0 = Clans.GFFJCJFIJ(arg_1_1, var_1_0[arg_3_2 + 1])
		...
		arg_3_0.ClanInfo:setText(Engine.CBBHFCGDIC("LUA_MENU/SWITCH_REGIMENT_INFO", Engine.JCBDICCAH(var_3_0.clanTag), Engine.JCBDICCAH(var_3_0.name), Engine.JCBDICCAH(var_3_2), Engine.JCBDICCAH(var_3_1)))
		...
		if not arg_3_0._hasButtonHandlers then
			...
			arg_3_0:addEventHandler("button_over", function(arg_4_0, arg_4_1)
				if arg_4_0.isLocalClientOwner and arg_4_0.numMembers > 1 then
			...
			if arg_3_0.isLocalClientOwner and arg_3_0.numMembers < 2 or not arg_3_0.isLocalClientOwner then
	...
	arg_1_0.RegimentsGrid:SetNumChildren(#var_1_0)
