...
local function var_0_0(arg_1_0, arg_1_1, arg_1_2)
	...
	arg_1_0._cinematic = arg_1_2

	assert(arg_1_0._menu.CinematicName)
	assert(arg_1_0._menu.CinematicDesc)
	arg_1_0.MissionLabel:setText(Engine.CBBHFCGDIC(arg_1_0._cinematic.name))

	if arg_1_0._cinematic.image and #arg_1_0._cinematic.image > 0 then
		arg_1_0.Image:setImage(RegisterMaterial(arg_1_0._cinematic.image))
	end
	...
	arg_1_0:registerEventHandler("button_action", function()
		LUI.FlowManager.RequestAddMenu("CinematicFullscreen", true, arg_1_0._controllerIndex, false, {
			widescreen = true,
			video = arg_1_0._cinematic.ref
		})
	end)
end

local function var_0_1(arg_3_0, arg_3_1, arg_3_2)
	assert(arg_3_0.MissionLabel)
	...
	arg_3_0.RefreshButton = var_0_0

	arg_3_0:addEventHandler("button_over", function()
		if arg_3_0._cinematic.ref and #arg_3_0._cinematic.ref > 0 then
			Engine.DFCGFCGBFD(arg_3_0._cinematic.ref, VideoPlaybackFlags.LOOP)
		end

		if arg_3_0._menu then
			arg_3_0._menu.CinematicName:setText(Engine.CBBHFCGDIC(arg_3_0._cinematic.name))
			arg_3_0._menu.CinematicDesc:setText(Engine.CBBHFCGDIC(arg_3_0._cinematic.desc))
			ACTIONS.AnimateSequence(arg_3_0._menu, "DetailsFadeIn")
		end
	end)
end

function CinematicSelectButton(arg_5_0, arg_5_1)
	local var_5_0 = LUI.UIButton.new()

	var_5_0:SetAnchorsAndPosition(0, 1, 0, 1, 0, 210 * _1080p, 0, 105 * _1080p)

	var_5_0.id = "CinematicSelectButton"
