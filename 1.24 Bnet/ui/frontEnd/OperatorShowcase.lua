...
local function var_0_0(arg_1_0, arg_1_1, arg_1_2, arg_1_3)
	...
	OPERATOR.UpdateClientCharacter(arg_1_1, arg_1_3, var_1_0.bodyModel, var_1_0.headModel, nil, arg_1_0, arg_1_0.weaponData.primaryModel, arg_1_0.weaponData.secondaryModel, true, var_1_2, true)
	ClientCharacter.DDHJHDEHFG(arg_1_1, 0, 10, 0)

	local var_1_4 = OPERATOR.GetExecutionForOperator(arg_1_3, arg_1_2)
	local var_1_5 = OPERATOR.GetPetCharacterForSuperFaction(arg_1_0.operatorData.currentState)

	OPERATOR.UpdatePet(arg_1_3, var_1_5, {
		idle = true,
		execution = var_1_4,
		element = arg_1_0
	})

	local var_1_6 = StringTable.DIFCHIGDFB(CSV.operators.file, CSV.operators.cols.ref, arg_1_2, CSV.operators.cols.gender)
	local var_1_7 = StringTable.DIFCHIGDFB(CSV.operatorTurnAnimations.file, CSV.operatorTurnAnimations.cols.gender, var_1_6, CSV.operatorTurnAnimations.cols.idleFront)

	assert(var_1_7 and var_1_7 ~= "")

	local var_1_8 = ClientCharacter.DCECEDGHEG(arg_1_1)
	local var_1_9, var_1_10, var_1_11 = OPERATOR.GetTransitionInfoFromAnimation(var_1_8)

	if arg_1_0.queueAnim then
		ClientCharacter.BHJJGDDGFI(arg_1_1, var_1_7, var_1_11, var_1_9, var_1_10)
	else
		ClientCharacter.CAECDIHFCF(arg_1_1, var_1_7)
	end

	arg_1_0.CharacterRotator:SetClientCharacterInfo(arg_1_1, arg_1_2)
end
...
local function var_0_2(arg_3_0, arg_3_1)
	...
	if arg_3_0._isBattlePassPreview or arg_3_0._isStorePreview then
		Engine.DHFCHIIJCA("character_preview_select")
	elseif arg_3_0.operatorData.currentState == OPERATOR.SuperFaction.WEST then
	...
	local var_3_2 = StringTable.DIFCHIGDFB(CSV.operatorSkins.file, CSV.operatorSkins.cols.ref, arg_3_1.itemRef, CSV.operatorSkins.cols.desc)

	if var_3_2 then
		arg_3_0.FlavorText:setText(Engine.CBBHFCGDIC(var_3_2))
	end

	local var_3_3 = LOOT.GetItemQuality(var_3_0, arg_3_1.itemRef)

	arg_3_0.ItemQuality:UpdateQualityText(var_3_3)
