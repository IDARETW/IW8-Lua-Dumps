...
local function var_0_0(arg_1_0, arg_1_1, arg_1_2)
	...
	arg_1_0:AddContextualMenuAction(var_1_1)
	...
	local var_1_2 = {
		...
		actionFunction = function()
			OPERATOR.OpenOperatorSubMenu(arg_1_2, arg_1_1, "OperatorCustomization")
		end
	}
	...
	local var_1_3 = {
		...
		actionFunction = function()
			OPERATOR.OpenOperatorSubMenu(arg_1_2, arg_1_1, "OperatorShowcase")
		end
	}
	...
	local var_1_5 = {
		id = "allMissions",
		actionName = Engine.CBBHFCGDIC("LUA_MENU/ALL_MISSIONS_PROMPT"),
		conditionFunction = function()
...
local function var_0_1(arg_12_0, arg_12_1, arg_12_2, arg_12_3, arg_12_4, arg_12_5)
	...
	for iter_12_0 = 1, #arg_12_4 do
		...
		var_0_0(var_12_2, arg_12_1, arg_12_5)
	...
	local var_12_3 = 74 * _1080p
	local var_12_4 = (#arg_12_4 - 1) * (6 * _1080p)
	local var_12_5 = #arg_12_4 * var_12_3 + var_12_4

	arg_12_0:SetAnchorsAndPosition(0, 1, 0, 1, 0, var_12_5, 0, 146 * _1080p)
...
local function var_0_2(arg_13_0, arg_13_1, arg_13_2)
	...
	arg_13_0.SetupButtonContainer = var_0_1
...
function OperatorSelectButtonContainer(arg_15_0, arg_15_1)
	...
	var_15_8:RegisterAnimationSequence("AR", var_15_12)
	...
	var_15_10:RegisterAnimationSequence("AR", var_15_13)
	...
	var_15_0._sequences.AR = var_15_14
