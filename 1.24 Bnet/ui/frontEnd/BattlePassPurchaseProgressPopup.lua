...
local function var_0_1(arg_1_0, arg_1_1)
	...
	if var_1_2 and #var_1_2 > 0 then
		...
		local var_1_4 = LOOT.GetRarityColor(var_1_3)
		local var_1_5 = LOOT.GetDarkRarityColor(var_1_3)

		arg_1_0.TierSkipCard.RarityBG:SetRGBFromTable(var_1_5)
		...
		arg_1_0.TierSkipCard.RarityImage:SetRGBFromTable(var_1_4)
		ACTIONS.AnimateSequence(arg_1_0.TierSkipCard, "GlintAnime")

		local var_1_6 = LOOT.GetItemImage(var_1_1, var_1_2, var_1_0)

		if var_1_6 and #var_1_6 > 0 then
			arg_1_0.TierSkipCard:UpdateCardConfig(var_1_1, var_1_6)
			arg_1_0.TierSkipCard.Foreground:setImage(RegisterMaterial(var_1_6))
		else
			DebugPrint("Could not find image asset for type: " .. var_1_1 .. ", and ref: " .. var_1_2)
		end

		local var_1_7 = LOOT.GetItemName(var_1_1, var_1_2)

		if var_1_7 and #var_1_7 > 0 then
			arg_1_0.TierSkipCard.ItemName:setText(ToUpperCase(var_1_7))
		else
			DebugPrint("Could not find item name for type: " .. var_1_1 .. ", and ref: " .. var_1_2)
		end

		local var_1_8 = LOOT.GetItemClassName(var_1_1, var_1_2)

		if var_1_8 and #var_1_8 > 0 then
			arg_1_0.TierSkipCard.ItemType:setText(var_1_8)
		else
...
local function var_0_2(arg_2_0, arg_2_1, arg_2_2)
	...
	if arg_2_2.tierSkipID then
		var_0_1(arg_2_0, arg_2_2.tierSkipID)
		ACTIONS.AnimateSequence(arg_2_0.Flare, "Smoke")
...
function BattlePassPurchaseProgressPopup(arg_5_0, arg_5_1)
	...
	var_5_12:RegisterAnimationSequence("S5", var_5_34)
	...
	var_5_16:RegisterAnimationSequence("S5", var_5_35)
	...
	var_5_0._sequences.S5 = var_5_36
