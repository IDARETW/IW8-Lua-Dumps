...
local function var_0_1(arg_4_0, arg_4_1, arg_4_2)
	...
	elseif arg_4_2.promoted then
		...
		arg_4_0.Message:setText(Engine.CBBHFCGDIC("MPUI/REMOVE_PLAYERS_DESC", var_4_6 - var_4_0, var_4_1))
		arg_4_0.LeavePartyButton.Text:setText(Engine.CBBHFCGDIC("MPUI/LEAVE_PARTY_AND_PLAY_GAMEMODE", var_4_1))
	end
	...
	if arg_4_2.leavePartyAction then
...
function RemovePlayersMatchmakingPopup(arg_11_0, arg_11_1)
	...
	var_11_4:addEventHandler("menu_create", function(arg_12_0, arg_12_1)
