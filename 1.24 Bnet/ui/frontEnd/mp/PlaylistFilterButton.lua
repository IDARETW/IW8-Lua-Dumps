...
function PlaylistFilterButton(arg_11_0, arg_11_1)
	...
	var_11_13:SetAnchorsAndPosition(1, 0, 0.5, 0.5, _1080p * -107, _1080p * -99, _1080p * -4, _1080p * 4)
	...
	var_11_17:setImage(RegisterMaterial("icon_double_xp"), 0)
	var_11_17:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 417, _1080p * 447, _1080p * 10, _1080p * 40)
	...
	var_11_6:RegisterAnimationSequence("ButtonOver", var_11_19)
	...
	var_11_6:RegisterAnimationSequence("ButtonUp", var_11_21)
	...
	var_11_9:RegisterAnimationSequence("Check", var_11_23)

	local function var_11_24()
		var_11_9:AnimateSequence("Check")
	end

	var_11_0._sequences.Check = var_11_24
	...
	var_11_9:RegisterAnimationSequence("UnCheck", var_11_25)

	local function var_11_26()
		var_11_9:AnimateSequence("UnCheck")
	end

	var_11_0._sequences.UnCheck = var_11_26
