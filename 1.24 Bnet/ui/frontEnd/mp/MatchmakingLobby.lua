...
local function var_0_2(arg_4_0, arg_4_1, arg_4_2)
	...
	arg_4_0:registerEventHandler("update_client_characters", function(arg_7_0, arg_7_1)
		arg_7_0._clientCharacterMap = Lobby.UpdateClientCharacters(arg_4_1, var_4_0)
	end)
	...
	arg_4_0.bindButton:registerEventHandler("button_alt1", function(arg_8_0, arg_8_1)
	...
	function arg_4_0.GetPartyCount()
		local var_9_0 = var_4_2:GetValue(arg_4_1)
		local var_9_1 = var_4_3:GetValue(arg_4_1)
		local var_9_2 = 0

		if var_9_0 and var_9_1 then
			var_9_2 = math.max(var_9_0, var_9_1)
		end
	...
	local function var_4_4(arg_10_0, arg_10_1, arg_10_2)
		if arg_4_0:GetCurrentMenu() then
			arg_4_0:GetCurrentMenu().UpdateChallengePrompt(arg_10_0, arg_10_1, arg_10_2)
		end
	end

	local function var_4_5(arg_11_0)
		if arg_4_0:GetCurrentMenu() then
	...
	if CONDITIONS.IsMatchSimToolEnabled(arg_4_0) then
		...
		arg_4_0.StartSim:addEventHandler("button_action", function(arg_12_0, arg_12_1)
...
function MatchmakingLobby(arg_15_0, arg_15_1)
	...
	if CONDITIONS.IsMatchSimToolEnabled(var_15_0) then
		local var_15_4 = MenuBuilder.BuildRegisteredType("GenericButton", {
			controllerIndex = var_15_1
		})

		var_15_4.id = "StartSim"

		if CONDITIONS.IsMatchSimToolEnabled(var_15_0) then
			-- block empty
		end

		var_15_4.Text:SetLeft(_1080p * 20, 0)
		var_15_4.Text:setText("BEGIN SIMULATION  ", 0)
		var_15_4.Text:SetAlignment(LUI.Alignment.Right)
		var_15_4:SetAnchorsAndPosition(0, 0, 0, 1, _1080p * 1574, _1080p * -96, _1080p * 707, _1080p * 787)
		var_15_0:addElement(var_15_4)

		var_15_0.StartSim = var_15_4
	end

	local var_15_5
	local var_15_6 = MenuBuilder.BuildRegisteredType("LobbyMap", {
		controllerIndex = var_15_1
	})

	var_15_6.id = "LobbyMap"

	var_15_6:SetAnchorsAndPosition(0, 1, 1, 0, _1080p * 96, _1080p * 526, _1080p * -231, _1080p * -101)
	var_15_0:addElement(var_15_6)

	var_15_0.LobbyMap = var_15_6

	local var_15_7
	local var_15_8 = LUI.UIText.new()

	var_15_8.id = "SquadCount"

	var_15_8:SetRGBFromTable(SWATCHES.genericButton.description, 0)
	var_15_8:setText(Engine.CBBHFCGDIC("LUA_MENU_MP/SQUAD_COUNT"), 0)
	var_15_8:SetFont(FONTS.GetFont(FONTS.BodyRegular.File))
	var_15_8:SetAlignment(LUI.Alignment.Left)
	var_15_8:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 130, _1080p * 630, _1080p * 216, _1080p * 238)
	var_15_0:addElement(var_15_8)

	var_15_0.SquadCount = var_15_8

	local var_15_9
	local var_15_10 = LUI.UIText.new()

	var_15_10.id = "LobbyCount"

	var_15_10:SetRGBFromTable(SWATCHES.genericButton.description, 0)
	var_15_10:setText(Engine.CBBHFCGDIC("LUA_MENU_MP/LOBBY_COUNT"), 0)
	var_15_10:SetFont(FONTS.GetFont(FONTS.MainRegular.File))
	var_15_10:SetAlignment(LUI.Alignment.Left)
	var_15_10:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 130, _1080p * 630, _1080p * 183, _1080p * 211)
	var_15_0:addElement(var_15_10)

	var_15_0.LobbyCount = var_15_10

	local var_15_11
	local var_15_12 = MenuBuilder.BuildRegisteredType("ChallengesSummary", {
		controllerIndex = var_15_1
	})

	var_15_12.id = "Challenges"

	var_15_12:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 1394, _1080p * 1824, _1080p * 216, _1080p * 716)
	var_15_0:addElement(var_15_12)

	var_15_0.Challenges = var_15_12

	local var_15_13
	local var_15_14 = MenuBuilder.BuildRegisteredType("BLMBanner", {
		controllerIndex = var_15_1
	})

	var_15_14.id = "BLMBanner"

	var_15_14:SetAnchorsAndPosition(0.5, 0.5, 0, 1, _1080p * -300, _1080p * 300, _1080p * 200, _1080p * 256)
	var_15_0:addElement(var_15_14)

	var_15_0.BLMBanner = var_15_14
	...
	var_15_6:RegisterAnimationSequence("MenuOpen", var_15_17)

	local function var_15_18()
		var_15_6:AnimateSequence("MenuOpen")
	end

	var_15_0._sequences.MenuOpen = var_15_18
