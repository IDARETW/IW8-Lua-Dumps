...
local function var_0_0(arg_1_0, arg_1_1, arg_1_2)
	...
	local function var_1_1(arg_2_0, arg_2_1)
		local var_2_0 = {}
		local var_2_1 = Lobby.GetMaxBotLimit()

		if arg_2_1 and var_2_1 > 0 then
			var_2_1 = math.floor(var_2_1 / 2)

			if arg_2_0 == Lobby.BotTeams.Enemy then
				var_2_1 = var_2_1 + 1
			end
		end
		...
		return {
			...
			action = function(arg_3_0)
				Lobby.DGDIGJDHH(arg_2_0, arg_3_0 - 1)

				if arg_2_1 and Lobby.BEAJCIDDGF(arg_2_0) + Lobby.BEAJCIDDGF(arg_2_1) > Lobby.GetMaxBotLimit() then
					local var_3_0 = Lobby.BEAJCIDDGF(arg_2_1) - 1

					var_1_0[arg_2_1]:SetCurrentValue(var_3_0 + 1)
				end
			end,
