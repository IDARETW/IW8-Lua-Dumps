...
local function var_0_2(arg_3_0, arg_3_1, arg_3_2)
	...
	arg_3_0:registerEventHandler("update_lobby_characters", function(arg_6_0, arg_6_1)
		arg_6_0._clientCharacterMap = Lobby.UpdateClientCharacters(arg_3_1, var_3_2)
	end)
	...
	local function var_3_9()
		local var_8_0 = var_3_7:GetValue(arg_3_1)
		local var_8_1 = var_3_8:GetValue(arg_3_1)

		if var_8_0 ~= nil and var_8_1 ~= nil then
			arg_3_0.LobbyCount:setText(Engine.CBBHFCGDIC("LUA_MENU_MP/LOBBY_COUNT", var_8_0, var_8_1))
		end
	end
	...
	if var_3_0 > 1 then
		...
		local function var_3_11()
			local var_9_0 = Dvar.CFHDGABACF("RRNTNNKNP")
			local var_9_1 = var_3_10:GetValue(arg_3_1)
			local var_9_2 = math.min(var_9_1, var_9_0)

			if var_9_2 ~= nil then
				arg_3_0.SquadCount:setText(Engine.CBBHFCGDIC("LUA_MENU_MP/SQUAD_COUNT", var_9_2, var_9_0))
...
function LobbyLPCMatchmade(arg_10_0, arg_10_1)
	...
	local var_10_3
	local var_10_4 = MenuBuilder.BuildRegisteredType("LobbyMap", {
		controllerIndex = var_10_1
	})

	var_10_4.id = "LobbyMap"

	var_10_4:SetAnchorsAndPosition(0, 1, 1, 0, _1080p * 96, _1080p * 526, _1080p * -231, _1080p * -101)
	var_10_0:addElement(var_10_4)

	var_10_0.LobbyMap = var_10_4

	local var_10_5
	local var_10_6 = LUI.UIText.new()

	var_10_6.id = "SquadCount"

	var_10_6:SetRGBFromTable(SWATCHES.genericButton.description, 0)
	var_10_6:setText(Engine.CBBHFCGDIC("LUA_MENU_MP/PLAYER_COUNT_PUBLIC"), 0)
	var_10_6:SetFont(FONTS.GetFont(FONTS.BodyRegular.File))
	var_10_6:SetAlignment(LUI.Alignment.Left)
	var_10_6:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 130, _1080p * 630, _1080p * 216, _1080p * 238)
	var_10_0:addElement(var_10_6)

	var_10_0.SquadCount = var_10_6

	local var_10_7
	local var_10_8 = LUI.UIText.new()

	var_10_8.id = "LobbyCount"

	var_10_8:SetRGBFromTable(SWATCHES.genericButton.description, 0)
	var_10_8:setText(Engine.CBBHFCGDIC("LUA_MENU_MP/LOBBY_COUNT"), 0)
	var_10_8:SetFont(FONTS.GetFont(FONTS.MainRegular.File))
	var_10_8:SetAlignment(LUI.Alignment.Left)
	var_10_8:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 130, _1080p * 630, _1080p * 183, _1080p * 211)
	var_10_0:addElement(var_10_8)

	var_10_0.LobbyCount = var_10_8

	local var_10_9

	if not CONDITIONS.IsBRGameType(var_10_0) then
		local var_10_10 = MenuBuilder.BuildRegisteredType("LobbyTeamDetails", {
			controllerIndex = var_10_1
		})

		var_10_10.id = "LobbyTeamDetails"

		var_10_10:SetAnchorsAndPosition(1, 0, 0, 1, _1080p * -445, _1080p * -96, _1080p * 193, _1080p * 316)
		var_10_0:addElement(var_10_10)

		var_10_0.LobbyTeamDetails = var_10_10
	end
