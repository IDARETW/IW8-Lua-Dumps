...
local function var_0_0(arg_2_0, arg_2_1, arg_2_2)
	...
	local function var_2_0()
		if Tournament.BEAIBEGFFB() then
			LUI.FlowManager.RequestAddMenu(TOURNAMENT.GetMenuName("arena"), false, arg_2_1, false, {})
		end
	end
...
function TournamentMatchmaking(arg_6_0, arg_6_1)
	local var_6_0 = LUI.UIElement.new()

	var_6_0.id = "TournamentMatchmaking"
