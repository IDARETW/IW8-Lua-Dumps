	...
	if var_1_2 and #var_1_2 >= 1 then
		for iter_1_0, iter_1_1 in pairs(var_1_2) do
			if iter_1_0 == LOOT.doubleXpTypes.XP and iter_1_1 then
				var_1_1():setImage(RegisterMaterial("icon_double_xp"), 0)
			elseif iter_1_0 == LOOT.doubleXpTypes.WEAPON and iter_1_1 then
				var_1_1():setImage(RegisterMaterial("icon_double_weapon_xp"), 0)
			elseif iter_1_0 == LOOT.doubleXpTypes.BATTLE_PASS and iter_1_1 then
				var_1_1():setImage(RegisterMaterial("icon_double_battle_xp"), 0)
			end
		end
	end
end
...
function BRPlayButton(arg_11_0, arg_11_1)
	...
	var_11_6:SetAnchorsAndPosition(1, 0, 0.5, 0.5, _1080p * -49, _1080p * -41, _1080p * -4, _1080p * 4)
	...
	var_11_8:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 351, _1080p * 375, _1080p * 13, _1080p * 37)
	...
	var_11_10:SetRGBFromTable(SWATCHES.text.primaryText, 0)
	var_11_10:SetAlpha(0, 0)
	var_11_10:setImage(RegisterMaterial("icon_double_battle_xp"), 0)
	var_11_10:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 289, _1080p * 313, _1080p * 13, _1080p * 37)
	...
	var_11_12:SetRGBFromTable(SWATCHES.text.primaryText, 0)
	var_11_12:SetAlpha(0, 0)
	var_11_12:setImage(RegisterMaterial("icon_double_weapon_xp"), 0)
	var_11_12:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 321, _1080p * 345, _1080p * 13, _1080p * 37)
	...
	if CONDITIONS.IsArabic(var_11_0) then
	...
	if not CONDITIONS.IsArabic(var_11_0) then
		ACTIONS.AnimateSequenceByElement(var_11_0, {
			elementPath = "self.PlayButton",
