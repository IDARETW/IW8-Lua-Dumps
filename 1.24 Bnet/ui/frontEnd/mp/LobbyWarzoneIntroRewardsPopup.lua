...
function LobbyWarzoneIntroRewardsPopup(arg_3_0, arg_3_1)
	...
	var_3_4:SetRGBFromTable(SWATCHES.HUD.DarkBacker, 0)
	...
	var_3_6:SetRGBFromTable(SWATCHES.HUD.DarkBacker, 0)
	...
	var_3_8:SetRGBFromTable(SWATCHES.highlight.frontEnd, 0)
	...
	var_3_10:SetRGBFromTable(SWATCHES.highlight.frontEnd, 0)
