...
function ItemSquare(arg_1_0, arg_1_1)
	local var_1_0 = LUI.UIButton.new()

	var_1_0:SetAnchorsAndPosition(0, 1, 0, 1, 0, 300 * _1080p, 0, 300 * _1080p)

	var_1_0.id = "ItemSquare"
	...
	var_1_11:SetAnchorsAndPosition(0, 1, 1, 0, _1080p * 181, _1080p * 279, _1080p * -61, _1080p * -31)
...
MenuBuilder.registerType("ItemSquare", ItemSquare)
LockTable(_M)
