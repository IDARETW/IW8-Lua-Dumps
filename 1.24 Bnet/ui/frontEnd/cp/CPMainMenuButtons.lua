...
local function var_0_12(arg_13_0, arg_13_1, arg_13_2)
	...
	local function var_13_0()
		...
		if arg_13_0.SurvivalButton then
			if arg_13_0._partyHasCrossPlayPlayer then
				...
				arg_13_0.SurvivalButton.DisabledText:SetAnimMoveTime(4000)
			else
	...
	if Engine.CIEGIACHAE() and CONDITIONS.IsSurvivalModeAllowed(arg_13_0) then
		local function var_13_3(arg_15_0)
			local var_15_0 = Engine.CIIBCJJCIB()

			if arg_15_0._partyHasCrossPlayPlayer ~= var_15_0 then
				arg_15_0._partyHasCrossPlayPlayer = var_15_0
	...
	if arg_13_0.SurvivalButton then
		arg_13_0.SurvivalButton:addEventHandler("button_action", function(arg_17_0, arg_17_1)
			if Engine.BAJHDFAJJF(CoD.CP_MAP_PACK_3_INDEX) == false then
				local var_17_0 = Engine.CBBHFCGDIC("LUA_MENU/MISSING_DLC_CP3")
				...
				local var_17_2 = Engine.CIIBCJJCIB()

				if Lobby.BGIADHIHAG() and not var_17_2 then
					local var_17_3 = Dvar.CFHDGABACF("NNKSOPNQPS")

					if var_17_3 ~= nil and Playlist.CEBBBFJJEB(var_17_3) then
