...
local function var_0_0(arg_1_0, arg_1_1)
	...
	if var_1_1.numChallenges == var_1_1.numComplete then
		...
		arg_1_0.RecommendedText:setText(Engine.CBBHFCGDIC("CHALLENGE/RECOMMENDED_X", var_1_1.nearestComplete.name))
		arg_1_0.ChallengeDesc:setText(var_1_1.nearestComplete.desc)
	...
	arg_1_0.ClassifiedChallengeDesc:setText(Engine.CBBHFCGDIC("CHALLENGE/CLASSIFIED_CHALLENGE_DESC_NO_NOTE", WEAPON.UltimateChallengeCounts.MAX))
...
function WeaponMasterSummary(arg_3_0, arg_3_1)
	...
	var_3_4:SetAnchorsAndPosition(0, 1, 0, 1, 0, _1080p * 576, _1080p * 200, _1080p * 300)
	...
	var_3_6:SetAnchorsAndPosition(0, 1, 0, 1, 0, _1080p * 576, 0, _1080p * 190)
