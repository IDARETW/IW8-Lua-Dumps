...
function Item2x2Square(arg_1_0, arg_1_1)
	local var_1_0 = LUI.UIButton.new()

	var_1_0:SetAnchorsAndPosition(0, 1, 0, 1, 0, 800 * _1080p, 0, 800 * _1080p)

	var_1_0.id = "Item2x2Square"
	...
	var_1_11:SetAnchorsAndPosition(0, 1, 1, 0, _1080p * 650, _1080p * 744, _1080p * -61, _1080p * -31)
...
MenuBuilder.registerType("Item2x2Square", Item2x2Square)
LockTable(_M)
