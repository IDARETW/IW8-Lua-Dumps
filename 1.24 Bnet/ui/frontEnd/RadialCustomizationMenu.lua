...
local function var_0_11(arg_13_0, arg_13_1)
	...
	table.sort(arg_13_0._currentTable, function(arg_14_0, arg_14_1)
		...
		if arg_14_0.rarity ~= arg_14_1.rarity and arg_13_0.raritySortingOptions ~= LOOT.raritySortingOptions.NONE then
...
local function var_0_16(arg_20_0, arg_20_1)
	...
	table.insert(var_20_0, {
		...
		hasNewItem = LOOT.IsCategoryNew(arg_20_1, LOOT.itemTypes.GESTURES)
	})
	table.insert(var_20_0, {
		disabled = false,
		...
		focusFunction = var_0_15(arg_20_0, arg_20_1),
		hasNewItem = LOOT.IsCategoryNew(arg_20_1, LOOT.itemTypes.SPRAYS)
	})
...
local function var_0_22(arg_29_0, arg_29_1, arg_29_2)
	...
	arg_29_0.MenuTitle:SetTitle(Engine.CBBHFCGDIC("LUA_MENU/RADIAL_CUSTOMIZATION"))
	arg_29_0.bindButton:addEventHandler("button_alt1", function(arg_30_0, arg_30_1)
		...
		local var_30_1 = MenuBuilder.BuildRegisteredType("CustomizeSortingPopup", {
		...
		var_30_1:addEventHandler("menu_close", function(arg_31_0, arg_31_1)
	...
	arg_29_0:addEventHandler("menu_close", function(arg_32_0, arg_32_1)
		...
		METRICS.IdentityUsageSendDLogEvent(arg_29_0, arg_29_1, var_29_0, LOOT.itemTypes.GESTURES, var_29_1, var_32_0)
	end)
...
function RadialCustomizationMenu(arg_35_0, arg_35_1)
	...
	local var_35_8
	local var_35_9 = MenuBuilder.BuildRegisteredType("TabBacker", {
		controllerIndex = var_35_1
	})

	var_35_9.id = "TabBacker"

	var_35_9:SetAnchorsAndPosition(0, 0, 0, 1, 0, 0, 0, _1080p * 160)
	var_35_0:addElement(var_35_9)

	var_35_0.TabBacker = var_35_9
	...
	local var_35_12 = LUI.UIGrid.new(var_35_11)

	var_35_12.id = "Grid"

	var_35_12:setUseStencil(true)
	var_35_12:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 96, _1080p * 1136, _1080p * 244, _1080p * 834)
	var_35_0:addElement(var_35_12)

	var_35_0.Grid = var_35_12

	local var_35_13
	local var_35_14 = MenuBuilder.BuildRegisteredType("VerticalMinimalScrollbar", {
		controllerIndex = var_35_1
	})

	var_35_14.id = "Scrollbar"

	var_35_14:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 1211, _1080p * 1230, _1080p * 244, _1080p * 870)
	var_35_0:addElement(var_35_14)

	var_35_0.Scrollbar = var_35_14

	local var_35_15
	local var_35_16 = LUI.UIImage.new()

	var_35_16.id = "GridDivider"

	var_35_16:SetRGBFromTable(SWATCHES.text.primaryText, 0)
	var_35_16:SetAlpha(0.6, 0)
	var_35_16:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 96, _1080p * 1206, _1080p * 230, _1080p * 231)
	var_35_0:addElement(var_35_16)

	var_35_0.GridDivider = var_35_16

	local var_35_17
	local var_35_18 = MenuBuilder.BuildRegisteredType("MenuTitle", {
		controllerIndex = var_35_1
	})

	var_35_18.id = "MenuTitle"

	var_35_18.MenuTitle:setText(ToUpperCase(Engine.CBBHFCGDIC("LUA_MENU/RADIAL_CUSTOMIZATION")), 0)
	var_35_18.Line:SetLeft(0, 0)
	var_35_18:SetAnchorsAndPosition(0, 1, 0, 1, 0, _1080p * 1020, 0, _1080p * 100)
	var_35_0:addElement(var_35_18)

	var_35_0.MenuTitle = var_35_18
	...
	local var_35_21 = LUI.TabManager.new(var_35_20)

	var_35_21.id = "Tabs"

	var_35_21:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 90, _1080p * 996, _1080p * 108, _1080p * 160)
	var_35_0:addElement(var_35_21)

	var_35_0.Tabs = var_35_21

	local var_35_22
	local var_35_23 = MenuBuilder.BuildRegisteredType("LobbyMembersFooter", {
		controllerIndex = var_35_1
	})

	var_35_23.id = "LobbyMembersFooter"

	var_35_23:SetAnchorsAndPosition(0, 0, 0, 1, 0, 0, 0, _1080p * 150)
	var_35_0:addElement(var_35_23)

	var_35_0.LobbyMembersFooter = var_35_23

	local var_35_24
	local var_35_25 = MenuBuilder.BuildRegisteredType("CustomizationDetailPanel", {
		controllerIndex = var_35_1
	})

	var_35_25.id = "DetailPanel"

	var_35_25:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 1269, _1080p * 1824, _1080p * 230, _1080p * 870)
	var_35_0:addElement(var_35_25)

	var_35_0.DetailPanel = var_35_25

	local var_35_26
	local var_35_27 = LUI.UIStyledText.new()

	var_35_27.id = "ItemsCollected"

	var_35_27:SetRGBFromTable(SWATCHES.genericButton.description, 0)
	var_35_27:setText(Engine.CBBHFCGDIC("LUA_MENU/COLLECTED_X"), 0)
	var_35_27:SetFont(FONTS.GetFont(FONTS.BodyRegular.File))
	var_35_27:SetAlignment(LUI.Alignment.Left)
	var_35_27:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 96, _1080p * 281, _1080p * 201, _1080p * 223)
	var_35_0:addElement(var_35_27)

	var_35_0.ItemsCollected = var_35_27

	local var_35_28
	local var_35_29 = MenuBuilder.BuildRegisteredType("FavoriteAndSort", {
		controllerIndex = var_35_1
	})

	var_35_29.id = "FavoriteAndSort"

	var_35_29:SetAnchorsAndPosition(0, 1, 0, 1, _1080p * 865, _1080p * 1206, _1080p * 200, _1080p * 224)
	var_35_0:addElement(var_35_29)

	var_35_0.FavoriteAndSort = var_35_29

	local function var_35_30()
		return
	end

	var_35_0._sequences.DefaultSequence = var_35_30
	...
	var_35_25:RegisterAnimationSequence("Popup", var_35_32)

	local function var_35_33()
		var_35_25:AnimateSequence("Popup")
	end

	var_35_0._sequences.Popup = var_35_33
	...
	var_35_25:RegisterAnimationSequence("Normal", var_35_35)

	local function var_35_36()
		var_35_25:AnimateSequence("Normal")
	end

	var_35_0._sequences.Normal = var_35_36

	local var_35_37 = LUI.UIScrollbar.new({
		direction = LUI.DIRECTION.vertical,
		eventListener = var_35_14,
		startCap = var_35_14.startCap,
		endCap = var_35_14.endCap,
		sliderArea = var_35_14.sliderArea,
		slider = var_35_14.sliderArea and var_35_14.sliderArea.slider,
		fixedSizeSlider = var_35_14.sliderArea and var_35_14.sliderArea.fixedSizeSlider
	})

	var_35_12:AddScrollbar(var_35_37)
	...
	local var_35_38 = LUI.UIBindButton.new()

	var_35_38.id = "selfBindButton"

	var_35_0:addElement(var_35_38)

	var_35_0.bindButton = var_35_38
