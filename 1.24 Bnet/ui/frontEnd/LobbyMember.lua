...
local function var_0_7(arg_7_0, arg_7_1)
	...
	local function var_7_3()
		...
		if var_9_0 ~= nil then
			if Engine.CGABICJHAI() then
				local var_9_1 = Engine.CBAAECBJAJ(var_9_0, var_0_0)

				arg_7_0.Gamertag:setText(var_9_1, 0)
			else
		...
		local var_9_2 = arg_7_0:GetDataSource().missingGamertag:GetValue(arg_7_1)

		if Engine.EAIICIFIFA() then
			if var_9_2 or CONDITIONS.IsSystemLink() then
				ACTIONS.AnimateSequence(arg_7_0, "HideRank")
			else
				ACTIONS.AnimateSequence(arg_7_0, "ShowRank")
			end
		elseif var_9_2 or CONDITIONS.IsSystemLink() or not CONDITIONS.IsPublicMatch() then
			ACTIONS.AnimateSequence(arg_7_0, "HideRank")
		else
			ACTIONS.AnimateSequence(arg_7_0, "ShowRank")
		end
	...
	local function var_7_8()
		...
		if var_20_0 ~= nil then
			ACTIONS.AnimateSequence(arg_7_0, PROGRESSION.IsElderRank(tonumber(var_20_0)) and "ElderRank" or "StandardRank")
		end
	end
...
function LobbyMember(arg_21_0, arg_21_1)
	...
	var_21_20:SetRGBFromInt(11711405, 0)
	...
	var_21_34:SetRGBFromInt(14954125, 0)
