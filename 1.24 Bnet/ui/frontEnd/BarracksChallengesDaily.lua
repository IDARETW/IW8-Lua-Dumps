...
local function var_0_6(arg_7_0, arg_7_1, arg_7_2)
	...
	arg_7_0:registerEventHandler("challenges_update_status", function(arg_8_0, arg_8_1)
		if arg_8_1.challenge then
			...
			arg_7_0.BarracksUpsellPurchaseButton:Enable(not arg_8_1.challenge.unlocked and Dvar.IBEGCHEFE("OKPORRORMM") and CONDITIONS.ShouldDisplayUpsellPopup(arg_7_1))
